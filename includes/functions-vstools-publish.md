...
4. En el cuadro de diálogo **Azure App Service: Crear nuevo**, use la configuración de **hospedaje** que se especifica en la tabla incluida debajo de la imagen:
