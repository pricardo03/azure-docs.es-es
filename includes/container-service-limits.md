...
| Máximo de clústeres por suscripción | 20<sup>2</sup> |
...
<sup>2</sup> cree una [solicitud de soporte técnico de Azure][azure-support] para solicitar un aumento del límite.<br />
