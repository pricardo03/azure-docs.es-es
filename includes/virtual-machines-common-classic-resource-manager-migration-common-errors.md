...
| La red virtual {nombre de la red virtual} no existe. |Esto puede ocurrir si ha creado la red virtual en el nuevo Azure Portal. El nombre de red Virtual real sigue el patrón "grupo * \<nombre de red virtual >" |
