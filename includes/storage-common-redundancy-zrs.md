...
Al almacenar los datos en una cuenta de almacenamiento con replicación ZRS, aún puede tener acceso a los datos y administrarlos si una zona de disponibilidad no está disponible. ZRS proporciona un excelente rendimiento y baja latencia. ZRS ofrece los mismos objetivos de escalabilidad que el [almacenamiento con redundancia local (LRS)](../articles/storage/common/storage-redundancy-lrs.md). Para obtener más información sobre los objetivos de escalabilidad de cuentas de almacenamiento estándar, consulte [Objetivos de escalabilidad para cuentas de almacenamiento estándar](../articles/storage/common/scalability-targets-standard-account.md).
