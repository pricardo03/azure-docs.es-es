...
1. Proporcione un nombre y un valor. Seleccione **+** para agregar la etiqueta.
...
1. En cualquier lista de recursos, seleccione la casilla de los recursos a los que quiere asignar la etiqueta.

     ![Seleccionar varios recursos](./media/resource-manager-tag-resources/select-multiple-resources.png)

1. Seleccionar **Asignar etiquetas**

     ![Asignar etiquetas](./media/resource-manager-tag-resources/assign-tags.png)

1. Después de cada nombre y valor, seleccione **+** . Cuando haya terminado, seleccione **Asignar**.
