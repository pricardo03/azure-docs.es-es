...
| Zonas de disponibilidad | En SKU de nivel Básico, front-ends zonales y con redundancia de zona para la entrada y la salida, asignaciones de flujos de salida, supervivencia a errores de zona, equilibrio de carga entre zonas. | No disponible |
...
| Seguro de forma predeterminada | La entrada predeterminada está cerrada para las direcciones IP y los puntos de conexión del equilibrador de carga públicos. Debe utilizarse un grupo de seguridad de red para crear explícitamente una lista blanca que permita que el tráfico fluya. | Abierto de forma predeterminada, grupo de seguridad de red opcional. |
