...
| Método | DESCRIPCIÓN |
| ------ | ----------- |
| Azure Portal |  También puede [equilibra la carga de tráfico de internet a las máquinas virtuales mediante Azure portal](../articles/load-balancer/tutorial-load-balancer-standard-manage-portal.md). |
...
| Método | DESCRIPCIÓN |
| ------ | ----------- |
| Azure Portal | También puede [equilibrar la carga de tráfico interno con un equilibrador de carga básico en el portal de Azure](../articles/load-balancer/tutorial-load-balancer-basic-internal-portal.md). |
