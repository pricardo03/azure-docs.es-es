...
Si no desea usar Azure Cloud Shell, puede instalar Azure PowerShell localmente en su lugar. Asegúrese de instalar la versión más reciente del módulo Azure PowerShell Az para que las funcionalidades estén actualizadas. Para más información, vea [Instalar Azure PowerShell](/powershell/azure/overview).
