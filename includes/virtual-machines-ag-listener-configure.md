...
4. <a name="congroup"></a>Configure el recurso IP para el grupo de disponibilidad.
...
5. <a name = "dependencyGroup"></a>Haga que el recurso del grupo de disponibilidad de SQL Server dependa del punto de acceso cliente.
...
6. <a name="listname"></a>Haga que el recurso de punto de acceso cliente dependa de la dirección IP.
...
7. <a name="setparam"></a>Establezca los parámetros de clúster en PowerShell.
...
4. <a name="setwsfcparam"></a>Establezca los parámetros de clúster en PowerShell.
