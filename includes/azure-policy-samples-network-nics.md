...
ms.locfileid: "34664679"
---
### <a name="network-interfaces"></a>Interfaces de red

|  |  |
|---------|---------|
| [NSG X en cada NIC](../articles/azure-policy/scripts/nsg-on-nic.md) | Requiere que se use un grupo de seguridad de red específico con cada interfaz de red virtual. Se especifica el identificador del grupo de seguridad de red que se va a usar. |
