...
2. Use la configuración de Function App especificada en la tabla debajo de la imagen.
    ...
    | **SISTEMA OPERATIVO** | Windows | Las opciones de idioma disponibles dependen del sistema operativo de la aplicación de función. Por ejemplo, Python requiere Linux. |
