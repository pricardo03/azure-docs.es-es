...
ms.locfileid: "55302202"
---
1. Complete el [inicio rápido de Azure Machine Learning en Python](../articles/machine-learning/service/quickstart-create-workspace-with-python.md) para crear un área de trabajo.  Si lo desea, omita la sección **Uso del cuaderno**.
