...
- Guías de inicio rápido
    ...
    |Título|DESCRIPCIÓN|
    |------|-----|
    |[Uso de Azure Portal](../articles/azure-resource-manager/resource-manager-quickstart-create-templates-use-the-portal.md)|Genere una plantilla mediante el portal y entienda el proceso de edición e implementación de la plantilla.|
    |[Usar Visual Studio Code](../articles/azure-resource-manager/resource-manager-quickstart-create-templates-use-visual-studio-code.md)|Use Visual Studio Code para crear y editar plantillas y use Azure Cloud Shell para implementar plantillas.|
    |[Usar Visual Studio](../articles/azure-resource-manager/vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)|Use Visual Studio para crear, editar e implementar plantillas.|
