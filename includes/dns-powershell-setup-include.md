...
Abre la consola de PowerShell y conéctate a tu cuenta. Para obtener más información, consulte [inicie sesión en](/powershell/azure/install-az-ps?view=azps-1.4.0#sign-in).
