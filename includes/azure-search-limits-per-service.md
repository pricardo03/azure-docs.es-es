...
| Recurso | Gratuito | Basic<sup>1</sup> | S1 | S2 | S3 | S3&nbsp;HD<sup>2</sup> |
| -------- | --- | --- | --- | --- | --- | --- |
| Nivel acuerdo de servicio (SLA)<sup>3</sup>  |Sin  |Sí |Sí |Sí |Sí |Sí |
...
<sup>1</sup>basic tiene una partición fija. En este nivel, las unidades de búsqueda adicional se usan para asignar más réplicas para cargas de trabajo de consulta.
