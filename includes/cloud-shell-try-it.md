...
| Vaya a [https://shell.azure.com](https://shell.azure.com) o seleccione el botón **Iniciar Cloud Shell** para abrir Cloud Shell en el explorador. | [![Iniciar Cloud Shell en una nueva ventana](media/cloud-shell-try-it/launchcloudshell.png)](https://shell.azure.com) |
