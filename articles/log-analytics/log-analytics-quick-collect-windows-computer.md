...
5. En la página **Opciones de instalación del agente**, elija la opción de conectar el agente a Azure Log Analytics y, luego, haga clic en **Siguiente**.   
