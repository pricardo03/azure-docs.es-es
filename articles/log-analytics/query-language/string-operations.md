---
title: Trabajar con cadenas en consultas de Azure Log Analytics | Microsoft Docs
...
ms.locfileid: "40191151"
---
# <a name="working-with-strings-in-log-analytics-queries"></a>Trabajar con cadenas en las consultas de Log Analytics


> [!NOTE]
> Debe completar la [Introducción al portal de Analytics](get-started-analytics-portal.md) y la [Introducción a las consultas en Log Analytics](get-started-queries.md) antes de completar este tutorial.
...
------------------------------------------------|----------------------------------------------------------
4663: se ha intentado obtener acceso a un objeto.  |Id. de actividad 4663: se ha intentado obtener acceso a un objeto.
