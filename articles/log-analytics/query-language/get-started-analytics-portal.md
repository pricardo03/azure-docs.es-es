...
![Agregar filtro a consulta](media/get-started-analytics-portal/add-filter.png)
...
![Filtrar](media/get-started-analytics-portal/filter.png)
...
![Ordenación de la columna](media/get-started-analytics-portal/sort-column.png)
...
![Anclar al panel](media/get-started-analytics-portal/pin-dashboard.png)
...
![Función Guardar](media/get-started-analytics-portal/save-function.png)
...
- Vínculo compartido: la propia consulta se puede compartir como vínculo y enviárselo a otros usuarios de esa área de trabajo para que estos la ejecuten.
