...
![Esquema de ejemplo simple](./media/log-analytics-create-pipeline-datacollector-api/example-simple-schema-01.png)
...
![Arquitectura de la canalización de recopilación de datos](./media/log-analytics-create-pipeline-datacollector-api/data-pipeline-dataflow-architecture.png)
...
![Ejemplo de flujo de trabajo de Logic Apps](./media/log-analytics-create-pipeline-datacollector-api/logic-apps-workflow-example-01.png)
...
2.  En la pestaña **Ver archivos** del panel derecho, cree un nuevo archivo llamado **project.json** y pegue el siguiente código de los paquetes de NuGet que estamos usando:
    ...
    ![Proyecto de ejemplo de Azure Functions](./media/log-analytics-create-pipeline-datacollector-api/functions-example-project-01.png)
...
5. Pruebe la función para asegurarse de que el código funciona correctamente. Cambie a la pestaña **Probar** en el panel derecho y configure la prueba como sigue. Especifique un vínculo a un blob con datos de ejemplo en cuadro de texto **Cuerpo de la solicitud**. Después de hacer clic en **Ejecutar**, debería ver la salida JSON en el cuadro **Salida**:
    ...
    ![Código de prueba de Function App](./media/log-analytics-create-pipeline-datacollector-api/functions-test-01.png)
...
![Ejemplo completo del flujo de trabajo de Logic Apps](./media/log-analytics-create-pipeline-datacollector-api/logic-apps-workflow-example-02.png)
...
![Correlación de datos separados en un ejemplo de resultado de búsqueda](./media/log-analytics-create-pipeline-datacollector-api/correlating-disjoined-data-example-01.png)
...
Obtenga más información sobre [Data Collector API](log-analytics-data-collector-api.md) para escribir datos en Log Analytics desde cualquier cliente de API REST.
