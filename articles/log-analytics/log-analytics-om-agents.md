...
* Un área de trabajo de Log Analytics. Para más información, consulte la [introducción a las áreas de trabajo de Log Analytics](log-analytics-manage-access.md?toc=/azure/azure-monitor/toc.json).
...
Después de completar la integración con Log Analytics, puede quitar la configuración; para hacerlo, ejecute `netsh winhttp reset proxy` y, después, use la opción **Configurar servidor proxy** de la Consola del operador para especificar el proxy o el servidor de puerta de enlace de Log Analytics. 
...
Para agregar funcionalidad y recopilar información, vea [Incorporación de soluciones de Log Analytics desde la galería de soluciones](../monitoring/monitoring-solutions.md).
