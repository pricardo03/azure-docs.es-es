...
1. Use la cuenta de facturación para administrar la facturación de su contrato de cliente de Microsoft. Los administradores de Enterprise se convierten en los propietarios de la cuenta de facturación. Para obtener más información sobre la cuenta de facturación, consulte [Descripción de la cuenta de facturación](billing-mca-overview.md#your-billing-account).
