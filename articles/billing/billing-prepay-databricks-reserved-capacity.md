...
![Ejemplo en el que se muestra la compra de Azure Databricks en Azure Portal](./media/billing-prepay-databricks-reserved-capacity/data-bricks-pre-purchase.png)
...
La compra anticipada de unidades de confirmación de Databricks no se puede dividir ni combinar. Para obtener más información sobre cómo administrar las reservas, consulte [Administración de reservas](billing-manage-reserved-vm-instance.md).
...
- Para obtener más información acerca de Azure Reservations, consulte los siguientes artículos:
  ...
  - [Descripción de cómo se aplica un descuento de DBCU de compra anticipada de Azure Databricks](billing-reservation-discount-databricks.md)
