---
title: Información general sobre la API de consumo de Azure | Microsoft Docs
...
Para obtener más información, vea la especificación técnica de la [API de saldos](https://docs.microsoft.com/rest/api/consumption/getbalancesbybillingaccount).
