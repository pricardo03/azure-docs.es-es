---
title: Visualización de los precios de Azure del Contrato Enterprise | Microsoft Docs
description: Obtenga información sobre cómo ver y descargar los precios o calcule los costos con los precios del contrato Enterprise.
services: ''
documentationcenter: ''
author: adpick
manager: dougeby
...
ms.locfileid: "53090863"
---
# <a name="view-your-organizations-azure-enterprise-agreement-pricing"></a>Visualización de los precios del Contrato Enterprise de Azure de su organización 

Los clientes de Azure con un Contrato Enterprise (EA) pueden ver y descargar los precios de su EA desde Azure Portal. También puede usar los precios de EA de su organización para estimar los costos mediante la calculadora de precios de Azure.
...
## <a name="estimate-costs-with-ea-pricing"></a>Estimación de los costos con los precios de EA
...
- [Administración del acceso a la información de facturación de Azure](billing-manage-access.md)
- [Descripción de la factura de los clientes de Azure con un Contrato Enterprise](billing-understand-your-bill-ea.md)
