...
## <a name="incorrect-overage-invoice"></a>Factura con un uso por encima del límite incorrecto

Si cree que tiene una factura de uso por encima del límite incorrecta, consulte [Descripción de la factura de Azure Enterprise](billing-understand-your-bill-ea.md) para ayudarle a conciliar los cargos de uso de Azure. Si cree que hay un error en el uso por encima del límite que le ha cobrado Microsoft, póngase en contacto con el soporte técnico.
...
El portal del Contrato Enterprise de Azure genera automáticamente un número de pedido de compra predeterminado, a menos que el administrador del Contrato Enterprise establezca uno antes de la fecha de la factura. Un administrador del Contrato Enterprise puede actualizar el número de pedido de compra en el portal del Contrato Enterprise de Azure iniciando sesión y yendo a **Reports** (Informes). Un administrador del Contrato Enterprise puede actualizar el número de pedido de compra. En la sección superior derecha, donde se muestra el número de pedido de compra, haga clic en el símbolo de lápiz y actualice la información.

Un administrador del Contrato Enterprise puede actualizar el número de pedido de compra durante el trimestre de facturación actual antes de crear una factura. También pueden actualizar el número de pedido de compra hasta siete días después de recibir un correo electrónico de notificación de factura automática.

Si el administrador del Contrato Enterprise no ha actualizado el número de pedido de compra y se necesita un nuevo número de pedido, la única opción es completar un crédito y volver a facturar. Si un cliente debe actualizar el número de pedido de compra, póngase en contacto con el asociado para obtener ayuda.
...
Todos los créditos o ajustes que se aplican a la inscripción están visibles en [https://www.ea.azure.com](https://www.ea.azure.com) en la sección **Informes**. Si tiene una pregunta específica sobre un importe de crédito real, póngase en contacto con el [soporte técnico del portal del Contrato Enterprise de Azure](https://support.microsoft.com/supportrequestform/cf791efa-485b-95a3-6fad-3daf9cd4027c).
...
_Los cargos se facturan por separado_ y _los servicios de Azure Marketplace_ son servicios de terceros que se implementan desde la plataforma Azure Marketplace. La principal diferencia entre los dos servicios es cómo se facturan, en función de la estructura del contrato establecida con publicadores de terceros.

El uso de terceros aparece en la factura bajo **Charges Billed Separately** (Cargos facturados por separado). El uso consume el saldo del compromiso monetario de Azure. Para ver la lista de servicios de terceros, consulte [Los servicios de revendedores de terceros de Azure Marketplace utilizan el compromiso monetario de Azure](https://azure.microsoft.com/updates/azure-marketplace-third-party-reseller-services-now-use-azure-monetary-commitment/).

El uso de la factura que aparece en **Azure Marketplace** se cobra por separado. No lo cubre ningún compromiso monetario. Sin embargo, todos los cargos, como Marketplace, uso por encima del límite y cargos facturados por separado, se consolidan en una sola factura.

Recibirá una única factura por el propio uso por encima del límite de Azure y por las compras en el Marketplace de terceros.

Cuando el compromiso monetario se consume por completo, el uso se factura mensual o trimestralmente. Si la inscripción se inició antes de mayo de 2018, se aplica una regla de umbral de compromiso monetario del 150 % y se le factura trimestralmente. Si la inscripción se ha iniciado después de mayo de 2018, todo el uso por encima del límite se factura mensualmente.
