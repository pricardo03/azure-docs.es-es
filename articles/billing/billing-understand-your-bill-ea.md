---
title: Descripción de la factura de Azure Enterprise
...
Esta sección no se aplica a los clientes de Azure en Australia, Japón ni Singapur. Si es cliente de uno de esos países o regiones, consulte [Facturas para otros clientes](#invoices-for-other-customers).
...
1. Para más detalles sobre los cargos, vaya a **Descarga del uso**.  
    ![Captura de pantalla que muestra la pestaña Descarga del uso](./media/billing-understand-your-bill-ea/ea-portal-download-usage.png)

## <a name="invoices-for-other-customers"></a>Facturas para otros clientes
...
## <a name="review-charges-for-other-customers"></a>Revisión de cargos para otros clientes
...
1. Para más información sobre los gastos, vaya a **Descargar uso** > **Descargar informe avanzado**. El informe no incluye los impuestos ni los gastos por reservas o de Marketplace.  
      ![Captura de pantalla que muestra Descargar informe avanzado en la pestaña Descarga del uso](./media/billing-understand-your-bill-ea/ea-portal-download-usage-advanced.png).
...
- [Visualización y descarga de los datos de uso y los cargos de Azure](billing-download-azure-daily-usage.md)
