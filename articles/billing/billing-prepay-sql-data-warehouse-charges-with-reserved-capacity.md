...
- Para más información sobre cómo se aplican los descuentos por reserva a Azure SQL Data Warehouse, consulte [Aplicación de descuentos por reserva a Azure SQL Data Warehouse](billing-prepay-sql-data-warehouse-charges-with-reserved-capacity.md).
