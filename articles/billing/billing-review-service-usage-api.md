...
El parámetro `{subscriptionGuid}` es obligatorio y debe contener un identificador de suscripción que pueda leerse utilizando las credenciales proporcionadas en el token de la API. `{reportName}`
