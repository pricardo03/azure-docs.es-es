...
Para información sobre la aplicación de Azure Reservations en informes de uso de facturación, consulte el artículo [Información sobre el uso de Azure Reservations](billing-understand-reserved-instance-usage-ea.md).
