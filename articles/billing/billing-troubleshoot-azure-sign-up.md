...
![Verificación de identidad mediante tarjeta](./media/billing-troubleshoot-azure-sign-up/identify-verification-by-card.png)
...
Es posible que vea reflejado un cargo de verificación mínimo en la tarjeta de crédito después de registrarse, que desaparecerá en un plazo de entre tres y cinco días. Si le preocupan los costos de administración, lea más información en la página sobre [prevención de costos inesperados](billing-getting-started.md).
