...
AccountOwnerId | EA, pago por uso | Identificador único de la cuenta de inscripción de EA o de la cuenta de facturación de pago por uso.
AdditionalInfo | Todo | Metadatos específicos del servicio. Por ejemplo, un tipo de imagen de una máquina virtual.
BillingAccountId | Todo | Identificador único de la cuenta de facturación raíz.
...
BillingProfileId | Todo | Identificador único de la inscripción de EA, suscripción de pago por uso, perfil de facturación de MCA o cuenta consolidada de AWS.
...
Date | Todo | La fecha de utilización o compra del cargo.
...
OfferId | Todo | Nombre de la oferta comprada.
PartNumber | EA, pago por uso | Identificador que se usa para obtener los precios específicos de medidor.
...
ProductId | MCA | Identificador único del producto.
...
ResourceId | Todo | Identificador único del recurso de [Azure Resource Manager](https://docs.microsoft.com/rest/api/resources/resources).
