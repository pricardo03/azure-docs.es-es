...
## <a name="azure-security-center-for-iot-alerts-available-for-customization"></a>Alertas de Azure Security Center para IoT disponibles para personalizarse 
