...
Todos los datos que se envían, incluso si se marca con el encabezado correcto, también deben cumplir con la [ASC para el esquema de mensaje IoT](https://github.com/Azure/ASC-for-IoT-Schemas). 
