...
Si no tiene un grupo de recursos existente, cree uno nuevo con el comando **New-AzResourceGroup**. Proporcione el nombre del grupo de recursos y la ubicación que desee utilizar. Por ejemplo:
