...
> [!NOTE]
> El nivel Básico de Service Bus no admite sesiones. Los niveles Estándar y Premium admiten sesiones. Para más información, consulte [Precios de Service Bus](service-bus-pricing-billing.md).
