...
Para dar a Service Bus el tiempo suficiente para poner en cola el mensaje en otro fragmento, el valor de [OperationTimeout](/dotnet/api/microsoft.azure.servicebus.queueclient.operationtimeout) especificado por el cliente que envía el mensaje debe ser superior a 15 segundos. Se recomienda establecer la propiedad [OperationTimeout](/dotnet/api/microsoft.azure.servicebus.queueclient.operationtimeout) en el valor predeterminado de 60 segundos.
