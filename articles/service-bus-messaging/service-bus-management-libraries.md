...
> [!IMPORTANT]
> Para obtener un ejemplo completo, vea el [ejemplo de administración de .NET en GitHub]((https://github.com/Azure-Samples/service-bus-dotnet-management/)). 
