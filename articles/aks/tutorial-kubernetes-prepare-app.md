...
Cuando se haya quitado la aplicación local, tendrá una imagen de Docker que contiene la aplicación Azure Vote, *azure-front-front*, que puede usar con el siguiente tutorial.
