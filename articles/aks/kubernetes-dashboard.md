...
> [!TIP]
> Si ejecuta este comando desde Azure Cloud Shell, agregue el parámetro `--enable-cloud-console-aks-browse` para abrir el panel correctamente.
