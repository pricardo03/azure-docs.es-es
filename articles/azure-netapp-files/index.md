---
title: Documentación sobre Azure NetApp Files | Microsoft Docs
description: Aprenda a configurar, acceder y administrar volúmenes mediante el servicio Azure NetApp Files
author: b-juche
manager: ''
layout: LandingPage
ms.assetid: ''
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Más información acerca de Azure NetApp Files</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introducción a Azure NetApp Files mediante Azure Portal</h3>
                    </div>
                </div>
            </div>
        </div>
