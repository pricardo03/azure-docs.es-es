---
title: Entrenamiento de un modelo de CNTK con Azure Batch AI mediante Python | Microsoft Docs
description: Entrenamiento de una red neuronal de Microsoft Cognitive Toolkit (CNTK) con Azure Batch AI mediante el SDK de Python
services: batch-ai
...
En este artículo se muestra cómo utilizar el SDK de Azure Python para entrenar un modelo de ejemplo de Microsoft Cognitive Toolkit (CNTK) mediante el servicio Batch AI.
...
* SDK de Python de Azure: consulte las [instrucciones de instalación](/python/azure/python-sdk-azure-install). En este artículo requiere al menos la versión 2.0.0 del paquete azure-mgmt-batchai.
...
Cree un recurso compartido de archivos llamado `batchaiquickstart`.
...
Cree un directorio en el recurso compartido llamado `mnistcntksample`.

```Python
mnist_dataset_directory = 'mnistcntksample'
service.create_directory(azure_file_share_name, mnist_dataset_directory, fail_on_exist=False)
```
Descargue el [paquete de ejemplo](https://batchaisamples.blob.core.windows.net/samples/BatchAIQuickStart.zip?st=2017-09-29T18%3A29%3A00Z&se=2099-12-31T08%3A00%3A00Z&sp=rl&sv=2016-05-31&sr=b&sig=hrAZfbZC%2BQ%2FKccFQZ7OC4b%2FXSzCF5Myi4Cj%2BW3sVZDo%3D) y descomprímalo en el directorio actual. El siguiente código carga los archivos necesarios en el recurso compartido de archivos de Azure:
...
Un área de trabajo es una colección de nivel máximo de todos los tipos de recursos de Batch AI. Cree el clúster de Batch AI y experimentos en un área de trabajo.
...
## <a name="create-experiment-and-training-job"></a>Creación de un experimento y un trabajo de aprendizaje

Tras crear el clúster, cree un experimento (un contenedor lógico de un grupo de trabajos relacionados). Luego, configure y envíe un trabajo de aprendizaje en el experimento:
...
Para más información sobre el uso de Batch AI con plataformas diferentes, consulte las [instrucciones de entrenamiento](https://github.com/Azure/BatchAI).