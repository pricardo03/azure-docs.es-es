---
title: 'Inicio rápido: Conexión a Azure Database for MySQL desde Python'
...
En este artículo se muestra cómo usar [Python](https://python.org) para conectarse a una instancia de Azure Database for MySQL. Se emplean instrucciones SQL para consultar, insertar, actualizar y eliminar datos de la base de datos en las plataformas Mac OS, Ubuntu Linux y Windows. 
...
Instale [Python](https://www.python.org/downloads/) y el [conector de MySQL para Python](https://dev.mysql.com/downloads/connector/python/) en su propia máquina. Según la plataforma, siga los pasos de la sección que proceda. 
...
1. Descargue e instale Python 3.7 desde [python.org](https://www.python.org/downloads/windows/). 
2. Para comprobar la instalación de Python, inicie el símbolo del sistema. Ejecute el comando `C:\python37\python.exe -V` mediante el modificador V mayúscula para ver el número de versión.
