...
Esta plantilla de Azure Resource Manager crea un servidor de Azure Database for MySQL y utiliza **KeyVault** y **Key** como parámetros para habilitar el cifrado de datos en el servidor.
