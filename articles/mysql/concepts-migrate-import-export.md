...
- Para obtener más información sobre cómo migrar bases de datos a Azure Database for MySQL, vea la [Guía de migración de base de datos](http://aka.ms/datamigration). 
