...
> [!NOTE]
> MySQL 8.0 se encuentra actualmente en versión preliminar. Si no ve MySQL 8.0 en Azure Portal, es posible que la implementación no se haya completado en su región. 
