...
Para pasar parámetros en línea, proporcione los nombres de parámetro con el comando `New-AzureRmResourceGroupDeployment`. Por ejemplo, para pasar una cadena y una matriz a una plantilla, use:
