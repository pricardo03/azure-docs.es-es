...
1. Se muestra un resumen de la implementación, incluido el id. de correlación. 
    ...
    ![Resumen de implementación](./media/resource-manager-deployment-operations/show-correlation-id.png)
...
1. En el Resumen de una implementación, seleccione **Detalles de la operación**.
    ...
    ![Selección de operaciones de implementación](./media/resource-manager-deployment-operations/get-operation-details.png)
...
1. Verá los detalles de ese paso de la implementación. Cuando se produce un error, los detalles incluyen el mensaje de error.
    ...
    ![Representación de los detalles de la operación](./media/resource-manager-deployment-operations/see-operation-details.png)
