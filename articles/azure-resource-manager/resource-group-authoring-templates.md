...
* Para más recomendaciones sobre creación de platillas, consulte [Procedimientos recomendados para plantillas de Azure Resource Manager](template-best-practices.md).
