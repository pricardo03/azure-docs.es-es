...
Para mover los recursos de la versión clásica a un nuevo grupo de recursos de la misma suscripción, utilice las [operaciones de traslado estándar](../resource-group-move-resources.md) en el portal, Azure PowerShell, la CLI de Azure o la API REST. Utilice las mismas operaciones que utiliza para trasladar recursos de Resource Manager.
