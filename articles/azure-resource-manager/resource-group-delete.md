...
* Para los comandos de eliminación, consulte [PowerShell](/powershell/module/azurerm.resources/Remove-AzureRmResourceGroup), [CLI de Azure](/cli/azure/group?view=azure-cli-latest#az-group-delete), y [API de REST](/rest/api/resources/resourcegroups/delete).
