...
- Para obtener el id. de un recurso de extensión en una plantilla de Azure Resource Manager, use [extensionResourceId](template-functions-resource.md#extensionresourceid).
