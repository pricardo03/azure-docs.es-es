...
![Cuenta de almacenamiento cifrada de implementación de referencia de plantilla de Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-tutorial-deploy-encrypted-storage-account.png)
...
1. En VS Code, contraiga la plantilla al nivel raíz. Tiene la estructura más sencilla con los siguientes elementos:
    ...
    ![La estructura más sencilla de la plantilla de Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-simplest-structure.png)
...
2. Expanda **recursos**. Hay un recurso `Microsoft.Storage/storageAccounts` definido. La plantilla crea una cuenta de Storage sin cifrar.
    ...
    ![Definición de cuenta de almacenamiento de la plantilla de Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resource.png)
...
3. Seleccione **Reference/Template reference/Storage/&lt;Version>/Storage Accounts** como se muestra en la captura de pantalla siguiente:
    ...
    ![Cuenta de almacenamiento de referencia de plantilla de Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts.png)
...
4. Búsqueda de la información de definición relacionada con el cifrado.
    ...
    ![Cifrado de la cuenta de almacenamiento de referencia de la plantilla de Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption.png)
    ...
    ![Objeto de cifrado de la cuenta de almacenamiento de referencia de la plantilla de Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption-object.png)
...
![Recursos de la cuenta de almacenamiento cifrada de la plantilla de Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resources.png)
...
![Cuenta de almacenamiento cifrada de Azure Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-account.png)
