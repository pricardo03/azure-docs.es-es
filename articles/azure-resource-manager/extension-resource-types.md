---
title: Tipos de recursos de extensión de Azure
...
- Para obtener el id. de un recurso de extensión en una plantilla de Azure Resource Manager, use [extensionResourceId](resource-group-template-functions-resource.md#extensionresourceid).
