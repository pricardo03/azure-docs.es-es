...
2. En la hoja **Function App**, escriba los siguientes valores y seleccione **Aceptar** para crear la aplicación:
    ...
    |**Subscription**|[Su suscripción]La suscripción para la que se crea la aplicación de función.||
    ...
    |**Cuenta de almacenamiento**|{autogenerated}| Cuenta de almacenamiento que necesita Azure Functions para el almacenamiento de carácter general.|
...
4. Seleccione **HttpTrigger-Powershell** y, a continuación, especifique la información restante. Por último, para crear la función, seleccione **Crear**.
    ...
    |**Asignar un nombre a la función**|AlertPacketCapturePowerShell|Nombre de la función.|
...
1. Haga clic en el **Az.Network** subcarpeta y, a continuación, seleccione **cargar archivos**. 

6. Vaya a los módulos de Azure. En el equipo local **Az.Network** carpeta, seleccione todos los archivos en la carpeta. Después seleccione **Aceptar**. 

7. Repita estos pasos para **Az.Accounts** y **Az.Resources**.
...
Vaya a una máquina virtual existente y agregue una regla de alerta. Se puede encontrar documentación más detallada sobre la configuración de alertas en [Creación de alertas en Azure Monitor para servicios de Azure (Azure Portal)](../monitoring-and-diagnostics/insights-alerts-portal.md). Escriba los siguientes valores en la hoja **Regla de alertas** y, a continuación, seleccione **Aceptar**.
  ...
  |**Condición**|Mayor que| La condición que se va a usar al evaluar la métrica.|
