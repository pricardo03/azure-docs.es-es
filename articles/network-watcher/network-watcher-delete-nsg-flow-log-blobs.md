...
- Los clientes pueden automatizar la ejecución del script mediante [Azure Scheduler](https://azure.microsoft.com/services/scheduler/) o [Azure Automation](https://azure.microsoft.com/services/automation/).
