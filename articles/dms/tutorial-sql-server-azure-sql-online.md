---
title: 'Tutorial: Uso de Azure Database Migration Service para realizar una migración en línea de SQL Server a Azure SQL Database | Microsoft Docs'
...
ms.locfileid: "52872228"
---
# <a name="tutorial-migrate-sql-server-to-azure-sql-database-online-using-dms"></a>Tutorial: Migración de SQL Server a Azure SQL Database en línea mediante DMS
...
En este artículo se describe una migración en línea desde SQL Server a Azure SQL Database. Para migraciones sin conexión, consulte [Migración de SQL Server a Azure SQL Database sin conexión mediante DMS](tutorial-sql-server-to-azure-sql.md).

## <a name="prerequisites"></a>Requisitos previos
Para completar este tutorial, necesita:

- Descargar e instalar [SQL Server 2012 o una versión posterior](https://www.microsoft.com/sql-server/sql-server-downloads) (cualquier edición).
...
5. En la sección **Elegir el tipo de actividad**, seleccione **Migración de datos en línea**
    ...
    ![Creación de un proyecto de Database Migration Service](media\tutorial-sql-server-to-azure-sql-online\dms-create-project3.png)
