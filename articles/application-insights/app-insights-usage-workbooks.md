...
![Captura de pantalla de navegación a los libros](./media/app-insights-usage-workbooks/001-workbooks.png)

Esto inicia una galería de libros con varios libros creados previamente que le ayudarán a empezar a trabajar.

![Captura de pantalla de la galería de libros](./media/app-insights-usage-workbooks/002-workbook-gallery.png)

Comenzaremos con la **Plantilla predeterminada**, que se encuentra en el encabezado **Inicio rápido**.

![Captura de pantalla de la galería de libros](./media/app-insights-usage-workbooks/003-default-template.png)
...
![Controles de edición de secciones de libros de Application Insights](./media/app-insights-usage-workbooks/editing-controls-new.png)
...
![Sección de consulta en los libros](./media/app-insights-usage-workbooks/analytics-section-new.png)
...
Cada sección tiene su propia configuración avanzada, a la que se puede acceder mediante el icono de configuración ![Controles de edición de la sección de libros de Application Insights](./media/app-insights-usage-workbooks/005-settings.png) situado a la derecha del botón **Agregar parámetros**.

![Controles de edición de secciones de libros de Application Insights](./media/app-insights-usage-workbooks/0006-settings-expanded.png)
...
![Controles de edición de secciones de libros de Application Insights](./media/app-insights-usage-workbooks/003-active-users.png)
...
![Controles de edición de secciones de libros de Application Insights](./media/app-insights-usage-workbooks/004-active-users-trend.png)
...
![Controles de edición de secciones de libros de Application Insights](./media/app-insights-usage-workbooks/007-settings-export.png)
...
![Controles de edición de secciones de libros de Application Insights](./media/app-insights-usage-workbooks/008-metrics-grid.png)
...
![Controles de edición de secciones de libros de Application Insights](./media/app-insights-usage-workbooks/009-time-range.png)

Esto iniciará el elemento de menú Editar parámetro:

![Controles de edición de secciones de libros de Application Insights](./media/app-insights-usage-workbooks/010-time-range-edit.png)
...
![Controles de edición de secciones de libros de Application Insights](./media/app-insights-usage-workbooks/011-data-table.png)

Un ejemplo más aplicable es usar una lista desplegable para elegir entre un conjunto de países por el nombre:
...
![Lista desplegable de países](./media/app-insights-usage-workbooks/012-country-dropdown.png)
...
![Lista desplegable de países](./media/app-insights-usage-workbooks/013-resource-picker.png)
