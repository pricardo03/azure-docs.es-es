...
El usuario debe tener una [cuenta de Microsoft][account] o tener acceso a su [cuenta de Microsoft de organización](../active-directory/fundamentals/sign-up-organization.md). Puede proporcionar acceso individual y también a grupos de usuarios definidos en Active Directory de Azure.
...
![Captura de pantalla del botón Control de acceso en Azure Portal](./media/app-insights-resources-roles-access-control/0001-access-control.png)

Seleccione **Agregar**.

![Captura de pantalla del menú Control de acceso con el botón Agregar resaltado en rojo](./media/app-insights-resources-roles-access-control/0002-add.png)
...
![Captura de pantalla de la lista de roles de usuario de Control de acceso](./media/app-insights-resources-roles-access-control/0003-user-roles.png)
