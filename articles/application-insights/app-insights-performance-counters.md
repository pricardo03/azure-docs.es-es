...
![Contadores de rendimiento notificados en Application Insights](./media/app-insights-performance-counters/performance-counters.png)
...
Al igual que otras métricas, puede [establecer una alerta](app-insights-alerts.md) para advertirle si un contador de rendimiento queda fuera de un límite especificado. Abra el panel de alertas y haga clic en Agregar alerta.
