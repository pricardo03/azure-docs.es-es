...
Para agregar funcionalidades de seguimiento distribuido a una aplicación con OpenCensus, primero debe [instalar y configurar el reenviador local de Application Insights](./opencensus-local-forwarder.md). Desde allí, puede configurar OpenCensus para que enrute los datos de seguimiento distribuido mediante el reenviador local. Se admiten [Python](./opencensus-python.md) y [Go](./opencensus-go.md).
