...
- Configuración del seguimiento de dependencias personalizadas para [.NET](app-insights-asp-net-dependencies.md).
- Configuración del seguimiento de dependencias personalizadas para [Java](app-insights-java-agent.md).
