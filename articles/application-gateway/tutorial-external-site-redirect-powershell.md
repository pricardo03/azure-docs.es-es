...
Se necesita un agente de escucha para habilitar la puerta de enlace de aplicaciones para enrutar el tráfico correctamente. Crear el agente de escucha mediante [New AzApplicationGatewayHttpListener](/powershell/module/az.network/new-azapplicationgatewayhttplistener) con la configuración de front-end y puerto de front-end que creó anteriormente. El tráfico se redirige mediante la creación de una configuración de redireccionamiento que se pueda agregar a la regla de enrutamiento creada.

Se necesita una regla de enrutamiento para que el agente de escucha sepa dónde enviar el tráfico entrante. Crear una regla básica llamada *redirectRule* mediante [New AzApplicationGatewayRequestRoutingRule](/powershell/module/az.network/new-azapplicationgatewayrequestroutingrule) con la configuración de redireccionamiento.
