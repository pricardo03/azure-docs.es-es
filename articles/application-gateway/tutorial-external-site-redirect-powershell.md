...
Se necesita un agente de escucha para habilitar la puerta de enlace de aplicaciones para enrutar el tráfico correctamente. Cree el cliente de escucha mediante [New-AzApplicationGatewayHttpListener](/powershell/module/az.network/new-azapplicationgatewayhttplistener) con la configuración y el puerto de front-end creados anteriormente. El tráfico se redirige mediante la creación de una configuración de redireccionamiento que se pueda agregar a la regla de enrutamiento creada.

Se necesita una regla de enrutamiento para que el agente de escucha sepa dónde enviar el tráfico entrante. Cree una regla básica denominada *redirectRule* mediante [New-AzApplicationGatewayRequestRoutingRule](/powershell/module/az.network/new-azapplicationgatewayrequestroutingrule) con la configuración de redireccionamiento.
