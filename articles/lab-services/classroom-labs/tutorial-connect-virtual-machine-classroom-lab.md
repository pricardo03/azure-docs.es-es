...
1. Vaya a la dirección URL de registro que recibió del profesor o educador. que recibió del profesor o educador. 

    ![Creación de un laboratorio educativo](../media/tutorial-connect-vm-in-classroom-lab/access-labs.png)
