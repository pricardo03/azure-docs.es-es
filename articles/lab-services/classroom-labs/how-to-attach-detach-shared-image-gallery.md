...
> [!NOTE]
> Actualmente, Azure Lab Services admite la creación de VM basadas solo en imágenes de VM **generalizadas** (no imágenes especializadas) en una galería de imágenes compartidas. 
