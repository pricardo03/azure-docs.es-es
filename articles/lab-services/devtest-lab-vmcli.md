...
* [Instalación de la CLI de Azure](https://docs.microsoft.com/cli/azure/install-azure-cli). Para empezar, ejecute az login para crear una conexión con Azure. 
