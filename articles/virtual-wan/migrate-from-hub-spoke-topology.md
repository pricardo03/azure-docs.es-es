...
En este artículo se describe cómo migrar un entorno híbrido existente a Virtual WAN.
...
- Quite la dependencia de los centros de datos locales existentes para la terminación de la VPN, pero conserve las siguientes rutas de acceso de conectividad:
...
- Conectividad a Internet para los recursos de una red virtual que proporciona Azure Virtual WAN. Conectividad a Internet para sitios remotos, que también proporciona Azure Virtual WAN. El desglose de Internet local se admite a través de la integración de asociados para optimizar el acceso a los servicios de SaaS como Office 365.

## <a name="migrate-to-azure-virtual-wan"></a>Migración a Azure Virtual WAN

En esta sección se describen los pasos que deben seguirse para migrar a Azure Virtual WAN.
...
- Servicios compartidos (cualquier función común requerida por varios radios): un ejemplo de qué usos de Contoso son controladores de dominio de Windows Server de IaaS en las máquinas virtuales de infraestructura como servicio (IaaS).
...
El primer paso es implementar un centro de conectividad de Virtual WAN en cada región. Configure el centro de conectividad de Virtual WAN con una puerta de enlace de VPN y de ExpressRoute, tal y como se describe en los siguientes artículos:  
...
**Figura 5: Migración de una red en estrella tipo hub-and-spoke de VDC a Virtual WAN: paso 2**

### <a name="connect-remote-sites-expressroute-and-vpn-to-virtual-wan"></a>Conexión de sitios remotos (ExpressRoute y VPN) a Virtual WAN

Ahora se conecta el centro de conectividad de Virtual WAN a los circuitos de ExpressRoute existentes y se instalan las VPN de sitio a sitio a través de Internet en las ramas remotas.
...
![Conectar sitios virtuales a Virtual WAN](./media/migrate-from-hub-spoke-topology/figure6.png)
**Figura 6: Migración de una red en estrella tipo hub-and-spoke de VDC a Virtual WAN: paso 3**
...
### <a name="test-hybrid-connectivity-via-virtual-wan"></a>Prueba de la conectividad híbrida mediante Virtual WAN
...
![Prueba de la conectividad híbrida mediante Virtual WAN](./media/migrate-from-hub-spoke-topology/figure7.png)
**Figura 7: Migración de VDC de una red en estrella tipo hub-and-spoke a Virtual WAN: paso 4**
...
![Conectividad de la transición a un centro de conectividad de Virtual WAN](./media/migrate-from-hub-spoke-topology/figure8.png)
**Figura 8: Migración de VDC de una red en estrella tipo hub-and-spoke a Virtual WAN: paso 5**
...
### <a name="old-hub-becomes-shared-services-spoke"></a>El centro anterior se convierte en un radio de servicios compartidos
...
**Figura 9: Migración de una red en estrella tipo hub-and-spoke de VDC a Virtual WAN: paso 6**
...
### <a name="optimize-on-premises-connectivity-to-fully-utilize-virtual-wan"></a>Optimización de la conectividad local para usar plenamente Virtual WAN
...
![Optimización de la conectividad local para utilizar plenamente Virtual WAN](./media/migrate-from-hub-spoke-topology/figure10.png)
**Figura 10: Migración de VDC de una red en estrella tipo hub-and-spoke a Virtual WAN: paso 7**
...
**Figura 11: Virtual WAN de dos regiones**
...
La ruta de acceso 1 describe el flujo de tráfico de una rama conectada de una VPN de sitio a sitio de Asia a la red virtual de Azure de la región de Asia Suroriental.
...
La ruta de acceso 2 describe el flujo de tráfico desde la sede europea conectada mediante ExpressRoute a una red virtual de Azure en la región de Asia Suroriental.

El tráfico se enruta de la manera siguiente:
- La sede europea está conectada mediante un circuito ExpressRoute Prémium al centro de conectividad de Virtual WAN de Oeste de Europa.
...
- El circuito ExpressRoute termina localmente en conexiones de la WAN privada al centro de conectividad de Virtual WAN de Asia Suroriental.
...
La ruta de acceso 4 describe el flujo de tráfico desde una red virtual de Azure en la región de Asia Suroriental a la red virtual de Azure de la región Oeste de Europa.
...
En la ruta de acceso 5 se describe el flujo de tráfico desde los usuarios de VPN itinerantes (conexión de punto a sitio) a una red virtual de Azure en la región Oeste de Europa.
...
- Este paso anterior permite que el centro de conectividad de Virtual WAN existente funcione como un centro virtual protegido e implementa los recursos de Azure Firewall requeridos.
...
La ruta de acceso 6 describe el flujo de tráfico seguro entre redes virtuales dentro de la misma región.
...
La ruta de acceso 7 describe el flujo de tráfico de red virtual de Azure a Internet o a un servicio de seguridad de terceros.
