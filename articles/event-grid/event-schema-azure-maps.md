...
| data | objeto | Datos de eventos de geovalla. |
...
| nearestlat | número | Latitud del punto más cercano de la geometría. |
| nearestlon | número | Longitud del punto más cercano de la geometría. |
