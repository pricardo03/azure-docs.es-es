---
title: Envío de eventos personalizados con Event Grid y la CLI de Azure
...
![Visualización de los resultados](./media/custom-event-quickstart/view-result.png)
...
![Visualización del evento de suscripción](./media/custom-event-quickstart/view-subscription-event.png)
