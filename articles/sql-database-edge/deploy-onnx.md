...
En esta guía de inicio rápido, aprenderá a entrenar un modelo, convertirlo a ONNX, implementarlo en la versión preliminar de Azure SQL Database Edge y, después, ejecutar la predicción nativa en los datos con el modelo de ONNX cargado.
