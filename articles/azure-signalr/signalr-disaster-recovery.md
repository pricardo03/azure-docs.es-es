...
![Topología](media/signalr-disaster-recovery/topology.png)
...
Ilustración 1. Antes de la conmutación por error ![Antes de la conmutación por error](media/signalr-disaster-recovery/before-failover.png)

Ilustración 2. Después de la conmutación por error ![Después de la conmutación por error](media/signalr-disaster-recovery/after-failover.png)

Ilustración 3. Poco tiempo después de la recuperación de la instancia principal ![Poco tiempo después de la recuperación de la instancia principal](media/signalr-disaster-recovery/after-recover.png)
...
En este artículo ha aprendido a configurar la aplicación para lograr resistencia para SignalR Service. Para conocer más detalles acerca de la conexión cliente/servidor y el enrutamiento de conexión en SignalR Service, consulte [este artículo](signalr-internals.md) para los aspectos internos de SignalR Service.