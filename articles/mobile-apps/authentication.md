...
description: Conozca los servicios de App Center que ayudan a configurar la autenticación de usuarios y a permitir que las aplicaciones móviles se autentiquen con cuentas de redes sociales, Azure Active Directory y autenticación personalizada.
author: elamalani
...
- **Traiga su propia identidad** y use otros proveedores de administración de identidades y acceso conocidos como Auth0 y Firebase.
- **Compatibilidad con AAD** 
    - Conexión de los inquilinos de AAD existentes. 
    - Posibilidad de autenticación en un dominio corporativo.
    - Administración del acceso a datos confidenciales.
- **Experiencia de usuario sencilla** y experiencia mágica con el SDK gracias al encapsulado de la biblioteca MSAL con el SDK de App Center.
...
- Compatibilidad con el inicio de sesión en redes sociales, como Facebook, GitHub, Google, LinkedIn, Twitter, WeChat y Weibo.
...
- Experiencias de registro e inicio de sesión con personalización de marca.
...
[Azure Active Directory (Azure AD)](https://azure.microsoft.com/services/active-directory/) es un servicio en la nube de administración de identidades y acceso de Microsoft que ayuda a los empleados en el inicio de sesión y el acceso.
...
- **Miles de aplicaciones integradas previamente**, tanto comerciales y como personalizadas, por ejemplo, Office 365, Salesforce.com y Box.
- **Administración del acceso a escala**.
