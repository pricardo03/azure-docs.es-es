...
| ![Informatica][4] |**Informatica PowerCenter**<br>Informatica es uno de los proveedores independientes de software de integración de datos más reconocible del mundo. PowerCenter constituye la base para todas sus iniciativas de integración de datos. Utilice PowerCenter para análisis, almacenamiento de datos, migración de aplicaciones, consolidación o gobierno de datos. |[Marketplace][informatica_PowerCenter_byol]<br>[Sitio web][informatica_PowerCenter_website]<br>[Datasheet][informatica_powercenter_datasheet]<br>[Twitter][informatica_powercenter_twitter]<br>[YouTube][informatica_powercenter_youtube] | |
