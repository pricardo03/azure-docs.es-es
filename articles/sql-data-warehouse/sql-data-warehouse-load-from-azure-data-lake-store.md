---
title: 'Tutorial: Carga de datos de Azure Data Lake Storage Gen1 a Azure SQL Data Warehouse | Microsoft Docs'
description: Use tablas externas de PolyBase para cargar datos de Azure Data Lake Storage Gen1 en Azure SQL Data Warehouse.
...
> [!div class="checklist"]
> * Cree los objetos de base de datos necesarios para cargar datos desde Data Lake Storage Gen1.
> * Conéctese al directorio de Data Lake Storage Gen1.
...
>[!NOTE] 
> Necesita el identificador del cliente, la clave y el valor del punto de conexión del token de OAuth2.0 de su aplicación Active Directory para conectarse a su cuenta de Data Lake Storage Gen1 de SQL Data Warehouse. En el vínculo siguiente se detalla cómo obtener estos valores. Para el registro de aplicación de Azure Active Directory, use el identificador de aplicación como identificador de cliente.
> 
...
Para importar los datos de Data Lake Storage Gen1, es preciso especificar el formato de archivo externo. Este objeto define cómo se escriben los archivos en Data Lake Storage Gen1.
...
Para cargar los datos de Data Lake Storage Gen1, use la instrucción [CREATE TABLE AS SELECT (Transact-SQL)](/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse). 
