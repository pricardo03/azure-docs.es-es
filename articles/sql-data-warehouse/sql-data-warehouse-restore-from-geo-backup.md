---
title: Restauración de una instancia de Azure SQL Data Warehouse a partir de una copia de seguridad geográfica | Microsoft Docs
...
Para realizar una restauración a partir de una copia de seguridad de replicación geográfica use el cmdlet [Get-AzSqlDatabaseGeoBackup][Get-AzSqlDatabaseGeoBackup] and [Restore-AzSqlDatabase][Restore-AzSqlDatabase].
