...
| 2 |Restablecimiento de fábrica |En algunos casos, cuando realiza un restablecimiento de fábrica, el dispositivo StorSimple se bloqueó y apareció este mensaje: **Restablecimiento de fábrica está en curso (fase 8)**. Esto sucedía si se presionaba CTRL+C mientras el cmdlet estaba en curso. El error se ha corregido. |Actualización 1 |Sí |Sin  |
