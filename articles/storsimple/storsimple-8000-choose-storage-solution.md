...
|Precios          |[Precios de StorSimple](https://azure.microsoft.com/pricing/details/storsimple/) |[Precios de AFS](https://azure.microsoft.com/pricing/details/storage/files/)  |[Precios de Data Box Edge](https://azure.microsoft.com/pricing/details/storage/databox/edge/)  |

## <a name="next-steps"></a>Pasos siguientes

- Obtenga información sobre [Azure Data Box Edge](/azure/databox-online/data-box-edge-overview.md) y [Azure Data Box Gateway](/azure/databox-online/data-box-gateway-overview.md).
- Obtenga información sobre [Azure File Sync](/azure/storage/files/storage-sync-files-deployment-guide.md).