...
| **17.** |Actualizaciones |Si ve el código de error: 2359302 (hex 0x240006) al intentar instalar una revisión mediante la interfaz de usuario local, significa que la revisión ya está instalada en el dispositivo.   | |
