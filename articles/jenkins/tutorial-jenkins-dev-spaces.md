...
ms.locfileid: "67550872"
---
<!-- GMinchAQ, 06/18/19 -->

# <a name="tutorial-using-the-azure-dev-spaces-plugin-for-jenkins-with-azure-kubenetes-service"></a>Tutorial: Uso del complemento de Azure Dev Spaces para Jenkins con Azure Kubernetes Service 
...
* Un grupo de recursos en el que se incluirán todos los recursos de Azure para este tutorial.
...
2. Cree un clúster de AKS. Cree el clúster de AKS en una [región que admita Dev Spaces](https://docs.microsoft.com/azure/dev-spaces/#a-rapid,-iterative-kubernetes-development-experience-for-teams).
...
5. Ejecute el comando `azds prep` para preparar la aplicación para que se ejecute en un espacio de desarrollo. Este comando se debe ejecutar desde `dev-spaces/samples/java/getting-started/webfrontend` para preparar correctamente la aplicación:
    ...
    * A [gráfico de Helm](https://helm.sh/docs/developing_charts/) bajo `./charts/webfrontend` describe cómo implementar el contenedor en Kubernetes.
