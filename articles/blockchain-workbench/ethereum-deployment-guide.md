...
![Tamaño de la red y rendimiento](./media/ethereum-deployment-guide/network-size-performance.png)
...
![Configuración de Ethereum](./media/ethereum-deployment-guide/standalone-leader-deployment.png)
...
![Implementaciones de recursos](./media/ethereum-deployment-guide/resource-deployments.png)
