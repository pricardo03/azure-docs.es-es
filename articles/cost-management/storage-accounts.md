...
Si no tiene una cuenta de almacenamiento de Azure, debe crear una. Para más información sobre la creación de una cuenta de almacenamiento de Azure, consulte [Crear una cuenta de almacenamiento](../storage/common/storage-quickstart-create-account.md).
