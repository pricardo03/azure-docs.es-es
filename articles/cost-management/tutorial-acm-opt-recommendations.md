...
![Recomendaciones de Advisor](./media/tutorial-acm-opt-recommendations/advisor-recommendations.png)
...
![Detalles de recomendación](./media/tutorial-acm-opt-recommendations/recommendation-details.png)
...
![Detalle de la VM](./media/tutorial-acm-opt-recommendations/vm-details.png)
...
![Cambiar el tamaño de la máquina virtual](./media/tutorial-acm-opt-recommendations/resize-vm.png)
...
![Elección de un tamaño](./media/tutorial-acm-opt-recommendations/choose-size.png)
...
![Notificación de cambio de tamaño](./media/tutorial-acm-opt-recommendations/resized-notification.png)
