...
description: Use la información de asociado de CSP para registrarse en Cloudyn.
...
2. En **Introducción** haga clic en **Cloudyn**  
    ![Página de Cloudyn](./media/quick-register-csp/cost-mgt-billing-service.png)
