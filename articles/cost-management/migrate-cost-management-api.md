...
Las API admiten el formato [asincrónico de REST de Azure](../azure-resource-manager/resource-manager-async-operations.md). Llame a la API mediante GET y recibirá la respuesta siguiente:
