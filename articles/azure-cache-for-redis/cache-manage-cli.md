...
## <a name="list-all-azure-cache-for-rediss-within-your-subscription-or-resource-group"></a>Lista de todas las instancias de Azure Cache for Redis de su suscripción o del grupo de recursos
