...
Si reinicia los nodos **master** y **subordinado**, se pueden perder todos los datos en la memoria caché (o de esa partición si se utiliza una caché premium con agrupación en clústeres habilitado), pero esto no se garantiza que cualquiera. Si ha configurado la [persistencia de los datos](cache-how-to-premium-persistence.md), se restaurará la copia de seguridad más reciente cuando la caché vuelva a estar en línea, pero se perderán las escrituras de caché producidas después de realizar la copia de seguridad.
