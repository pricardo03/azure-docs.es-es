...
Azure Redis Cache proporciona acceso a una instancia de Azure Redis Cache segura y dedicada, administrada por Microsoft, hospedada en Azure y accesible a cualquier aplicación dentro o fuera de Azure.

## <a name="why-use-azure-cache-for-redis"></a>Por qué utilizar Azure Cache for Redis
