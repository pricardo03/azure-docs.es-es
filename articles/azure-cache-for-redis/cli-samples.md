---
title: Ejemplos de la CLI de Azure para Azure Cache for Redis | Microsoft Docs
description: Ejemplos de la CLI de Azure para Azure Cache for Redis.
services: cache
documentationcenter: ''
author: yegu-ms
manager: jhubbard
