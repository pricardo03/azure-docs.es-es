...
Los parámetros de la aplicación se aplican a las actualizaciones mediante PowerShell o Visual Studio. Los parámetros requeridos y opcionales aplicables a PowerShell o Visual Studio se describen en las tablas de parámetros requeridos y opcionales como se indica a continuación.
...
| MaxPercentUnhealthyPartitionsPerService|PS, VS |El valor predeterminado y recomendado es 0. Especifique el número máximo de particiones en un servicio que puede ser incorrecto antes de que el servicio se considere incorrecto. |
| MaxPercentUnhealthyReplicasPerPartition|PS, VS |El valor predeterminado y recomendado es 0. Especifique el número máximo de réplicas en la partición que puede ser incorrecto antes de que esta se considere incorrecta. |
