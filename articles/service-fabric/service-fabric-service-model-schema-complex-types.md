...
Modo de aislamiento del contenedor. Los valores válidos son default, process o hyperv (solo compatibles para contenedores Windows). En los hosts de Windows 10, solamente se admite el modo de aislamiento de Hyper-V, por lo que el contenedor se ejecuta en modo de aislamiento de Hyper-V independientemente de la configuración de modo de aislamiento que tenga.
|Atributo|Valor|
|---|---|
|Nombre|Aislamiento|
|use|opcional|
