...
|contenido|0 elementos, 4 atributos|
|definido|globalmente|
|Nombre|ConfigPackageDescriptionType|
...
|Atributo|Valor|
|---|---|
|Nombre|EnvironmentVariableName|
|Tipo|xs:string|
|use|opcional|
|default||
...
|contenido|1 elemento, 1 atributo|
|definido|globalmente|
|Nombre|ConfigPackagePoliciesType|
...
|Atributo|Valor|
|---|---|
|contenido|10 elementos, 8 atributos|
|definido|globalmente|
...
|Atributo|Valor|
|---|---|
|Nombre|UseDefaultRepositoryCredentials|
|Tipo|xs:string|
|use|opcional|
|default|false|
...
|Atributo|Valor|
|---|---|
|Nombre|UseTokenAuthenticationCredentials|
|Tipo|xs:string|
|use|opcional|
|default|false|
...
|contenido|0 elementos, 1 atributo|
|definido|globalmente|
|Nombre|ContainerNetworkPolicyEndpointBindingType|
...
|contenido|1 elemento, 1 atributo|
|definido|globalmente|
|Nombre|ContainerNetworkPolicyType|
...
|Atributo|Valor|
|---|---|
|contenido|4 elementos, 10 atributos|
|definido|globalmente|
...
|contenido|0 elementos, 3 atributos|
|definido|globalmente|
|Nombre|EnvironmentVariableOverrideType|
...
|Atributo|Valor|
|---|---|
|contenido|21 elementos, 0 atributos|
|definido|globalmente|
...
|Atributo|Valor|
|---|---|
|contenido|0 elementos, 12 atributos|
|definido|globalmente|
...
|contenido|0 elemento(s), 2 atributo(s)|
|definido|globalmente|
|Nombre|ServiceFabricRuntimeAccessPolicyType|
...
|Atributo|Valor|
|---|---|
|Nombre|RemoveServiceFabricRuntimeAccess|
|Tipo|xs:boolean|
|default|false|
...
|Atributo|Valor|
|---|---|
|Nombre|UseServiceFabricReplicatedStore|
|Tipo|xs:boolean|
|default|false|
...
|Atributo|Valor|
|---|---|
|contenido|11 elementos, 0 atributos|
|definido|globalmente|
...
|contenido|1 elemento, 2 atributos|
|definido|globalmente|
|Nombre|ServicePackageContainerPolicyType|
...
|Atributo|Valor|
|---|---|
|contenido|11 elementos, 4 atributos|
|definido|globalmente|
