...
|contenido|0 elementos, 0 atributos|
|definido|localmente en [FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype)|
|Nombre|CentralSecretServiceReplicatorEndpoint|
|minOccurs|0|
...
Declara una carpeta denominada por el atributo Name y PackageRoot que contiene un archivo Settings.xml. Este archivo contiene secciones de configuración del par clave-valor definida por el usuario que el proceso puede volver a leer en tiempo de ejecución. Durante una actualización, si solo ha cambiado la versión de ConfigPackage, no se reiniciará el proceso en ejecución. En su lugar, una devolución de llamada notifica el proceso que los ajustes de configuración han cambiado, por lo que pueden volver a cargarse de forma dinámica.
...
|---|---|
|Tipo|complexType anónimo|
|contenido|6 elementos, 2 atributos|
...
|contenido|0 elementos, 0 atributos|
|definido|localmente en [FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype)|
|Nombre|EventStoreServiceReplicatorEndpoint|
|minOccurs|0|
...
|contenido|0 elementos, 0 atributos|
|definido|localmente en [FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype)|
|Nombre|GatewayResourceManagerReplicatorEndpoint|
|minOccurs|0|
...
Describe una información de la infraestructura necesaria.
...
|contenido|0 elementos, 0 atributos|
|definido|localmente en [ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype), [ServicePackageType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
|Nombre|ServiceFabricRuntimeAccessPolicy|
|minOccurs|0|
|maxOccurs|1|
...
|contenido|0 elementos, 0 atributos|
|definido|localmente en [ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype), [ServicePackageType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
|Nombre|ServicePackageContainerPolicy|
|minOccurs|0|
|maxOccurs|1|
