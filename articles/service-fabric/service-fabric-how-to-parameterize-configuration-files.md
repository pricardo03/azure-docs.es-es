...
1. Abra el  *\<MyService > \PackageRoot\Config\Settings.xml* archivo en el proyecto de servicio.
...
1. Abra el  *\<MyApplication > \ApplicationPackageRoot\ApplicationManifest.xml* archivo.
