...
El nombre del manifiesto de servicio. El nombre debe coincidir con el nombre declarado en el elemento ServiceManifest del manifiesto de servicio.
|Atributo|Valor|
|---|---|
...
La versión del manifiesto de servicio. La versión debe coincidir con la versión declarada en el manifiesto de servicio.
|Atributo|Valor|
|---|---|
