...
5. Para conectar con el contenedor en ejecución, abra un explorador web y navegue a la dirección URL del clúster; por ejemplo, `http://linh1x87d1d.westus.cloudapp.azure.com:80`. Debería ver la aplicación de votación en el explorador.
