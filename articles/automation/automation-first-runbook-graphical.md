...
1. El campo **Etiqueta** tiene como valor predeterminado el nombre del cmdlet, pero puede cambiarlo a algo más descriptivo. Cámbielo a **Escribir Hello World para la salida**.
...
1. Seleccione **Get-AzVM** y después **Conjunto de parámetros** para ver los conjuntos para el cmdlet. 
