...
> [!NOTE]
> Después de escribir un valor en el cuadro **Tipo de salida** en el panel **Propiedades de entrada y salida**, tiene que hacer clic fuera del control para que este pueda reconocer la entrada.
