...
Cuando se ejecuta un runbook mediante un webhook, se envía un parámetro de entrada predefinido, *[WebhookData](automation-webhooks.md#details-of-a-webhook)* , junto con los parámetros de entrada que defina. 
