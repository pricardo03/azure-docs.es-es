...
La comprobación de .NET Framework verifica si en el sistema existe la versión mínima [.NET Framework 4.5](https://www.microsoft.com/download/details.aspx?id=30653).
