...
Las siguientes soluciones de base de datos son compatibles con la característica de copia de seguridad: 
   ...
   - [MySQL en aplicación](https://azure.microsoft.com/en-us/blog/mysql-in-app-preview-app-service/)
...
3. En la página **Configuración de copia de seguridad**, haga clic en **Almacenamiento: Sin configurar** para configurar una cuenta de almacenamiento.
