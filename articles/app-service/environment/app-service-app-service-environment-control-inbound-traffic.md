---
title: 'Control del tráfico de entrada a un entorno de App Service: Azure'
description: Obtenga información acerca de cómo configurar las reglas de seguridad de red para controlar el tráfico entrante a un entorno de App Service.
