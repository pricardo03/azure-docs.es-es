...
| Get-Help | Notas |
|---|---|
| [Add-AzAccount](/powershell/module/az.profile/add-azaccount) | Agrega una cuenta autenticada para utilizarla con las solicitudes de cmdlet de Azure Resource Manager.  |
