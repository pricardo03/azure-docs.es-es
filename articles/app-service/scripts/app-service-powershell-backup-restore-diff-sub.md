---
title: 'Ejemplo de script de Azure PowerShell: Restauración de una aplicación web a partir de una copia de seguridad de otra suscripción | Microsoft Docs'
...
ms.locfileid: "52291616"
---
# <a name="restore-a-web-app-from-a-backup-in-another-subscription"></a>Restauración de una aplicación web desde una copia de seguridad en otra suscripción
