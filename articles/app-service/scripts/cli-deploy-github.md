---
title: 'Ejemplo de script de la CLI de Azure: creación de una aplicación con implementación desde GitHub | Microsoft Docs'
description: 'Ejemplo de script de la CLI de Azure: creación de una aplicación de App Service con implementación desde GitHub'
