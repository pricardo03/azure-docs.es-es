---
title: 'Ejemplo de script de la CLI de Azure: conexión de una aplicación a MongoDB (Cosmos DB) | Microsoft Docs'
description: 'Ejemplo de script de la CLI de Azure: conexión de una aplicación a MongoDB (Cosmos DB)'
services: appservice
