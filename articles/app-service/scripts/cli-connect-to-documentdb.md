...
Este script de ejemplo crea una cuenta de Azure Cosmos DB con Cosmos DB para la API de MongoDB y una aplicación de App Service. A continuación, vincula una cadena de conexión de MongoDB a la aplicación web mediante la configuración de la aplicación.
