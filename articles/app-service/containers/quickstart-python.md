---
title: Creación de una aplicación web de Python en Azure App Service en Linux | Microsoft Docs
...
El código de ejemplo de Python se ejecuta en una aplicación web con una imagen integrada.
