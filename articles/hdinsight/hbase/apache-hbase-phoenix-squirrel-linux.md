...
Para más información, consulte el [manual de SQLLine](http://sqlline.sourceforge.net/#manual) y la [gramática de Apache Phoenix](http://phoenix.apache.org/language/index.html).
