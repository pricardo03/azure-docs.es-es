...
| `hdfs.url` | El sistema de archivos que usa el clúster de Storm. Para las cuentas de Azure Storage, use un valor de `wasb:///`. Para Azure Data Lake Storage, use un valor de `adl:///`. |
