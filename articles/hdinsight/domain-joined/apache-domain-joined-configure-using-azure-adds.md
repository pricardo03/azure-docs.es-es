...
- **Usuario de administrador de clúster**: elija un administrador para el clúster desde su Azure AD DS sincronizado. Esta cuenta de dominio ya debe estar sincronizada y disponible en Azure AD DS.
