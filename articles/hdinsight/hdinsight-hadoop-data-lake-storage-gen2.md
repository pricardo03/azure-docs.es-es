...
Para más información, vea [Controlador Azure Blob FileSystem (ABFS): un controlador de Azure Storage dedicado para Apache Hadoop](../storage/data-lake-storage/abfs-driver.md).
