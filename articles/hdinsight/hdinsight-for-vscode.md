...
- [Extensión de la cuenta de Azure](https://marketplace.visualstudio.com/items?itemName=ms-vscode.azure-account) de VS Code
...
1. Si no tiene una carpeta de trabajo y un archivo .py, créelos.
