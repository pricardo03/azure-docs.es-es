...
description: Aprenda a utilizar documentos JSON y analizarlos mediante Apache Hive en HDInsight de Azure.
...
Aprenda a procesar y analizar los archivos JavaScript Object Notation (JSON) con Apache Hive en Azure HDInsight. Este artículo usa el siguiente documento JSON:
...
* Escriba su propia función definida por el usuario con Python u otros lenguajes. Para obtener más información sobre cómo ejecutar su propio código Python con Hive, consulte [UDF de Python con Apache Hive y Apache Pig] [hdinsight-python].
