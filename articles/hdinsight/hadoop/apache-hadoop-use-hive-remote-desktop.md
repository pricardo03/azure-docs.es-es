...
Si usa Tez con Hive, consulte los siguientes documentos para obtener la información de depuración: [Use la vista Tez de Apache Ambari en HDInsight basado en Linux](../hdinsight-debug-ambari-tez-view.md).
