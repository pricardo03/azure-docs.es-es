...
Twitter permite recuperar los datos de cada tweet como un documento con formato de notación de objetos JavaScript (JSON) mediante una API REST. [OAuth](http://oauth.net) para autenticación en la API.
