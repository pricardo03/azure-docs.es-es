...
Obtenga información sobre cómo usar la [CLI clásica de Azure](../cli-install-nodejs.md) para administrar clústeres de Apache Hadoop en Azure HDInsight. La CLI clásica se implementa en Node.js. y se puede usar en cualquier plataforma compatible con Node.js, entre las que se incluyen Windows, Mac y Linux.
