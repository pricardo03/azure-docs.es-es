...
1. En Azure Portal, haga clic en **Crear un recurso**.
    ...
    ![Creación de recursos en Azure Portal](./media/apache-spark-jupyter-spark-sql-use-portal/azure-portal-create.png "Creación de un recurso en Azure Portal")

1. En la página **Nuevo**, seleccione **Análisis** > **HDInsight**.

    ![Creación en Azure Portal HDInsight](./media/apache-spark-jupyter-spark-sql-use-portal/azure-portal-create-hdinsight-spark-cluster.png "HDInsight en Azure Portal")
...
1. En **Datos básicos**, proporcione los valores siguientes:
    ...
    |Nombre del clúster | Asigne un nombre al clúster de HDInsight. El nombre del clúster usado para este inicio rápido es **myspark2019**.|
