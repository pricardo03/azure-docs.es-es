...
* [Uso del complemento de herramientas de HDInsight para IntelliJ IDEA para depurar aplicaciones de Apache Spark de forma remota](../hdinsight-apache-spark-intellij-tool-plugin-debug-jobs-remotely.md)
