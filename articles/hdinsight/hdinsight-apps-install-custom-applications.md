...
En este artículo, aprenderá a instalar una aplicación de Apache Hadoop en Azure HDInsight que no se ha publicado en Azure Portal. La aplicación que instalará en este artículo es [Hue](http://gethue.com/).
