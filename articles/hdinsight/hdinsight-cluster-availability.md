...
![Hoja de registros del área de trabajo de Log Analytics](media/hdinsight-cluster-availability/portal-logs.png)
...
![Consulta de ejemplo de la hoja de registros “equipos no disponibles” del área de trabajo de Log Analytics](media/hdinsight-cluster-availability/portal-unavailable-computers.png)
...
![Nuevo grupo de acciones de regla de alertas](media/hdinsight-cluster-availability/portal-create-new-action-group.png)
...
![Grupo de acciones de adición de regla de alertas](media/hdinsight-cluster-availability/portal-add-action-group.png)
...
![Finalización de creación de regla de alertas](media/hdinsight-cluster-availability/portal-create-alert-rule-finish.png)
...
![Correo electrónico de alerta de Azure Monitor](media/hdinsight-cluster-availability/alert-email.png)
...
![Alertas del área de trabajo de Log Analytics](media/hdinsight-cluster-availability/portal-alerts.png)
...
![Alertas de gravedad 1 del área de trabajo de Log Analytics](media/hdinsight-cluster-availability/portal-alerts-sev-1.png)
