...
A continuación, haga clic en **Iniciar** en el icono del acelerador de soluciones Supervisión remota que implementó en el [Inicio rápido](quickstart-remote-monitoring-deploy.md).
