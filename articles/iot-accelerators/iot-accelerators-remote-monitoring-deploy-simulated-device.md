...
En esta guía se muestra cómo implementar modelos de dispositivos personalizados en el acelerador de soluciones de supervisión remota. El paso siguiente que se sugiere es aprender a [conectar un dispositivo físico a la solución Supervisión remota](iot-accelerators-connecting-devices-node.md).
