---
title: Simulación de dispositivos con aceleradores de soluciones de IoT - Azure | Microsoft Docs
description: En esta guía paso a paso, se muestra cómo usar el simulador de dispositivos con el acelerador de soluciones de simulación de dispositivos.
author: dominicbetts
manager: timlt
ms.author: dobett
...
El siguiente paso sugerido es obtener información sobre cómo implementar los tipos de dispositivos simulados y personalizados en el [Acelerador de soluciones simulación de dispositivos](iot-accelerators-device-simulation-deploy-simulated-device.md).
