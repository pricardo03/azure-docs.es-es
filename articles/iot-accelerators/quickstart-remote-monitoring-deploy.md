---
title: Implementación de una solución de supervisión remota de IoT basada en la nube en Azure | Microsoft Docs
...
Haga clic en **Try Now** (Probar ahora) en el icono **Remote Monitoring** (Supervisión remota).
