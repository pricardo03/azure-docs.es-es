...
| SDK para desarrolladores | .NET, Java, Python, Node.js  | .NET, Java, Python, Node.js, C++, Ruby, PHP, Go, Android, iOS| SDK de blob: *ya disponible*. SDK de Azure Data Lake Storage Gen2: *no disponible aún*  |
