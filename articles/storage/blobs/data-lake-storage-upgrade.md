---
title: Actualización de Azure Data Lake Storage de Gen1 a Gen2
description: Actualice Azure Data Lake Storage de Gen1 a Gen2.
author: normesta
ms.topic: conceptual
ms.author: normesta
ms.date: 11/19/2019
...
ms.locfileid: "74894239"
---
# <a name="upgrade-azure-data-lake-storage-from-gen1-to-gen2"></a>Actualización de Azure Data Lake Storage de Gen1 a Gen2
...
| API de servidor| [WebHDFS-compatible REST API (API de REST compatible con WebHDFS)](https://msdn.microsoft.com/library/azure/mt693424.aspx) | API REST de Azure Blob Service [API REST de Data Lake Storage Gen2](https://docs.microsoft.com/rest/api/storageservices/data-lake-storage-gen2) | API de REST de Data Lake Storage Gen2: *ya disponible* <br><br> API REST de Azure Blob Service: *ya disponible*       |
| Cliente de sistema de archivos de Hadoop | Sí ([Azure Data Lake Storage](https://hadoop.apache.org/docs/current/hadoop-azure-datalake/index.html)) | Sí ([ABFS](https://jira.apache.org/jira/browse/HADOOP-15407))  | *Ya disponible*  |  
...
| Operaciones de datos: registros  | Sí | Sí | *Ya disponible* (versión preliminar). Vea [Problemas conocidos](data-lake-storage-known-issues.md).<br><br> Integración en supervisión de Azure: *no disponible aún* |
...
| Operaciones de administración (por ejemplo, creación de cuentas) | [Control de acceso basado en rol](https://docs.microsoft.com/azure/role-based-access-control/overview) (RBAC) proporcionado por Azure para la administración de cuentas | [Control de acceso basado en rol](https://docs.microsoft.com/azure/role-based-access-control/overview) (RBAC) proporcionado por Azure para la administración de cuentas | *Ya disponible*|
| SDK para desarrolladores | .NET, Java, Python, Node.js  | .NET, Java, Python, Node.js, C++, Ruby, PHP, Go, Android, iOS| SDK de blob: *ya disponible*. [SDK de Azure Data Lake Storage Gen2](https://azure.microsoft.com/blog/extended-filesystem-programming-capabilities-in-azure-data-lake-storage/)- *Disponible ya para .NET, Java, Python (versión preliminar pública)*  |
| |Rendimiento optimizado para cargas de trabajo de análisis paralelas. Gran capacidad de procesamiento e IOPS | Rendimiento optimizado para cargas de trabajo de análisis paralelas. Gran capacidad de procesamiento e IOPS | *Ya disponible* |
| Compatibilidad con redes virtuales (VNet)  | [Uso de la integración de redes virtuales](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-network-security)  | [Uso del punto de conexión de servicio para Azure Storage](https://docs.microsoft.com/azure/storage/common/storage-network-security?toc=%2fazure%2fstorage%2fblobs%2ftoc.json) | *Ya disponible* |
...
| Redundancia geográfica| Almacenamiento con redundancia local (LRS) | Con redundancia local (LRS), con redundancia de zona (ZRS), con redundancia geográfica (GRS), con redundancia geográfica con acceso de lectura (RA-GRS) Consulte [este enlace](https://docs.microsoft.com/azure/storage/common/storage-redundancy) para obtener más información| *Ya disponible* |
...
| Administración de datos                             | Expiración de archivo                                                                                                                                        | Directivas de ciclo de vida                                                                                                                                                                                                                                                                                                                                                                                                          | Las directivas de ciclo de vida *ya están disponibles* (versión preliminar). Vea [Problemas conocidos](data-lake-storage-known-issues.md).                                                                                                                     |

### <a name="programming-interfaces"></a>Interfaces de programación

En esta tabla se describe los conjuntos de API que están disponibles para las aplicaciones personalizadas. Todavía no se admite el SDK para las operaciones de ACL y de nivel de directorio.
...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| .NET SDK                  | [Vínculo](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet) | *Ya disponible* | *Ya disponible* |
| SDK de Java                | [Vínculo](https://docs.microsoft.com/java/api/overview/azure/datalakestore/management)                                                                                                                                                                                                                                     | *Ya disponible*                                                      | *Ya disponible*                                     |
| Node.js                | [Vínculo](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | *Ya disponible*                                                     | *Ya disponible*                                                                                           |
| SDK de Python                   | [Vínculo](https://docs.microsoft.com/python/api/overview/azure/datalakestore/management?view=azure-python)                                                                                                                                                                                                                 | *Ya disponible*                                                      | *Ya disponible*                                        |
| API DE REST                 | [Vínculo](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Ya disponible*                                                      | *Ya disponible*                                                                                                                                               |
| PowerShell | [Vínculo](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | *Ya disponible* |
| CLI                 | [Vínculo](https://docs.microsoft.com/cli/azure/dls/account?view=azure-cli-latest)                                                                                                                                                                                                                                          | *Ya disponible*                                                      | *Ya disponible*                                                               |
| Plantillas de Azure Resource Manager: administración             | [Template1](https://azure.microsoft.com/resources/templates/101-data-lake-store-no-encryption/)  [Template2](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-adls/)  [Template3](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-key-vault/)  | *Ya disponible*                                                      | *Ya disponible*                                          |
...
|                      | [SQL Server Integration Services](https://docs.microsoft.com/sql/integration-services/connection-manager/azure-data-lake-store-connection-manager?view=sql-server-2017) | *Ya disponible*                                                                                                                                                          | *Ya disponible*                                                                                                                             |
...
|                      | [Logic Apps](https://docs.microsoft.com/connectors/azuredatalake/)                                                                                                      | *Ya disponible*                                                                                                                                                          | *Ya disponible*                                                                                                                             |
| IoT                  | [Event Hubs: Capture](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-archive-eventhub-capture)                                                       | *Ya disponible*                                                                                                                                                          | *Ya disponible*                                                                                                                             |
|                      | [Stream Analytics](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-stream-analytics)                                                                   | *Ya disponible*                                                                                                                                                          | *Ya disponible*                                                                                                                             |
| Consumo          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *Ya disponible*                                                                                                                                                          | *Ya disponible*                                                                                                                             |
...
|                     | Qubole       |                      | [Vínculo](https://www.qubole.com/blog/big-data-analytics-microsoft-azure-data-lake-store-qubole/)                                                                                            | [Vínculo](https://docs.qubole.com/en/latest/quick-start-guide/Azure-quick-start-guide/QuboleConnect/detailed-azure-qubole-steps/azure-Azure-setup.html#step-4c-configure-azure-data-lake-gen-2-storage-with-keys)                                                                                                  | [Vínculo](https://docs.qubole.com/en/latest/quick-start-guide/Azure-quick-start-guide/QuboleConnect/detailed-azure-qubole-steps/azure-Azure-setup.html#step-4d-configure-azure-data-lake-gen-2-storage-with-tokens)                                                                                                 |
...
| Registros de diagnóstico                                                                                        | [Vínculo](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *Ya disponible* (versión preliminar). Vea [Problemas conocidos](data-lake-storage-known-issues.md). <br>Integración de la supervisión de Azure: *no disponible aún* |
...
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Migración mediante lift-and-shift**                 | [Azure Data Factory](https://docs.microsoft.com/azure/data-factory/load-azure-data-lake-storage-gen2-from-gen1) | Servicio en la nube administrado                                                                                                                | Actualmente, se pueden copiar los datos y las ACL.                                                                                                                                                                                                                                                                      |
...
| **Copia única y copia incremental** | Azure Data Factory                                                                                                    | Servicio en la nube administrado                                                                                                                | Actualmente, se pueden copiar los datos y las ACL. Para admitir la copia incremental en el ADF, los datos se deben organizar en una manera de serie temporal. El intervalo más breve entre las copias incrementales es de [15 minutos](https://docs.microsoft.com/azure/data-factory/how-to-create-tumbling-window-trigger). |
| **Adopción en paralelo**              | [WANdisco](https://docs.wandisco.com/bigdata/wdfusion/adls/)                                                           | Admite la replicación coherente. Si se usa un entorno de Hadoop puro conectado a Azure Data Lake Storage, admite la replicación bidireccional. | Si no se usa un entorno de Hadoop puro, puede haber un retraso en la replicación.                                                                                                                                                                                                                                                  |
...
* En Data Lake Storage Gen1, el nivel más alto en que puede establecer las ACL es en la raíz de la cuenta. Sin embargo, en Data Lake Storage Gen2, el nivel más alto en que puede establecer las ACL es en la carpeta raíz de un contenedor, no toda la cuenta. Por lo tanto, si quiere establecer las ACL predeterminadas en el nivel de la cuenta, deberá duplicarlas en todos los sistemas de archivos de la cuenta de Data Lake Storage Gen2.
