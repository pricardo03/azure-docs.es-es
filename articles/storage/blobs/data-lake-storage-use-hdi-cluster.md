...
* [Configuración de clústeres de HDInsight mediante Azure Data Lake Storage Gen2 con Hadoop, Spark, Kafka y más](data-lake-storage-quickstart-create-connect-hdi-cluster.md)
