...
description: Obtenga información sobre cómo crear una SAS de delegación de usuarios (versión preliminar) con credenciales de Azure Active Directory mediante la CLI de Azure.
services: storage
author: tamram
ms.service: storage
ms.topic: conceptual
