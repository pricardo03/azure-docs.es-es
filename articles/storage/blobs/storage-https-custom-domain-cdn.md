...
> [!NOTE]  
> Además de proporcionar compatibilidad con SSL para los nombres de dominio personalizados, la red CDN de Azure puede ayudarle a escalar la aplicación para proporcionar contenido con un elevado ancho de banda en todo el mundo. Para obtener más información, vea [Información general de la red CDN de Azure](../../cdn/cdn-overview.md).
