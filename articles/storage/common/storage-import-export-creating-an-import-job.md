...
Para crear el trabajo de importación, llame a la operación [Put Job](/rest/api/storageimportexport/jobs). Tiene que proporcionar la siguiente información:
