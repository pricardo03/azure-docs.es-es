...
1. Llame al cmdlet [New-AzStorageContext](https://docs.microsoft.com/powershell/module/az.storage/new-azstoragecontext) para crear un contexto e incluya el parámetro `-UseConnectedAccount`. 
