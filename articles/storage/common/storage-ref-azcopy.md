...
**--output-type** Dé formato a la salida del comando. Las opciones incluyen: text, json. El valor predeterminado es "text". (el valor predeterminado es "text")
