...
---
# <a name="security-attributes-for-azure-storage"></a>Atributos de seguridad para el almacenamiento de Azure

En este artículo describe los atributos de seguridad integrados en Azure Storage. 
