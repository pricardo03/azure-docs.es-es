...
- Aprenda a:
    - [Transferencia de datos con Data Box Gateway](https://docs.microsoft.com/azure/databox-online/data-box-gateway-deploy-add-shares.md).
    - [Transformar datos con Data Box Edge antes de enviarlos a Azure](https://docs.microsoft.com/azure/databox-online/data-box-edge-deploy-configure-compute).
