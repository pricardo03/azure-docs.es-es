...
> [!NOTE]
> Tendrá que instalar las dependencias de .NET Core 2.1 resaltadas en este [artículo de requisitos previos de .NET Core](https://docs.microsoft.com/dotnet/core/linux-prerequisites?tabs=netcore2x) en función de la distribución. 
>
...
## <a name="blob-download"></a>Blob: Descargar
...
## <a name="blob-upload"></a>Blob: Cargar
...
### <a name="customizing-the-mime-content-type-mapping"></a>Personalización de la asignación de tipo de contenido MIME
...
Cuando copia un blob sin la opción --syn-copy, se realiza una operación de [copia de lado servidor](https://blogs.msdn.com/b/windowsazurestorage/archive/2012/06/12/introducing-asynchronous-cross-account-copy-blob.aspx).
...
azcopy \
    ...
    --recursive
```
Al copiar un archivo desde un blob en un recurso compartido de archivos, se realiza una operación de [copia del lado del servidor](https://blogs.msdn.com/b/windowsazurestorage/archive/2012/06/12/introducing-asynchronous-cross-account-copy-blob.aspx).
...
* [Uso de Blob Storage en C++](../blobs/storage-c-plus-plus-how-to-use-blobs.md)
...
* [Cómo usar Blob storage desde Python](../blobs/storage-python-how-to-use-blob-storage.md)

### <a name="azure-storage-blog-posts"></a>Publicaciones en blobs de Azure Storage
* [Anuncio de AzCopy en versión preliminar de Linux](https://azure.microsoft.com/blog/announcing-azcopy-on-linux-preview/)
