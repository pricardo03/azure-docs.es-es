...
## <a name="how-to-add-a-message-to-a-queue"></a>Procedimientos para: un mensaje a una cola
...
## <a name="how-to-dequeue-the-next-message"></a>Procedimientos para: Extracción del siguiente mensaje de la cola
