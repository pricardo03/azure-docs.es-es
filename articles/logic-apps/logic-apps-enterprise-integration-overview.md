...
* [Seguimiento de mensajes B2B en Azure Log Analytics](logic-apps-track-b2b-messages-omsportal.md "Más información sobre cómo realizar un seguimiento de mensajes B2B en Azure Log Analytics")
