...
#### <a name="queue-trigger-look-up-id-queue-message-using-sqlquery-c-script"></a>Desencadenador de cola, buscar identificador de mensaje de cola, mediante SqlQuery (script en C#)
