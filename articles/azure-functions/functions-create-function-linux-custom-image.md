...
> * Agregue la supervisión de Application Insights.
...
> [Más información sobre las opciones para implementar funciones en Azure](functions-deployment-technologies.md)
