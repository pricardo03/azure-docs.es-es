...
La opción `--build remote` compila el proyecto de Python de forma remota en Azure a partir de los archivos del paquete de implementación, lo que se recomienda. 
