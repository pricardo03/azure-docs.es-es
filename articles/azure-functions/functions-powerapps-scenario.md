...
+ Una [cuenta de PowerApps](https://docs.microsoft.com/powerapps/maker/signup-for-powerapps) activa con las mismas credenciales de inicio de sesión que su cuenta de Azure. 
