...
> [!NOTE]
> Los desarrolladores de C# deben considerar la [creación de la primera función en Visual Studio 2017](functions-create-your-first-function-visual-studio.md) en lugar de en el portal. 
