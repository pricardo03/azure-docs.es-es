...
Esta función tiene un parámetro de tipo `DurableActivityContext`, que usa para obtener la entrada que se le pasó mediante la llamada de la función de orquestador a `CallActivityAsync<T>`.
