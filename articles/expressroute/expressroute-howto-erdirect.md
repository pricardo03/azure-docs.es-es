...
## <a name="resources"></a>1. Crear el recurso
...
## <a name="state"></a>2. Cambiar el estado de administración de vínculos
...
## <a name="circuit"></a>3. Crear un circuito
...
Otros anchos de banda incluyen: 1.0, 2.0, 5.0, 10.0 y 40.0
