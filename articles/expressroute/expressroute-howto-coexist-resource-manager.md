...
3. Agregue una subred de puerta de enlace que sea /27 o superior.
   ...
   $vnet = Set-AzVirtualNetwork -VirtualNetwork $vnet
   ```
4. Ya tiene una red virtual sin puertas de enlace. Para crear nuevas puertas de enlace y configurar las conexiones, siga los pasos descritos en la sección anterior.
