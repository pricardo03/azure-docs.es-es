...
* [Administrar el escalado horizontal del clúster](manage-cluster-scale-out.md) para escalar dinámicamente de forma horizontal el recuento de instancias en función de las métricas que especifique.
