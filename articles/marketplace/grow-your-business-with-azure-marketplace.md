...
| Configuración del escaparate | Procedimiento recomendado |
|:--- |:--- |  
| Sectores: solo aplicaciones de AppSource y servicios de consultoría | Seleccione estos sectores si su oferta aborda requisitos específicos para ellos:<br>Indique las funcionalidades específicas para los sectores en la descripción de la oferta.<br><br>**Nota**: El número máximo de opciones varía según el tipo de oferta y se indica en Cloud Partner Portal. |
| Categorías | Seleccione las categorías que se ajusten mejor a la oferta:<br>Elija detenidamente las categorías, ya que los clientes las utilizan para buscar aplicaciones apropiadas. Asegúrese de indicar cómo la oferta se ajusta con las necesidades específicas de las categorías en la descripción de la oferta.<br><br> **Nota**: El número máximo de opciones varía según el tipo de oferta y se indica en Cloud Partner Portal. |
| Productos con los que funciona su aplicación (3&nbsp;como máximo): solo aplicaciones de AppSource | Enumere otros productos y tecnologías que utiliza o amplía su solución:<br>Por ejemplo, Azure IoT Hub o Azure Machine Learning. |
| Palabras clave de búsqueda (3&nbsp;como máximo) | Utilice palabras clave de búsqueda que ayudan a los usuarios empresariales a encontrar su oferta al realizar búsquedas en Azure Marketplace y AppSource o en motores de búsqueda:<br>Identifique las tres principales palabras clave de búsqueda de su oferta, incorpórelas en el resumen de la oferta, en la descripción y cítelas aquí. |
...
| Documentos de "Más información" | Incluya recursos auxiliares de ventas y marketing en "Más información":<br>Por ejemplo, notas del producto, folletos, listas de comprobación o presentaciones de PowerPoint. Guarde todos los archivos en formato PDF. El objetivo debe ser informar a los clientes acerca del producto, no venderlo.<br><br>Agregue un vínculo a la página de aterrizaje de la aplicación en todos los documentos e incluya parámetros de URL para ayudarlo a realizar un seguimiento de los visitantes y las evaluaciones. |
| Vídeos: solo AppSource, servicios de consultoría y ofertas de SaaS | Los vídeos más atractivos comunican el valor de la oferta en forma de narración:<br>Asegúrese de que el héroe de la historia es el cliente, no su negocio. El vídeo debe abordar los objetivos y retos más importantes del cliente de destino.<br><br>Longitud recomendada: de 60 a 90 segundos.<br><br>Incorpore palabras clave de búsqueda que usan el nombre de los vídeos.<br><br>Considere la posibilidad de agregar otros vídeos como, por ejemplo, de instrucciones, de introducción o de testimonios de clientes. |
...
* Optimice la descripción para ayudar a mejorar el posicionamiento en los motores de búsqueda.<br>Incorpore palabras clave de búsqueda en el nombre, resumen y descripción de la aplicación. 
...
La audiencia de cada sector, mercado vertical o categoría es diferente. ¿Su audiencia se entera en Internet, mediante el correo electrónico, en ferias comerciales a través de medios sociales o en conversaciones con asesores de confianza? En función de dónde y cómo se entere su audiencia, deberá diseñar actividades y distribuir el dinero de su estrategia de marketing en consecuencia. La combinación de estas tácticas se convierte en su estrategia de campaña.
...
Para promover la oferta o la aplicación para acceder a más ventajas y recursos, utilice la siguiente tabla:
