...
El gráfico de barras **Pedidos por tipo de cliente** muestra el número de pedidos dividido por **nuevos clientes** y **clientes existentes**. 
...
Hay tres tipos de cliente: nuevos, existentes y perdidos. 
...
![Detalles de clientes de Analizar del Centro de partners](./media/analyze-customer-table.png)
...
![Descargas de Analizar del Centro de partners](./media/analyze-downloads.png)
...
| Tipo de licencia de Marketplace: Traiga su propia licencia | Orden| La máquina virtual requiere una clave de licencia proporcionada por el cliente para la implementación. Microsoft no factura a los clientes por mostrar sus ofertas de esta manera a través de Marketplace.||
| Tipo de licencia de Marketplace: Gratuito| Orden| La oferta está configurada para ser gratis para todos los usuarios. Microsoft no factura a los clientes por su uso de esta oferta.||
| Tipo de licencia de Marketplace: Microsoft como revendedor  | Orden| Microsoft es su revendedor para esta oferta de Marketplace.|  |
