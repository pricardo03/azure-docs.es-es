...
Marque esta casilla para permitir la configuración del acceso al almacenamiento seguro de CRM o del acceso saliente de servidor a servidor (S2S). Tenga en cuenta que esta característica requiere una atención especial por parte del equipo de Dynamics 365 durante la fase de certificación. Microsoft se pondrá en contacto con usted para completar los pasos adicionales para admitir esta característica.
...
Esta página le permite proporcionar información adicional sobre la oferta.
