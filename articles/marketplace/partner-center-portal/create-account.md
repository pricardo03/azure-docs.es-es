...
- Si ya está inscrito en Microsoft Partner Network, cree una cuenta directamente desde el Centro de partners mediante la sección sobre cómo [crear una cuenta mediante la inscripción de Microsoft Partner Network](#create-an-account-using-your-microsoft-partner-network-enrollment).
...
## <a name="create-an-account-using-your-microsoft-partner-network-enrollment"></a>Creación de una cuenta mediante la inscripción de Microsoft Partner Network

Si ya está inscrito en Microsoft Partner Network, use esta sección para crear su cuenta directamente desde el Centro de partners mediante estos pasos:

- [Iniciar sesión en el Centro de partners con su cuenta profesional](#sign-into-partner-center-with-your-work-account)
- [Escribir el perfil de publicación](#enter-your-publisher-profile)

Asegúrese de tener a mano la información de cuenta de Microsoft Partner Network.

>[!Important]
>Si tiene una cuenta en [Cloud Partner Portal (CPP)](https://cloudpartner.azure.com) que se ha trasladado al Centro de partners, no es necesario que cree una cuenta. Consulte [Publicadores que se trasladan desde CPP](#publishers-moving-from-cpp) para obtener más información.

### <a name="sign-into-partner-center-with-your-work-account"></a>Iniciar sesión en el Centro de partners con su cuenta profesional
...
### <a name="enter-your-publisher-profile"></a>Escribir el perfil de publicación

Después de iniciar sesión, use los pasos de esta sección para terminar de configurar su cuenta.

>[!NOTE]
> Debe tener un rol de administrador de cuenta o global para iniciar sesión en Microsoft Partner Network.

1. En el Centro de partners, seleccione **Configuración** > **Configuración de partners** > **Programas** > **Introducción**.
...
3. Lea los términos y condiciones en el [Acuerdo de publicador de Microsoft Marketplace](http://go.microsoft.com/fwlink/?LinkID=699560) y, a continuación, seleccione **Aceptar y continuar** para completar su inscripción.
