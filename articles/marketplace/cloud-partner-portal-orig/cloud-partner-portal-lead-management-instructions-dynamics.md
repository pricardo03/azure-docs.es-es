...
Si no desea usar Azure Active Directory, puede registrar un nuevo usuario en el portal de administración de Office 365. Tendrá que actualizar cada 90 días su nombre de usuario y contraseña para continuar obteniendo clientes potenciales.

Use los siguientes pasos para configurar Office 365 para Dynamics CRM.

1. Inicie sesión en el [Portal de administración de Microsoft Office 365](https://go.microsoft.com/fwlink/?LinkId=225975).

2. Seleccione el icono de **Administración** ![Administración de Office Online](./media/cloud-partner-portal-lead-management-instructions-dynamics/crmonline3.png)
...
4. Cree un usuario nuevo para el servicio de escritura de clientes potenciales. Configure las siguientes opciones:
    ...
    ![Configure los permisos de usuario y la licencia](./media/cloud-partner-portal-lead-management-instructions-dynamics/crmonline5.png)
...
-   **Office 365** - **URL** (ejemplo: *https://contoso.crm4.dynamics.com*), **Nombre de usuario** (ejemplo: *contoso\@contoso.onmicrosoft.com*) y **Contraseña** (ejemplo: *C0ntr\@seña*).
