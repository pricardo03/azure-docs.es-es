---
title: Bibliotecas de proceso de negocio | Microsoft Docs
description: Explicación de las metodologías y las bibliotecas de proceso de negocio.
...
Una metodología consta de fases, tareas e hitos. Cada fase puede tener cualquier número de tareas, algunas de las cuales son obligatorias. Cuando se hayan completado todas las tareas en una fase, la fase se puede marcar como completada. También puede crear un hito para cuando prevea que se completará una fase. Las metodologías siguientes se incluyen en un proyecto de LCS:

- Implementación
- Paso seguro
- Aprender a desarrollar
- Migrar y crear soluciones
- Usar soluciones

Vea [LCS Methodologies](https://docs.microsoft.com/dynamics365/operations/dev-itpro/lifecycle-services/create-methodology) (Metodologías LCS) para obtener más información.
