---
title: Configurar la administración de clientes potenciales de Marketo | Azure Marketplace
description: Configurar la administración de clientes potenciales de Marketo para los clientes de Azure marketplace.
