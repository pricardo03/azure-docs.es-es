...
Una plantilla de Azure Resource Manager (Azure Resource Manager) consiste en un contenedor codificado de recursos de Azure que el usuario diseña para que represente mejor su solución. Si no está familiarizado con lo que es una plantilla de Resource Manager, lea las secciones de [descripción de las plantillas ARM](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-overview) y [creación de plantillas ARM](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-authoring-templates) para asegurarse de que sabe cómo compilar y probar sus propias plantillas.
...
Asegúrese de dedicar el tiempo suficiente a evaluar cuáles son las mejores maneras de mostrar su producto. Concretamente, en lo que respecta a todos los recursos necesarios que se puedan requerirse, ya que simplifica bastante el diseño de la plantilla de Resource Manager.
