...
- Usar la [pestaña Marketplace](./cpp-marketplace-tab.md) para agregar un vínculo a [dispositivos certificados IoT Edge compatibles](http://aka.ms/iot-edge-certified). Este vínculo se resuelve en `http://aka.ms/iot-edge-certified`, un sitio web donde los clientes pueden examinar o buscar dispositivos certificados. Este sitio web también se conoce como el catálogo de dispositivos [Azure IoT Edge Certified](https://catalog.azureiotsolutions.com/).
