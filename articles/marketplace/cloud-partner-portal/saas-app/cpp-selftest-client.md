---
title: Cliente de prueba automática para la validación previa de una aplicación SaaS de Azure | Microsoft Docs
description: Creación de un cliente de prueba automática para la validación previa de una aplicación SaaS de Azure.
...
ms.locfileid: "54082566"
---
# <a name="create-a-self-test-client-to-pre-validate-an-azure-saas-application"></a>Creación de un cliente de prueba automática para la validación previa de una aplicación SaaS de Azure
...
La API tiene la siguiente estructura.
...
|      Campo         |    DESCRIPCIÓN    |
|  ---------------   |  ---------------  |
|        Autorización            |         La cadena "Bearer xxxx-xxxx-xxxx-xxxxx" contiene el token de cliente de Azure Active Directory (AD), el cual se puede crear mediante PowerShell.          |
|          DNSName          |         El nombre DNS de la máquina virtual que se va a probar.          |
|          Usuario          |          Nombre de usuario para conectarse e iniciar sesión en la máquina virtual.         |
|           Contraseña         |         La contraseña para conectarse e iniciar sesión en la máquina virtual.          |
|          SO          |         El sistema operativo de la máquina virtual, "Linux" o "Windows".          |
|         PortNo           |         El número de puerto abierto para conectarse a la máquina virtual. El número de puerto es normalmente "22" para Linux y "5986" para Windows.          |
...
La captura de pantalla siguiente muestra un ejemplo de los resultados de las pruebas que se ven en un visor JSON en línea.
...
20. Cree una clave secreta seleccionando el cuadro de texto **DESCRIPCIÓN** de la clave. Configure los campos siguientes:
    ...
    - En **VALOR**, copie la clave.
     ...
     >[!Important]
     >No podrá ver el valor de la clave después de salir del formulario de claves.
...
Para solicitar tokens a Auth0 para todas las aplicaciones autorizadas, realice una operación POST en el punto de conexión [https://soamtenant.auth0.com/oauth/token](https://soamtenant.auth0.com/oauth/token) con una carga en el formato siguiente:
...
Cuando haya comprobado correctamente la aplicación SaaS de Azure, puede [publicar la oferta](./cpp-publish-offer.md)