...
| certificateUrl        | Dirección URL para el certificado, incluida la versión en el almacén de claves, por ejemplo  `https://testault.vault.azure.net/secrets/testcert/b621es1db241e56a72d037479xab1r7` |
|  |  |
