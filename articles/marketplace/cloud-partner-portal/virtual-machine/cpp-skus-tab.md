---
title: Pestaña SKU de máquina virtual en Cloud Partner Portal para Azure Marketplace | Microsoft Docs
...
![Pestaña SKU en el formulario Nueva oferta de máquinas virtuales](./media/publishvm_006.png)

En la tabla siguiente se describen el propósito, el contenido y el formato de estos campos.
...
| **Disponibilidad por país o región** | Determina en qué países o regiones del mundo estará disponible la SKU para su compra. Seleccione al menos una región o un país. <!-- TD: Is this parameter an AMP visibility control or a contractual one, or both? --> |  
|  *Precios*   |  |
...
* Microsoft clasifica a algunos países como *tax remitted countries* (países sujetos a recaudación fiscal).  En esos países, Microsoft recauda los impuestos de los clientes y los devuelve al gobierno.  En otros países, los asociados normalmente son los responsables de recaudar los impuestos de los clientes y de devolverlos al gobierno. Si decide vender en estos países, debe tener la capacidad de calcular y pagar los impuestos locales.  <!-- TD: Find a good reference on taxing policies. The best I found was in the UWP section: https://docs.microsoft.com/windows/uwp/publish/tax-details-for-paid-apps -->
