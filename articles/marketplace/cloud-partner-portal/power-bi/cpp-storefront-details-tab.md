---
title: Detalles del escaparate para una aplicación de Power BI ofrecen | Azure Marketplace
...
En la tabla siguiente proporciona más información acerca de estos campos. Los campos obligatorios se indican con un asterisco (*).  
...
Para completar los campos de esta sección, utilice la siguiente tabla.  Los campos obligatorios se indican con un asterisco (*).
...
| **Vínculo de ayuda para la aplicación\***               | Proporcione una dirección URL a una página que se ofrece ayuda en línea para la aplicación.           |
