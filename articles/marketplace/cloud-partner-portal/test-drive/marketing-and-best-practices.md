---
title: Pruebe los procedimientos recomendados de Marketing | Azure Marketplace
description: Procedimientos recomendados de marketing para los publicadores de versión de prueba
...
- **Página de referencia**: Publicar una página en su presencia web que todo se habla de la unidad de prueba de Azure y registrar varios vínculos de referencia que dirigir el tráfico a la versión de prueba
- **Medios sociales**: Crear una programación que se registra en los canales de medios sociales acerca de la versión de prueba de forma periódica
- **Blogs**: Escribir una entrada de blog sobre la versión de prueba de Azure. Destaque las características y ventajas que obtendrá el usuario al experimentar la solución de forma gratuita y en muy poco tiempo. Asegúrese de agregar vínculos a la página de la versión de prueba de Azure en varios lugares de la copia del blog. Este es un vínculo a una entrada de blog de ejemplo sobre la versión de prueba de Azure. Mejor aún. Publique los vínculos a la entrada de blog en sus redes sociales.
- **Promoción de correo electrónico**: Informar a los clientes potenciales que se han comprometido con su marca a través de otros canales por correo electrónico para informarles sobre la versión de prueba y se les animará para probarlo de forma gratuita.
- **Capacitación de ventas y las herramientas**: Configurar una sesión de aprendizaje con sus equipos de ventas para la experiencia de prueba de demostración y proponer maneras puede contratar a sus clientes potenciales y clientes con él. El personal de ventas puede preparar una demostración para varios contactos de una empresa y, después, enviarles a cada uno de ellos el vínculo a la versión de prueba para que ellos mismos la prueben.
- **Comercio muestra y conferencias**: ¿Tiene una cabina en un evento del sector que participarán en los clientes potenciales? Configure varios equipos portátiles en el stand y haga que se ejecuten las versiones de prueba para que los clientes puedan probarlas en el stand. A continuación, hábleles acerca del producto durante su experiencia y con posterioridad a esta.
