...
1. Seleccione el botón **Crear un recurso** (+) de la esquina superior izquierda del portal. Escriba **Azure Database for MariaDB** en el cuadro de búsqueda para encontrar el servicio.
