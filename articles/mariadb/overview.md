...
ms.locfileid: "58295154"
---
# <a name="what-is-azure-database-for-mariadb"></a>¿Qué es Azure Database for MariaDB?

Azure Database for MariaDB es un servicio de base de datos relacional en la nube de Microsoft. Azure Database for MariaDB usa la versión 10.2 del motor de base de datos de [MariaDB Community Edition](https://mariadb.org/download/) (disponible bajo la licencia de GPLv2).
