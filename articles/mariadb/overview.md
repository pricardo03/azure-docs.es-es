...
- [Create an Azure Database for MariaDB server using Azure Portal](quickstart-create-mariadb-server-database-using-azure-portal.md) (Creación de un servidor de Azure Database for MariaDB mediante Azure Portal)
- [Create an Azure Database for MariaDB server using Azure CLI](quickstart-create-mariadb-server-database-using-azure-cli.md) (Creación de un servidor de Azure Database for MariaDB mediante la CLI de Azure)
...
- Comience por crear su primer servidor. [Create an Azure Database for MariaDB server using Azure Portal](quickstart-create-mariadb-server-database-using-azure-portal.md) (Creación de un servidor de Azure Database for MariaDB mediante Azure Portal)
