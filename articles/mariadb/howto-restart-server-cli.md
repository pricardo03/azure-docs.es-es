---
title: Reiniciar la base de datos de Azure para el servidor de MariaDB mediante CLI de Azure
description: En este artículo se describe cómo puede reiniciar un servidor Azure Database for MariaDB mediante la CLI de Azure.
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
---
# <a name="restart-azure-database-for-mariadb-server-using-the-azure-cli"></a>Reiniciar la base de datos de Azure para el servidor de MariaDB mediante la CLI de Azure
...
- Un [-Azure Database for MariaDB server](quickstart-create-mariadb-server-database-using-azure-cli.md)
