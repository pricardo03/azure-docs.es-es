...
- Configurar una [regla de alerta de métrica](../../monitoring-and-diagnostics/alert-metric.md) que envíe una notificación o realice una [acción automatizada](../../monitoring-and-diagnostics/monitoring-action-groups.md) cuando la métrica cruce un umbral.
...
- Agentes de las máquinas virtuales [Windows](../../log-analytics/log-analytics-windows-agent.md) y [Linux](../../log-analytics/log-analytics-quick-collect-linux-computer.md), que envían datos de telemetría desde el sistema operativo invitado y las aplicaciones a Log Analytics de acuerdo con los [orígenes de datos](../../azure-monitor/platform/agent-data-sources.md) que se configuran.
...
![Componentes de Log Analytics](media/data-collection/logs-overview.png)
...
- Crear un flujo de trabajo basado en datos de Log Analytics mediante [Logic Apps](~/articles/logic-apps/index.yml).
