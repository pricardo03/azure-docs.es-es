...
2. Si usa el portal de la búsqueda de registros, haga clic en **Power BI**.  Si usa el portal de Analytics portal, seleccione **Exportar** > **Power BI Query (M)** [Consulta de Power BI (M)].  Ambas opciones exportan la consulta a un archivo de texto con nombre **PowerBIQuery.txt**. 
    ...
    ![Exportación de la búsqueda de registros](media/powerbi/export-logsearch.png) ![Exportación de la búsqueda de registros](media/powerbi/export-analytics.png)
...
* Obtenga información sobre de las [búsquedas de registro](../../azure-monitor/log-query/log-query-overview.md) para crear consultas que se puedan exportar a Power BI.
