...
| Análisis | Abre el [portal de análisis avanzado](../../log-analytics/log-analytics-log-search-portals.md) para analizar los datos con consultas de registro. |
