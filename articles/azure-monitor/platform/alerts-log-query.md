...
Las [consultas de Log Analytics](../log-query/log-query-overview.md) se inician con una tabla o un operador de [búsqueda](/azure/kusto/query/searchoperator) o de [unión](/azure/kusto/query/unionoperator).
