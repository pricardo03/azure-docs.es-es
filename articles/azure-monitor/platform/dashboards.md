...
* Cree [alertas](../../monitoring-and-diagnostics/monitoring-overview-alerts.md) en Log Analytics para generar notificaciones y solucionar problemas.
