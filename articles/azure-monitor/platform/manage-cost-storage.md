...
Utilice esta consulta con moderación, ya que su ejecución es costosa. Si quiere ver qué tipos de datos envían datos a un equipo específico, use:
