...
![En la hoja de información general, haga clic en Stream en vivo.](./media/live-stream/live-stream-2.png)
...
![Creación de una clave de API](./media/live-stream/live-metrics-apikeycreate.png)
