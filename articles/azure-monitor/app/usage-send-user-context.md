...
Cree un inicializador de telemetría, tal como se describe [aquí](https://docs.microsoft.com/azure/application-insights/app-insights-api-filtering-sampling#add-properties-itelemetryinitializer) en detalle. Pase el id. de sesión a través de la telemetría de solicitudes y establezca Context.User.Id y Context.Session.Id.
