...
---
# <a name="status-monitor-v2-api-set-applicationinsightsmonitoringconfig-v021-alpha"></a>API del Monitor de estado v2: Set-ApplicationInsightsMonitoringConfig (v0.2.1-alpha)
