...
ms.locfileid: "68326291"
---
# <a name="status-monitor-v2-api-set-applicationinsightsmonitoringconfig"></a>API del Monitor de estado v2: Set-ApplicationInsightsMonitoringConfig
