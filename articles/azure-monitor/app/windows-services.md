...
Puede configurar [Application Insights](../../azure-monitor/app/app-insights-overview.md) para que supervise una amplia variedad de aplicaciones o roles de aplicación, componentes o microservicios. Para servicios y aplicaciones web, Visual Studio ofrece una [configuración de un solo paso](../../azure-monitor/app/asp-net.md). Para otros tipos de aplicación. NET, como roles de servidor back-end o aplicaciones de escritorio, puede configurar Application Insights manualmente.

![Gráficos de supervisión de rendimiento de ejemplo](./media/windows-services/10-perf.png)
...
![Haga clic en Nuevo, Application Insights.](./media/windows-services/01-new-asp.png)
...
![Haga clic en Propiedades, seleccione la clave y presione ctrl + C.](./media/windows-services/02-props-asp.png)
...
1. En Visual Studio, haga clic con el botón derecho en el proyecto y elija **Administrar paquetes NuGet**.
    ...
    ![Haga clic con el botón secundario en el proyecto y seleccione Administrar paquetes de Nuget.](./media/windows-services/03-nuget.png)
2. Instale el paquete de Application Insights para aplicaciones de Windows Server, "Microsoft.ApplicationInsights.WindowsServer".
    ...
    ![Busque "Application Insights"](./media/windows-services/04-ai-nuget.png)
...
* [Escriba su propia telemetría mediante la API](../../azure-monitor/app/api-custom-events-metrics.md#ikey).
...
Es útil establecer la clave de instrumentación en el código si desea [cambiar la clave para diferentes configuraciones de compilación](../../azure-monitor/app/separate-resources.md). Si establece la clave en el código, no tiene que establecerla en el archivo `.config`.
...
![Recuento de eventos en Visual Studio](./media/windows-services/appinsights-09eventcount.png)
...
![Haga clic en las distintas opciones para obtener más datos](./media/windows-services/12-first-perf.png)

Haga clic en cualquier gráfico para ver métricas más detalladas. [Más información acerca de las métricas](../../azure-monitor/app/web-monitor-performance.md)

### <a name="no-data"></a>¿No hay datos?
* Use la aplicación y abra varias páginas para generar telemetría.
* Abra el icono [Búsqueda](../../azure-monitor/app/diagnostic-search.md) para ver los eventos individuales. A veces, los eventos tardan un poco en llegar a través de la canalización de métricas.
...
* Vea [Solución de problemas](../../azure-monitor/app/troubleshoot-faq.md).
...
![Uso de Visual Studio para publicar la aplicación](./media/windows-services/15-publish.png)
...
Consulte [este apartado de la solución de problemas](../../azure-monitor/app/asp-net-troubleshoot-no-data.md#NuGetBuild).
...
* [Agregue más telemetría](../../azure-monitor/app/asp-net-more.md) para obtener la visión completa de 360 grados de la aplicación.
