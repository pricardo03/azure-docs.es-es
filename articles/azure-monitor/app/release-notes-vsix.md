...
![Tendencias de Application Insights](./media/release-notes-vsix/Trends.png)
...
![Excepciones en CodeLens](./media/release-notes-vsix/ExceptionsCodeLens.png)
...
![Compatibilidad con ASP.NET Core](./media/release-notes-vsix/NetCoreSupport.png)
...
![Compatibilidad de Herramientas de diagnóstico](./media/release-notes-vsix/DiagnosticTools.png)
...
![Menú contextual del proyecto para las aplicaciones universales de Windows](./media/release-notes-vsix/UniversalContextMenu.png)
...
![Cuadro de diálogo de carga de las aplicaciones universales de Windows](./media/release-notes-vsix/UniversalUploadDialog.png)
...
![Cargar notificación completa](./media/release-notes-vsix/UploadComplete.png)
...
![Portal de HockeyApp](./media/release-notes-vsix/HockeyAppPortal.png)

Consulte la [base de conocimiento de HockeyApp](https://support.hockeyapp.net/kb/app-management-2) para más información acerca de la administración de la aplicación.
...
![Menú contextual del proyecto para las aplicaciones de Windows Forms](./media/release-notes-vsix/WinFormContextMenu.png)

Esto abre el cuadro de diálogo de carga de HockeyApp, que es similar a una aplicación universal de Windows.

![Cuadro de diálogo de carga de las aplicaciones de Windows Forms](./media/release-notes-vsix/WinFormsUploadDialog.png)
...
El resto del flujo es similar al de las aplicaciones universales de Windows: elegir las opciones de Azure Pipelines, agregar notas de la versión, cargar y administrar en el portal de HockeyApp.
...
![Carga completa](./media/release-notes-vsix/LocalSearch.png)
...
![Notificación del registro](./media/release-notes-vsix/LoggingToast.png)
...
![Seguimientos](./media/release-notes-vsix/Traces.png)
...
![Buscar coincidencia](./media/release-notes-vsix/FindMatch.png)
...
![Ventana de búsqueda](./media/release-notes-vsix/SearchWindow.png)
...
![Elementos relacionados](./media/release-notes-vsix/RelatedItems.png)
...
![Volver](./media/release-notes-vsix/GoBAck.png)
...
![Clic en detalles de la excepción](./media/release-notes-vsix/jumptocode.png)
...
![Buscar en el Explorador de soluciones](./media/release-notes-vsix/searchentry.png)
...
![Publicar notificación completa](./media/release-notes-vsix/publishtoast.png)
...
![Ventana de búsqueda](./media/release-notes-vsix/search.png)
...
![Página Herramientas de diagnóstico](./media/release-notes-vsix/diagtools.png)
...
![Cuadro de diálogo Nuevo proyecto](./media/release-notes-vsix/newproject.png)
