...
![Crear un recurso > Herramientas de desarrollo > Application Insights](./media/monitor-web-app-availability/1create-resource-appinsights.png)
...
2. Abra el archivo .webtest y empiece a grabar.
    ...
    ![Abra el archivo .webtest y haga clic en Grabar.](./media/monitor-web-app-availability/appinsights-71webtest-multi-vs-start.png)
3. Realice las acciones del usuario que desea simular en la prueba: abra el sitio web, agregue un producto al carro, etc. Después, detenga la prueba.
    ...
    ![Se ejecuta la grabadora de la prueba web en Internet Explorer.](./media/monitor-web-app-availability/appinsights-71webtest-multi-vs-record.png)
...
5. Ejecute la prueba en Visual Studio para asegurarse de que funciona.
    ...
    ![En Visual Studio, abra el archivo .webtest y haga clic en Ejecutar.](./media/monitor-web-app-availability/appinsights-71webtest-multi-vs-run.png)

#### <a name="2-upload-the-web-test-to-application-insights"></a>2. Cargar la prueba web en Application Insights
1. En el portal de Application Insights, en la hoja Disponibilidad, haga clic en Agregar prueba.

    ![En la hoja Disponibilidad, seleccione Agregar prueba.](./media/monitor-web-app-availability/3addtest-web.png)
...
![Una prueba web con parámetros.](./media/monitor-web-app-availability/appinsights-72webtest-parameters.png)
...
1. Agregue un complemento de prueba de web a cada valor variable que desee. En la barra de herramientas de pruebas web, elija **Agregar complemento de prueba web**.
    ...
    ![Elija Agregar complemento de prueba web y seleccione un tipo.](./media/monitor-web-app-availability/appinsights-72webtest-plugins.png)
...
2. Abra las propiedades de cada complemento. Asígnele un nombre y configúrelo para utilizar la hora actual. En cada uno de ellos, establezca Añadir minutos = -15.
    ...
    ![Establezca el nombre, Usar hora actual y Agregar minutos.](./media/monitor-web-app-availability/appinsights-72webtest-plugin-parameters.png)
3. En los parámetros de prueba en la web, utilice {{plug-in name}} para hacer referencia al nombre de un complemento.

    ![En el parámetro de la prueba, utilice {{plug-in name}}.](./media/monitor-web-app-availability/appinsights-72webtest-plugin-name.png)
...
En la pestaña Información general, se muestra el índice de éxito de las pruebas, mientras que en la pestaña de detalles se muestra el gráfico de dispersión y una cuadrícula con detalles específicos.

Después de unos minutos, haga clic en **Actualizar** para ver los resultados de las pruebas.

![Diagrama de dispersión en la hoja de detalle](./media/monitor-web-app-availability/4refresh.png)
...
![Ver los detalles de la prueba, editar y deshabilitar una prueba web](./media/monitor-web-app-availability/5viewdetails.png)
...
![Experiencia de creación](./media/monitor-web-app-availability/appinsights-71webtestUpload.png)

> [!NOTE]
>  Con las [nuevas alertas unificadas](https://docs.microsoft.com/azure/monitoring-and-diagnostics/monitoring-action-groups), la gravedad de la regla de alertas y las preferencias de notificación con **grupos de acciones** se tienen que configurar en la experiencia de alertas. Sin los pasos siguientes, solo recibirá las notificaciones del portal.
...
![Editar después de guardar](./media/monitor-web-app-availability/9editalert.png)
...
![Editar después de guardar](./media/monitor-web-app-availability/10editalert.png)
...
![Ejemplo de secreto de cliente](./media/monitor-web-app-availability/110.png)
...
![Crea una prueba de rendimiento](./media/monitor-web-app-availability/11new-performance-test.png)

Una vez finalizada la prueba, se muestran los tiempos de respuesta y las tasas de éxito.

![Resultados de la prueba de rendimiento](./media/monitor-web-app-availability/12performance-test.png)

> [!TIP]
> Para observar los efectos de una prueba de rendimiento, utilice [Live Stream](../../azure-monitor/app/live-stream.md) y el [Generador de perfiles](../../azure-monitor/app/profiler.md).
>
