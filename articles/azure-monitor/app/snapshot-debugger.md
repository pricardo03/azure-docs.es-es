...
3. Revise las opciones predeterminadas que el paquete ha agregado a [ApplicationInsights.config](../../azure-monitor/app/configuration-with-applicationinsights-config.md):
...
Si una instantánea está disponible para una excepción o un identificador de problema determinados, se mostrará un botón **Abrir instantánea de depuración** en la [excepción](../../azure-monitor/app/asp-net-exceptions.md) del portal de Application Insights.

![Botón Abrir instantánea de depuración de la excepción](./media/snapshot-debugger/snapshot-on-exception.png)
