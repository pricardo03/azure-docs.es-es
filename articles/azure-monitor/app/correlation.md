...
- **Configuración de entrada**
  ...
  - En el caso de las aplicaciones de J2EE, agregue lo siguiente a la etiqueta `<TelemetryModules>` en el archivo ApplicationInsights.xml:
...
- Obtenga más información sobre la [opción cloud_RoleName](../../azure-monitor/app/app-map.md#set-cloudrolename) en otros SDK.
