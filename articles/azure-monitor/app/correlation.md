...
**Las aplicaciones de J2EE** agregan lo siguiente a la etiqueta `<TelemetryModules>` dentro del archivo ApplicationInsights.xml
...
**Las aplicaciones de Spring Boot** agregan las siguientes propiedades:
...
Lo ideal sería cuando todos los servicios se hayan actualizado a la versión más reciente de los SDK compatibles con el protocolo W3C. Se recomienda encarecidamente pasar a la versión más reciente de los SDK con compatibilidad con W3C lo antes posible. 

Asegúrese de que **las configuraciones tanto entrantes como salientes sean exactamente iguales**.
