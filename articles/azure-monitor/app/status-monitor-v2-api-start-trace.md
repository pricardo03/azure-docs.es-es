...
ms.locfileid: "67807048"
---
# <a name="status-monitor-v2-api-start-applicationinsightsmonitoringtrace-v040-alpha"></a>API del Monitor de estado v2: Start-ApplicationInsightsMonitoringTrace (v0.4.0-alpha)
