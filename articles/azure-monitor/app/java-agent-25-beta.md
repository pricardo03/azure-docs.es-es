---
title: Supervisión de rendimiento de aplicaciones web de Java en Azure Application Insights (2.5.0-BETA) | Microsoft Docs
description: Supervisión extendida del rendimiento y el uso de su sitio web de Java con Application Insights (2.5.0-BETA).
...
Clave: `JAVA_OPTS` Valor: `-javaagent:D:/home/site/wwwroot/applicationinsights-agent-2.5.0-BETA.jar`
