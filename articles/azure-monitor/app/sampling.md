...
Se puede deshabilitar la característica de muestreo predeterminado al agregar el servicio de Application Insights, en el método ```ConfigureServices```, usando ```ApplicationInsightsServiceOptions```:
