...
ms.locfileid: "68424129"
---
# <a name="status-monitor-v2-api-get-applicationinsightsmonitoringstatus"></a>API del Monitor de estado v2: Get-ApplicationInsightsMonitoringStatus
