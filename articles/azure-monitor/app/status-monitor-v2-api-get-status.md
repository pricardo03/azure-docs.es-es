...
ms.locfileid: "65147499"
---
# <a name="status-monitor-v2-api-get-applicationinsightsmonitoringstatus-v021-alpha"></a>API de v2 del Monitor de estado: Get-ApplicationInsightsMonitoringStatus (v0.2.1-alpha)
