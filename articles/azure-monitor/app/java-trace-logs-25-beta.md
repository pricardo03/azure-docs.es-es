---
title: Exploración de los registros de seguimiento de Java en Azure Application Insights (2.5.0-BETA) | Microsoft Docs
description: Búsqueda de seguimiento Log4J o Logback en Application Insights (2.5.0-BETA)
...
ms.locfileid: "68298196"
---
# <a name="explore-java-trace-logs-in-application-insights-250-beta"></a>Exploración de los registros de seguimiento de Java en Application Insights (2.5.0-BETA)
...
## <a name="note-if-you-are-using-the-application-insights-java-agent"></a>Nota: Si usa el agente de Java de Application Insights
