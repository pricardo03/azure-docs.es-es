...
* [Aplicación .NET](../../azure-monitor/app/asp-net-troubleshoot-no-data.md)
* [Supervisión de una aplicación que ya se está ejecutando](../../azure-monitor/app/monitor-performance-live-website-now.md#troubleshoot)
* [Diagnóstico de Azure](../../azure-monitor/platform/diagnostics-extension-to-application-insights.md)
* [Aplicaciones web de Java](../../azure-monitor/app/java-troubleshoot.md)

*No recibo datos de mi servidor*

* [Establecer excepciones del firewall](../../azure-monitor/app/ip-addresses.md)
* [Configurar un servidor ASP.NET](../../azure-monitor/app/monitor-performance-live-website-now.md)
* [Configurar un servidor de Java](../../azure-monitor/app/java-agent.md)

## <a name="can-i-use-application-insights-with-"></a>¿Se puede usar Application Insights con...?

* [Aplicaciones web en un servidor de IIS: local o en una máquina virtual](../../azure-monitor/app/asp-net.md)
* [Aplicaciones web de Java](../../azure-monitor/app/java-get-started.md)
* [Aplicaciones de Node.js](../../azure-monitor/app/nodejs.md)
* [Aplicaciones web de Azure](../../azure-monitor/app/azure-web-apps.md)
* [Cloud Services en Azure](../../azure-monitor/app/cloudservices.md)
* [Servidores de aplicaciones que se ejecutan en Docker](../../azure-monitor/app/docker.md)
* [Aplicaciones web de una sola página](../../azure-monitor/app/javascript.md)
* [SharePoint](sharepoint.md)
* [Aplicación de escritorio de Windows](../../azure-monitor/app/windows-desktop.md)
...
Los volúmenes más grandes de telemetría se cobran por GB. Se proporcionan algunas sugerencias sobre cómo [limitar los gastos](../../azure-monitor/app/pricing.md).
...
Consulte las [notas de la versión](../../azure-monitor/app/release-notes.md) del SDK adecuado para el tipo de aplicación.
...
[Más información](../../azure-monitor/app/monitor-performance-live-website-now.md#questions).
...
* Solicitudes HTTP
* [Dependencias](../../azure-monitor/app/asp-net-dependencies.md). Llamadas a: instancias de SQL Database; llamadas HTTP a servicios externos; Azure Cosmos DB, tabla, almacenamiento de blobs y colas. 
* [Excepciones](../../azure-monitor/app/asp-net-exceptions.md) y seguimientos de pila.
* [Contadores de rendimiento](../../azure-monitor/app/performance-counters.md): si usa el [Monitor de estado](../../azure-monitor/app/monitor-performance-live-website-now.md), la [supervisión de Azure](../../azure-monitor/app/azure-web-apps.md) o el [escritor de collectd de Application Insights](../../azure-monitor/app/java-collectd.md).
* [Eventos y métricas personalizados](../../azure-monitor/app/api-custom-events-metrics.md) que puede crear mediante código.
* [Registros de seguimiento](../../azure-monitor/app/asp-net-trace-logs.md) si configura el recopilador adecuado.

De las [páginas web de cliente](../../azure-monitor/app/javascript.md):

* [Recuentos de vistas de página](usage-overview.md)
* [Llamadas AJAX](../../azure-monitor/app/asp-net-dependencies.md): solicitudes realizadas desde un script en funcionamiento
* Datos de carga de vista de página
* Recuentos de usuarios y sesiones
* [Id. de usuario autenticados](../../azure-monitor/app/api-custom-events-metrics.md#authenticated-users).

De otros orígenes, si los configura:

* [Diagnóstico de Azure](../../azure-monitor/platform/diagnostics-extension-to-application-insights.md)
* [Importación a Analytics](https://docs.microsoft.com/azure/log-analytics/log-analytics-data-collector-api)
...
Más información sobre [ASP.NET](../../azure-monitor/app/api-filtering-sampling.md) o [Java](../../azure-monitor/app/java-filter-telemetry.md).
...
También puede [usar Power BI](../../azure-monitor/app/export-power-bi.md ) para mostrar la telemetría de solicitudes en un mapa.
...
* [Ejemplo: servicio en la nube con roles web y de trabajo](../../azure-monitor/app/cloudservices.md)
...
* Para identificar un usuario que ha iniciado sesión en todas las máquinas y exploradores, agregue una llamada a [setAuthenticatedUserContext()](../../azure-monitor/app/api-custom-events-metrics.md#authenticated-users).

## <a name="q17"></a> ¿He habilitado todo en Application Insights?
| Qué debería ver | Cómo conseguirlo | Razones para quererlo |
| --- | --- | --- |
| Gráficos de disponibilidad |[Pruebas web](../../azure-monitor/app/monitor-web-app-availability.md) |Saber que la aplicación web funciona |
| Rendimiento de la aplicación de servidor: tiempos de respuesta, etc. |[Agregue Application Insights a su proyecto](../../azure-monitor/app/asp-net.md) o [instale el Monitor de estado de Application Insights en un servidor](../../azure-monitor/app/monitor-performance-live-website-now.md) (o escriba su propio código para [realizar un seguimiento de las dependencias](../../azure-monitor/app/api-custom-events-metrics.md#trackdependency)). |Detectar problemas de rendimiento |
| Telemetría de dependencia |[Instalar el Monitor de estado de Application Insights en el servidor](../../azure-monitor/app/monitor-performance-live-website-now.md) |Diagnosticar problemas con las bases de datos u otros componentes externos |
| Obtener seguimientos de pila de las excepciones |[Insertar llamadas TrackException en el código](../../azure-monitor/app/asp-net-exceptions.md) (aunque algunas se notifican automáticamente) |Detectar y diagnosticar excepciones |
| Buscar seguimientos del registro |[Agregar un adaptador de registro](../../azure-monitor/app/asp-net-trace-logs.md) |Diagnosticar excepciones, problemas de rendimiento |
| Aspectos básicos del uso de cliente: vistas de página, sesiones,... |[Inicializador de JavaScript en páginas web](../../azure-monitor/app/javascript.md) |Análisis de uso |
| Métricas personalizadas de cliente |[Seguimiento de llamadas en páginas web](../../azure-monitor/app/api-custom-events-metrics.md) |Mejorar la experiencia del usuario |
| Métricas personalizadas de servidor |[Seguimiento de llamadas en el código de servidor](../../azure-monitor/app/api-custom-events-metrics.md) |Business intelligence |
...
También puede [escribir scripts de PowerShell](../../azure-monitor/app/powershell.md) mediante el Monitor de recursos de Azure para:
...
Use la [API de REST](https://dev.applicationinsights.io/) para ejecutar consultas de [Analytics](../../azure-monitor/app/analytics.md).
...
Se recomienda usar nuestros SDK y la [API de SDK](../../azure-monitor/app/api-custom-events-metrics.md). Hay variantes del SDK para distintas [plataformas](../../azure-monitor/app/platforms.md). Estos SDK controlan el almacenamiento en búfer, la compresión, la limitación, los reintentos, etc. Sin embargo, el [esquema de ingesta](https://github.com/Microsoft/ApplicationInsights-dotnet/tree/develop/Schema/PublicSchema) y el [protocolo de punto de conexión](https://github.com/Microsoft/ApplicationInsights-Home/blob/master/EndpointSpecs/ENDPOINT-PROTOCOL.md) son públicos.
...
Consulte nuestra lista de servicios y direcciones IP [aquí](../../azure-monitor/app/ip-addresses.md).
...
Nuestras [pruebas web](../../azure-monitor/app/monitor-web-app-availability.md) se ejecutan en puntos de presencia que están repartidos por todo el mundo. Hay dos soluciones:

* Puerta de firewall: permitir solicitudes al servidor desde [la lista larga y modificable de agentes de prueba web](../../azure-monitor/app/ip-addresses.md).
