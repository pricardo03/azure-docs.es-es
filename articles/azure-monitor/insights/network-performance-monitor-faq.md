...
Las dos funcionalidades, Supervisión del rendimiento y Monitor de conectividad de servicio, admiten nodos [conectados como agentes directos](../../azure-monitor/platform/agent-windows.md), así como [conectados a través de Operations Manager](../../azure-monitor/platform/om-agents.md).
