...
2. Use la siguiente consulta para mostrar las recomendaciones para los equipos que presentan errores en el entorno.
    ...
    Captura de pantalla que muestra la consulta de Búsqueda de registros: <br><br> ![búsqueda de registros](./media/scom-assessment/scom-log-search.png)<br>
