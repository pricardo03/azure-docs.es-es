...
**¿Cómo fue el uso del Monitor de rendimiento se facturan en el modelo anterior?**
...
**Tengo dos subredes (A y B), y tener varios agentes en cada subred. Monitor de rendimiento supervisa la conectividad de todos los agentes en la subred A con todos los agentes en la subred B. ¿Se me cobrará en función del número de conexiones entre subredes?**
...
**¿Cuáles son los cargos por uso de la supervisión de ExpressRoute?**
...
**Uso a ExpressRoute Monitor para supervisar varios circuitos de ExpressRoute. ¿Se cobra en función del número de circuitos que se está supervisando?**
...
**¿Qué es el volumen de datos generados cuando ExpressRoute supervisa un único circuito?**
...
**¿Cuáles son algunas de las razones para las variaciones en el volumen de datos?**
...
**¿Cuáles son los cargos de uso del Monitor de punto de conexión de servicio?**
...
**¿Cuáles son los costos de Monitor de punto de conexión de servicio?**
