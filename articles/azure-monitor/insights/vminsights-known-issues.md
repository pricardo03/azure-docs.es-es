...
- La característica de mantenimiento se ha habilitado para todas las máquinas virtuales conectadas al área de trabajo de Log Analytics, incluso si se ha iniciado y completado desde una sola máquina virtual.
- Después de deshabilitar la supervisión para una máquina virtual mediante los métodos admitidos, cuando se vuelve a intentar la incorporación, debe realizarse en la misma área de trabajo.  Si se usa una nueva área de trabajo, al visualizar el estado de mantenimiento de esa máquina virtual, puede mostrarse un comportamiento anómalo.
...
- El resumen de alertas que se incluye en Azure Monitor para VM corresponde solo a alertas activadas para problemas de mantenimiento detectados con VM de Azure supervisadas.
