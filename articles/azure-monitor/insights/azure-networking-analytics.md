...
* Use [Búsquedas de registros en Log Analytics](../../log-analytics/log-analytics-queries.md) para ver datos detallados sobre los diagnósticos de Azure.
