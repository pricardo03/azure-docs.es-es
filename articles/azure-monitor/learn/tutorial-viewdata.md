...
![Consulta sencilla](media/tutorial-viewdata/log-analytics-portal-eventlist-01.png)
...
![Filtrar](media/tutorial-viewdata/log-analytics-portal-eventlist-02.png)
...
![Menú Agregar a filtros](media/tutorial-viewdata/log-analytics-portal-eventlist-03.png)
...
Puede agrupar los resultados de una sola propiedad seleccionando la opción **Agrupar por** en el menú de registro.  Esto agregará un operador [summarize](/azure/kusto/query/summarizeoperator) a la consulta que muestra los resultados en un gráfico.  Puede agrupar por más de una propiedad, pero deberá editar la consulta directamente.  Seleccione el menú de registro situado junto a la propiedad **Computer** y seleccione **Agrupar por "Computer"**.  

![Agrupar por equipo](media/tutorial-viewdata/log-analytics-portal-eventlist-04.png)
...
![Vista Tabla](media/tutorial-viewdata/log-search-portal-table-01.png)

Haga clic en la flecha junto a un registro para ver los detalles de ese registro.

![Ordenar resultados](media/tutorial-viewdata/log-search-portal-table-02.png)

Ordene cualquier campo haciendo clic en el encabezado de la columna.

![Ordenar resultados](media/tutorial-viewdata/log-search-portal-table-03.png)
...
![Filtrar resultados](media/tutorial-viewdata/log-search-portal-table-04.png)
...
![Agrupar resultados](media/tutorial-viewdata/log-search-portal-table-05.png)
...
![Datos de rendimiento](media/tutorial-viewdata/log-analytics-portal-perfsearch-01.png)
...
![Gráfico con datos de rendimiento](media/tutorial-viewdata/log-analytics-portal-perfsearch-03.png)

Ahora que los datos están agrupados adecuadamente, puede mostrarlos en un gráfico visual agregando el operador [render](/azure/kusto/query/renderoperator).  
...
![Gráfico de líneas](media/tutorial-viewdata/log-analytics-portal-linechart-01.png)
...
> [Creación y uso compartido de paneles de Log Analytics](tutorial-logs-dashboards.md)
