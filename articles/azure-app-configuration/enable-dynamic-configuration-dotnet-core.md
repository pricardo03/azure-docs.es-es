...
Abra *Program.cs* y actualice el archivo para especificar la configuración de la actualización en el método `AddAzureAppConfiguration` y desencadene la actualización manual mediante el método `Refresh`.
