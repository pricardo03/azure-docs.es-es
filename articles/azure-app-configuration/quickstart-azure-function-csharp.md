...
2. Abra *Function1.cs* y agregue una referencia al proveedor de configuración general de .NET Core y al proveedor de App Configuration de .NET Core.
