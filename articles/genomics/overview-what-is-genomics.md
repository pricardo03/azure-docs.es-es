...
titleSuffix: Azure
description: Obtenga información sobre cómo Microsoft Genomics puede potenciar la secuenciación del genoma y ahora ofrece una implementación en la nube de Burrows-Wheeler Aligner (BWA) y de Genome Analysis Toolkit (GATK) para análisis secundario. Tiene un certificado ISO y está conforme con las regulaciones HIPAA.
services: genomics
author: grhuynh
manager: cgronlun
ms.author: grhuynh
...
En lugar de tener que administrar sus propios centros de datos, aproveche la escala y la experiencia de Microsoft para ejecutar cargas de trabajo a escala de exabytes. Nuestra implementación de nube de BWA-GATK es altamente compatible con la canalización de procedimientos recomendados del Instituto Broad.
