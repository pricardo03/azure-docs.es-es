...
* **Puntos de conexión externos** se usan para las direcciones IPv4 o IPv6, FQDN, o para los servicios hospedados fuera de Azure que puede ser local o con otro proveedor de hospedaje.
