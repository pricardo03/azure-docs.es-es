...
En esta sección, instalará el servidor IIS en las dos máquinas virtuales, &mdash;myIISVMEastUS y myIISVMWEurope&mdash; y, luego, actualizará la página web predeterminada. La página web personalizada muestra el nombre de la máquina virtual a la que se conecta cuando visita el sitio web desde un explorador web.
