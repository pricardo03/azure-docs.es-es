...
| [New-AzTrafficManagerEndpoint](/powershell/module/az.trafficmanager/new-aztrafficmanagerendpoint) | Añade un punto de conexión a un perfil de Azure Traffic Manager. |
