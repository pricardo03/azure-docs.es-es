...
Este tutorial le guiará a través del proceso de creación de un entorno de Time Series Insight, rellenado con datos de dispositivos simulados. En este tutorial, aprenderá a:
...
> * Conexión del entorno de Time Series Insights al centro de IoT
> * Ejecución de una simulación de dispositivo para transmitir datos al entorno de Time Series Insights
...
El entorno de Time Series Insights es donde se recopilan y almacenan los datos del dispositivo. Una vez almacenados en el entorno de Time Series Insights, el [Explorador de Time Series Insights](time-series-quickstart.md) y la [API de consulta de Time Series Insights](/rest/api/time-series-insights/ga-query-api) pueden usarse para consultar y analizar los datos. IoT Hub es el punto de conexión que utilizan todos los dispositivos (simulados o físicos) para conectar y transmitir datos de forma segura a la nube de Azure. En [Introducción a Time Series Insights](time-series-insights-overview.md), se explica que IoT Hub también sirve como origen de eventos para la transmisión de datos a un entorno de Time Series Insights. En este tutorial se utiliza un [acelerador de soluciones de IoT](/azure/iot-accelerators/) para generar y transmitir datos de telemetría de ejemplo a IoT Hub.
...
1. En la página **Entorno de Time Series Insights**, rellene los parámetros necesarios:
   ...
   ---|---
   **Nombre del entorno** | Elija un nombre único para el entorno de Time Series Insights. El nombre lo utilizan el Explorador de Time Series Insights y las API de consulta.
   **Suscripción** | Las suscripciones son contenedores para recursos de Azure. Elija una suscripción para la que crear el entorno de Time Series Insights.
   ...
   **Ubicación** | Elija una región del centro de datos para su entorno de Time Series Insights. Para evitar costos de ancho de banda y una latencia agregados, es mejor mantener el entorno de Azure Time Series Insights en la misma región que otros recursos de IoT.
...
A continuación, cree la solución Simulación de dispositivo, que generará datos de prueba para rellenar su entorno de Time Series Insights:
...
1. Escriba los parámetros necesarios en la página **Crear la solución Simulación de dispositivos**.
   ...
   **Suscripción** | Especifique la misma suscripción usada para la creación del entorno de Time Series Insights, en la sección anterior.
   **Región** | Especifique la misma región usada para la creación del entorno de Time Series Insights, en la sección anterior.
...
Recuerde que los dispositivos simulados necesitan conectarse a una instancia de IoT Hub para transmitir datos de dispositivo. Para que los datos fluyan al entorno de Time Series Insights, es necesario realizar cambios de configuración tanto en su centro de IoT como en el entorno de Time Series Insights.
...
Conecte ahora el nuevo punto de conexión de eventos **grupo de consumidores** del centro de IoT al entorno de Time Series Insights, como un **origen de eventos**.

1. Vaya a la página **Información general** del grupo de recursos que ha creado para el entorno de Time Series Insights; después, seleccione el entorno de Time Series Insights:
...
1. En la página del entorno de Time Series Insights, seleccione **Orígenes de eventos** y, a continuación, haga clic en **+ Agregar**.
...
1. Escriba los parámetros necesarios en la página **Nuevo origen de eventos**.
   ...
   **Nombre de propiedad de marca de tiempo** | Especifique `timestamp`.
   ...
   Cuando finalice, haga clic en **Crear** para agregar el origen del evento. Cuando regrese a la página **Información general** del grupo de recursos, junto con su recurso de entorno de Time Series Insights, verá un nuevo recurso "Origen del evento de Time Series Insights".
...
Ahora que se ha completado todo el trabajo de configuración, es el momento de rellenar el entorno de Time Series Insights con datos de ejemplo de los dispositivos simulados.
...
1. En la página **Información general** del entorno de Time Series Insights, haga clic en **URL del explorador de Time Series Insights** para abrir el explorador de Time Series Insights.
...
1. La reducción del intervalo de tiempo permite al gráfico acercarse a las distintivas ráfagas de transferencia de datos, a la instancia de IoT Hub y al entorno de Time Series Insights. Observe también el texto **Se ha completado la transmisión.** en la parte superior derecha, que muestra el número total de eventos encontrados. También puede arrastrar el control deslizante **Tamaño de intervalo** para controlar la granularidad del gráfico.
...
En este tutorial se crean varios servicios de Azure activos, para admitir la solución Simulación de dispositivo y el entorno de Time Series Insights. Si desea abandonar o retrasar la finalización de esta serie de tutoriales, le recomendamos eliminar todos los recursos para no incurrir en costos innecesarios.

En el menú izquierdo de Azure Portal:

1. Haga clic en el icono **Grupos de recursos** y, después, seleccione el grupo de recursos que ha creado para el entorno de Time Series Insights. En la parte superior de la página, haga clic en **Eliminar grupo de recursos**, escriba el nombre del grupo de recursos y haga clic en **Eliminar**.
