---
title: 'Incorporación de un centro de eventos a Azure Time Series Insights: agregar un origen del evento de Event Hubs a Azure Time Series Insights| Microsoft Docs'
