---
title: 'Seguridad de la versión preliminar de Azure Time Series Insights: Configuración de seguridad para el acceso y administración de la versión preliminar de Azure Time Series Insights | Microsoft Docs'
