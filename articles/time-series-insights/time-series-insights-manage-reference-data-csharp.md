---
title: 'Datos de referencia de Azure Time Series Insights en C#: administración de datos de referencia en el entorno de Azure Time Series Insights con C# | Microsoft Docs'
