---
title: 'Datos de referencia de Azure Time Series Insights: cómo agregar un conjunto de datos de referencia al entorno de Azure Time Series Insights | Microsoft Docs'
