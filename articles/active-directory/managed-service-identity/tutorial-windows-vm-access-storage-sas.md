---
title: Uso de Managed Service Identity en una máquina virtual Windows para tener acceso a Azure Storage con una credencial SAS
description: Tutorial que muestra cómo utilizar Managed Service Identity en una máquina virtual Windows para acceder a Azure Storage, mediante una credencial SAS en lugar de una clave de acceso de la cuenta de almacenamiento.
...
En este tutorial se explica cómo habilitar Managed Service Identity en una máquina virtual Windows y, después, usar Managed Service Identity para obtener una credencial de firma de acceso compartido (SAS) del almacenamiento. En concreto, una [credencial SAS de servicio](/azure/storage/common/storage-dotnet-shared-access-signature-part-1?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#types-of-shared-access-signatures). 
...
Si aún no tiene una, creará ahora una cuenta de almacenamiento. También puede omitir este paso y conceder a la característica Managed Service Identity de la máquina virtual acceso a la credencial SAS de una cuenta de almacenamiento existente. 
...
## <a name="grant-your-vms-managed-service-identity-access-to-use-a-storage-sas"></a>Conceda a la característica Managed Service Identity de su máquina virtual acceso para usar una clave de acceso compartido de almacenamiento 

Azure Storage no admite la autenticación de Azure AD de forma nativa.  No obstante, puede usar una instancia de Managed Service Identity para recuperar una SAS de almacenamiento de Resource Manager y usar la SAS para acceder al almacenamiento.  En este paso, concede a la característica Managed Service Identity de la máquina virtual acceso a la clave de acceso compartido de su cuenta de almacenamiento.   
...
7. Por último, en **Seleccionar**, elija la máquina virtual Windows en el menú desplegable y haga clic en **Guardar**. 
    ...
    ![Texto alternativo de imagen](../managed-service-identity/media/msi-tutorial-linux-vm-access-storage/msi-storage-role-sas.png)
...
En este tutorial, ha obtenido información sobre cómo crear una instancia de Managed Service Identity para acceder a Azure Storage mediante una credencial de SAS.  Para obtener más información sobre SAS de Azure Storage, vea:
