...
| Azure API Management | Vista previa | No disponible | [Plantilla de Azure Resource Manager](/azure/api-management/api-management-howto-use-managed-service-identity) | 
...
| Azure Storage | https://azure.microsoft.com/services/storage/ | Vista previa | Mayo de 2018 | |
