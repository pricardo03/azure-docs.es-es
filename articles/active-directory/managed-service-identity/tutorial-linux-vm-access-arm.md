...
3. En la ventana del terminal, utilice CURL para realizar una solicitud al punto de conexión local de Managed Identities for Azure Resources y obtener un token de acceso para Azure Resource Manager.  
