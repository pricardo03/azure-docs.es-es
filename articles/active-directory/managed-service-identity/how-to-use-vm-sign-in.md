...
Consulte [Servicios de Azure que admiten la autenticación de Azure AD](services-support-msi.md#azure-services-that-support-azure-ad-authentication) para ver una lista de recursos que admite Azure AD y que se han probado con identidades administradas para recursos de Azure y sus respectivos identificadores de recursos.
...
- Vaya a la página **Extensiones** y asegúrese de que las identidades administradas para la extensión de recursos de Azure se haya implementado correctamente.
