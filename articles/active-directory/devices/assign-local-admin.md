...
A partir de la versión **Windows 10 1709**, puede realizar esta tarea en **Configuración -> Cuentas -> Otros usuarios** mediante la selección de **Agregar un usuario de trabajo o escuela**.
