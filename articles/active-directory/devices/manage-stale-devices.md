...
- **Windows 7/8**: deshabilite o elimine los dispositivos Windows 10 en Azure AD. No se puede usar Azure AD Connect para deshabilitar o eliminar dispositivos Windows 7/8 en Azure AD.
