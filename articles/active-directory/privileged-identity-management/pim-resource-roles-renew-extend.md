...
![Extender roles](media/azure-pim-resource-rbac/aadpim_rbac_extend_ui.png)
...
![Abrir el formulario de solicitud](media/azure-pim-resource-rbac/aadpim_rbac_extend_role_assignment_request.png)
...
![Extender la asignación de roles](media/azure-pim-resource-rbac/aadpim_rbac_extend_form_complete.png)
...
![Captura de pantalla del error](media/azure-pim-resource-rbac/aadpim_rbac_extend_admin_approve_grid.png)
...
![Extender la pertenencia a un rol](media/azure-pim-resource-rbac/aadpim_rbac_extend_admin_extend.png)
...
![Renovar asignaciones de roles](media/azure-pim-resource-rbac/aadpim_rbac_renew_request_form.png)
...
![Aprobar solicitudes](media/azure-pim-resource-rbac/aadpim_rbac_extend_admin_approve_grid.png)

Cuando un administrador selecciona **Aprobar** o **Denegar**, se muestran los detalles de la solicitud, junto con un campo para especificar una justificación para los registros de auditoría.

![Aprobar asignaciones de roles](media/azure-pim-resource-rbac/aadpim_rbac_extend_admin_approve_blade.png)
...
![Roles expirados](media/azure-pim-resource-rbac/aadpim_rbac_renew_from_member_blade.png)
