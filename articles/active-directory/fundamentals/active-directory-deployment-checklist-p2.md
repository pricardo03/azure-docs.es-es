...
* [Guía de licencias de Azure AD B2B](../b2b/licensing-guidance.md)
...
| ---- | ------ | ---------------- |
| [Designar más de un administrador global](../users-groups-roles/directory-emergency-access.md) | Asigne al menos dos cuentas de administrador global permanentes solo en la nube para casos de emergencia. Estas cuentas no son para un uso diario y deben tener contraseña compleja y larga. | Azure AD Free |
| [Usar roles administrativos no global siempre que sea posible](../users-groups-roles/directory-assign-admin-roles.md) | Asigne a los administradores solo el acceso que necesitan a las áreas a las que necesitan acceso. No todos los administradores necesitan ser administradores globales. | Azure AD Free |
| [Habilitar Privileged Identity Management para el seguimiento de uso de roles de administrador](../privileged-identity-management/pim-getting-started.md) | Habilite Privileged Identity Management para empezar el seguimiento del uso del rol de administrador. | Azure AD Premium P2 |
| [Implementar el restablecimiento de contraseña de autoservicio](../authentication/howto-sspr-deployment.md) | Reduzca las llamadas al departamento de soporte técnico para el restablecimiento de contraseña al permitir a los empleados restablecerlas ellos mismos mediante directivas que controle usted como administrador. | Azure AD Basic |
...
| [Habilitar la integración local con la protección de contraseña de Azure AD](../authentication/concept-password-ban-bad-on-premises.md) | Amplíe la lista de contraseñas prohibidas al directorio local para garantizar que las contraseñas locales también cumplen los requisitos de las listas de contraseñas prohibidas globales y específicas del inquilino. | Azure AD Premium P1 |
| [Habilitar la Guía de contraseñas de Microsoft](https://www.microsoft.com/research/publication/password-guidance/) | Olvídese de solicitar a los usuarios que cambien periódicamente la contraseña, deshabilite los requisitos de complejidad y a los usuarios les será más fácil recordar la contraseña y mantener una segura. | Azure AD Free |
| [Deshabilitar los reinicios de contraseña periódico de cuentas de usuario en la nube](../authentication/concept-sspr-policy.md#set-a-password-to-never-expire) | Los restablecimientos de contraseña periódicos promueven un aumento de las contraseñas existentes para los usuarios. Sírvase de la documentación de guía de las directrices de Microsoft sobre las contraseñas y copie la directiva local con los usuarios únicamente de la nube. | Azure AD Free |
| [Personalizar el bloqueo inteligente de Azure Active Directory](../authentication/howto-password-smart-lockout.md) | Deje de tener bloqueos de los usuarios de la nube al replicarlos a usuarios de Active Directory locales. | Azure AD Basic |
| [Habilitar el bloqueo inteligente de Extranet de AD FS](/windows-server/identity/ad-fs/operations/configure-ad-fs-extranet-smart-lockout-protection) | El bloqueo de la extranet de AD FS protege contra los ataques de adivinación de contraseñas por fuerza bruta al tiempo que permite a los usuarios de AD FS válidos continuar usando sus cuentas. | |
| [Implementar la autenticación multifactor de Azure AD mediante directivas de acceso condicional](../authentication/howto-mfa-getstarted.md) | Haga que los usuarios realicen la verificación en dos pasos al acceder a aplicaciones confidenciales mediante directivas de acceso condicional. | Azure AD Premium P1 |
| [Habilitar Azure Active Directory Identity Protection](../identity-protection/enable.md) | Habilite el seguimiento de los inicios de sesión de riesgo y de las credenciales en riesgo para los usuarios de su organización. | Azure AD Premium P2 |
| [Usar eventos de riesgo para desencadenar la autenticación multifactor y los cambios de contraseña](../authentication/tutorial-risk-based-sspr-mfa.md) | Habilite la automatización que desencadene eventos como la autenticación multifactor, el restablecimiento de contraseña y el bloqueo del inicio de sesión en caso de riesgo. | Azure AD Premium P2 |
| [Habilitar el registro convergente para restablecer la contraseña de autoservicio y autenticación multifactor de Azure AD (versión preliminar)](../authentication/concept-registration-mfa-sspr-converged.md) | Permita que los usuarios se registren para una de las experiencias comunes: Azure Multi-Factor Authentication o el autoservicio de restablecimiento de contraseña. | Azure AD Premium P1 |
...
| [Implementar la sincronización de Hash de contraseña](../connect/active-directory-aadconnectsync-implement-password-hash-synchronization.md) | Sincronice los hash de contraseña para permitir que se repliquen los cambios de contraseña, la detección y la solución de problemas con la contraseña y los informes de revelación de credenciales. | Azure AD Premium P1 |
| [Implementar la escritura diferida de contraseñas](../authentication/howto-sspr-writeback.md) | Permita la escritura diferida de los cambios de contraseña en la nube en un entorno de Windows Server Active Directory local. | Azure AD Premium P1 |
| [Implemente Azure AD Connect Health](../connect-health/active-directory-aadconnect-health.md) | Habilite la supervisión de estadísticas de las claves de estado para los servidores de Azure AD Connect y de AD FS, y los controladores de dominio. | Azure AD Premium P1 |
...
| [Crear un plan para el acceso de usuarios invitados](../b2b/what-is-b2b.md) | Colabore con los usuarios invitados y permítales iniciar sesión en las aplicaciones y los servicios con sus propias identidades profesionales, educativas o sociales. | [Guía de licencias de Azure AD B2B](../b2b/licensing-guidance.md) |
| [Decida la estrategia de administración de dispositivos](../devices/overview.md) | Decida lo que permite su organización con respecto a los dispositivos. Registro o unión, dispositivos propios o proporcionados por la empresa, etc. | |
...
| [Integrar aplicaciones SaaS compatibles en la Galería](../manage-apps/add-application-portal.md) | Azure AD incluye una galería que contiene miles de aplicaciones previamente integradas. Algunas de las aplicaciones que su organización usa probablemente estén en la galería y se pueda acceder a ellas desde Azure Portal. | Azure AD Free |
| [Usar a Proxy de aplicación para integrar las aplicaciones locales](../manage-apps/application-proxy-add-on-premises-application.md) | Un proxy de aplicación permite a los usuarios acceder a aplicaciones locales mediante el sesión con su cuenta de Azure AD. | Azure AD Basic |
...
| [Implementar directivas de pertenencia a grupo dinámico](../users-groups-roles/groups-dynamic-membership.md) | Use grupos dinámicos para asignar automáticamente usuarios a grupos en función de sus atributos de RR. HH. (o su origen fiable), como el departamento, el puesto, la región y otros atributos. |  |
| [Implementar el aprovisionamiento de aplicaciones de grupo basado](../manage-apps/what-is-access-management.md) | Use el aprovisionamiento de administración del acceso basado en grupos para aprovisionar usuarios automáticamente para las aplicaciones SaaS. |  |
...
[Detalles de precios y licencias de AD de Azure](https://azure.microsoft.com/pricing/details/active-directory/)
...
[Común recomienda las directivas de acceso de dispositivos e identidades](https://docs.microsoft.com/microsoft-365/enterprise/identity-access-policies)
