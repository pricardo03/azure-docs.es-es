---
title: Uso de grupos para administrar el acceso a recursos en Azure AD | Microsoft Docs
...
* [Puesta a disposición de un grupo para el autoservicio del usuario final](../users-groups-roles/groups-self-service-management.md)
* [Sincronización de un grupo local con Azure mediante Azure AD Connect](../connect/active-directory-aadconnect.md)
...
* [Uso de atributos para crear reglas avanzadas](../users-groups-roles/groups-dynamic-membership.md)
