---
title: Personalización de la página de inicio de sesión del inquilino de Azure AD | Microsoft Docs
...
Las personalizaciones de marca de la empresa aparecerán en la página de inicio de sesión de Azure AD cuando los usuarios tengan acceso a una dirección URL específica del inquilino como [*https://outlook.com/contoso.com*](https://outlook.com/contoso.com) o pasando la variable de dominio en la dirección URL como [*https://passwordreset.microsoftonline.com/?whr=contoso.com*](https://passwordreset.microsoftonline.com/?whr=contoso.com).
...
2. Seleccione **Azure Active Directory** > **Personalización de marca de empresa** > **Editar**.
...
2. Seleccione **Azure Active Directory** > **Personalización de marca de empresa** > **Nuevo idioma**.
