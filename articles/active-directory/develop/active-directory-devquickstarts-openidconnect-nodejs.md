...
8. Para crear una clave secreta, siga el paso 4 de [Para agregar credenciales o permisos para tener acceso a las API web](https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-integrating-applications#to-add-application-credentials-or-permissions-to-access-web-apis).
