...
5.  En la hoja **Probar el inicio de sesión único**, use sus credenciales corporativas para iniciar sesión en la aplicación de destino. Puede iniciar sesión como el usuario actual o como otro usuario. Si inicia sesión como otro usuario, un mensaje le pedirá que se autentique.
    ...
    ![Prueba de página SAML](media/active-directory-saml-debugging/testing.png)
...
![Error de inicio de sesión](media/active-directory-saml-debugging/error.png)
...
3. Observe estos elementos en el token de la respuesta SAML:
    ...
    - Certificado usado en el token de inicio de sesión. Para obtener información sobre cómo revisar la respuesta SAML, vea [Protocolo SAML de inicio de sesión único](active-directory-single-sign-on-protocol-reference.md).
4. Para más información sobre la respuesta SAML, vea [Protocolo SAML de inicio de sesión único](active-directory-single-sign-on-protocol-reference.md).
...
Ahora que el inicio de sesión único funciona para la aplicación, puede ir a la [Automatización del aprovisionamiento y desaprovisionamiento de usuarios para aplicaciones SaaS con Azure Active Directory](../active-directory-saas-app-provisioning.md) o a la [Introducción al acceso condicional en Azure Active Directory](../active-directory-conditional-access-azure-portal-get-started.md).
