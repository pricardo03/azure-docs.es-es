...
Vea los ejemplos de código para escenarios de explorador web a aplicación web. Agregamos nuevos ejemplos continuamente, así que no olvide consultarlos con frecuencia. [Aplicación web](sample-v1-code.md#web-applications).
...
![Diagrama de aplicación de una sola página](./media/authentication-scenarios/single_page_app.png)
...
Consulte los ejemplos de código para escenarios de aplicación de una sola página (SPA). Agregamos nuevos ejemplos continuamente, así que no olvide consultarlos con frecuencia. [Aplicación de una sola página (SPA)](sample-v1-code.md#single-page-applications).
