...
| `homepage` | String | La dirección URL a la página principal de la aplicación. <br><br> _Nota: Esto solo está disponible en experiencia de registros (heredado) de la aplicación. Reemplazado por `signInUrl` en el [registros de aplicaciones](https://go.microsoft.com/fwlink/?linkid=2083908) experimentar._ | `"https://MyRegisteredApp"` |
