...
Un manifiesto de aplicación tiene varios atributos que se conocen como colecciones, por ejemplo approles, keycredentials, knownClientApplications, identifierUris, rediretUris, requiredResourceAccess, oauth2Permissions etcetera. Dentro del manifiesto de aplicación completa para cualquier aplicación, el número total de entradas de todas las colecciones que se combinan se ha limitado a 1200. Si ya tiene 100 URI de redireccionamiento especificado en el manifiesto de aplicación es el único que queda con 1100 restantes entradas que se use en todas las demás colecciones combinarán que componen el manifiesto.

> [!NOTE]
> En caso de que intente agregar más de 1.200 entradas en el manifiesto de aplicación. Puede recibir un error **"no se pudo actualizar la aplicación xxxxxx. Detalles del error: El tamaño del manifiesto superó su límite. Reduzca el número de valores y vuelva a intentar la solicitud.** "
