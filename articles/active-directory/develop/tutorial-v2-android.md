---
title: Introducción a Android para Azure Active Directory v2.0 | Microsoft Docs
description: Cómo puede una aplicación de Android obtener un token de acceso y llamar a Microsoft Graph API o a API que requieran tokens de acceso desde el punto de conexión de Azure Active Directory v2.0.
