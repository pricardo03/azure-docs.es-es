...
> 1. Encuentre el valor del **identificador de aplicación (cliente)** de la aplicación. Copie este valor, ya que lo necesitará más adelante.
> 1. Busque el valor de **Id. de directorio (inquilino)** de la aplicación. Copie este valor, ya que lo necesitará más adelante.
...
>    - Copie el valor de la clave, ya que lo necesitará más adelante.
>
