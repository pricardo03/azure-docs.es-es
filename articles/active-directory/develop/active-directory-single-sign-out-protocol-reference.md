...
![Flujo de trabajo de cierre de sesión único de Azure AD](media/active-directory-single-sign-out-protocol-reference/active-directory-saml-single-sign-out-workflow.png)
