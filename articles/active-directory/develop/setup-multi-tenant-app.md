...
- Descripción general de [cómo se configura una aplicación para que sea multiinquilino](https://docs.microsoft.com/en-us/azure/active-directory/develop/howto-convert-app-to-be-multi-tenant)
