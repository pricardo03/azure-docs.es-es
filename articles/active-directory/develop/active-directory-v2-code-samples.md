...
> [!NOTE]
> Si está interesado en los ejemplos de V1, consulte [Azure AD code samples (V1 endpoint)](active-directory-code-samples.md) Ejemplos de código de Azure AD (punto de conexión V1).
