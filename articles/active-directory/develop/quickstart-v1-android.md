...
En el caso de las nuevas aplicaciones de Android, se recomienda usar la Plataforma de identidad de Microsoft (v 2.0) y MSAL para adquirir tokens y acceder a API web protegidas. Consulte [Quickstart: inicio de sesión por los usuarios y llamada a Microsoft Graph API desde una aplicación de Android](quickstart-v2-android.md) para comenzar.
