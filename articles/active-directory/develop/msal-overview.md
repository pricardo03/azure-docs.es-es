...
| ![MSAL.js](media/sample-v2-code/logo_js.png) <br/>[MSAL.js (versión preliminar)](https://github.com/AzureAD/microsoft-authentication-library-for-js)| Marcos de JavaScript/TypeScript como AngularJS, Ember.js o Durandal.js|
