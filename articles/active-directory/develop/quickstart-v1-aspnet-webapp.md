...
Para más información sobre esta configuración y el concepto de las aplicaciones multiinquilino, consulte [este artículo](howto-convert-app-to-be-multi-tenant.md "Introducción a multiinquilino").
