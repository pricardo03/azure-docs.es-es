...
Durante la adquisición silenciosa o interactiva de tokens, las aplicaciones pueden sufrir errores durante la experiencia de inicio de sesión, como errores de consentimiento, de acceso condicional (MFA, administración de dispositivos, restricciones basadas en la ubicación), de emisión y canje de tokens y de las propiedades del usuario.

## <a name="msal-for-ios-and-macos-errors"></a>Errores en MSAL en iOS y macOS

La lista completa de errores se muestra en la [lista MSALError](https://github.com/AzureAD/microsoft-authentication-library-for-objc/blob/master/MSAL/src/public/MSALError.h#L128).
...
### <a name="interaction-required-errors"></a>Errores con interacción necesaria
