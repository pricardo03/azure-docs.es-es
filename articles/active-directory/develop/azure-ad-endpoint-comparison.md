...
ms.locfileid: "39581020"
---
# <a name="whats-different-about-the-v20-endpoint"></a>¿Qué hay diferente en el punto de conexión v2.0?

Si está familiarizado con Azure Active Directory (Azure AD) o ha integrado aplicaciones con Azure AD en el pasado, hay algunas diferencias en el punto de conexión v2.0 que no se esperan. En este artículo se describen esas diferencias para su comprensión.
...
El punto de conexión v2.0 permite a los desarrolladores crear aplicaciones que aceptan el inicio de sesión tanto desde cuentas de Microsoft como desde cuentas de Azure AD mediante un punto de conexión de autenticación único. Esto le ofrece la posibilidad de crear su aplicación completamente independiente de la cuenta; lo que significa que la aplicación puede no conocer el tipo de cuenta con el que el usuario inicia sesión. Puede hacer que la aplicación reconozca el tipo de cuenta que se usa en una sesión determinada, aunque no es necesario.
...
* Cada componente aparecía como una aplicación distinta en el inquilino de Azure AD de cada cliente.
...
El ámbito `email` permite que la aplicación acceda a la dirección de correo electrónico principal del usuario a través de la notificación `email` en id_token. 
