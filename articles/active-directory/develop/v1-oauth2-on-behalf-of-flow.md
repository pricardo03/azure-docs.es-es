...
> [!IMPORTANT]
> Los clientes públicos que utilizan la [Concesión implícita de OAuth 2.0](v1-oauth2-implicit-grant-flow.md) no pueden usar el flujo OBO. Estos clientes han de pasar su token de acceso a un cliente confidencial de nivel intermedio para ejecutar flujos OBO. Para más información sobre los clientes que pueden realizar llamadas OBO, vea [Limitaciones de cliente](#client-limitations).
