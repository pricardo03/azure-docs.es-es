...
Si quiere leer y escribir con MSAL.NET Azure Active Directory mediante API Graph de Azure AD (https:\//graph.windows.net/), debe crear una lista de ámbitos, como se indica a continuación:
