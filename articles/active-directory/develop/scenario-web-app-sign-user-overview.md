...
ms.locfileid: "65075106"
---
# <a name="scenario-web-app-that-signs-in-users"></a>Escenario: Aplicación Web que los usuarios inicia sesión
...
> [!div class="nextstepaction"]
> [Inicio rápido: Aplicación web ASP.NET Core que los usuarios inicia sesión](quickstart-v2-aspnet-webapp.md)
