...
| ------------------------------------ | ---------- | ---------- |
| Logotipo de Microsoft  | ![Logotipo de Microsoft en formato PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.png) | ![Logotipo de Microsoft en formato SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.svg) |
...
![Inicio de sesión con líneas rojas de Microsoft](./media/active-directory-branding-guidelines/Sign-in-with-Microsoft-redlines.png)
...
| Recurso                                | Formato PNG | Formato SVG |
| ------------------------------------ | ---------- | ---------- |
| Inicio de sesión en Microsoft (tema oscuro)  | ![PNG del tema oscuro del botón de inicio de sesión](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.png) | ![SVG del tema oscuro del botón de inicio de sesión en Microsoft](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.svg) |
| Inicio de sesión en Microsoft (tema claro) | ![PNG del tema claro del botón de inicio de sesión](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.png) | ![SVG del tema claro del botón de inicio de sesión en Microsoft](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.svg) |
| Inicio de sesión (tema oscuro)                 | ![PNG del tema oscuro del botón corto de inicio de sesión](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.png) | ![SVG del tema oscuro del botón corto de inicio de sesión](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.svg) |
| Inicio de sesión (tema claro)                | ![PNG del tema claro del botón corto de inicio de sesión](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.png) | ![SVG del tema claro del botón corto de inicio de sesión](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.svg) |
