...
* RealtimeBoard admite SSO iniciado por **SP** e **IDP**

* RealtimeBoard admite el aprovisionamiento de usuarios **Just-In-Time**
...
4. En el cuadro de búsqueda, escriba **RealtimeBoard**, seleccione **RealtimeBoard** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![RealtimeBoard en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de RealtimeBoard.
...
2. **[Configuración del inicio de sesión único de RealtimeBoard](#configure-realtimeboard-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)**, para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de RealtimeBoard](#create-realtimeboard-test-user)**: para tener un homólogo de Britta Simon en RealtimeBoard que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **RealtimeBoard**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, si desea configurar la aplicación en modo iniciado por **IDP**, realice el siguiente paso:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de RealtimeBoard](common/idp-identifier.png)

    En el cuadro de texto **Identificador**, escriba una dirección URL: `https://realtimeboard.com`

5. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:

    ![imagen](common/both-preintegrated-signon.png)

    En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL: `https://realtimeboard.com/sso/saml`

6. En la página **Configurar el inicio de sesión único con SAML**, en la sección **Certificado de firma de SAML**, haga clic en **Descargar** para descargar el **XML de metadatos de federación** de las opciones proporcionadas según sus requisitos y guárdelo en el equipo.

    ![Vínculo de descarga del certificado](common/metadataxml.png)

7. En la sección **Set up RealtimeBoard** (Configurar RealtimeBoard), copie las direcciones URL adecuadas según sus necesidades.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **RealtimeBoard**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **RealtimeBoard**.

    ![Vínculo a RealtimeBoard en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-realtimeboard-test-user"></a>Creación de un usuario de prueba de RealtimeBoard

En esta sección, se crea un usuario llamado Britta Simon en RealtimeBoard. RealtimeBoard admite el aprovisionamiento de usuarios Just-In-Time, que está habilitado de forma predeterminada. No hay ningún elemento de acción para usted en esta sección. Si un usuario deja de existir en RealtimeBoard, se crea uno nuevo después de la autenticación.

### <a name="test-single-sign-on"></a>Prueba de inicio de sesión único 

En esta sección, probará la configuración de inicio de sesión único de Azure AD mediante el Panel de acceso.

Al hacer clic en el icono de RealtimeBoard en el panel de acceso y debería iniciar sesión automáticamente en la versión de RealtimeBoard para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
