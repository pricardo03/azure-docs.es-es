...
1. En el cuadro de búsqueda, escriba **Tableau Online**.

    ![Creación de un usuario de prueba de Azure AD](./media/tableauonline-tutorial/tutorial_tableauonline_search.png)

1. En el panel de resultados, seleccione **Tableau Online** y haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/tableauonline-tutorial/tutorial_tableauonline_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Tableau Online](#creating-a-tableau-online-test-user)** : para tener un homólogo de Britta Simon en Tableau Online vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/tableauonline-tutorial/tutorial_tableauonline_samlbase.png)

1. En la sección **Tableau Online Domain and URLs** (Dominio y direcciones URL de Tableau Online), lleve a cabo los pasos siguientes:
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/tableauonline-tutorial/tutorial_tableauonline_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/tableauonline-tutorial/tutorial_general_400.png)
...
1. Para habilitar SAML, en la sección **Tipos de autenticación**, marque la casilla **Inicio de sesión único con SAML**.
   
    ![Configurar inicio de sesión único](./media/tableauonline-tutorial/tutorial_tableauonline_12.png)

1. Desplácese hacia abajo hasta la sección **Importar archivo de metadatos en Tableau Online** .  Haga clic en Examinar e importe el archivo de metadatos que ha descargado desde Azure AD. A continuación, haga clic en **Aplicar**.
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/tableauonline-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/tableauonline-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/tableauonline-tutorial/create_aaduser_03.png) 
...
1. Seleccione **Add users for single sign-on (SSO) authentication**[Agregar usuarios para la autenticación mediante inicio de sesión único (SSO)]. En el cuadro de texto **Especificar direcciones de correo electrónico** agregue britta.simon@contoso.com
...
1. En la lista de aplicaciones, seleccione **Tableau Online**.
    ...
    ![Configurar inicio de sesión único](./media/tableauonline-tutorial/tutorial_tableauonline_app.png) 
