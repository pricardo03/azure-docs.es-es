...
1. En el cuadro de búsqueda, escriba **DATABASICS**, seleccione **DATABASICS** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![DATABASICS en la lista de resultados](./media/databasics-tutorial/tutorial_databasics_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de DATABASICS](#create-a-databasics-test-user)**: para tener un homólogo de Britta Simon en DATABASICS que esté vinculado a su representación en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/databasics-tutorial/tutorial_databasics_samlbase.png)

1. En la sección de **dominio y direcciones URL de DATABASICS**, lleve a cabo los pasos siguientes:
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/databasics-tutorial/tutorial_databasics_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/databasics-tutorial/tutorial_general_400.png)

1. Para configurar el inicio de sesión único en DATABASICS, complete el formulario en la dirección URL que se indica a continuación. Una vez enviado el formulario, el [equipo de soporte técnico de DATABASICS](https://www.data-basics.com/support/) se pondrá en contacto con usted.
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/databasics-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/databasics-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/databasics-tutorial/create_aaduser_03.png)
...
1. En la lista de aplicaciones, seleccione **DATABASICS**.
    ...
    ![Vínculo a DATABASICS en la lista de aplicaciones](./media/databasics-tutorial/tutorial_databasics_app.png)  
