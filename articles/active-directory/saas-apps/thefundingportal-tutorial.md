...
**Para agregar The Funding Portal desde la galería, siga estos pasos:**
...
4. En el cuadro de búsqueda, escriba **The Funding Portal**, seleccione **The Funding Portal** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

     ![The Funding Portal en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de The Funding Portal.
...
2. **[Configuración del inicio de sesión único en The Funding Portal](#configure-the-funding-portal-single-sign-on)**: para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)**, para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de The Funding Portal](#create-the-funding-portal-test-user)**: para tener un homólogo de Britta Simon en The Funding Portal que esté vinculado a la representación de ella en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **The Funding Portal**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información acerca del inicio de sesión único de dominio y direcciones URL de The Funding Portal](common/sp-identifier.png)
...
8. En la sección **Set up The Funding Portal** (Configurar The Funding Portal), copie las direcciones URL que necesite.
...
### <a name="configure-the-funding-portal-single-sign-on"></a>Configuración del inicio de sesión único en The Funding Portal
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **The Funding Portal**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **The Funding Portal**.

    ![Vínculo a The Funding Portal en la lista de aplicaciones](common/all-applications.png)
