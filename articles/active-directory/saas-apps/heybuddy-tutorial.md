...
* Puede habilitar a los usuarios para que inicien sesión automáticamente en HeyBuddy (inicio de sesión único) con sus cuentas de Azure AD.
...
* Suscripción habilitada para el inicio de sesión único de HeyBuddy
...
4. En el cuadro de búsqueda, escriba **HeyBuddy**, seleccione **HeyBuddy** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![HeyBuddy en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de HeyBuddy.
...
2. **[Configuración del inicio de sesión único de HeyBuddy](#configure-heybuddy-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de HeyBuddy](#create-heybuddy-test-user)** : para tener un homólogo de Britta Simon en HeyBuddy que esté vinculado a la representación de Azure AD de usuario.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **HeyBuddy**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de HeyBuddy](common/sp-identifier.png)
...
6. Además de lo anterior, la aplicación HeyBuddy espera que se usen algunos atributos más en la respuesta de SAML. En la sección **Notificaciones del usuario** del cuadro de diálogo **Atributos de usuario**, realice los siguientes pasos para agregar el atributo Token SAML como se muestra en la tabla siguientes:
...
### <a name="configure-heybuddy-single-sign-on"></a>Configuración del inicio de sesión único de HeyBuddy
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **HeyBuddy**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **HeyBuddy**.

    ![Vínculo a HeyBuddy en la lista de aplicaciones](common/all-applications.png)
