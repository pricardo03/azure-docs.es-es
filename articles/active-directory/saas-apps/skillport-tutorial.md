...
1. Haga clic en el botón **Nueva aplicación** en la parte superior del cuadro de diálogo.

    ![APLICACIONES][3]

1. En el cuadro de búsqueda, escriba **Skillport**.

    ![Creación de un usuario de prueba de Azure AD](./media/skillport-tutorial/tutorial_skillport_search.png)

1. En el panel de resultados, seleccione **Skillport** y luego haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/skillport-tutorial/tutorial_skillport_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Skillport](#creating-a-skillport-test-user)**: el objetivo es tener un homólogo de Britta Simon en Skillport que esté vinculado a la representación del usuario en Azure AD.
...
**Para configurar el inicio de sesión único en Azure AD con Skillport, realice los pasos siguientes:**
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/skillport-tutorial/tutorial_skillport_samlbase.png)

1. En la sección **Dominio y direcciones URL de Skillport**, lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/skillport-tutorial/tutorial_skillport_url.png)

     a. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL:
      
      Centro de datos de la UE: `https://adfs.skillport.eu`
   
      Centro de datos de EE. UU.: `https://sso.skillport.com`

    b. En el cuadro de texto **Identificador**, escriba la dirección URL:
      
      Centro de datos de la UE: `http://adfs.skillport.eu/adfs/services/trust`
   
      Centro de datos de EE. UU.: `https://sso.skillport.com`
   
    c. En el cuadro de texto **URL de respuesta**, escriba la siguiente dirección URL:
    
      Centro de datos de la UE: `https://adfs.skillport.eu/adfs/ls/`
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo XML en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/skillport-tutorial/tutorial_skillport_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/skillport-tutorial/tutorial_general_400.png)

1. Para configurar el inicio de sesión único en **Skillport**, debe enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de Skillport](https://www.skillsoft.com/contact.asp). Ellos se encargarán de configurarlo para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/skillport-tutorial/create_aaduser_01.png) 

1. Vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios** para mostrar la lista de usuarios.
    
    ![Creación de un usuario de prueba de Azure AD](./media/skillport-tutorial/create_aaduser_02.png) 

1. En la parte superior del diálogo, haga clic en **Agregar** para abrir el diálogo **Usuario**.
 
    ![Creación de un usuario de prueba de Azure AD](./media/skillport-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/skillport-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **Skillport**.
    ...
    ![Configurar inicio de sesión único](./media/skillport-tutorial/tutorial_skillport_app.png) 
