...
* Puede permitir que los usuarios inicien sesión automáticamente en Arc Publishing (inicio de sesión único) con sus cuentas de Azure AD.
...
4. En el cuadro de búsqueda, escriba **Arc Publishing - SSO**, seleccione **Arc Publishing - SSO** en el panel de resultados y, después, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![Arc Publishing - SSO en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Arc Publishing - SSO.
...
2. **[Configuración del inicio de sesión único en Arc Publishing - SSO](#configure-arc-publishing---sso-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Arc Publishing - SSO](#create-arc-publishing---sso-test-user)** : para tener un homólogo de Britta Simon en Arc Publishing - SSO que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Arc Publishing - SSO**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, si desea configurar la aplicación en el modo iniciado por **IDP** siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Arc Publishing - SSO](common/idp-intiated.png)
...
5. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Arc Publishing - SSO](common/metadata-upload-additional-signon.png)
...
### <a name="configure-arc-publishing---sso-single-sign-on"></a>Configuración del inicio de sesión único en Arc Publishing - SSO
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Arc Publishing - SSO**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Arc Publishing - SSO**.

    ![Vínculo a Arc Publishing - SSO en la lista de aplicaciones](common/all-applications.png)
