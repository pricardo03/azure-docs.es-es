...
1. En el cuadro de búsqueda, escriba **Tidemark**.

    ![Creación de un usuario de prueba de Azure AD](./media/tidemark-tutorial/tutorial_tidemark_search.png)

1. En el panel de resultados, seleccione **Tidemark** y luego haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/tidemark-tutorial/tutorial_tidemark_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Tidemark](#creating-a-tidemark-test-user)**: para tener un homólogo de Britta Simon en Tidemark vinculado a su representación en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/tidemark-tutorial/tutorial_tidemark_samlbase.png)

1. En la sección **Dominio y direcciones URL de Tidemark**, lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/tidemark-tutorial/tutorial_tidemark_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/tidemark-tutorial/tutorial_tidemark_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/tidemark-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Tidemark**, haga clic en **Configurar Tidemark** para abrir la ventana **Configurar inicio de sesión**. Copie la **URL del servicio de inicio de sesión único de SAML, el identificador de entidad de SAML y la dirección URL de cierre de sesión** de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/tidemark-tutorial/tutorial_tidemark_configure.png) 
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/tidemark-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/tidemark-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/tidemark-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/tidemark-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **Tidemark**.

    ![Configurar inicio de sesión único](./media/tidemark-tutorial/tutorial_tidemark_app.png) 
