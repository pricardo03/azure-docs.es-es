...
3. Para agregar Zscaler, haga clic en el **nueva aplicación** botón en la parte superior del cuadro de diálogo.

    ![Botón Nueva aplicación][3]

4. En el cuadro de búsqueda, escriba **Zscaler**.

    ![Aprovisionamiento de Zscaler](./media/zscaler-provisioning-tutorial/app-search.png)

5. En el panel de resultados, seleccione **Zscaler**y, a continuación, haga clic en el **agregar** para agregar Zscaler a la lista de aplicaciones SaaS.

    ![Aprovisionamiento de Zscaler](./media/zscaler-provisioning-tutorial/app-search-results.png)

    ![Aprovisionamiento de Zscaler](./media/zscaler-provisioning-tutorial/app-creation.png)
...
2. Seleccione Zscaler desde la lista de aplicaciones de SaaS.

    ![Aprovisionamiento de Zscaler](./media/zscaler-provisioning-tutorial/app-instance-search.png)
