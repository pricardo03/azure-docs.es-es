...
1. En el cuadro de búsqueda, escriba **Work.com**, seleccione **Work.com** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Incorporación desde la galería](./media/work-com-tutorial/tutorial_work-com_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Work.com](#create-a-workcom-test-user)**: para tener un homólogo de Britta Simon en Work.com que esté vinculado a su representación en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Inicio de sesión basado en SAML](./media/work-com-tutorial/tutorial_work-com_samlbase.png)

1. En la sección **Dominio y direcciones URL de Work.com**, lleve a cabo los pasos siguientes:

    ![Sección Dominio y direcciones URL de Work.com](./media/work-com-tutorial/tutorial_work-com_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Sección Certificado de firma SAML](./media/work-com-tutorial/tutorial_work-com_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Guardar](./media/work-com-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Work.com**, haga clic en **Configurar Work.com** para abrir la ventana **Configurar inicio de sesión**. Copie la **URL del servicio de inicio de sesión único de SAML, el identificador de entidad de SAML y la dirección URL de cierre de sesión** de la sección **Referencia rápida**.

    ![Sección de configuración de Work.com](./media/work-com-tutorial/tutorial_work-com_configure.png) 
...
1. Inicie sesión en su inquilino de Work.com.

1. Acceda a **Setup**(Configuración).
    
    ![Instalación](./media/work-com-tutorial/ic794108.png "Instalación")

1. Expanda el menú **Security Controls** (Controles de seguridad) y luego haga clic en **Single Sign-On Settings** (Configuración de inicio de sesión único).
    
    ![Configuración de inicio de sesión único](./media/work-com-tutorial/ic794113.png "Configuración de inicio de sesión único")

1. En la página del cuadro de diálogo **Single Sign-On Settings** (Configuración de inicio de sesión único), siga estos pasos:
...
1. En la sección **SAML Single Sign-On Settings** (Configuración del inicio de sesión único de SAML), siga estos pasos:
...
1. En el portal de Work.com, en el panel de navegación izquierdo, haga clic en **Domain Management** (Administración de dominios) para expandir la sección relacionada y luego haga clic en la página **My Domain** (Mi dominio) para abrir la página **My Domain** (Mi dominio). 
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/work-com-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Usuarios y grupos -> Todos los usuarios](./media/work-com-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Sumar](./media/work-com-tutorial/create_aaduser_03.png) 
...
1. En la sección Edición de usuarios, realice los pasos siguientes, en los atributos de una cuenta de Azure AD válida que desee aprovisionar en los cuadros de texto relacionados:
...
1. En la lista de aplicaciones, seleccione **Work.com**.

    ![Work.com en la lista de la aplicación](./media/work-com-tutorial/tutorial_work-com_app.png) 
