...
4. En el cuadro de búsqueda, escriba **Learning at Work**, seleccione **Learning at Work** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

     ![Learning at Work en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Learning at Work.
...
2. **[Configuración del inicio de sesión único en Learning at Work](#configure-learning-at-work-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)**, para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba en Learning at Work](#create-learning-at-work-test-user)**: para tener un homólogo de Britta Simon en Learning at Work que esté vinculado a la representación de dicho usuario en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con Learning at Work, siga estos pasos:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Learning at Work**, haga clic en **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Learning at Work](common/sp-identifier.png)
...
### <a name="configure-learning-at-work-single-sign-on"></a>Configuración del inicio de aprendizaje en Learning at Work
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Learning at Work**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Learning at Work**.

    ![Vínculo de Learning at Work en la lista de aplicaciones](common/all-applications.png)
...
En esta sección, creará un usuario llamado Britta Simon en Learning at Work. Trabaje con el  [equipo de soporte técnico de Learning at Work](https://www.learninga-z.com/site/contact/support) para agregar los usuarios a la plataforma Learning at Work. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
