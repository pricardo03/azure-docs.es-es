...
3. **[Creación de un usuario de prueba de Flock](#create-a-flock-test-user)**: para tener un homólogo de Britta Simon en Flock que esté vinculado a la representación del usuario en Azure AD.
...
3. En la sección **Dominio y direcciones URL de Flock**, lleve a cabo los pasos siguientes:
...
6. En la sección **Configuración de Flock**, haga clic en **Configurar Flock** para abrir la ventana **Configurar inicio de sesión**. Copie **SAML Entity ID and SAML Single Sign-On Service URL** (URL del servicio de inicio de sesión único de SAML e Identificador de entidad de SAML) de la sección **Referencia rápida**.

    ![Configuración de Flock](./media/flock-tutorial/tutorial_flock_configure.png) 

7. En otra ventana del explorador web, inicie sesión en su sitio de la compañía de Flock como administrador.

8. Seleccione la pestaña **Autenticación** en el panel de navegación izquierdo y, después, seleccione **Autenticación SAML**.
