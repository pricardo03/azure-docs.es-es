...
1. **Creación de un usuario de prueba de Lessonly.com**: para tener un homólogo de Britta Simon en Lessonly.com que esté vinculado a la representación de Azure AD de usuario.
