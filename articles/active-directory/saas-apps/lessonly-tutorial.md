...
* Lessonly.com admite SSO iniciado por **SP**
* Lessonly.com admite el aprovisionamiento de usuarios **Just-In-Time**
...
4. En el cuadro de búsqueda, escriba **Lessonly.com**, seleccione **Lessonly.com** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

     ![Lessonly.com en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Lessonly.com.
...
2. **[Configuración del inicio de sesión único en Lessonly.com](#configure-lessonlycom-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)**, para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba en Lessonly.com](#create-lessonlycom-test-user)**: para tener un homólogo de Britta Simon en Lessonly.com que esté vinculado a la representación de Azure AD de usuario.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Lessonly.com**, haga clic en **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Lessonly.com](common/sp-identifier.png)

     a. En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL con el siguiente patrón: `https://<companyname>.lessonly.com/signin`

    > [!NOTE]
    > Cuando se hace referencia a un nombre genérico, debe reemplazar **nombreDeCompañía** por un nombre real.

    b. En el cuadro de texto **Identificador (id. de entidad)**, escriba una dirección URL con el siguiente patrón: `https://<companyname>.lessonly.com/auth/saml/metadata`
...
5. La aplicación Lessonly.com espera las aserciones de SAML en un formato específico, que requiere que se agreguen asignaciones de atributos personalizados a la configuración de los atributos del token de SAML. La siguiente captura de muestra la lista de atributos predeterminados. Haga clic en el icono  **Editar**  para abrir el cuadro de diálogo Atributos de usuario.
...
8. En la sección **Set up Lessonly.com** (Configurar Lessonly.com), copie las direcciones URL que necesite.
...
### <a name="configure-lessonlycom-single-sign-on"></a>Configuración del inicio de sesión único en Lessonly.com

Para configurar el inicio de sesión único en **Lessonly.com**, es preciso enviar el **certificado (Base64)** descargado y las direcciones URL correspondientes copiadas de Azure Portal al [equipo de soporte técnico de Lessonly.com](mailto:support@lessonly.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Lessonly.com**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Lessonly.com**.

    ![Vínculo a Lessonly.com en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-lessonlycom-test-user"></a>Creación de un usuario de prueba en Lessonly.com
...
Al hacer clic en el icono de Lessonly.com en el Panel de acceso y debería iniciar sesión automáticamente en la versión de Lessonly.com para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
