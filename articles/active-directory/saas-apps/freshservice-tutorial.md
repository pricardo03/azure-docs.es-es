...
4. En el cuadro de búsqueda, escriba **Freshservice**, seleccione **Freshservice** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

     ![Freshservice en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Freshservice.
...
2. **[Configuración del inicio de sesión único de Freshservice](#configure-freshservice-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
...
1. En [Azure portal](https://portal.azure.com/), en la página de integración aplicaciones de **Freshservice**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Freshservice](common/sp-identifier.png)
...
7. En la sección **Set up Freshservice** (Configurar Freshservice), copie las direcciones URL adecuada según sus necesidades.
...
### <a name="configure-freshservice-single-sign-on"></a>Configuración del inicio de sesión único de Freshservice
...
3. En el **Portal del cliente**, haga clic en **Seguridad**.

    ![Seguridad](./media/freshservice-tutorial/ic790815.png "Seguridad")

4. En la sección **Seguridad** , realice estos pasos:
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **Freshservice**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Freshservice**.

    ![Vínculo a Freshservice en la lista de aplicaciones](common/all-applications.png)
