...
1. En el cuadro de búsqueda, escriba **Evernote**, seleccione **Evernote** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Evernote en la lista de resultados](./media/evernote-tutorial/tutorial_evernote_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Evernote](#create-an-evernote-test-user)**: para tener un homólogo de Britta Simon en Evernote que esté vinculado a la representación de ella en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/evernote-tutorial/tutorial_evernote_samlbase.png)

1. En la sección **Dominio y direcciones URL de Evernote**, realice los siguientes pasos si quiere configurar la aplicación en el modo iniciado por IDP:

    ![Información de dominio y direcciones URL de inicio de sesión único de Evernote](./media/evernote-tutorial/tutorial_evernote_url.png)
...
1. Active **Mostrar configuración avanzada de URL** y siga estos pasos si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Evernote](./media/evernote-tutorial/tutorial_evernote_url1.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/evernote-tutorial/tutorial_evernote_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/evernote-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Evernote**, haga clic en **Configurar Evernote** para abrir la ventana **Configurar inicio de sesión**. Copie la **dirección URL de servicio de inicio de sesión único de SAML** de la sección **Referencia rápida**.

    ![Configuración de Evernote](./media/evernote-tutorial/tutorial_evernote_configure.png) 

1. En otra ventana del explorador web, inicie sesión en el sitio de la empresa de Evernote como administrador.

1. Vaya a **"Consola de administración"**

    ![Admin-Console](./media/evernote-tutorial/tutorial_evernote_adminconsole.png)

1. En la **"Consola de administración"**, vaya a **"Seguridad"** y seleccione **"Inicio de sesión único"**
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/evernote-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/evernote-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/evernote-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/evernote-tutorial/create_aaduser_04.png)
...
1. Haga clic en la **"Consola de administración"**.

    ![Admin-Console](./media/evernote-tutorial/tutorial_evernote_adminconsole.png)

1. En la **"Consola de administración"**, vaya a **"Agregar usuarios"**.

    ![Add-testUser](./media/evernote-tutorial/create_aaduser_0001.png)

1. **Agregue miembros del equipo** en el cuadro de texto **Correo electrónico**, escriba la dirección de correo electrónico de la cuenta de usuario y haga clic en **Invitar**.

    ![Add-testUser](./media/evernote-tutorial/create_aaduser_0002.png)
    
1. Una vez que se envía la invitación, el titular de la cuenta de Azure Active Directory recibirá un correo electrónico para aceptar la invitación.
...
1. En la lista de aplicaciones, seleccione **Evernote**.
    ...
    ![Vínculo de Evernote en la lista de aplicaciones](./media/evernote-tutorial/tutorial_evernote_app.png)  
