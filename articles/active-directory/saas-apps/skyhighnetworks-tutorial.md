...
1. En el cuadro de búsqueda, escriba **Skyhigh Networks**, seleccione **Skyhigh Networks** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
...
1. **[Creación de un usuario de prueba de Skyhigh Networks](#create-a-skyhigh-networks-test-user)**: para tener un homólogo de Britta Simon en Skyhigh Networks que esté vinculado a su representación en Azure AD.
...
1. En la sección **Skyhigh Networks Domain and URLs** (Dominio y direcciones URL de Skyhigh Networks), realice los siguientes pasos si quiere configurar la aplicación en el modo iniciado por **IDP**:
...
1. En la lista de aplicaciones, seleccione **Skyhigh Networks**.
