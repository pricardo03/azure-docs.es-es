...
1. En el cuadro de búsqueda, escriba **Synergi**, seleccione **Synergi** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Synergi en la lista de resultados](./media/synergi-tutorial/tutorial_synergi_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Synergi](#create-a-synergi-test-user)**: para tener un homólogo de Britta Simon en Synergi que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/synergi-tutorial/tutorial_synergi_samlbase.png)

1. En la sección **Dominio y direcciones URL de Synergi**, lleve a cabo los pasos siguientes:

    ![Información sobre dominio y direcciones URL de inicio de sesión único de Synergi](./media/synergi-tutorial/tutorial_synergi_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/synergi-tutorial/tutorial_synergi_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/synergi-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Synergi**, haga clic en **Configurar Synergi** para abrir la ventana **Configurar inicio de sesión**. Copie los valores de **Sign-Out URL and SAML Entity ID** (Dirección URL de cierre de sesión e identificador de entidad de SAML) de la **sección Referencia rápida**.

    ![Configuración de Synergi](./media/synergi-tutorial/tutorial_synergi_configure.png) 

1. Para configurar el inicio de sesión único en **Synergi**, debe enviar el **certificado (Base64) descargado y la dirección URL de cierre de sesión y el identificador de entidad de SAML** al [equipo de soporte técnico de Synergi](https://www.irmsecurity.com/contact/).
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/synergi-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/synergi-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/synergi-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/synergi-tutorial/create_aaduser_04.png)
...
1. En la lista de aplicaciones, seleccione **Synergi**.
    ...
    ![Vínculo de Synergi en la lista de aplicaciones](./media/synergi-tutorial/tutorial_synergi_app.png)  
