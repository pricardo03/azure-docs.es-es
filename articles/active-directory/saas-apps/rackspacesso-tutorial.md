...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Rackspace SSO.
...
5. **[Creación de un usuario de prueba de Rackspace SSO](#create-rackspace-sso-test-user)**: para tener un homólogo de Britta Simon en Rackspace SSO que esté vinculado a la representación del usuario en Azure AD.
...
6. En la sección **Configurar Rackspace SSO**, copie las direcciones URL adecuadas según sus necesidades.
...
Para configurar el inicio de sesión único en **Rackspace SSO**, es preciso enviar el **XML de metadatos de federación** descargado y las direcciones URL apropiadas copiadas de Azure Portal al [equipo de soporte técnico de Rackspace SSO](https://support.rackspace.com/). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
### <a name="create-rackspace-sso-test-user"></a>Creación de un usuario de prueba de Rackspace SSO

En esta sección, creará un usuario llamado Britta Simon en Rackspace SSO. Trabaje con el  [equipo de soporte técnico de Rackspace SSO](https://support.rackspace.com/) para agregar usuarios a la plataforma de Rackspace SSO. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
