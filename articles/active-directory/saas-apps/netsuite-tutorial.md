...
4. En el cuadro de búsqueda, escriba **NetSuite**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/netsuite-tutorial/tutorial_netsuite_search.png)

5. En el panel de resultados, seleccione **NetSuite** y luego haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/netsuite-tutorial/tutorial_netsuite_addfromgallery.png)
...
11. En la página **Configuración de SAML** , realice los pasos siguientes:
    ...
    ![Configurar inicio de sesión único](./media/netsuite-tutorial/ns-sso-setup.png)
