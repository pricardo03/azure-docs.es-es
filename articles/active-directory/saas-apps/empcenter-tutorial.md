...
1. En el cuadro de búsqueda, escriba **EmpCenter**.

    ![Creación de un usuario de prueba de Azure AD](./media/empcenter-tutorial/tutorial_EmpCenter_search.png)

1. En el panel de resultados, seleccione **EmpCenter** y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/empcenter-tutorial/tutorial_EmpCenter_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de EmpCenter](#creating-an-empcenter-test-user)**: para tener un homólogo de Britta Simon en EmpCenter que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/empcenter-tutorial/tutorial_EmpCenter_samlbase.png)

1. En la sección **Dominio y direcciones URL de EmpCenter**, lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/empcenter-tutorial/tutorial_EmpCenter_url.png)
    ...
    > [!NOTE] 
    > Este valor no es real. Actualícelo con la dirección URL de inicio de sesión real. Póngase en contacto con el [equipo de soporte técnico de EmpCenter](https://www.workforcesoftware.com/services/customer-support/) para obtener este valor. 
 
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.

    ![Configurar inicio de sesión único](./media/empcenter-tutorial/tutorial_EmpCenter_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/empcenter-tutorial/tutorial_general_400.png)

1. Para configurar el inicio de sesión único en **EmpCenter**, necesita enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de EmpCenter](https://www.workforcesoftware.com/services/customer-support/). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/empcenter-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/empcenter-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/empcenter-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/empcenter-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **EmpCenter**.

    ![Configurar inicio de sesión único](./media/empcenter-tutorial/tutorial_EmpCenter_app.png) 
