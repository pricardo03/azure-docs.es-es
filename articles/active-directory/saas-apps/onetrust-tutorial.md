...
1. En el cuadro de búsqueda, escriba **OneTrust Privacy Management Software**, seleccione **OneTrust Privacy Management Software** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![OneTrust Privacy Management Software en la lista de resultados](./media/onetrust-tutorial/tutorial_onetrust_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de OneTrust Privacy Management Software](#create-a-onetrust-privacy-management-software-test-user)**: para tener un homólogo de Britta Simon en OneTrust Privacy Management Software que esté vinculado a la representación de ella en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/onetrust-tutorial/tutorial_onetrust_samlbase.png)

1. En la sección **Dominio y direcciones URL de OneTrust Privacy Management Software**, si quiere configurar la aplicación en modo iniciado por **IDP**, realice los siguientes pasos:

    ![Información de inicio de sesión único de dominio y direcciones URL de OneTrust Privacy Management Software](./media/onetrust-tutorial/tutorial_onetrust_url.png)
...
1. Active **Mostrar configuración avanzada de URL** y siga estos pasos si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Información de inicio de sesión único de dominio y direcciones URL de OneTrust Privacy Management Software](./media/onetrust-tutorial/tutorial_onetrust_url1.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/onetrust-tutorial/tutorial_onetrust_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/onetrust-tutorial/tutorial_general_400.png)
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/onetrust-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/onetrust-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/onetrust-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/onetrust-tutorial/create_aaduser_04.png)
...
>[!Note]
>Si tiene que crear manualmente un usuario, póngase en contacto con el  [equipo de soporte técnico de OneTrust Privacy Management Software](mailto:support@onetrust.com).
...
1. En la lista de aplicaciones, seleccione **OneTrust Privacy Management Software**.
    ...
    ![El vínculo de OneTrust Privacy Management Software en la lista de aplicaciones](./media/onetrust-tutorial/tutorial_onetrust_app.png)  
