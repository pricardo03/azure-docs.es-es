...
1. Siga estos pasos en la sección de configuración de Single Sign-On (Inicio de sesión único):
    ...
    b. En el cuadro de texto  **Remote Log Out URL** (Dirección URL de cierre de sesión remoto), pegue el valor **Dirección URL de cierre de sesión** que copió de Azure Portal.
