...
1. En el cuadro de búsqueda, escriba **Zoho**, seleccione **Zoho** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Zoho en la lista de resultados](./media/zoho-mail-tutorial/tutorial_zoho_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Zoho](#create-a-zoho-test-user)** : para tener un homólogo de Britta Simon en Zoho que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/zoho-mail-tutorial/tutorial_zoho_samlbase.png)

1. En la sección **Dominio y direcciones URL de Zoho**, lleve a cabo los pasos siguientes:

    ![Información de dominio y direcciones URL de inicio de sesión único de Zoho](./media/zoho-mail-tutorial/tutorial_zoho_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/zoho-mail-tutorial/tutorial_zoho_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/zoho-mail-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Zoho**, haga clic en **Configurar Zoho** para abrir la ventana **Configurar inicio de sesión**. Copie las **direcciones URL del servicio de inicio de sesión único de SAML, de cambio de contraseña y de cierre de sesión** de la sección **Referencia rápida**.

    ![Configuración de Zoho](./media/zoho-mail-tutorial/tutorial_zoho_configure.png) 
...
1. Vaya al **Panel de control**.
    ...
    ![Panel de control](./media/zoho-mail-tutorial/ic789607.png "Panel de control")

1. Haga clic en la pestaña **Autenticación SAML** .
   
    ![Autenticación SAML](./media/zoho-mail-tutorial/ic789608.png "Autenticación SAML")

1. En la sección **Detalles de la autenticación SAML** , realice los pasos siguientes:
   
    ![Detalles de la autenticación SAML](./media/zoho-mail-tutorial/ic789609.png "Detalles de la autenticación SAML")
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/zoho-mail-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/zoho-mail-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/zoho-mail-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/zoho-mail-tutorial/create_aaduser_04.png)
...
1. En la lista de aplicaciones, seleccione **Zoho**.
    ...
    ![Vínculo a Zoho en la lista de aplicaciones](./media/zoho-mail-tutorial/tutorial_zoho_app.png)  
