...
* Una suscripción habilitada para el inicio de sesión único en Convene

## <a name="scenario-description"></a>Descripción del escenario

En este tutorial, puede configurar y probar el inicio de sesión único de Azure AD en un entorno de prueba.

* Convene admite el inicio de sesión único iniciado por **SP**.
...
4. En el cuadro de búsqueda, escriba **Convene**, seleccione **Convene** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![Convene en la lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configuración y prueba del inicio de sesión único en Azure AD

En esta sección, configurará y probará el inicio de sesión único en Azure AD con Convene con un usuario de prueba llamado **Britta Simon**.
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Convene.
...
2. **[Configuración del inicio de sesión único de Convene](#configure-convene-single-sign-on)** : para configurar el inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Convene](#create-convene-test-user)** : para tener un homólogo de Britta Simon en Convene que esté vinculado a la representación de ella en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con Convene, realice los pasos siguientes:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Convene**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, si quiere configurar la aplicación en modo iniciado por **IDP**, realice los siguientes pasos:
    ...
    ![Información sobre dominio y direcciones URL de inicio de sesión único de Convene](common/both-replyurl.png)
...
5. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Información sobre dominio y direcciones URL de inicio de sesión único de Convene](common/both-signonurl.png)
...
9. En la sección **Set up Convene** (Configurar Convene), copie las direcciones URL adecuadas según sus necesidades.
...
### <a name="configure-convene-single-sign-on"></a>Configuración del inicio de sesión único de Convene
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y, luego, **Convene**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Convene**.

    ![El vínculo a Convene en la lista de aplicaciones](common/all-applications.png)
