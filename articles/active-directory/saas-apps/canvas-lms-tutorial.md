...
1. En el cuadro de búsqueda, escriba **Canvas**.

    ![Creación de un usuario de prueba de Azure AD](./media/canvas-lms-tutorial/tutorial_canvaslms_search.png)

1. En el panel de resultados, seleccione **Canvas** y luego haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/canvas-lms-tutorial/tutorial_canvaslms_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Canvas](#creating-a-canvas-test-user)**: para tener un homólogo de Britta Simon en Canvas que esté vinculado a la representación de Azure AD de usuario.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/canvas-lms-tutorial/tutorial_canvaslms_samlbase.png)

1. En la sección **Dominio y direcciones URL de Canvas**, lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/canvas-lms-tutorial/tutorial_canvaslms_url.png)
...
1. En la sección **Certificado de firma de SAML**, copie el valor de **HUELLA DIGITAL** certificado.

    ![Configurar inicio de sesión único](./media/canvas-lms-tutorial/tutorial_canvaslms_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/canvas-lms-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Canvas**, haga clic en **Configurar Canvas** para abrir la ventana **Configurar inicio de sesión**. Copie la **dirección URL cambiada de la contraseña, la dirección URL de cierre de sesión, el identificador de entidad de SAML y la dirección URL del servicio de inicio de sesión único de SAML** de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/canvas-lms-tutorial/tutorial_canvaslms_configure.png) 
 
1. En otra ventana del explorador web, inicie sesión como administrador en el sitio de la compañía de Canvas.

1. Vaya a **Cursos \> Cuentas administradas \> Microsoft**.
   
    ![Canvas](./media/canvas-lms-tutorial/IC775990.png "Canvas")

1. En el panel de navegación izquierdo, seleccione **Authentication** (Autenticación) y, después, haga clic en **Add New SAML Config** (Agregar nueva configuración de SAML).
   
    ![Autenticación](./media/canvas-lms-tutorial/IC775991.png "Autenticación")

1. En la página Curent Integration (integración actual) realice los siguientes pasos:
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/canvas-lms-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/canvas-lms-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/canvas-lms-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/canvas-lms-tutorial/create_aaduser_04.png) 
...
1. En la página de diálogo Agregar nuevo usuario, realice los pasos siguientes:
...
1. En la lista de aplicaciones, seleccione **Canvas**.
    ...
    ![Configurar inicio de sesión único](./media/canvas-lms-tutorial/tutorial_canvaslms_app.png) 
