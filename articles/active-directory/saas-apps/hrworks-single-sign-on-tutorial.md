---
title: 'Tutorial: Integración de Azure Active Directory con HRworks Single Sign-On | Microsoft Docs'
...
En este tutorial, obtendrá información sobre cómo integrar HRworks Single Sign-On con Azure Active Directory (Azure AD).
La integración de HRworks Single Sign-On con Azure AD le proporciona las siguientes ventajas:

* Puede controlar en Azure AD quién tiene acceso a HRworks Single Sign-On.
* Puede permitir que los usuarios inicien sesión automáticamente en HRworks Single Sign-On (inicio de sesión único) con sus cuentas de Azure AD.
...
Para configurar la integración de Azure AD con HRworks Single Sign-On, necesita los siguientes elementos:

* Una suscripción de Azure AD. Si no dispone de un entorno de Azure AD, puede obtener una versión de prueba de un mes [aquí](https://azure.microsoft.com/pricing/free-trial/)
* Suscripción habilitada para el inicio de sesión único en HRworks Single Sign-On
...
4. En el cuadro de búsqueda, escriba **HRworks Single Sign-On**, seleccione **HRworks Single Sign-On** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

     ![HRworks Single Sign-On en la lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configuración y prueba del inicio de sesión único en Azure AD

En esta sección, configurará y probará el inicio de sesión único de Azure AD con HRworks Single Sign-On con un usuario de prueba llamado **Britta Simon**.
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de HRworks Single Sign-On.
...
Para configurar el inicio de sesión único de Azure AD con HRworks Single Sign-On, realice los pasos siguientes:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **HRworks Single Sign-On**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información sobre dominio y direcciones URL de inicio de sesión único de HRworks Single Sign-On](common/sp-signonurl.png)
    ...
    > [!NOTE]
    > Este valor no es real. Actualícelo con la dirección URL de inicio de sesión real. Póngase en contacto con el [equipo de soporte técnico de HRworks Single Sign-On](mailto:support@hrworks.de) para obtener este valor. También puede hacer referencia a los patrones que se muestran en la sección **Configuración básica de SAML** de Azure Portal.

5. En la página **Configurar el inicio de sesión único con SAML**, en la sección **Certificado de firma de SAML**, haga clic en **Descargar** para descargar el **XML de metadatos de federación** de las opciones proporcionadas según sus requisitos y guárdelo en el equipo.

    ![Vínculo de descarga del certificado](common/metadataxml.png)

6. En la sección **Set up HRworks Single Sign-On** (Configurar HRworks Single Sign-On), copie las direcciones URL adecuadas según sus necesidades.
...
### <a name="configure-hrworks-single-sign-on-single-sign-on"></a>Configuración del inicio de sesión único de HRworks Single Sign-On

1. En otra ventana del explorador web, inicie sesión en HRworks Single Sign-On como administrador.
...
En esta sección, concederá acceso a Britta Simon a HRworks Single Sign-On para que use el inicio de sesión único de Azure.

1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y, a continuación, seleccione **HRworks Single Sign-On**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **HRworks Single Sign-On**.

    ![Vínculo de HRworks Single Sign-On en la lista de aplicaciones](common/all-applications.png)
...
4. En el elemento emergente **Create new person with country for legal terms** (Crear nueva persona con un país para condiciones legales), rellene los detalles correspondientes **First name** (Nombre), **Last name** (Apellidos) y haga clic en **Create** (Crear).
