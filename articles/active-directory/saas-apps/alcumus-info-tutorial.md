...
4. En el cuadro de búsqueda, escriba **Alcumus Info Exchange**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_search.png)
...
5. En el panel de resultados, seleccione **Alcumus Info Exchange** y, después, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_addfromgallery.png)
...
2. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_samlbase.png)

3. En la sección **Dominio y direcciones URL de Alcumus Info Exchange**, lleve a cabo los siguientes pasos:

    ![Configurar inicio de sesión único](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_url.png)
...
4. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_certificate.png) 

5. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/alcumus-info-tutorial/tutorial_general_400.png)
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/alcumus-info-tutorial/create_aaduser_01.png) 

2. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/alcumus-info-tutorial/create_aaduser_02.png) 

3. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/alcumus-info-tutorial/create_aaduser_03.png) 

4. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/alcumus-info-tutorial/create_aaduser_04.png) 
...
2. En la lista de aplicaciones, seleccione **Alcumus Info Exchange**.
    ...
    ![Configurar inicio de sesión único](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_app.png) 
