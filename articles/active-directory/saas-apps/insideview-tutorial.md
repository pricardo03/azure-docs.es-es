...
1. **[Creación de un usuario de prueba de InsideView](#creating-an-insideview-test-user)**  : para tener un homólogo de Britta Simon en InsideView que esté vinculado a la representación del usuario en Azure AD.
