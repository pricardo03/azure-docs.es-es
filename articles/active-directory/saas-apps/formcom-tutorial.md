...
1. En el cuadro de búsqueda, escriba **Form.com**, seleccione **Form.com** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Form.com en la lista de resultados](./media/formcom-tutorial/tutorial_form.com_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Form.com](#create-a-formcom-test-user)**: para tener un homólogo de Britta Simon en Form.com que esté vinculado a su representación en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/formcom-tutorial/tutorial_form.com_samlbase.png)

1. En la sección **Dominio y direcciones URL de Form.com**, lleve a cabo los pasos siguientes:

    ![Información de dominio y direcciones URL de inicio de sesión único de Form.com](./media/formcom-tutorial/tutorial_form.com_url.png)
...
1. En la sección  **Certificado de firma de SAML** , realice los pasos siguientes:
    ...
    ![Configurar inicio de sesión único](./media/formcom-tutorial/tutorial_metadataurl.png)

     a. Haga clic en el botón Copiar para copiar el valor de  **Dirección URL de metadatos de federación de aplicación **  y péguelo en el Bloc de notas.

    b. Haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
     
1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/formcom-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Form.com**, haga clic en **Configurar Form.com** para abrir la ventana **Configurar inicio de sesión**. Copie la **dirección URL de servicio de inicio de sesión único de SAML** de la sección **Referencia rápida**.

    ![Configuración de Form.com](./media/formcom-tutorial/tutorial_form.com_configure.png) 
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/formcom-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/formcom-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/formcom-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/formcom-tutorial/create_aaduser_04.png)
...
1. En la lista de aplicaciones, seleccione **Form.com**.
    ...
    ![Vínculo a Form.com en la lista de aplicaciones](./media/formcom-tutorial/tutorial_form.com_app.png)  
