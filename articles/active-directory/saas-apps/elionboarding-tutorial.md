...
1. En el cuadro de búsqueda, escriba **Eli Onboarding**, seleccione **Eli Onboarding** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
...
1. **[Creación de un usuario de prueba de Eli Onboarding](#create-an-eli-onboarding-test-user)**: para tener un homólogo de Britta Simon en Eli Onboarding que esté vinculado a la representación del usuario en Azure AD.
...
1. En la sección **Dominio y direcciones URL de Eli Onboarding**, lleve a cabo los pasos siguientes:
...
1. Para configurar el inicio de sesión único en el lado de **Eli Onboarding**, necesita enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de Eli Onboarding](mailto:support@geteli.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
