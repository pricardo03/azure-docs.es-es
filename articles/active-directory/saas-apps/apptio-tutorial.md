...
2. **[Configuración del inicio de sesión único en Apptio](#configure-apptio-sso)** : para configurar los valores de Inicio de sesión único en la aplicación.
...
6. En la sección **Configurar Apptio**, copie las direcciones URL adecuadas según sus necesidades.
