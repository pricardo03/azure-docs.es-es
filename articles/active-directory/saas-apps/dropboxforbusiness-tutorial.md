...
2. **[Configuración del inicio de sesión único de Dropbox for Business](#configure-dropbox-for-business-sso)** : para configurar los valores de Inicio de sesión único en la aplicación.
