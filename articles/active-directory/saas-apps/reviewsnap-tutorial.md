...
1. En el cuadro de búsqueda, escriba **Reviewsnap**, seleccione **Reviewsnap** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
...
1. **[Creación de un usuario de prueba de Reviewsnap](#create-a-reviewsnap-test-user)**: para tener un homólogo de Britta Simon en Reviewsnap que esté vinculado a la representación del usuario en Azure AD.
...
1. En la sección **Dominio y direcciones URL de Reviewsnap**, realice los siguientes pasos si quiere configurar la aplicación en el modo iniciado por **IDP**:
...
1. En la sección **Configuración de Reviewsnap**, haga clic en **Configurar Reviewsnap** para abrir la ventana **Configurar inicio de sesión**. Copie la **URL del servicio de inicio de sesión único de SAML, el identificador de entidad de SAML y la dirección URL de cierre de sesión** de la sección **Referencia rápida**.
...
1. En la lista de aplicaciones, seleccione **Reviewsnap**.
