...
1. **[Creación de un usuario de prueba de IriusRisk](#create-an-iriusrisk-test-user)**  : para tener un homólogo de Britta Simon en IriusRisk que esté vinculado a la representación del usuario en Azure AD.
