---
title: 'Tutorial: Integración de Azure Active Directory con Templafy | Microsoft Docs'
...
ms.locfileid: "65441506"
---
# <a name="tutorial-azure-active-directory-integration-with-templafy"></a>Tutorial: Integración de Azure Active Directory con Templafy

En este tutorial, aprenderá a integrar Templafy con Azure Active Directory (Azure AD).
La integración de Templafy con Azure AD le proporciona las siguientes ventajas:

* Puede controlar en Azure AD quién tiene acceso a Templafy.
* Puede permitir que los usuarios inicien sesión automáticamente en Templafy (inicio de sesión único) con sus cuentas de Azure AD.
...
Para configurar la integración de Azure AD con Templafy, se necesitan los siguientes elementos:

* Una suscripción de Azure AD. Si no dispone de un entorno de Azure AD, puede obtener [una cuenta gratuita](https://azure.microsoft.com/free/)
* Suscripción habilitada para el inicio de sesión único en Templafy
...
**Para agregar Templafy desde la galería, realice los pasos siguientes:**
...
4. En el cuadro de búsqueda, escriba **Templafy**, seleccione **Templafy** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

    ![Templafy en la lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configuración y prueba del inicio de sesión único en Azure AD

En esta sección, podrá configurar y probar el inicio de sesión único de Azure AD con Templafy con un usuario de prueba llamado **Britta Simon**.
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Templafy.
...
2. **[Configuración del inicio de sesión único de Templafy](#configure-templafy-single-sign-on)**: para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)**, para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Templafy](#create-templafy-test-user)**: para tener un homólogo de Britta Simon en Templafy que esté vinculado a la representación del usuario en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con Templafy, siga estos pasos:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Templafy**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Templafy](common/sp-signonurl.png)
...
### <a name="configure-templafy-single-sign-on"></a>Configurar inicio de sesión único de Templafy
...
En esta sección, habilitará a Britta Simon para que use el inicio de sesión único de Azure concediéndole acceso a Templafy.

1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Templafy**.
