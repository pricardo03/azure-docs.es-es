...
1. Para configurar el inicio de sesión único en **ASC Contracts**, llame al soporte técnico de ASC Networks Inc. (ASC) en el **613-599-6178** y proporcióneles el **XML de metadatos** descargado. Ellos configuran esta aplicación para establecer la conexión de SSO de SAML correctamente en ambos lados.
