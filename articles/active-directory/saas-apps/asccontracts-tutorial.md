...
1. En el cuadro de búsqueda, escriba **ASC Contracts**.

    ![Creación de un usuario de prueba de Azure AD](./media/asccontracts-tutorial/tutorial_asccontracts_search.png)

1. En el panel de resultados, seleccione **ASC Contracts** y haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/asccontracts-tutorial/tutorial_asccontracts_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de ASC Contracts](#creating-an-asc-contracts-test-user)**: para tener un homólogo de Britta Simon en ASC Contracts que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/asccontracts-tutorial/tutorial_asccontracts_samlbase.png)

1. En la sección **Dominio y direcciones URL de ASC Contracts**, lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/asccontracts-tutorial/tutorial_asccontracts_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/asccontracts-tutorial/tutorial_asccontracts_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/asccontracts-tutorial/tutorial_general_400.png)

1. Para configurar el inicio de sesión único en **ASC Contracts**, póngase en contacto con el soporte técnico de ASC Networks Inc. (ASC) en el teléfono **613.599.6178** y proporcióneles el **XML de metadatos** descargado. Ellos configuran esta aplicación para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/asccontracts-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/asccontracts-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/asccontracts-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/asccontracts-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **ASC Contracts**.

    ![Configurar inicio de sesión único](./media/asccontracts-tutorial/tutorial_asccontracts_app.png) 
...
Al hacer clic en el icono de ASC Contracts en el panel de acceso, debería iniciar sesión automáticamente en su aplicación ASC Contracts. Para más información sobre el Panel de acceso, vea la [introducción al Panel de acceso](../user-help/active-directory-saas-access-panel-introduction.md).
