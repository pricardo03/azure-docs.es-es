...
1. En el cuadro de búsqueda, escriba **New Relic**, seleccione **New Relic** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

    ![New Relic en la lista de resultados](./media/new-relic-tutorial/tutorial_new-relic_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de New Relic](#create-a-new-relic-test-user)**: el objetivo es tener un homólogo de Britta Simon en New Relic que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/new-relic-tutorial/tutorial_new-relic_samlbase.png)

1. En la sección **Dominio y direcciones URL de New Relic**, lleve a cabo los pasos siguientes:

    ![Información acerca del inicio de sesión único de dominio y direcciones URL de New Relic](./media/new-relic-tutorial/tutorial_new-relic_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/new-relic-tutorial/tutorial_new-relic_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/new-relic-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de New Relic**, haga clic en **Configurar New Relic** para abrir la ventana **Configurar inicio de sesión**. Copie los valores **Sign-Out URL y SAML Single Sign-On Service URL** (Dirección URL de cierre de sesión y Dirección URL del servicio de inicio de sesión único de SAML) de la **sección de referencia rápida**.

    ![Configuración de New Relic](./media/new-relic-tutorial/tutorial_new-relic_configure.png) 
...
1. Haga clic en la pestaña **Seguridad y autenticación** y, luego, haga clic en la pestaña **Inicio de sesión único**.
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/new-relic-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/new-relic-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/new-relic-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/new-relic-tutorial/create_aaduser_04.png)
...
1. En el panel **Cuenta** que se encuentra en el lado izquierdo, haga clic en **Resumen** y, luego, haga clic en **Agregar usuario**.
   
    ![Configuración de la cuenta](./media/new-relic-tutorial/ic797041.png "configuración de la cuenta")

1. En el cuadro de diálogo **Usuarios activos** , realice los pasos siguientes:
...
1. En la lista de aplicaciones, seleccione **New Relic**.
    ...
    ![Vínculo a New Relic en la lista de aplicaciones](./media/new-relic-tutorial/tutorial_new-relic_app.png)  
