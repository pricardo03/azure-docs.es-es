...
1. Adición de Certain Admin SSO desde la galería
...
1. En el cuadro de búsqueda, escriba **Certain Admin SSO**, seleccione **Certain Admin SSO** en el panel de resultados y, a continuación, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Certain Admin SSO en la lista de resultados](./media/certainadminsso-tutorial/tutorial_certainadminsso_addfromgallery.png)
...
Para que el inicio de sesión único funcione, Azure AD debe saber cuál es el usuario homólogo de Certain Admin SSO para un usuario de Azure AD. Es decir, es necesario establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Certain Admin SSO.
...
1. **[Creación de un usuario de prueba de Certain Admin SSO](#create-a-certain-admin-sso-test-user)**: para tener un homólogo de Britta Simon en Certain Admin SSO que esté vinculado a la representación del usuario en Azure AD.
1. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
1. **[Prueba del inicio de sesión único](#test-single-sign-on)**: para comprobar si la configuración funciona.

### <a name="configure-azure-ad-single-sign-on"></a>Configuración del inicio de sesión único de Azure AD

En esta sección habilitará el inicio de sesión único de Azure AD en Azure Portal y configurará el inicio de sesión único en la aplicación Certain Admin SSO.

**Para configurar el inicio de sesión único de Azure AD con Certain Admin SSO, realice los pasos siguientes:**

1. En la página de integración de la aplicación **Certain Admin SSO** de Azure Portal, haga clic en **Inicio de sesión único**.

    ![Vínculo Configurar inicio de sesión único][4]

1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
 
    ![Cuadro de diálogo Inicio de sesión único](./media/certainadminsso-tutorial/tutorial_certainadminsso_samlbase.png)

1. En la sección **Dominio y direcciones URL de Certain Admin SSO**, lleve a cabo los pasos siguientes:
    ...
    > [!NOTE] 
    > Estos valores no son reales. Debe actualizarlos con la dirección URL y el identificador reales de inicio de sesión. Póngase en contacto con el [equipo de soporte de cliente de Certain Admin SSO](mailto:integrations@certain.com) para obtener estos valores. 
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (sin procesar)** y, a continuación, guarde el archivo de certificado en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/certainadminsso-tutorial/tutorial_certainadminsso_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/certainadminsso-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Certain Admin SSO**, haga clic en **Configurar Certain Admin SSO** para abrir la ventana **Configurar inicio de sesión único**. Copie la **URL del servicio de inicio de sesión único de SAML, el identificador de entidad de SAML y la dirección URL de cierre de sesión** de la sección **Referencia rápida**.

    ![Configuración de Certain Admin SSO](./media/certainadminsso-tutorial/tutorial_certainadminsso_configure.png) 

1. Para configurar el inicio de sesión único en **Certain Admin SSO**, debe enviar los valores descargados de **Certificate (Raw)**, **Sign-Out URL, SAML Entity ID, and SAML Single Sign-On Service URL** [Certificado (sin procesar), Dirección URL de cierre de sesión, Identificador de entidad SAML y Dirección URL del servicio de inicio de sesión único de SAML] al [equipo de soporte técnico de Certain Admin SSO](mailto:integrations@certain.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/certainadminsso-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/certainadminsso-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/certainadminsso-tutorial/create_aaduser_03.png)
...
**Para asignar a Britta Simon a Certain Admin SSO, realice los pasos siguientes:**
...
1. En la lista de aplicaciones, seleccione **Certain Admin SSO**.
    ...
    ![Vínculo a Certain Admin SSO en la lista de aplicaciones](./media/certainadminsso-tutorial/tutorial_certainadminsso_app.png)  
