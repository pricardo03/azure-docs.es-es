...
3. **[Creación de un usuario de prueba de Certain Admin SSO](#create-a-certain-admin-sso-test-user)**: para tener un homólogo de Britta Simon en Certain Admin SSO que esté vinculado a la representación del usuario en Azure AD.
...
3. En la sección **Dominio y direcciones URL de Certain Admin SSO**, lleve a cabo los pasos siguientes:
