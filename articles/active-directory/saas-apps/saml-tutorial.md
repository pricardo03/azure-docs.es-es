...
3. **[Creación de un usuario de prueba de la aplicación LOB habilitada para el token SAML 1.1](#create-a-saml-11-token-enabled-lob-app-test-user)**: para tener un homólogo de Britta Simon en la aplicación LOB habilitada para el token SAML 1.1 vinculado a la representación del usuario de Azure AD.
...
3. En la sección **Dominio y direcciones URL de la aplicación LOB habilitada para el token SAML 1.1**, lleve a cabo los pasos siguientes:
...
2. En la lista de aplicaciones, seleccione **SAML 1.1 Token enabled LOB App** (Aplicación LOB habilitada para el token SAML 1.1).
