...
3. **[Creación de un usuario de prueba en Settling music](#create-a-settling-music-test-user)**: para tener un homólogo de Britta Simon en Settling music que esté vinculado a la representación del usuario en Azure AD.
...
3. En la sección **Settling music Domain and URLs** (Dominio y direcciones URL de Settling music), lleve a cabo los pasos siguientes:
