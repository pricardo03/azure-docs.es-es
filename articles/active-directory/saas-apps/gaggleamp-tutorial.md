...
1. En el cuadro de búsqueda, escriba **GaggleAMP**.

    ![Creación de un usuario de prueba de Azure AD](./media/gaggleamp-tutorial/tutorial_gaggleamp_search.png)

1. En el panel de resultados, seleccione **GaggleAMP** y haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/gaggleamp-tutorial/tutorial_gaggleamp_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de GaggleAMP](#creating-a-gaggleamp-test-user)**: para tener un homólogo de Britta Simon en GaggleAMP que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/gaggleamp-tutorial/tutorial_gaggleamp_samlbase.png)

1. En la sección **GaggleAMP Domain and URLs** (Dominio y direcciones URL de GaggleAMP), realice los siguientes pasos si quiere configurar la aplicación en modo iniciado por **IDP**:

    ![Configurar inicio de sesión único](./media/gaggleamp-tutorial/tutorial_gaggleamp_url.png)
...
1. Active **Mostrar configuración avanzada de URL** y siga estos pasos si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Configurar inicio de sesión único](./media/gaggleamp-tutorial/tutorial_gaggleamp_url1.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/gaggleamp-tutorial/tutorial_gaggleamp_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/gaggleamp-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de GaggleAMP**, haga clic en **Configurar GaggleAMP** para abrir la ventana **Configurar inicio de sesión**. Copie **SAML Entity ID and SAML Single Sign-On Service URL** (URL del servicio de inicio de sesión único de SAML e Identificador de entidad de SAML) de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/gaggleamp-tutorial/tutorial_gaggleamp_configure.png) 
...
1. En la página **SAML SSO** (Inicio de sesión único de SAML), realice los pasos siguientes:  
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/gaggleamp-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/gaggleamp-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/gaggleamp-tutorial/create_aaduser_03.png) 
...
1. En la lista de aplicaciones, seleccione **GaggleAMP**.
    ...
    ![Configurar inicio de sesión único](./media/gaggleamp-tutorial/tutorial_gaggleamp_app.png) 
