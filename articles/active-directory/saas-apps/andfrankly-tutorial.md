...
4. En el cuadro de búsqueda, escriba **&frankly**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/andfrankly-tutorial/tutorial_andfrankly_search.png)

5. En el panel de resultados, seleccione **&frankly** y luego haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/andfrankly-tutorial/tutorial_andfrankly_addfromgallery.png)
...
3. 
  **
  [Creación de un usuario de prueba de &frankly](#creating-a-frankly-test-user)**: para tener un homólogo de Britta Simon en &amp;amp;frankly que esté vinculado a su representación en Azure AD.
...
2. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/andfrankly-tutorial/tutorial_andfrankly_samlbase.png)

3. En la sección **Dominio y direcciones URL de &frankly**, si quiere configurar la aplicación en modo iniciado por **IDP**:

    ![Configurar inicio de sesión único](./media/andfrankly-tutorial/tutorial_andfrankly_url.png)
...
4. Active **Mostrar configuración avanzada de URL**. Si quiere volver a configurar la aplicación en modo iniciado por **SP**:
    ...
    ![Configurar inicio de sesión único](./media/andfrankly-tutorial/tutorial_andfrankly_url1.png)
...
5. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/andfrankly-tutorial/tutorial_andfrankly_certificate.png) 

6. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/andfrankly-tutorial/tutorial_general_400.png)
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/andfrankly-tutorial/create_aaduser_01.png) 

2. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/andfrankly-tutorial/create_aaduser_02.png) 

3. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/andfrankly-tutorial/create_aaduser_03.png) 

4. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/andfrankly-tutorial/create_aaduser_04.png) 
...
2. En la lista de aplicaciones, seleccione **&frankly**.
    ...
    ![Configurar inicio de sesión único](./media/andfrankly-tutorial/tutorial_andfrankly_app.png) 
