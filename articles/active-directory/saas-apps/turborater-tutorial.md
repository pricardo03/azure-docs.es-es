...
* TurboRater admite SSO iniciado por **IDP**
...
**Para agregar TurboRater desde la galería, siga estos pasos:**
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de TurboRater.
...
2. **[Configuración del inicio de sesión único de TurboRater](#configure-turborater-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)**, para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de TurboRater](#create-turborater-test-user)**: para tener un homólogo de Britta Simon en TurboRater que esté vinculado a la representación del usuario en Azure AD.
...
4. En la página **Configurar inicio de sesión único con SAML** realice los siguientes pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de TurboRater](common/idp-intiated.png)
     ...
     a. En el cuadro de texto **Identificador**, escriba una dirección URL: `https://www.itcdataservices.com`
    ...
    > [!NOTE]
    > Estos valores no son reales. Actualice estos valores con el identificador y la URL de respuesta reales. Póngase en contacto con el [equipo de soporte técnico para clientes de TurboRater](https://www.getitc.com/support) para obtener estos valores. También puede hacer referencia a los patrones que se muestran en la sección **Configuración básica de SAML** de Azure Portal.

5. En la página **Configurar el inicio de sesión único con SAML**, en la sección **Certificado de firma de SAML**, haga clic en **Descargar** para descargar el **XML de metadatos de federación** de las opciones proporcionadas según sus requisitos y guárdelo en el equipo.

    ![Vínculo de descarga del certificado](common/metadataxml.png)

6. En la sección **Set up TurboRater** (Configurar TurboRater), copie las direcciones URL adecuadas según sus necesidades.
...
Para configurar el inicio de sesión único en **TurboRater**, es preciso enviar el **XML de metadatos de federación** descargado y las direcciones URL apropiadas copiadas de Azure Portal al [equipo de soporte técnico de TurboRater](https://www.getitc.com/support). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **TurboRater**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **TurboRater**.

    ![Vínculo a TurboRater en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-turborater-test-user"></a>Creación de un usuario de prueba en TurboRater

En esta sección, creará un usuario llamado Britta Simon en TurboRater. Trabaje con el  [equipo de soporte técnico de TurboRater](https://www.getitc.com/support) para agregar los usuarios a la plataforma de TurboRater. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.

### <a name="test-single-sign-on"></a>Prueba de inicio de sesión único 

En esta sección, probará la configuración de inicio de sesión único de Azure AD mediante el Panel de acceso.

Al hacer clic en el icono de TurboRater en el panel de acceso y debería iniciar sesión automáticamente en la versión de TurboRater para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
