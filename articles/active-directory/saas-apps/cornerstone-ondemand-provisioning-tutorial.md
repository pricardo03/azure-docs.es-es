...
4. En el cuadro de búsqueda, escriba **Cornerstone OnDemand**.
    ...
    ![Aprovisionamiento de Cornerstone OnDemand](./media/cornerstone-ondemand-provisioning-tutorial/AppSearch.png)
...
5. En el panel de resultados, seleccione **Cornerstone OnDemand** y, luego, haga clic en el botón **Agregar** para agregar Cornerstone OnDemand a la lista de aplicaciones SaaS.
    ...
    ![Aprovisionamiento de Cornerstone OnDemand](./media/cornerstone-ondemand-provisioning-tutorial/AppSearchResults.png)

    ![Aprovisionamiento de Cornerstone OnDemand](./media/cornerstone-ondemand-provisioning-tutorial/AppCreation.png)
...
2. Seleccione Cornerstone OnDemand en la lista de aplicaciones SaaS.
    ...
    ![Aprovisionamiento de Cornerstone OnDemand](./media/cornerstone-ondemand-provisioning-tutorial/Successcenter2.png)
