...
4. **[Creación de un usuario de prueba de AuditBoard](#create-auditboard-test-user)**: para tener un homólogo de Britta Simon en AuditBoard que esté vinculado a la representación del usuario en Azure AD.
