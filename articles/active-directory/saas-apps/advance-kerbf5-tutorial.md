...
* **Paso 1: Crear una cuenta de delegación**
    ...
    * Nombre de dominio de ejemplo: superdemo.live Nombre de cuenta SAM: big-ipuser

    * New-ADUser -Name "APM Delegation Account" -UserPrincipalName host/big-ipuser.superdemo.live@superdemo.live -SamAccountName "big-ipuser" -PasswordNeverExpires $true -Enabled $true -AccountPassword (Read-Host -AsSecureString "Password!1234")

* **Paso 2: Establecer SPN (en la cuenta de delegación de APM)**

    *  Ejemplo setspn –A host/big-ipuser.superdemo.live big-ipuser
