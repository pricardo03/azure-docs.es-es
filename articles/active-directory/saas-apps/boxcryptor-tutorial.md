...
1. En el cuadro de búsqueda, escriba **Boxcryptor**, seleccione **Boxcryptor** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Boxcryptor en la lista de resultados](./media/boxcryptor-tutorial/tutorial_boxcryptor_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Boxcryptor](#create-a-boxcryptor-test-user)**: para tener un homólogo de Britta Simon en Boxcryptor que esté vinculado a su representación en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/boxcryptor-tutorial/tutorial_boxcryptor_samlbase.png)

1. En la sección **Dominios y direcciones URL de Boxcryptor**, lleve a cabo los pasos siguientes:

    ![Información de dominio y direcciones URL de inicio de sesión único de Boxcryptor](./media/boxcryptor-tutorial/tutorial_boxcryptor_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/boxcryptor-tutorial/tutorial_boxcryptor_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/boxcryptor-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Boxcryptor**, haga clic en **Configurar Boxcryptor** para abrir la ventana **Configurar inicio de sesión**. Copie los valores de **URL del servicio de inicio de sesión único de SAML** e **Identificador de entidad de SAML** de la sección **Referencia rápida**.

    ![Configuración de Andromeda SCM](./media/boxcryptor-tutorial/tutorial_boxcryptor_configure.png)
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/boxcryptor-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/boxcryptor-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/boxcryptor-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/boxcryptor-tutorial/create_aaduser_04.png)
...
1. En la lista de aplicaciones, seleccione **Boxcryptor**.
    ...
    ![Vínculo a Boxcryptor en la lista de aplicaciones](./media/boxcryptor-tutorial/tutorial_boxcryptor_app.png)  
