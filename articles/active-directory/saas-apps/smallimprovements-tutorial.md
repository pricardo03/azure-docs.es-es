...
1. En el cuadro de búsqueda, escriba **Small Improvements**.

    ![Creación de un usuario de prueba de Azure AD](./media/smallimprovements-tutorial/tutorial_smallimprovements_search.png)

1. En el panel de resultados, seleccione **Small Improvements** y haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/smallimprovements-tutorial/tutorial_smallimprovements_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Small Improvements](#creating-a-small-improvements-test-user)**: para tener un homólogo de Britta Simon en Small Improvements que esté vinculado a su representación en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/smallimprovements-tutorial/tutorial_smallimprovements_samlbase.png)

1. En la sección **Dominio y direcciones URL de Small Improvements**, lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/smallimprovements-tutorial/tutorial_smallimprovements_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/smallimprovements-tutorial/tutorial_smallimprovements_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/smallimprovements-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Small Improvements**, haga clic en **Configurar Small Improvements** para abrir la ventana **Configurar inicio de sesión**. Copie la **dirección URL de servicio de inicio de sesión único de SAML** de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/smallimprovements-tutorial/tutorial_smallimprovements_configure.png) 
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/smallimprovements-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/smallimprovements-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/smallimprovements-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/smallimprovements-tutorial/create_aaduser_04.png) 
...
1. En el cuadro de diálogo **Agregar usuarios**, realice los pasos siguientes: 
    ...
    c. Escriba la dirección de **correo electrónico** del usuario como <strong>brittasimon@contoso.com</strong>. 
...
1. En la lista de aplicaciones, seleccione **Small Improvements**.
    ...
    ![Configurar inicio de sesión único](./media/smallimprovements-tutorial/tutorial_smallimprovements_app.png) 
