...
4. En el cuadro de búsqueda, escriba **People**, seleccione **People** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

     ![People en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de People.
...
2. **[Configuración del inicio de sesión único de People](#configure-people-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)**, para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de People](#create-people-test-user)**: el objetivo es tener un homólogo de Britta Simon en People que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **People**, seleccione **Inicio de sesión único**.
...
6. En la sección **Set up People** (Configurar People), copie las direcciones URL adecuada según sus necesidades.
...
### <a name="configure-people-single-sign-on"></a>Configuración del inicio de sesión único de People
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **People**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **People**.

    ![Vínculo a People en la lista de aplicaciones](common/all-applications.png)
