...
4. En el cuadro de búsqueda, escriba **Achieve3000**, seleccione **Achieve3000** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![Achieve3000 en la lista de resultados](./media/achieve3000-tutorial/tutorial_achieve3000_addfromgallery.png)
...
2. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/achieve3000-tutorial/tutorial_achieve3000_samlbase.png)

3. En la sección **Achieve3000 Domain and URLs** (Dominios y direcciones URL de Achieve3000), lleve a cabo los pasos siguientes:

    ![Información acerca del inicio de sesión único de dominio y direcciones URL de Achieve3000](./media/achieve3000-tutorial/tutorial_achieve3000_url.png)
...
4. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/achieve3000-tutorial/tutorial_achieve3000_certificate.png) 
...
5. La aplicación Achieve3000 espera el valor de **studentID** único de la notificación en el identificador de nombre. El cliente puede asignar el valor correcto de la notificación del identificador de nombre. En este caso, asignamos **user.mail** para la demostración. Sin embargo, debe asignar el valor correcto según el identificador único.   
    ...
    ![Configurar el atributo de inicio de sesión único](./media/achieve3000-tutorial/tutorial_achieve3000_attribute.png)
...
6. En la sección **Atributos de usuario** del cuadro de diálogo **Inicio de sesión único**, configure el atributo token de SAML como muestra la imagen y siga estos pasos:
    ...
    ![Configurar la adición del inicio de sesión único](./media/achieve3000-tutorial/tutorial_officespace_04.png)

    ![Configurar la adición del atributo del inicio de sesión único](./media/achieve3000-tutorial/tutorial_attribute_05.png)
...
7. Haga clic en el botón **Guardar** .
    ...
    ![Botón Configurar inicio de sesión único](./media/achieve3000-tutorial/tutorial_general_400.png)
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/achieve3000-tutorial/create_aaduser_01.png)

2. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/achieve3000-tutorial/create_aaduser_02.png)

3. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/achieve3000-tutorial/create_aaduser_03.png)

4. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/achieve3000-tutorial/create_aaduser_04.png)
...
2. En la lista de aplicaciones, seleccione **Achieve3000**.
    ...
    ![Vínculo a Achieve3000 en la lista de aplicaciones](./media/achieve3000-tutorial/tutorial_achieve3000_app.png)  
