...
* Una suscripción habilitada para el inicio de sesión único en Achieve3000
...
4. En el cuadro de búsqueda, escriba **Achieve3000**, seleccione **Achieve3000** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![Achieve3000 en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Achieve3000.
...
2. **[Configuración del inicio de sesión único de Achieve3000](#configure-achieve3000-single-sign-on)** : para configurar el inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Achieve3000](#create-achieve3000-test-user)** : para tener un homólogo de Britta Simon en Achieve3000 que esté vinculado a la representación de ella en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Achieve3000**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información acerca del inicio de sesión único de dominio y direcciones URL de Achieve3000](common/sp-identifier.png)
    ...
    b. En el cuadro de texto **Identificador (id. de entidad)** , escriba el valor: `achieve3000-saml`
...
8. En la sección **Set up Achieve3000** (Configurar Achieve3000), copie las direcciones URL adecuadas según sus necesidades.
...
### <a name="configure-achieve3000-single-sign-on"></a>Configuración del inicio de sesión único de Achieve3000
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y, luego, **Achieve3000**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Achieve3000**.

    ![Vínculo a Achieve3000 en la lista de aplicaciones](common/all-applications.png)
...
En esta sección, creará un usuario llamado Britta Simon en Achieve3000. Trabaje con el  [equipo de soporte técnico de Achieve3000](https://www.achieve3000.com/contact-us/) para agregar los usuarios a la plataforma de Achieve3000. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
