...
11. Aparece un cuadro de diálogo del asistente. En el cuadro de diálogo, haga clic en la pestaña **"Identity Provider Details"** (Detalles del proveedor de identidades) y rellene los campos siguientes:  
    ...
    b. En el cuadro de texto  **IdP Login URL** (Dirección URL de inicio de sesión del IdP), pegue el valor de la  **Dirección URL del servicio de inicio de sesión único** que copió de Azure Portal.

    c. En el cuadro de texto  **IdP Logout URL** (Dirección URL de cierre de sesión del IdP), pegue el valor de la  **Dirección URL de cierre de sesión único** que copió de Azure Portal.
