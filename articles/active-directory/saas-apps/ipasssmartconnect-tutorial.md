...
3. **[Creación de un usuario de prueba de iPass SmartConnect](#create-an-ipass-smartconnect-test-user)**: para tener un homólogo de Britta Simon en iPass SmartConnect que esté vinculado a la representación del usuario en Azure AD.
...
3. En la sección **Dominio y direcciones URL de iPass SmartConnect**, si quiere configurar la aplicación en modo iniciado por **IDP**, no es necesario realizar ningún paso.
