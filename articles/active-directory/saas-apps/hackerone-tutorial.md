...
1. En el cuadro de búsqueda, escriba **HackerOne**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/hackerone-tutorial/tutorial_hackerone_search.png)

1. En el panel de resultados, seleccione **HackerOne** y haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/hackerone-tutorial/tutorial_hackerone_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de HackerOne](#creating-a-hackerone-test-user)**: para tener un homólogo de Britta Simon en HackerOne vinculado a la representación de usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/hackerone-tutorial/tutorial_hackerone_samlbase.png)

1. En la sección de **dirección URL de inicio de sesión único e identificador de HackerOne**, realice los pasos siguientes:

    ![Configurar inicio de sesión único](./media/hackerone-tutorial/tutorial_hackerone_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/hackerone-tutorial/tutorial_hackerone_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/hackerone-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de HackerOne**, haga clic en **Configurar HackerOne** para abrir la ventana **Configurar inicio de sesión**. Copie la **dirección URL de servicio de inicio de sesión único de SAML** de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/hackerone-tutorial/tutorial_hackerone_configure.png) 

1. Inicie sesión en el inquilino de HackerOne como administrador.

1. En el menú de la parte superior, haga clic en "**Settings**" (Configuración).
   
    ![Configurar inicio de sesión único](./media/hackerone-tutorial/tutorial_hackerone_001.png) 

1. Vaya a "**Authentication**" (Autenticación) y haga clic en el botón "**Add SAML settings**" (Agregar configuración de SAML).
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/hackerone-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/hackerone-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/hackerone-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/hackerone-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **HackerOne**.
    ...
    ![Configurar inicio de sesión único](./media/hackerone-tutorial/tutorial_hackerone_app.png) 
