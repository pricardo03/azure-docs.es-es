...
3. **[Creación de un usuario de prueba de TonicDM](#create-a-tonicdm-test-user)**: para tener un homólogo de Britta Simon en TonicDM que esté vinculado a la representación del usuario en Azure AD.
...
3. En la sección **Dominio y direcciones URL de TonicDM**, siga estos pasos:
...
6. En la sección **Configuración de TonicDM**, haga clic en **Configurar TonicDM** para abrir la ventana **Configurar inicio de sesión**. Copie la **URL del servicio de inicio de sesión único de SAML, el identificador de entidad de SAML y la dirección URL de cierre de sesión** de la sección **Referencia rápida**.
