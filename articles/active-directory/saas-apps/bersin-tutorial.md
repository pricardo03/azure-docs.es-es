...
1. En el cuadro de búsqueda, escriba **Bersin**, seleccione **Bersin** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
...
1. **[Creación de un usuario de prueba de Bersin](#create-a-bersin-test-user)**: para tener un homólogo de Britta Simon en Bersin que esté vinculado a su representación en Azure AD.
...
1. En la sección **Dominio y direcciones URL de Bersin**, realice los siguientes pasos si desea configurar la aplicación en el modo iniciado por **IDP**:
...
1. Si desea configurar la aplicación en modo iniciado por **SP**, realice el siguientes paso:
...
1. Para configurar el inicio de sesión único en el lado de **Bersin**, necesita enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de Bersin](mailto:USBersinServiceClient@deloitte.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En la lista de aplicaciones, seleccione **Bersin**.
