...
En esta sección, probará la configuración de inicio de sesión único de Azure AD mediante el Panel de acceso.
 ...
 Al hacer clic en el icono de BC in the Cloud en el Panel de acceso, debería iniciar sesión automáticamente en la aplicación BC in the Cloud. Para más información sobre el Panel de acceso, consulte la  [introducción al Panel de acceso](../user-help/active-directory-saas-access-panel-introduction.md).
