...
1. En el cuadro de búsqueda, escriba **FileCloud**, seleccione **FileCloud** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![FileCloud en la lista de resultados](./media/filecloud-tutorial/tutorial_filecloud_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de FileCloud](#create-a-filecloud-test-user)**: para tener un homólogo de Britta Simon en FileCloud que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/filecloud-tutorial/tutorial_filecloud_samlbase.png)

1. En la sección **Dominio y direcciones URL de FileCloud**, lleve a cabo los pasos siguientes:

    ![Información de dominio y direcciones URL de inicio de sesión único de FileCloud](./media/filecloud-tutorial/tutorial_filecloud_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/filecloud-tutorial/tutorial_filecloud_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/filecloud-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de FileCloud**, haga clic en **Configurar FileCloud** para abrir la ventana **Configurar inicio de sesión**. Copie el valor de **Identificador de entidad de SAML** de la **sección Referencia rápida**

    ![Configuración de FileCloud](./media/filecloud-tutorial/tutorial_filecloud_configure.png) 
...
1. Haga clic en la ficha **SSO** de la sección de configuración. 
   
    ![Configuración del inicio de sesión único en la aplicación](./media/filecloud-tutorial/tutorial_filecloud_001.png)

1. Seleccione **SAML** como **Default SSO Type** (Tipo de SSO predeterminado) en el panel **Configuración de inicio de sesión único (SSO)**.
   
    ![Configuración del inicio de sesión único en la aplicación](./media/filecloud-tutorial/tutorial_filecloud_002.png)

1. En el cuadro de texto **IdP End Point URL** (Dirección URL de punto de conexión de IdP), pegue el valor de **SAML Entity ID** (Identificador de entidad de SAML) que copió de Azure Portal.

    ![Configuración del inicio de sesión único en la aplicación](./media/filecloud-tutorial/tutorial_filecloud_003.png)

1. Abra el archivo de metadatos descargado en el Bloc de notas, copie el contenido del mismo en el Portapapeles y luego péguelo en el cuadro de texto **IdP Meta Data** (Metadatos de IdP) en el panel **Configuración de SAML**.
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/filecloud-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/filecloud-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/filecloud-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/filecloud-tutorial/create_aaduser_04.png)
...
1. En la lista de aplicaciones, seleccione **FileCloud**.
    ...
    ![Enlace a FileCloud en la lista de aplicaciones](./media/filecloud-tutorial/tutorial_filecloud_app.png)  
