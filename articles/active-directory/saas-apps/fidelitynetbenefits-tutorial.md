...
1. En el cuadro de búsqueda, escriba **Fidelity NetBenefits**, seleccione **Fidelity NetBenefits** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
...
1. **[Crear un usuario de prueba de Fidelity NetBenefits](#create-a-fidelity-netbenefits-test-user)**: para tener un homólogo de Britta Simon en Fidelity NetBenefits que esté vinculado a la representación del usuario en Azure AD.
...
1. En la sección **Dominio y direcciones URL de Fidelity NetBenefits**, lleve a cabo los pasos siguientes:
