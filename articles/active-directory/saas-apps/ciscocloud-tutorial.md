...
1. En el cuadro de búsqueda, escriba **Cisco Cloud**, seleccione **Cisco Cloud** en el panel de resultados y, luego, haga clic en el botón **Agregar** para añadir la aplicación.

    ![Cisco Cloud en la lista de resultados](./media/ciscocloud-tutorial/tutorial_ciscocloud_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Cisco Cloud](#create-a-cisco-cloud-test-user)**: para tener un homólogo de Britta Simon en Cisco Cloud que esté vinculado a su representación en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/ciscocloud-tutorial/tutorial_ciscocloud_samlbase.png)

1. En la sección **Dominio y direcciones URL de Cisco Cloud**, realice los siguientes pasos si quiere configurar la aplicación en el modo iniciado por **IDP**:

    ![Información de dominio y direcciones URL de inicio de sesión único de Cisco Cloud](./media/ciscocloud-tutorial/tutorial_ciscocloud_url.png)
...
1. Active **Mostrar configuración avanzada de URL** y siga estos pasos si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Cisco Cloud](./media/ciscocloud-tutorial/tutorial_ciscocloud_url1.png)
...
1. La aplicación Cisco Cloud espera las aserciones de SAML en un formato específico. Configure las siguientes notificaciones para esta aplicación. Puede administrar los valores de estos atributos en la sección **Atributos de usuario** de la página de integración de aplicaciones.
 La siguiente captura de pantalla muestra un ejemplo al respecto.

    ![Configurar inicio de sesión único](./media/ciscocloud-tutorial/attribute.png)
...
1. En la sección **Atributos de usuario**, active la casilla **Ver y editar todos los demás atributos de usuario** para expandir los atributos. Realice los pasos siguientes en cada uno de los atributos mostrados:
    ...
    ![Configurar inicio de sesión único](./media/ciscocloud-tutorial/tutorial_attribute_04.png)

    ![Configurar inicio de sesión único](./media/ciscocloud-tutorial/tutorial_attribute_05.png)

    b. En el cuadro de texto **Nombre**, escriba el nombre que se muestra para la fila.

    c. En la lista **Valor**, seleccione el atributo que se muestra para esa fila.

    d. Deje el valor **Espacio de nombres** en blanco.
...
1. En la sección **Certificado de firma de SAML**, haga clic en el botón Copiar para copiar la **dirección URL de metadatos de federación de la aplicación** y péguela en el Bloc de notas.
    ...
    ![Vínculo de descarga del certificado](./media/ciscocloud-tutorial/tutorial_ciscocloud_certificate.png)

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/ciscocloud-tutorial/tutorial_general_400.png)

1. Para configurar el inicio de sesión único en **Cisco Cloud**, debe enviar la **dirección URL de metadatos de federación de la aplicación** al [equipo de soporte técnico de Cisco Cloud](mailto:cpr-ops@cisco.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/ciscocloud-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/ciscocloud-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/ciscocloud-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/ciscocloud-tutorial/create_aaduser_04.png)
...
1. En la lista de aplicaciones, seleccione **Cisco Cloud**.
    ...
    ![Vínculo a Cisco Cloud en la lista de aplicaciones](./media/ciscocloud-tutorial/tutorial_ciscocloud_app.png)  
