...
3. **[Creación de un usuario de prueba de JIRA SAML SSO by Microsoft](#creating-jira-saml-sso-by-microsoft-test-user)**: Para tener un homólogo de Britta Simon en JIRA SAML SSO by Microsoft que esté vinculado a la representación del usuario en Azure AD.
...
5. En la página **Certificado de firma de SAML** de la sección **Certificado de firma de SAML**, haga clic en el botón Copiar para copiar la **dirección URL de metadatos de federación de la aplicación** y péguela en el Bloc de notas.

    ![Vínculo de descarga del certificado](./media/jiramicrosoft-tutorial/tutorial_metadataurl.png) 
...
### <a name="creating-jira-saml-sso-by-microsoft-test-user"></a>Creación de un usuario de prueba de JIRA SAML SSO by Microsoft
...
2. En la lista de aplicaciones, seleccione **JIRA SAML SSO by Microsoft**.
    ...
    ![Configurar inicio de sesión único](./media/jiramicrosoft-tutorial/tutorial_singlesign-onforjira_app.png)
