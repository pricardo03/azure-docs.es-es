...
1. En el cuadro de búsqueda, escriba **PatentSQUARE**, seleccione **PatentSQUARE** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

    ![PatentSQUARE en la lista de resultados](./media/patentsquare-tutorial/tutorial_patentsquare_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de PatentSQUARE](#create-a-patentsquare-test-user)**: para tener un homólogo de Britta Simon en PatentSQUARE que esté vinculado a la representación de ella en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/patentsquare-tutorial/tutorial_patentsquare_samlbase.png)

1. En la sección **Dominio y direcciones URL de PatentSQUARE**, lleve a cabo los pasos siguientes:

    ![Información sobre dominio y direcciones URL de inicio de sesión único de PatentSQUARE](./media/patentsquare-tutorial/tutorial_patentsquare_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/patentsquare-tutorial/tutorial_patentsquare_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/patentsquare-tutorial/tutorial_general_400.png)
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/patentsquare-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/patentsquare-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/patentsquare-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/patentsquare-tutorial/create_aaduser_04.png)
...
1. En la lista de aplicaciones, seleccione **PatentSQUARE**.

    ![El vínculo de PatentSQUARE en la lista de aplicaciones](./media/patentsquare-tutorial/tutorial_patentsquare_app.png)  
