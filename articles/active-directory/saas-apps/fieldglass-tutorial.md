---
title: 'Tutorial: Tutorial: Integración de Azure Active Directory con Fieldglass | Microsoft Docs'
...
1. En el cuadro de búsqueda, escriba **Fieldglass**.

    ![Creación de un usuario de prueba de Azure AD](./media/fieldglass-tutorial/tutorial_fieldglass_search.png)

1. En el panel de resultados, seleccione **Fieldglass** y luego haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/fieldglass-tutorial/tutorial_fieldglass_addfromgallery.png)
...
1. **[Creación de un usuario de prueba en Fieldglass](#creating-a-fieldglass-test-user)**: para tener un homólogo de Britta Simon en Fieldglass que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/fieldglass-tutorial/tutorial_fieldglass_samlbase.png)

1. En la sección de **dominio y direcciones URL de Fieldglass**, lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/fieldglass-tutorial/tutorial_fieldglass_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/fieldglass-tutorial/tutorial_fieldglass_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/fieldglass-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Fieldglass**, haga clic en **Configurar Fieldglass** para abrir la ventana **Configurar inicio de sesión**. Copie los valores de **Sign-Out URL and SAML Entity ID** (Dirección URL de cierre de sesión e identificador de entidad de SAML) de la **sección Referencia rápida**.
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/fieldglass-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/fieldglass-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/fieldglass-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/fieldglass-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **Fieldglass**.
    ...
    ![Configurar inicio de sesión único](./media/fieldglass-tutorial/tutorial_fieldglass_app.png) 
