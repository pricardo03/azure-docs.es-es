...
* Suscripción de GitHub con el inicio de sesión único habilitado
...
6. En la sección **Set up GitHub** (Configurar GitHub), copie las direcciones URL que necesite.
