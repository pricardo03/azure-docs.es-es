...
* Uberflip admite el inicio de sesión único iniciado por **SP** e **IDP**.

* Uberflip admite el aprovisionamiento de usuarios **Just-In-Time**
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Uberflip.
...
2. **[Configuración del inicio de sesión único de Uberflip](#configure-uberflip-single-sign-on)**: para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)**, para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Uberflip](#create-uberflip-test-user)**: para tener un homólogo de Britta Simon en Uberflip que esté vinculado a su representación en Azure AD.
...
4. En la sección **Configuración básica de SAML**, si desea configurar la aplicación en modo iniciado por **IDP**, realice el siguiente paso:
    ...
    > [!NOTE]
    > Este valor no es real. Actualice este valor con la dirección URL de respuesta real. Póngase en contacto con el [equipo de soporte al cliente de Uberflip](mailto:support@uberflip.com) para obtener este valor. También puede hacer referencia a los patrones que se muestran en la sección **Configuración básica de SAML** de Azure Portal.
...
5. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL: `https://app.uberflip.com/users/login`

6. En la página **Configurar el inicio de sesión único con SAML**, en la sección **Certificado de firma de SAML**, haga clic en **Descargar** para descargar el **XML de metadatos de federación** de las opciones proporcionadas según sus requisitos y guárdelo en el equipo.

    ![Vínculo de descarga del certificado](common/metadataxml.png)

7. En la sección **Set up Uberflip** (Configurar Uberflip), copie las direcciones URL adecuadas según sus necesidades.
...
Para configurar el inicio de sesión único en **Uberflip**, es preciso enviar el **XML de metadatos de federación** descargado y las direcciones URL apropiadas copiadas de Azure Portal al [equipo de soporte técnico de Uberflip](mailto:support@uberflip.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y luego **Uberflip**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Uberflip**.

    ![Vínculo a Uberflip en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-uberflip-test-user"></a>Creación de un usuario de prueba de Uberflip

En esta sección, se crea un usuario llamado Britta Simon en Uberflip. Uberflip admite el aprovisionamiento de usuarios Just-In-Time, que está habilitado de forma predeterminada. No hay ningún elemento de acción para usted en esta sección. Si el usuario no existe en Uberflip, se crea uno después de la autenticación.
...
Al hacer clic en el icono de Uberflip en el panel de acceso, debería iniciar sesión automáticamente en la versión de Uberflip para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
