...
1. En el cuadro de búsqueda, escriba **Coupa**, seleccione **Coupa** en el panel de resultados y, luego, haga clic en el botón **Agregar** para añadir la aplicación.
...
1. **[Creación de un usuario de prueba de Coupa](#create-a-coupa-test-user)**: para tener un homólogo de Britta Simon en Coupa que esté vinculado a la representación del usuario en Azure AD.
...
1. En la sección **Dominio y direcciones URL de Coupa**, lleve a cabo los pasos siguientes:
...
1. Vaya a **Configuración \> Control de seguridad**.

   ![Controles de seguridad](./media/coupa-tutorial/ic791900.png "Controles de seguridad")

1. En la sección **Iniciar sesión con credenciales de Coupa** , realice los pasos siguientes:
...
1. En el menú en la parte superior, haga clic en **Configurar** y, después, en **Usuarios**.
...
1. En la sección **Creación de usuario** , lleve a cabo estos pasos:
