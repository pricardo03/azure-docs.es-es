...
> [!NOTE]
> La integración del aprovisionamiento de Azure AD se basa en la [API REST de Zendesk](https://developer.zendesk.com/rest_api/docs/zendesk-apis/resources), que está disponible para los equipos de Zendesk con el plan Enterprise o superiores.
...
4. En el cuadro de búsqueda, escriba **Zendesk**.
    ...
    ![Aprovisionamiento de Zendesk](./media/zendesk-provisioning-tutorial/ZenDesk6.png)
...
5. En el panel de resultados, seleccione **Zendesk** y, luego, haga clic en el botón **Agregar** para agregar Zendesk a la lista de aplicaciones SaaS.
    ...
    ![Aprovisionamiento de Zendesk](./media/zendesk-provisioning-tutorial/ZenDesk7.png)

    ![Aprovisionamiento de Zendesk](./media/zendesk-provisioning-tutorial/ZenDesk20.png)
...
2. Seleccione Zendesk en la lista de aplicaciones SaaS.
    ...
    ![Aprovisionamiento de Zendesk](./media/zendesk-provisioning-tutorial/ZenDesk3.png)
