...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de 4me.
...
2. **[Configuración del inicio de sesión único de 4me](#configure-4me-single-sign-on)**: para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)**, para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación del usuario de prueba de 4me](#create-4me-test-user)**: para tener un homólogo de Britta Simon en 4me vinculado a la representación del usuario en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con 4me, realice los siguientes pasos:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **4me**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de 4me](common/sp-identifier.png)
...
8. En la sección **Certificado de firma de SAML**, copie el valor de **Huella digital** y guárdelo en el equipo.

    ![Copia del valor de la huella digital](common/copy-thumbprint.png)

9. En la sección **Set up 4me** (Configurar 4me), copie las direcciones URL que necesite.
...
### <a name="configure-4me-single-sign-on"></a>Configuración del inicio de sesión único de 4me

1. En otra ventana del explorador web, inicie sesión en 4me como administrador.

2. En la esquina superior izquierda, haga clic en el logotipo de **Configuración** y en la barra izquierda, haga clic en **Single Sign-On** (Inicio de sesión único).

    ![Configuración de 4me](./media/4me-tutorial/tutorial_4me_settings.png)

3. En la página **Single Sign-On** (Inicio de sesión único) realice los pasos siguientes:
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **4me**.
