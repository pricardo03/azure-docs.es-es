...
* Desde Azure AD puede controlar quién tiene acceso a Kronos.
...
* Suscripción de Kronos con el inicio de sesión único habilitado
...
4. En el cuadro de búsqueda, escriba **Kronos**, seleccione **Kronos** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

     ![Kronos en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Kronos.
...
2. **[Configuración del inicio de sesión único de Kronos](#configure-kronos-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Kronos](#create-kronos-test-user)** : para tener un homólogo de Britta Simon en Kronos que esté vinculado a la representación de ella en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con Kronos, siga estos pasos:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Kronos**, haga clic en **Inicio de sesión único**.
...
4. En el cuadro de diálogo **Configuración básica de SAML**, realice los siguientes pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Kronos](common/idp-intiated.png)
...
### <a name="configure-kronos-single-sign-on"></a>Configuración del inicio de sesión único de Kronos

Para configurar el inicio de sesión único en **Kronos**, es preciso enviar el archivo **XML de metadatos de federación** descargado de Azure Portal al [equipo de soporte técnico de Kronos](https://www.kronos.in/contact/en-in/form). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y  **Kronos**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Kronos**.

    ![Vínculo a Kronos en la lista de aplicaciones](common/all-applications.png)
