...
1. En el cuadro de búsqueda, escriba **Kronos**.

    ![Creación de un usuario de prueba de Azure AD](./media/kronos-tutorial/tutorial_kronos_search.png)

1. En el panel de resultados, seleccione **Kronos** y luego haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/kronos-tutorial/tutorial_kronos_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Kronos](#creating-a-kronos-test-user)**: para tener un homólogo de Britta Simon en Kronos que esté vinculado a la representación de ella en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/kronos-tutorial/tutorial_kronos_samlbase.png)

1. En la sección **Dominio y direcciones URL de Kronos**, lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/kronos-tutorial/tutorial_kronos_url.png)
...
1. La aplicación Kronos espera las aserciones de SAML en un formato concreto. Trabaje primero con el [equipo de soporte técnico de Kronos](https://www.kronos.in/contact/en-in/form) para identificar el identificador de usuario correcto que se asignará a la aplicación. También siga sus instrucciones sobre el atributo que desean usar para esta asignación.
    ...
    ![Configurar inicio de sesión único](./media/kronos-tutorial/tutorial_kronos_attribute.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/kronos-tutorial/tutorial_kronos_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/kronos-tutorial/tutorial_general_400.png)

1. Para configurar el inicio de sesión único en el lado de **Kronos**, necesita enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de Kronos](https://www.kronos.in/contact/en-in/form). 
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/kronos-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/kronos-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/kronos-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/kronos-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **Kronos**.
    ...
    ![Configurar inicio de sesión único](./media/kronos-tutorial/tutorial_kronos_app.png) 
