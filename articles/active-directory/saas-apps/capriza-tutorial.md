...
1. En el cuadro de búsqueda, escriba **Capriza Platform**.

    ![Creación de un usuario de prueba de Azure AD](./media/capriza-tutorial/tutorial_caprizaplatform_search.png)

1. En el panel de resultados, seleccione **Capriza Platform** y luego haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/capriza-tutorial/tutorial_caprizaplatform_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Capriza Platform](#creating-a-capriza-platform-test-user)**: para tener un homólogo de Britta Simon en Capriza Platform que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/capriza-tutorial/tutorial_caprizaplatform_samlbase.png)

1. En la sección **Dominio y direcciones URL de Capriza Platform**, lleve a cabo los siguientes pasos:

    ![Configurar inicio de sesión único](./media/capriza-tutorial/tutorial_caprizaplatform_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/capriza-tutorial/tutorial_caprizaplatform_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/capriza-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Capriza Platform**, haga clic en **Configurar Capriza Platform** para abrir la ventana **Configurar inicio de sesión**. Copie la **URL del servicio de inicio de sesión único de SAML, el identificador de entidad de SAML y la dirección URL de cierre de sesión** de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/capriza-tutorial/tutorial_caprizaplatform_configure.png) 
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/capriza-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/capriza-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/capriza-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/capriza-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **Capriza Platform**.

    ![Configurar inicio de sesión único](./media/capriza-tutorial/tutorial_caprizaplatform_app.png) 
...
Al hacer clic en el icono de Capriza Platform en el Panel de acceso, debería iniciar sesión automáticamente en su aplicación Capriza Platform. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/active-directory-saas-access-panel-introduction.md). 
