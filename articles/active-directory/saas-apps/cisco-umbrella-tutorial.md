...
4. **[Creación de un usuario de prueba de Cisco Umbrella](#create-cisco-umbrella-test-user)**: para tener un homólogo de Britta Simon en Cisco Umbrella que esté vinculado a su representación en Azure AD.
...
3. En la página **Cuentas**, haga clic en **Agregar** en el lado superior derecho de la página y siga los siguientes pasos.
    ...
    d. En el campo **Dirección de correo electrónico**, escriba la dirección de correo electrónico del usuario, como **brittasimon@contoso.com**.
