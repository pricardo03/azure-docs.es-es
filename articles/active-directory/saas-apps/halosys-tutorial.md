...
1. En el cuadro de búsqueda, escriba **Halosys**, seleccione **Halosys** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Halosys en la lista de resultados](./media/halosys-tutorial/tutorial_halosys_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Halosys](#create-a-halosys-test-user)**: para tener un homólogo de Britta Simon en Halosys que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/halosys-tutorial/tutorial_halosys_samlbase.png)

1. En la sección **Dominio y direcciones URL de Halosys**, lleve a cabo los pasos siguientes:

    ![Información de dominio y direcciones URL de inicio de sesión único de Halosys](./media/halosys-tutorial/tutorial_halosys_url.png)
    ...
    > [!NOTE] 
    > Estos valores no son reales. Actualice estos valores con el identificador y la URL de respuesta reales. Póngase en contacto con el [equipo de soporte técnico de Halosys](https://halosys.com/halosys#contact) para obtener estos valores.
 
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.

    ![Vínculo de descarga del certificado](./media/halosys-tutorial/tutorial_halosys_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/halosys-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Halosys**, haga clic en **Configurar Halosys** para abrir la ventana **Configurar inicio de sesión**. Copie la **dirección URL de servicio de inicio de sesión único de SAML** de la sección **Referencia rápida**.

    ![Configuración de Halosys](./media/halosys-tutorial/tutorial_halosys_configure.png) 

1. Para configurar el inicio de sesión único en **Halosys**, es preciso enviar los valores descargados de **XML de metadatos** y la **dirección URL del servicio de cierre de sesión único de SAML** al [equipo de soporte técnico de Halosys](https://halosys.com/halosys#contact). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/halosys-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/halosys-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/halosys-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/halosys-tutorial/create_aaduser_04.png)
...
1. En la lista de aplicaciones, seleccione **Halosys**.

    ![Vínculo a Halosys en la lista de aplicaciones](./media/halosys-tutorial/tutorial_halosys_app.png)  
