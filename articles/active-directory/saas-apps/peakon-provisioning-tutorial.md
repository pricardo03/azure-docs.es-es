...
12. Para configurar filtros de ámbito, vea las siguientes instrucciones, que se proporcionan en el [tutorial de filtros de ámbito](../manage-apps/define-conditional-rules-for-provisioning-user-accounts.md).
