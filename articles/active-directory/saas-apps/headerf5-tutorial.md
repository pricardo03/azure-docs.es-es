...
1. Debe importar el certificado de metadatos en F5 (basada en encabezados), que se usará más adelante en el proceso de instalación. Vaya a **System > Certificate Management > Traffic Certificate Management > > SSL Certificate List** (Sistema > Administración de certificados > Lista de certificados SSL). Haga clic en **Import** (Importar) en la esquina derecha.

    ![Configuración de F5 (basada en encabezados)](./media/headerf5-tutorial/configure12.png)
 
1. Además, también se necesita un **certificado SSL** para el nombre de host (`headerapp.superdemo.live`), en este ejemplo, se ha usado un certificado comodín.

    ![Configuración de F5 (basada en encabezados)](./media/headerf5-tutorial/configure13.png)

1. Vaya a – **F5 (basada en encabezados) BIG-IP Haga clic en Access > Guided Configuration > Federation > SAML Service Provider** (Acceso > Configuración guiada > Federación > Proveedor de servicios SAML).
...
1. Cree un nuevo servidor virtual y especifique la **dirección de destino**. El **puerto de redireccionamiento** es opcional. Elija el **certificado comodín** (o **Cert** que cargó para la aplicación) que cargamos antes y la **clave privada asociada**.
...
1. En Inicio de sesión único, seleccione **HTTP basado en encabezados**. Puede agregar otros encabezados basados en la aplicación. Consulte el apéndice para ver la lista de variables de sesión de SAML.

    ![Configuración de F5 (basada en encabezados)](./media/headerf5-tutorial/configure07.png) 

1. Póngase en contacto con el [equipo de soporte técnico al cliente de F5 (basada en encabezados) ](https://support.f5.com/csp/knowledge-center/software/BIG-IP?module=BIG-IP%20APM45) para obtener detalles de documentación de **las propiedades de comprobación de puntos de conexión**.

    ![Configuración de F5 (basada en encabezados)](./media/headerf5-tutorial/configure08.png)

1. Póngase en contacto con el [equipo de soporte técnico al cliente de F5 (basada en encabezados) ](https://support.f5.com/csp/knowledge-center/software/BIG-IP?module=BIG-IP%20APM45) para obtener detalles de documentación de **las propiedades de administración de sesiones**.
