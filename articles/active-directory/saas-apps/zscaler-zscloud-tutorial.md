...
1. En el cuadro de búsqueda, escriba **ZScaler ZSCloud**.

    ![Creación de un usuario de prueba de Azure AD](./media/zscaler-zscloud-tutorial/tutorial_zscalerzscloud_search.png)

1. En el panel de resultados, seleccione **ZScaler ZSCloud** y haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/zscaler-zscloud-tutorial/tutorial_zscalerzscloud_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de ZScaler ZSCloud](#creating-a-zscaler-zscloud-test-user)**: para tener un homólogo de Britta Simon en ZScaler ZSCloud vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/zscaler-zscloud-tutorial/tutorial_zscalerzscloud_samlbase.png)

1. En la sección **ZScaler ZSCloud Domain and URLs** (Dominio y direcciones URL de ZScaler ZSCloud), lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/zscaler-zscloud-tutorial/tutorial_zscalerzscloud_url.png)
    ...
    > [!NOTE] 
    > Tiene que actualizar este valor con la dirección URL de inicio de sesión real. Póngase en contacto con el [equipo de soporte técnico de ZScaler ZSCloud](https://help.zscaler.com/zia) para obtenerlo. 
 
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.

    ![Configurar inicio de sesión único](./media/zscaler-zscloud-tutorial/tutorial_zscalerzscloud_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/zscaler-zscloud-tutorial/tutorial_general_400.png)

1. En la sección **ZScaler ZSCloud Configuration** (Configuración de ZScaler ZSCloud), haga clic en **Configure ZScaler ZSCloud** (Configurar ZScaler ZSCloud) para abrir la ventana **Configurar inicio de sesión**. Copie la **dirección URL de servicio de inicio de sesión único de SAML** de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/zscaler-zscloud-tutorial/tutorial_zscalerzscloud_configure.png) 

1. En otra ventana del explorador web, inicie sesión en su sitio de la compañía de ZScaler ZSCloud como administrador.
...
1. En **Manage Administrators & Roles (Administrar administradores y roles)** haga clic en **Manage Users & Authentication (Administrar usuarios y autenticación)**.   
    ...
    ![Administración de usuarios y autenticación](./media/zscaler-zscloud-tutorial/ic800207.png "Administración de usuarios y autenticación")
...
1. En la sección **Choose Authentication Options for your Organization** (Elegir opciones de autenticación para su organización), lleve a cabo los pasos siguientes:   
    ...
    ![Autenticación](./media/zscaler-zscloud-tutorial/ic800208.png "Autenticación")
...
1. En la página de diálogo **Configure SAML Single Sign-On Parameters** (Configurar parámetros de inicio de sesión único SAML), realice estos pasos y luego haga clic en **Done** (Listo)
    ...
    ![Inicio de sesión único](./media/zscaler-zscloud-tutorial/ic800209.png "Inicio de sesión único")
...
1. En la página del cuadro de diálogo **Configurar autenticación de usuario** , realice los pasos siguientes:
    ...
    ![Administración](./media/zscaler-zscloud-tutorial/ic800210.png "Administración")
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/zscaler-zscloud-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/zscaler-zscloud-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/zscaler-zscloud-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/zscaler-zscloud-tutorial/create_aaduser_04.png) 
...
1. Haga clic en **Administración**.   
    ...
    ![Administración](./media/zscaler-zscloud-tutorial/ic781035.png "Administración")

1. Haga clic en **User Management**(Administración de usuarios).   
        
     ![Agregar](./media/zscaler-zscloud-tutorial/ic781037.png "Agregar")
...
1. En la sección Agregar usuario, lleve a cabo estos pasos:
    ...
    ![Agregar usuario](./media/zscaler-zscloud-tutorial/ic781038.png "Agregar usuario")
...
1. En la lista de aplicaciones, seleccione **ZScaler ZSCloud**.
