...
1. En el cuadro de búsqueda, escriba **Gigya**.

    ![Creación de un usuario de prueba de Azure AD](./media/gigya-tutorial/tutorial_gigya_search.png)

1. En el panel de resultados, seleccione **Gigya** y haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/gigya-tutorial/tutorial_gigya_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Gigya](#creating-a-gigya-test-user)**: para tener un homólogo de Britta Simon en Gigya que esté vinculado a la representación de Azure AD de usuario.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/gigya-tutorial/tutorial_gigya_samlbase.png)

1. En la sección **Dominio y direcciones URL de Gigya**, siga estos pasos:

    ![Configurar inicio de sesión único](./media/gigya-tutorial/tutorial_gigya_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/gigya-tutorial/tutorial_gigya_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/gigya-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Gigya**, haga clic en **Configurar Gigya** para abrir la ventana **Configurar inicio de sesión**. Copie los valores de **SAML Entity ID y SAML Single Sign-On Service URL** (Identificador de entidad de SAML y Dirección URL del servicio de inicio de sesión único de SAML) de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/gigya-tutorial/tutorial_gigya_configure.png) 

1. En otra ventana del explorador web, inicie sesión en el sitio de la compañía de Gigya como administrador.

1. Vaya **Settings \> SAML Login** (Configuración > Inicio de sesión de SAML), y luego haga clic en el botón **Add** (Agregar).
   
    ![Inicio de sesión SAML](./media/gigya-tutorial/ic789532.png "Inicio de sesión SAML")

1. En la sección **Inicio de sesión de SAML** , realice los pasos siguientes:
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/gigya-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/gigya-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/gigya-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/gigya-tutorial/create_aaduser_04.png) 
...
1. Vaya a **Admin \> Manage Users** (Administrador > Administrar usuarios) y, a continuación, haga clic en **Invite Users** (Invitar a usuarios).
   
    ![Administración de usuarios](./media/gigya-tutorial/ic789535.png "Administración de usuarios")

1. En el cuadro de diálogo Invite Users (Invitar a usuarios), realice los pasos siguientes:
...
1. En la lista de aplicaciones, seleccione **Gigya**.
    ...
    ![Configurar inicio de sesión único](./media/gigya-tutorial/tutorial_gigya_app.png) 
