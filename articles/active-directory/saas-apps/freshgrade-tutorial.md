...
1. En el cuadro de búsqueda, escriba **FreshGrade**.

    ![Creación de un usuario de prueba de Azure AD](./media/freshgrade-tutorial/tutorial_freshgrade_search.png)

1. En el panel de resultados, seleccione **FreshGrade** y luego haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/freshgrade-tutorial/tutorial_freshgrade_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de FreshGrade](#creating-a-freshgrade-test-user)**: para tener un homólogo de Britta Simon en FreshGrade que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/freshgrade-tutorial/tutorial_freshgrade_samlbase.png)

1. En la sección **Dominio y direcciones URL de FreshGrade**, siga estos pasos:

    ![Configurar inicio de sesión único](./media/freshgrade-tutorial/tutorial_freshgrade_url.png)
...
1. En la sección **Certificado de firma de SAML** , haga clic en el botón Copiar para copiar la **dirección URL de metadatos de federación de la aplicación** y péguela en el Bloc de notas.
    ...
    ![Configurar inicio de sesión único](./media/freshgrade-tutorial/tutorial_metadataurl.png)
     
1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/freshgrade-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de FreshGrade**, haga clic en **Configurar FreshGrade** para abrir la ventana **Configurar inicio de sesión**. Copie la **dirección URL de servicio de inicio de sesión único de SAML** de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/freshgrade-tutorial/tutorial_freshgrade_configure.png)
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/freshgrade-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/freshgrade-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/freshgrade-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/freshgrade-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **FreshGrade**.

    ![Configurar inicio de sesión único](./media/freshgrade-tutorial/tutorial_freshgrade_app.png) 
