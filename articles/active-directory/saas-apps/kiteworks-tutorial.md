...
4. En el cuadro de búsqueda, escriba **Kiteworks**, seleccione **Kiteworks** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

     ![Kiteworks en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Kiteworks.
...
2. **[Configuración del inicio de sesión único en Kiteworks](#configure-kiteworks-single-sign-on)** : para configurar los valores de inicio de sesión único en la aplicación.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Kiteworks**, seleccione **Inicio de sesión único**.
...
6. En la sección **Set up Kiteworks** (Configurar Kiteworks), copie las direcciones URL que necesite.
...
### <a name="configure-kiteworks-single-sign-on"></a>Configuración del inicio de sesión único en Kiteworks
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **Kiteworks**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Kiteworks**.

    ![Vínculo a Kiteworks en la lista de aplicaciones](common/all-applications.png)
