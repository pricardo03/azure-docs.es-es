...
* Signagelive admite inicio de sesión único iniciado por **SP**

## <a name="adding-signagelive-from-the-gallery"></a>Incorporación de Signagelive desde la galería
...
**Para agregar Signagelive desde la galería, realice los pasos siguientes:**
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Signagelive.

Para configurar y probar el inicio de sesión único de Azure AD con Signagelive, es preciso completar los siguientes bloques de creación:
...
5. **[Creación de un usuario de prueba de Signagelive](#create-signagelive-test-user)**: para tener un homólogo de Britta Simon en Signagelive que esté vinculado a la representación de ella en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con Signagelive, realice los pasos siguientes:
...
6. En la sección **Set up Signagelive** (Configurar Signagelive), copie las direcciones URL adecuadas según sus necesidades.
...
Para configurar el inicio de sesión único en **Signagelive**, es preciso enviar el **certificado (sin procesar)** descargado y las direcciones URL apropiadas copiadas de Azure Portal al [equipo de soporte técnico de Signagelive](mailto:support@signagelive.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Signagelive**.
...
En esta sección, creará un usuario llamado Britta Simon en Signagelive. Trabaje con el  [equipo de soporte técnico de Signagelive](mailto:support@signagelive.com) para agregar los usuarios en la plataforma de Signagelive. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.

### <a name="test-single-sign-on"></a>Prueba de inicio de sesión único 

En esta sección, probará la configuración de inicio de sesión único de Azure AD mediante el Panel de acceso.

Al hacer clic en el icono de Signagelive en el Panel de acceso, debería iniciar sesión automáticamente en la solución de Signagelive para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
