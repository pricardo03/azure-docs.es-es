...
4. **[Creación de un usuario de prueba de Firstbird](#create-firstbird-test-user)**: para tener un homólogo de Britta Simon en Firstbird que esté vinculado a la representación del usuario en Azure AD.
