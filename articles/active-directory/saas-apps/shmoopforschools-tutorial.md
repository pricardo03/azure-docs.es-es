...
* Suscripción a Shmoop For Schools con inicio de sesión único habilitado
...
4. En el cuadro de búsqueda, escriba **Shmoop For Schools**, seleccione **Shmoop For Schools** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![Shmoop For Schools en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Shmoop For Schools.
...
2. **[Configuración del inicio de sesión único de Shmoop For Schools](#configure-shmoop-for-schools-single-sign-on)** : para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Shmoop For Schools](#create-shmoop-for-schools-test-user)** : para tener un homólogo de Britta Simon en Shmoop For Schools que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Shmoop For Schools**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Shmoop For Schools](common/sp-identifier.png)
...
### <a name="configure-shmoop-for-schools-single-sign-on"></a>Configuración del inicio de sesión único de Shmoop For Schools
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Shmoop For Schools**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Shmoop For Schools**.

    ![Vínculo a Shmoop For Schools en la lista de aplicaciones](common/all-applications.png)
