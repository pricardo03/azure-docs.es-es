...
4. En el cuadro de búsqueda, escriba **LinkedIn Sales Navigator**, seleccione **LinkedIn Sales Navigator** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![LinkedIn Sales Navigator en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de LinkedIn Sales Navigator.
...
2. **[Configuración del inicio de sesión único en LinkedIn Sales Navigator](#configure-linkedin-sales-navigator-single-sign-on)** : para configurar el inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de LinkedIn Sales Navigator](#create-linkedin-sales-navigator-test-user)** : para tener un homólogo de Britta Simon en LinkedIn Sales Navigator que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **LinkedIn Sales Navigator**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, si desea configurar la aplicación en modo iniciado por **IDP**, realice los siguientes pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión de LinkedIn Sales Navigator](common/idp-intiated.png)
...
5. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión de LinkedIn Sales Navigator](common/metadata-upload-additional-signon.png)
...
9. En la sección **Configurar LinkedIn Sales Navigator**, copie las direcciones URL adecuadas según sus necesidades.
...
### <a name="configure-linkedin-sales-navigator-single-sign-on"></a>Configuración del inicio de sesión único en LinkedIn Sales Navigator
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y, luego, **LinkedIn Sales Navigator**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **LinkedIn Sales Navigator**.

    ![El vínculo de LinkedIn Sales Navigator en la lista de aplicaciones](common/all-applications.png)
