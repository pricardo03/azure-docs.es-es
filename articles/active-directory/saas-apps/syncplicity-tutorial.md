...
1. En el cuadro de búsqueda, escriba **Syncplicity**.

    ![Creación de un usuario de prueba de Azure AD](./media/syncplicity-tutorial/tutorial_syncplicity_search.png)

1. En el panel de resultados, seleccione **Syncplicity** y haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/syncplicity-tutorial/tutorial_syncplicity_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Syncplicity](#creating-a-syncplicity-test-user)**: para tener un homólogo de Britta Simon en Syncplicity vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/syncplicity-tutorial/tutorial_syncplicity_samlbase.png)

1. En la sección **Syncplicity Domain and URLs** (Dominio y direcciones URL de Syncplicity), lleve a cabo los pasos siguientes:
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/syncplicity-tutorial/tutorial_syncplicity_certificate.png) 

  
1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/syncplicity-tutorial/tutorial_general_400.png)

1. En la sección **Syncplicity Configuration** (Configuración de Syncplicity), haga clic en **Configure Syncplicity** (Configurar Syncplicity) para abrir la ventana **Configurar inicio de sesión**. Copie la **URL del servicio de inicio de sesión único de SAML, el identificador de entidad de SAML y la dirección URL de cierre de sesión** de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/syncplicity-tutorial/tutorial_syncplicity_configure.png) 
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/syncplicity-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/syncplicity-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/syncplicity-tutorial/create_aaduser_03.png) 
...
1. Haga clic en **admin** y seleccione **cuentas de usuario**.

1. Haga clic en **ADD A USER** (AGREGAR UN USUARIO).
   
    ![Administración de usuarios](./media/syncplicity-tutorial/ic769764.png "Administración de usuarios")

1. Escriba las **Email Address** (Direcciones de correo electrónico) de una cuenta de AAD que quiera aprovisionar, seleccione **User** (Usuario) como **Role** (Rol) y haga clic en **NEXT** (SIGUIENTE).
...
1. En la lista de aplicaciones, seleccione **Syncplicity**.
    ...
    ![Configurar inicio de sesión único](./media/syncplicity-tutorial/tutorial_syncplicity_app.png) 
