...
4. En el cuadro de búsqueda, escriba **PlanGrid**, seleccione **PlanGrid** en el panel de resultados y, a continuación, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![PlanGrid en la lista de resultados](./media/plangrid-tutorial/tutorial_plangrid_addfromgallery.png)
...
2. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/plangrid-tutorial/tutorial_plangrid_samlbase.png)
...
3. En la sección **Dominio y direcciones URL de PlanGrid**, siga los pasos a continuación si quiere configurar la aplicación en el modo que inició **IDP**:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de PlanGrid](./media/plangrid-tutorial/tutorial_plangrid_url1.png)
...
4. Active **Mostrar configuración avanzada de URL** y siga estos pasos si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de PlanGrid](./media/plangrid-tutorial/tutorial_plangrid_url2.png)
...
5. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/plangrid-tutorial/tutorial_plangrid_certificate.png) 

6. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/plangrid-tutorial/tutorial_general_400.png)
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/plangrid-tutorial/create_aaduser_01.png)

2. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/plangrid-tutorial/create_aaduser_02.png)

3. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/plangrid-tutorial/create_aaduser_03.png)
...
2. En la lista de aplicaciones, seleccione **PlanGrid**.
    ...
    ![Vínculo de PlanGrid en la lista de aplicaciones](./media/plangrid-tutorial/tutorial_plangrid_app.png)  
