...
1. En el cuadro de búsqueda, escriba **Lifesize Cloud**.

    ![Creación de un usuario de prueba de Azure AD](./media/lifesize-cloud-tutorial/tutorial_lifesize-cloud_search.png)

1. En el panel de resultados, seleccione **Lifesize Cloud** y haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/lifesize-cloud-tutorial/tutorial_lifesize-cloud_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Lifesize Cloud](#creating-a-lifesize-cloud-test-user)**: el objetivo es tener un homólogo de Britta Simon en Lifesize Cloud que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/lifesize-cloud-tutorial/tutorial_lifesize-cloud_samlbase.png)

1. En la sección **Dominio y direcciones URL de Lifesize Cloud**, lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/lifesize-cloud-tutorial/tutorial_lifesize-cloud_url.png)
...
1. Active la casilla **Mostrar configuración avanzada de URL** y realice el siguiente paso:    
    ...
    ![Configurar inicio de sesión único](./media/lifesize-cloud-tutorial/tutorial_lifesize-cloud_url1.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/lifesize-cloud-tutorial/tutorial_lifesize-cloud_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/lifesize-cloud-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Lifesize Cloud**, haga clic en **Configurar Lifesize Cloud** para abrir la ventana **Configurar inicio de sesión**. Copie los valores de **SAML Entity ID y SAML Single Sign-On Service URL** (Identificador de entidad de SAML y Dirección URL del servicio de inicio de sesión único de SAML) de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/lifesize-cloud-tutorial/tutorial_lifesize-cloud_configure.png) 
...
1. En la esquina superior derecha, haga clic en su nombre y, después, en **Configuración avanzada**.
   
    ![Configurar inicio de sesión único](./media/lifesize-cloud-tutorial/tutorial_lifesizecloud_06.png)

1. En Configuración avanzada, haga clic en el vínculo **Configuración de SSO**. Se abrirá la página de configuración de SSO de la instancia.
   
    ![Configurar inicio de sesión único](./media/lifesize-cloud-tutorial/tutorial_lifesizecloud_07.png)

1. Ahora, configure los valores siguientes en la interfaz de configuración de SSO.    
...
1. Para comprobar la configuración, puede hacer clic en el botón **Probar**.
...
1. Para habilitar SSO, seleccione el botón **Habilitar SSO**.

1. Ahora, haga clic en el botón **Actualizar** para guardar la configuración. Se generará el valor RelayState. Copie el valor de RelayState, que se genera en el cuadro de texto y péguelo en el cuadro de texto **Estado de la retransmisión** en la sección **Dominio y direcciones URL de Lifesize Cloud**. 
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/lifesize-cloud-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/lifesize-cloud-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/lifesize-cloud-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/lifesize-cloud-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **Lifesize Cloud**.
    ...
    ![Configurar inicio de sesión único](./media/lifesize-cloud-tutorial/tutorial_lifesize-cloud_app.png) 
