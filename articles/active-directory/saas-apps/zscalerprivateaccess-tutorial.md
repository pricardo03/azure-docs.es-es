...
1. **Creación de un usuario de prueba de Zscaler Private Access (ZPA)**: para tener un homólogo de Britta Simon en Zscaler Private Access (ZPA) que esté vinculado a la representación de ella en Azure AD.
