...
4. En el cuadro de búsqueda, escriba **BenefitHub**, seleccione **BenefitHub** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

     ![BenefitHub en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de BenefitHub.
...
2. **[Configuración del inicio de sesión único en BenefitHub](#configure-benefithub-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)**, para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba en BenefitHub](#create-benefithub-test-user)**: para tener un homólogo de Britta Simon en BenefitHub que esté vinculado a la representación del usuario en Azure AD.
...
Para configurar el inicio de sesión único en Azure AD con BenefitHub, siga estos pasos:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **BenefitHub**, haga clic en **Inicio de sesión único**.
...
4. En la página **Configurar inicio de sesión único con SAML** realice los siguientes pasos:
    ...
    ![Información sobre dominio y direcciones URL de inicio de sesión único de BenefitHub](common/idp-intiated.png)
...
8. En la sección **Set up BenefitHub** (Configurar BenefitHub), copie las direcciones URL adecuadas según sus necesidades.
...
### <a name="configure-benefithub-single-sign-on"></a>Configuración del inicio de sesión único en BenefitHub
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **BenefitHub**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **BenefitHub**.

    ![Vínculo de BenefitHub en la lista de aplicaciones](common/all-applications.png)
