...
1. En el cuadro de búsqueda, escriba **ChronicX®**, seleccione **ChronicX®** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
...
1. **[Creación de un usuario de prueba de ChronicX®](#create-a-chronicx®-test-user)**: para tener un homólogo de Britta Simon en ChronicX® que esté vinculado a la representación del usuario en Azure AD.
...
1. En la sección **Dominio y direcciones URL de ChronicX®**, lleve a cabo los pasos siguientes:
...
1. Para configurar el inicio de sesión único en **ChronicX®**, debe enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de ChronicX®](https://www.casebank.com/contact-us/). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En la lista de aplicaciones, seleccione **ChronicX®**.
