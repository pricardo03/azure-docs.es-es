...
1. En el cuadro de búsqueda, escriba **Mercer BenefitsCentral (MBC)**, seleccione **Mercer BenefitsCentral (MBC)** del panel de resultados y, a continuación, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Mercer BenefitsCentral (MBC) en la lista de resultados](./media/mercerhrs-tutorial/tutorial_mercerhrs_addfromgallery.png)
...
1. **[Crear un usuario de prueba de Mercer BenefitsCentral (MBC)](#create-a-mercer-benefitscentral-mbc-test-user)**: para tener un homólogo de Britta Simon en Mercer BenefitsCentral (MBC) que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/mercerhrs-tutorial/tutorial_mercerhrs_samlbase.png)

1. En la sección **Dominio y direcciones URL de Mercer BenefitsCentral (MBC)**, lleve a cabo los pasos siguientes:

    ![Información de dominio y direcciones URL de inicio de sesión único de Mercer BenefitsCentral (MBC)](./media/mercerhrs-tutorial/tutorial_mercerhrs_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/mercerhrs-tutorial/tutorial_mercerhrs_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/mercerhrs-tutorial/tutorial_general_400.png)

1. En la sección **Configuración de Mercer BenefitsCentral (MBC)**, haga clic en **Configurar Mercer BenefitsCentral (MBC)** para abrir la ventana **Configurar inicio de sesión**. Copie la **dirección URL de servicio de inicio de sesión único de SAML** de la sección **Referencia rápida**.

    ![Configuración de Mercer BenefitsCentral (MBC)](./media/mercerhrs-tutorial/tutorial_mercerhrs_configure.png) 
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/mercerhrs-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/mercerhrs-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/mercerhrs-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/mercerhrs-tutorial/create_aaduser_04.png)
...
1. En la lista de aplicaciones, seleccione **Mercer BenefitsCentral (MBC)**.

    ![Vínculo de Mercer BenefitsCentral (MBC) en la lista de aplicaciones](./media/mercerhrs-tutorial/tutorial_mercerhrs_app.png)  
