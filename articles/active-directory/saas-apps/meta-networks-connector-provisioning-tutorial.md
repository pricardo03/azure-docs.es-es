...
8.  En **Configure SCIM**  (Configurar SCIM), seleccione el nombre de la clave de API que se creó en los pasos anteriores. Haga clic en **Save**(Guardar).
