...
1. En el cuadro de búsqueda, escriba **PurelyHR**.

    ![Creación de un usuario de prueba de Azure AD](./media/purelyhr-tutorial/tutorial_purelyhr_search.png)

1. En el panel de resultados, seleccione **PurelyHR** y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/purelyhr-tutorial/tutorial_purelyhr_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de PurelyHR](#creating-a-purelyhr-test-user)**: para tener un homólogo de Britta Simon en PurelyHR que esté vinculado a la representación de Azure AD de usuario.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/purelyhr-tutorial/tutorial_purelyhr_samlbase.png)

1. En la sección **Dominio y direcciones URL de PurelyHR**, realice los siguientes pasos si quiere configurar la aplicación en el modo iniciado por **IDP**:

    ![Configurar inicio de sesión único](./media/purelyhr-tutorial/tutorial_purelyhr_url.png)
...
1. Active **Mostrar configuración avanzada de URL**, si desea volver a configurar la aplicación en modo iniciado por **SP**:
    ...
    ![Configurar inicio de sesión único](./media/purelyhr-tutorial/tutorial_purelyhr_url1.png)
    ...
    > [!NOTE]
    > Estos valores no son reales. Actualice estos valores con los valores reales de URL de respuesta y URL de inicio de sesión. Póngase en contacto con el [equipo de soporte técnico de PurelyHR](https://support.purelyhr.com/) para obtener estos valores. 

1. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.

    ![Configurar inicio de sesión único](./media/purelyhr-tutorial/tutorial_purelyhr_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/purelyhr-tutorial/tutorial_general_400.png)
    
1. En la sección **Configuración de PurelyHR**, haga clic en **Configurar PurelyHR** para abrir la ventana **Configurar inicio de sesión**. Copie **SAML Entity ID and SAML Single Sign-On Service URL** (URL del servicio de inicio de sesión único de SAML e Identificador de entidad de SAML) de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/purelyhr-tutorial/tutorial_purelyhr_configure.png) 
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/purelyhr-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/purelyhr-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/purelyhr-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/purelyhr-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **PurelyHR**.
    ...
    ![Configurar inicio de sesión único](./media/purelyhr-tutorial/tutorial_purelyhr_app.png) 
