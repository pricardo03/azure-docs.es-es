...
1. En el cuadro de búsqueda, escriba **Benefitsolver**, seleccione **Benefitsolver** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

    ![Benefitsolver en la lista de resultados](./media/benefitsolver-tutorial/tutorial_benefitsolver_addfromgallery.png)
...
1. **[Creación de un usuario de prueba en Benefitsolver](#create-a-benefitsolver-test-user)**: para tener un homólogo de Britta Simon en Benefitsolver que esté vinculado a su representación en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/benefitsolver-tutorial/tutorial_benefitsolver_samlbase.png)

1. En la sección **Dominio y direcciones URL de Benefitsolver**, lleve a cabo los pasos siguientes:

    ![Información acerca del inicio de sesión único de dominio y direcciones URL de Benefitsolver](./media/benefitsolver-tutorial/tutorial_benefitsolver_url.png)
...
1. La aplicación Benefitsolver espera las aserciones de SAML en un formato específico, que requiere que se agreguen asignaciones de atributos personalizados a la configuración de los **atributos del token de SAML** .

    ![Sección del atributo Benefitsolver](./media/benefitsolver-tutorial/tutorial_attribute.png)
...
1. En la sección **Atributos de usuario** del cuadro de diálogo **Inicio de sesión único**, configure el atributo token de SAML como muestra la imagen y siga estos pasos:
    ...
    ![Sección del atributo Benefitsolver](./media/benefitsolver-tutorial/tutorial_attribute_04.png)
    
    ![Sección del atributo Benefitsolver](./media/benefitsolver-tutorial/tutorial_attribute_05.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/benefitsolver-tutorial/tutorial_benefitsolver_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/benefitsolver-tutorial/tutorial_general_400.png)

1. Para configurar el inicio de sesión único en el lado de **Benefitsolver**, es preciso enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de Benefitsolver](https://www.businessolver.com/contact).
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/benefitsolver-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/benefitsolver-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/benefitsolver-tutorial/create_aaduser_03.png)

1. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/benefitsolver-tutorial/create_aaduser_04.png)
...
1. En la lista de aplicaciones, seleccione **Benefitsolver**.
    ...
    ![Vínculo a Benefitsolver en la lista de aplicaciones](./media/benefitsolver-tutorial/tutorial_benefitsolver_app.png)  
