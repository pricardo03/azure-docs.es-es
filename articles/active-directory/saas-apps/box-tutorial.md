...
* Box admite el [**aprovisionamiento automatizado** de usuarios](https://docs.microsoft.com/azure/active-directory/saas-apps/box-userprovisioning-tutorial)
