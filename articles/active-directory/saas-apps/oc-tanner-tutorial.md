...
* Puede controlar en Azure AD quién tiene acceso a O.C. Tanner - AppreciateHub.
* Puede permitir que los usuarios inicien sesión automáticamente en O.C. Tanner - AppreciateHub (inicio de sesión único) con sus cuentas de Azure AD.
...
* O.C. Una suscripción habilitada para el inicio de sesión único en Tanner - AppreciateHub
...
4. En el cuadro de búsqueda, escriba **O.C. Tanner - AppreciateHub**, seleccione  **O.C. Tanner - AppreciateHub** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

     ![O.C. Tanner - AppreciateHub en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de O.C. Tanner - AppreciateHub.
...
2. **[Configuración de O.C. Configuración del inicio de sesión único de Tanner - AppreciateHub](#configure-oc-tanner---appreciatehub-single-sign-on)**: para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)**, para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de O.C. Tanner - AppreciateHub](#create-oc-tanner---appreciatehub-test-user)**: para tener un homólogo de Britta Simon en O.C. Tanner - AppreciateHub que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **O.C Tanner - AppreciateHub**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, si tiene el **archivo de metadatos del proveedor de servicios**, lleve a cabo los siguientes pasos:
    ...
    >[!NOTE]
    >Puede descargar el **archivo de metadatos del proveedor de servicios** desde [aquí](https://fed.appreciatehub.com/fed/sp/metadata).
    ...
    c. Una vez que se haya cargado correctamente el archivo de metadatos, el valor de **Identificador** y **URL de respuesta** se rellena automáticamente en la sección Configuración básica de SAML.
     ...
     ![O.C. Tanner - AppreciateHub: Información de dominio y direcciones URL de inicio de sesión único](common/idp-intiated.png)

    > [!Note]
    > Si los valores **Identificador** y **URL de respuesta** no se rellenan automáticamente, hágalo manualmente según sus necesidades. Póngase en contacto con el [equipo de soporte técnico del cliente O.C. Tanner - AppreciateHub](mailto:sso@octanner.com) para obtener estos valores. También puede hacer referencia a los patrones que se muestran en la sección **Configuración básica de SAML** de Azure Portal.

5. En la página **Configurar el inicio de sesión único con SAML**, en la sección **Certificado de firma de SAML**, haga clic en **Descargar** para descargar el **XML de metadatos de federación** de las opciones proporcionadas según sus requisitos y guárdelo en el equipo.

    ![Vínculo de descarga del certificado](common/metadataxml.png)

6. En la sección **Set up O.C. Tanner - AppreciateHub** (Configurar O.C. Tanner - AppreciateHub), copie las direcciones URL adecuadas según sus necesidades.
...
### <a name="configure-oc-tanner---appreciatehub-single-sign-on"></a>Configuración del inicio de sesión único de O.C. Tanner - AppreciateHub
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **O.C. Tanner - AppreciateHub**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **O.C. Tanner - AppreciateHub**.

    ![Vínculo de O.C. Tanner - AppreciateHub en la lista de aplicaciones](common/all-applications.png)
