...
1. En el cuadro de búsqueda, escriba **OnTrack**, seleccione **OnTrack** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![OnTrack en la lista de resultados](./media/ontrack-tutorial/tutorial_ontrack_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de OnTrack](#create-an-ontrack-test-user)**: para tener un homólogo de Britta Simon en OnTrack que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/ontrack-tutorial/tutorial_ontrack_samlbase.png)

1. En la sección **Dominio y direcciones URL de OnTrack**, lleve a cabo los pasos siguientes:
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/ontrack-tutorial/tutorial_ontrack_certificate.png)
...
1. La aplicación OnTrack espera las aserciones de SAML en un formato específico, que requiere que se agreguen asignaciones de atributos personalizados a la configuración de los atributos del token de SAML. Configure las siguientes notificaciones para esta aplicación. Puede administrar los valores de estos atributos en la sección "**Atributos de usuario**" de la página de integración de aplicaciones. 
    ...
    ![Configurar inicio de sesión único](./media/ontrack-tutorial/tutorial_attribute.png)
...
1. En la sección **Atributos de usuario** del cuadro de diálogo **Inicio de sesión único**, configure el atributo del token de SAML como muestra la imagen anterior y realice los siguientes pasos:
    ...
    ![Configurar inicio de sesión único](./media/ontrack-tutorial/tutorial_attribute_05.png)
...
1. Haga clic en el botón **Guardar** .
    ...
    ![Botón Configurar inicio de sesión único](./media/ontrack-tutorial/tutorial_general_400.png)
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/ontrack-tutorial/create_aaduser_01.png)

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/ontrack-tutorial/create_aaduser_02.png)

1. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/ontrack-tutorial/create_aaduser_03.png)
...
1. En la lista de aplicaciones, seleccione **OnTrack**.

    ![Vínculo a OnTrack en la lista de aplicaciones](./media/ontrack-tutorial/tutorial_ontrack_app.png)  
