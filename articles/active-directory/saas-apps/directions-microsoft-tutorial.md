...
1. En el cuadro de búsqueda, escriba **Directions on Microsoft**.

    ![Creación de un usuario de prueba de Azure AD](./media/directions-microsoft-tutorial/tutorial_directionsonmicrosoft_search.png)

1. En el panel de resultados, seleccione **Directions on Microsoft**y luego haga clic en el botón **Agregar** para agregar la aplicación.

    ![Creación de un usuario de prueba de Azure AD](./media/directions-microsoft-tutorial/tutorial_directionsonmicrosoft_addfromgallery.png)
...
1. **[Creación de un usuario de prueba de Directions on Microsoft](#creating-a-directions-on-microsoft-test-user)**: para tener un homólogo de Britta Simon en Directions on Microsoft que esté vinculado a la representación del usuario en Azure AD.
...
1. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Configurar inicio de sesión único](./media/directions-microsoft-tutorial/tutorial_directionsonmicrosoft_samlbase.png)

1. En la sección **Dominio y direcciones URL de Directions on Microsoft**, lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/directions-microsoft-tutorial/tutorial_directionsonmicrosoft_url.png)
...
1. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Configurar inicio de sesión único](./media/directions-microsoft-tutorial/tutorial_directionsonmicrosoft_certificate.png) 

1. Haga clic en el botón **Guardar** .

    ![Configurar inicio de sesión único](./media/directions-microsoft-tutorial/tutorial_general_400.png)
...
1. En el panel de navegación izquierdo de **Azure Portal**, haga clic en el icono de **Azure Active Directory**.
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/directions-microsoft-tutorial/create_aaduser_01.png) 

1. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y haga clic en **Todos los usuarios**.
    
    ![Creación de un usuario de prueba de Azure AD](./media/directions-microsoft-tutorial/create_aaduser_02.png) 

1. Para abrir el cuadro de diálogo **Usuario**, haga clic en **Agregar** en la parte superior del cuadro de diálogo.
 
    ![Creación de un usuario de prueba de Azure AD](./media/directions-microsoft-tutorial/create_aaduser_03.png) 

1. En la página de diálogo **Usuario**, realice los siguientes pasos:
 
    ![Creación de un usuario de prueba de Azure AD](./media/directions-microsoft-tutorial/create_aaduser_04.png) 
...
1. En la lista de aplicaciones, seleccione **Directions on Microsoft**.

    ![Configurar inicio de sesión único](./media/directions-microsoft-tutorial/tutorial_directionsonmicrosoft_app.png) 
