---
title: Interpretación del esquema de registros de inicio de sesión de Azure Active Directory en Azure Monitor (versión preliminar) | Microsoft Docs
...
ms.locfileid: "39240582"
---
# <a name="interpret-the-azure-active-directory-sign-in-logs-schema-in-azure-monitor-preview"></a>Interpretación del esquema de registros de inicio de sesión de Azure Active Directory en Azure Monitor (versión preliminar)

En este artículo se describe el esquema de registros de inicio de sesión de Azure AD en Azure Monitor. La mayoría de la información relacionada con los inicios de sesión se proporciona en el atributo *Propiedades* del objeto de registros.
...
| Categoría | Para inicios de sesión, siempre es *SignIn*. | 
...
| Properties (Propiedades) | Enumera todas las propiedades asociadas con los inicios de sesión. Para más información, lea la [referencia de Graph API de MS](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/resources/signin). Este esquema usa los nombres de atributo como se muestra en el recurso de inicio de sesión, para fines de legibilidad.
