...
- La [configuración de la directiva de acceso condicional](conditional-access/app-based-mfa.md).

- La [migración de directivas de acceso condicional](conditional-access/best-practices.md#policy-migration).
