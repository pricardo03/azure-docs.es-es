...
* [Assigning licenses to a group in Azure Active Directory](licensing-groups-assign.md) (Asignación de licencias a un grupo en Azure Active Directory)
