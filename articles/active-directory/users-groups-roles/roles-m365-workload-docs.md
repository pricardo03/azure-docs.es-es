...
Protección contra amenazas avanzada de Azure | [Grupos de roles de ATP de Azure](https://docs.microsoft.com/azure-advanced-threat-protection/atp-role-groups) | No disponible
