---
title: 'Migración de usuarios a licencias de productos con grupos: Azure Active Directory | Microsoft Docs'
description: Describe el proceso recomendado para migrar usuarios de un grupo a distintas licencias de productos (Office 365 Enterprise E1 y E3) mediante licencias basadas en grupos.
...
ms.locfileid: "58201371"
---
# <a name="change-the-license-for-a-single-user-in-a-licensed-group-in-azure-active-directory"></a>Cambiar la licencia para un solo usuario en un grupo con licencia en Azure Active Directory
...
![Usuario con licencia de origen heredada de un grupo](./media/licensing-groups-change-licenses/UserWithSourceLicenseInherited.png)
...
![Usuario con la licencia de origen y de destino heredadas de grupos](./media/licensing-groups-change-licenses/UserWithBothSourceAndTargetLicense.png)
...
![Usuario con licencia de destino heredada del grupo](./media/licensing-groups-change-licenses/UserWithTargetLicenseAssigned.png)
...
![Usuario con licencia de origen heredada de un grupo](./media/licensing-groups-change-licenses/UserWithSourceLicenseInheritedConflictScenario.png)
...
![Usuario con una licencia de origen heredada del grupo y la licencia de destino en estado de error](./media/licensing-groups-change-licenses/UserWithSourceLicenseAndTargetLicenseInConflict.png)
...
![Usuario con licencia de destino heredada del grupo](./media/licensing-groups-change-licenses/UserWithTargetLicenseAssignedConflictScenario.png)
