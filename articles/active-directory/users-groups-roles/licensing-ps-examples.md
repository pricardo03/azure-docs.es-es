...
```
> [!NOTE]
> Actualice los valores de las variables `$skuId` y `$groupId`  que va dirigido para la eliminación de licencias directas según el entorno de prueba antes de ejecutar el script anterior. 
