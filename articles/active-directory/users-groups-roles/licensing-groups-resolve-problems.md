...
![Falta el requisito previo del grupo.](./media/licensing-groups-resolve-problems/group-prerequisite-required.png)
...
![El requisito previo del grupo está incluido.](./media/licensing-groups-resolve-problems/group-addon-with-prerequisite.png)
