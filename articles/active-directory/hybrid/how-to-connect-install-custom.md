...
![Componentes necesarios](./media/how-to-connect-install-custom/requiredcomponents.png)
...
Para más información, consulte [Modo provisional](how-to-connect-sync-operations.md#staging-mode).
