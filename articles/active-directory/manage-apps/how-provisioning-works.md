...
*   El usuario ya no cumple con un filtro de alcance y sale del alcance
    * De manera predeterminada, el servicio de aprovisionamiento de Azure AD elimina o deshabilita los usuarios que quedan fuera del alcance. Si desea anular este comportamiento predeterminado, puede establecer una marca para [omitir las eliminaciones fuera del alcance](skip-out-of-scope-deletions.md).
...
[Compilación de un punto de conexión de SCIM y configuración del aprovisionamiento cuando crea su propia aplicación](use-scim-to-provision-users-and-groups.md)
