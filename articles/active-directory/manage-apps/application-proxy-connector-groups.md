---
title: Publicación de aplicaciones en redes independientes con los grupos de conectores de proxy de una aplicación de Azure AD | Microsoft Docs
