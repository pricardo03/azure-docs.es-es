...
3. Siga las instrucciones de la sección anterior [Generación automática de certificado para aplicaciones de la galería y ajenas a la misma](#auto-generated-certificate-for-gallery-and-non-gallery-applications). Mediante este paso se descarga el certificado en el formato de codificación que se requiere para la carga de la aplicación.
...
4. Antes de que expire el certificado antiguo, siga las instrucciones de la sección anterior [Cargar y activar un certificado](#upload-and-activate-a-certificate).
