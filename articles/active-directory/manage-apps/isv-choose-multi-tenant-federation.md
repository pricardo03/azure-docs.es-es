---
title: Elección del protocolo de federación correcto para una aplicación multiinquilino
...
Web Services Federation (WSFed) es un [estándar de la industria](http://docs.oasis-open.org/wsfed/federation/v1.2/ws-federation.html) que normalmente se usa para las aplicaciones web que se desarrollan mediante la plataforma. NET.
