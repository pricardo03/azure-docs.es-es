...
-   Utilice una herramienta como [Fiddler](https://www.telerik.com/fiddler) para capturar la solicitud SAML, la respuesta de SAML y el token de SAML.
