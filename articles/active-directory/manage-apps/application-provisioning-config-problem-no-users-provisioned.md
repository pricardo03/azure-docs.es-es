...
[Azure AD Connect Sync: conocimiento del aprovisionamiento declarativo](../connect/active-directory-aadconnectsync-understanding-declarative-provisioning.md)
