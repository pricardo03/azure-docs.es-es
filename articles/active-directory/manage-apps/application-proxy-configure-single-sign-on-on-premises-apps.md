---
title: Inicio de sesión único de SAML en aplicaciones locales mediante el proxy de aplicación de Azure AD | Microsoft Docs
...
2. En **Agregar aplicación propia**, seleccione **Aplicación situada fuera de la galería**.
