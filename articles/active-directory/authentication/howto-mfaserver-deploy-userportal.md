...
> [!NOTE]
> El portal de usuarios solo está disponible con el Servidor Multi-Factor Authentication. Si utiliza Multi-Factor Authentication en la nube, remita a sus usuarios a [Configuración de mi cuenta para la verificación en dos pasos](end-user/current/multi-factor-authentication-end-user-first-time.md) o [Administración de la configuración de la verificación en dos pasos](end-user/current/multi-factor-authentication-end-user-manage-settings.md).
