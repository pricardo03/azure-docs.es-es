---
title: 'Administración de la configuración de verificación en dos pasos: Azure AD | Microsoft Docs'
...
Cuando desinstala la aplicación del dispositivo o restablece el dispositivo, no se quita la activación en el back-end. Para más información, vea [Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md).
...
* Configure las [contraseñas de aplicación](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-app-passwords.md) para las aplicaciones que no admitan la verificación en dos pasos.
