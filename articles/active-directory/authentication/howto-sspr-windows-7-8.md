---
title: 'Autoservicio de restablecimiento de contraseña de Azure AD para Windows 7 y 8.1: Azure Active Directory'
...
![Ejemplo de Windows 7 después de hacer clic en "¿Olvidó la contraseña?" Flujo de SSPR](media/howto-sspr-windows-7-8/windows-7-sspr.png)
...
Si más de un proveedor de credenciales de terceros está habilitado en su máquina, los usuarios verán más de un perfil de usuario en la pantalla de inicio de sesión.
...
![Ejemplo de restablecimiento de contraseña de Windows 7 en el registro de auditoría de Azure AD](media/howto-sspr-windows-7-8/windows-7-sspr-azure-ad-audit-log.png)
