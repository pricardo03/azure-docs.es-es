...
Si los usuarios [tienen problemas con la verificación en dos pasos](end-user/current/multi-factor-authentication-end-user-troubleshoot.md), ayúdelos a autodiagnosticar problemas. 
