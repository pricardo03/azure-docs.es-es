---
title: Configurar inicio de sesión sin contraseña de Azure Active Directory (versión preliminar)
description: Habilite el inicio de sesión sin contraseña en Azure AD con las claves de seguridad FIDO2 o la aplicación Microsoft Authenticator (versión preliminar)
...
ms.locfileid: "67711965"
---
# <a name="enable-passwordless-sign-in-for-azure-ad-preview"></a>Habilitar el inicio de sesión sin contraseña para Azure AD (versión preliminar)
...
![Creación de directiva de configuración de dispositivos personalizada de Intune](./media/howto-authentication-passwordless-enable/intune-custom-profile.png)
...
Las características de registro de las claves de seguridad FIDO2 se basan en la versión preliminar de registro combinado. Siga los pasos siguientes para habilitar la versión preliminar de registro combinado.

1. Inicie sesión en el [Portal de Azure](https://portal.azure.com)
1. Vaya a **Azure Active Directory** > **Configuración de usuario**.
   1. Haga clic en **Administrar la configuración de las características en versión preliminar del panel de acceso**.
   1. En **Mejoras para los usuarios a la hora de utilizar las características en versión preliminar para registrar y administrar la información de seguridad**.
      1. Seleccione **Seleccionado** y luego un grupo de usuarios que vaya a participar en la versión preliminar.
      1. O bien seleccione **Todos** para habilitar para todos los del directorio.
1. Haga clic en **Guardar**

### <a name="enable-new-passwordless-authentication-methods"></a>Habilitar nuevos métodos de autenticación sin contraseña
...
## <a name="sign-in-with-passwordless-credentials"></a>Iniciar sesión con credenciales sin contraseña
...
![Inicio de sesión de clave de seguridad en la pantalla de bloqueo de Windows 10](./media/howto-authentication-passwordless-enable/fido2-windows-10-1903-sign-in-lock-screen.png)
...
![Inicio de sesión de clave de seguridad en Microsoft Edge](./media/howto-authentication-passwordless-enable/fido2-windows-10-1903-edge-sign-in.png)

Para obtener información sobre el inicio de sesión mediante la aplicación Microsoft Authenticator, vea el artículo [Inicio de sesión en sus cuentas mediante la aplicación Microsoft Authenticator](../user-help/user-help-auth-app-sign-in.md).
...
### <a name="authenticator-app"></a>Aplicación de autenticación
