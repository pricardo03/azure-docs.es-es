...
* Un servidor existente configurado que ejecute una versión actual de [Azure AD Connect](../connect/active-directory-aadconnect-get-started-express.md).
