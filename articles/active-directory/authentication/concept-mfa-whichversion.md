---
title: ¿Servidor o servicio MFA de Azure, en el entorno local o en la nube? - Azure Active Directory
...
| Acceso remoto como VPN, RDG mediante la extensión de NPS o un servidor existente de NPS | ● | ● |
...
[![Opción para Azure MFA en la nube](./media/concept-mfa-whichversion/cloud2.png)](howto-mfa-getstarted.md) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; [ ![Elección  para servidor Azure MFA local  ](./media/concept-mfa-whichversion/server2.png)](howto-mfaserver-deploy.md) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </center>
