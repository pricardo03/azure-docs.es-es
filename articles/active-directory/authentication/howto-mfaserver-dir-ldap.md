---
title: 'Autenticación LDAP y Azure MFA Server: Azure Active Directory'
...
2. Active la casilla **Habilitar autenticación LDAP**.
   ...
   ![Autenticación LDAP en el servidor MFA](./media/howto-mfaserver-dir-ldap/ldap2.png)
