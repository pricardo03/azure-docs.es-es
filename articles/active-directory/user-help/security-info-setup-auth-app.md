...
Para descargar la aplicación Microsoft Authenticator y obtener más información sobre ella, vea [Introducción a la aplicación Microsoft Authenticator](user-help-auth-app-download-install.md).
