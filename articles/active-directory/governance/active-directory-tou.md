...
description: Describe cómo empezar a usar los Términos de uso de Azure AD para presentar información a empleados o invitados antes de obtener acceso.
...
1. Si desea hacer expirar autorizaciones de términos de uso en una programación, establezca **Expirar autorizaciones** en **Activado**. Al establecerse en Activado, se muestran dos opciones de configuración de la programación adicionales.
    ...
    ![Expirar autorizaciones](./media/active-directory-tou/expire-consents.png)
...
1. En **Acceso condicional**, use la lista **Exigir con plantillas de directiva de acceso condicional** para seleccionar la plantilla para exigir los Términos de uso.
    ...
    ![Plantillas de acceso condicional](./media/active-directory-tou/conditional-access-templates.png)
...
1. Haga clic en **Create**(Crear).
    ...
    ![Directiva personalizada](./media/active-directory-tou/custom-policy.png)
...
1. Inicie sesión en Azure y vaya a **Términos de uso** en [https://aka.ms/catou](https://aka.ms/catou).
    ...
    ![Hoja Términos de uso](./media/active-directory-tou/view-tou.png)
...
1. Haga clic en **Ver registros de auditoría**.
    ...
    ![Hoja Términos de uso](./media/active-directory-tou/audit-tou.png)
...
1. En la pantalla de registros de auditoría de Azure AD, puede filtrar la información mediante las listas proporcionadas para seleccionar información de registro de auditoría específica.
    ...
    ![Registros de auditoría](./media/active-directory-tou/audit-logs-tou.png)

    Si hace clic en un registro, aparecerá un panel con detalles de actividad adicionales.

    ![Detalles de actividad](./media/active-directory-tou/audit-log-activity-details.png)
...
1. En el panel de edición de términos de uso, cambie el nombre, muestre el nombre o solicite a los usuarios que expandan los valores.
    ...
    ![Edición de términos de uso](./media/active-directory-tou/edit-tou.png)
...
![Windows 10 y Microsoft Edge: mensaje de conexión a dispositivos](./media/active-directory-tou/per-device-win10-edge.png)
...
![Explorador no compatible](./media/active-directory-tou/per-device-browser-unsupported.png)
...
1. En el mensaje que le pregunta si desea continuar, haga clic en **Sí**.
    ...
    ![Eliminar los términos de uso](./media/active-directory-tou/delete-tou.png)
...
![Aplicación en la nube de Azure Information Protection](./media/active-directory-tou/cloud-app-info-protection.png)
...
![Aplicación en la nube de Microsoft Intune](./media/active-directory-tou/cloud-app-intune.png)
...
- [Guía de inicio rápido: Solicitar la aceptación de los términos de uso antes de acceder a aplicaciones en la nube](../conditional-access/require-tou.md)
