...
![Directiva de riesgo de inicio de sesión](./media/overview/1014.png "Directiva de riesgo de inicio de sesión")
...
* Configurar los usuarios y grupos a los que se aplica la directiva:
    ...
    ![Directiva de riesgo de inicio de sesión](./media/overview/1015.png "Directiva de riesgo de inicio de sesión")
* Establecer el umbral de nivel de riesgo del inicio de sesión (bajo, medio o alto) que desencadena la directiva:

    ![Directiva de riesgo de inicio de sesión](./media/overview/1016.png "Directiva de riesgo de inicio de sesión")
* Establecer los controles que se aplicará cuando se desencadene la directiva:  

    ![Directiva de riesgo de inicio de sesión](./media/overview/1017.png "Directiva de riesgo de inicio de sesión")
* Cambiar el estado de la directiva:

    ![Registro MFA](./media/overview/403.png "Registro MFA")
* Revisar y evaluar el impacto de un cambio antes de activarlo:

    ![Directiva de riesgo de inicio de sesión](./media/overview/1018.png "Directiva de riesgo de inicio de sesión")
...
- En la hoja **Azure AD Identity Protection**, en la sección **Configurar**, haga clic en **Directiva de riesgo de inicio de sesión**.
    ...
    ![Directiva de riesgo de usuario](./media/overview/1014.png "Directiva de riesgo de usuario")



## <a name="users-flagged-for-risk"></a>Usuarios marcados con riesgo

Todos los [eventos de riesgo](../reports-monitoring/concept-risk-events.md) activos que detectó Azure Active Directory para un usuario contribuyen a la creación de un concepto lógico que se denomina riesgo de usuario. Un usuario marcado como en peligro es un indicador de una cuenta de usuario que puede haber estado en peligro.

![Usuarios marcados con riesgo](./media/overview/1200.png)
...
![Riesgos de usuario](./media/overview/1031.png "Riesgos de usuario")
...
![Acciones](./media/overview/34.png "Acciones")
...
1. En la hoja **Azure AD Identity Protection**, en **Investigar**, haga clic en **Eventos de riesgo**.
    ...
    ![Restablecimiento manual de la contraseña](./media/overview/1002.png "Restablecimiento manual de la contraseña")
2. En la lista de **eventos de riesgo** , haga clic en uno de ellos.

    ![Restablecimiento manual de la contraseña](./media/overview/1003.png "Restablecimiento manual de la contraseña")
3. En la hoja del riesgo, haga clic con el botón derecho en un usuario.

    ![Restablecimiento manual de la contraseña](./media/overview/1004.png "Restablecimiento manual de la contraseña")
...
![Acciones](./media/overview/2222.png "Acciones")
...
![Directiva](./media/overview/1005.png "Directiva")

**Para abrir el cuadro de diálogo de configuración relacionado, siga estos pasos**:

1. En la hoja **Azure AD Identity Protection**, haga clic en **Usuarios marcados en riesgo**.

    ![Restablecimiento manual de la contraseña](./media/overview/1006.png "Restablecimiento manual de la contraseña")
2. En la lista de usuarios, seleccione un usuario que tenga al menos un evento de riesgo.

    ![Restablecimiento manual de la contraseña](./media/overview/1007.png "Restablecimiento manual de la contraseña")
3. En la hoja del usuario, haga clic en **Reset password**(Restablecer contraseña).

    ![Restablecimiento manual de la contraseña](./media/overview/1008.png "Restablecimiento manual de la contraseña")
...
![Directiva de riesgo de usuario](./media/overview/1009.png "Directiva de riesgo de usuario")
...
* Configurar los usuarios y grupos a los que se aplica la directiva:
    ...
    ![Directiva de riesgo de usuario](./media/overview/1010.png "Directiva de riesgo de usuario")
* Establecer el umbral de nivel de riesgo del usuario (bajo, medio o alto) que desencadena la directiva:

    ![Directiva de riesgo de usuario](./media/overview/1011.png "Directiva de riesgo de usuario")
* Establecer los controles que se aplicará cuando se desencadene la directiva:

    ![Directiva de riesgo de usuario](./media/overview/1012.png "Directiva de riesgo de usuario")
* Cambiar el estado de la directiva:

    ![Directiva de riesgo de usuario](./media/overview/403.png "Registro MFA")
* Revisar y evaluar el impacto de un cambio antes de activarlo:

    ![Directiva de riesgo de usuario](./media/overview/1013.png "Directiva de riesgo de usuario")
...
![Directiva de riesgo de usuario](./media/overview/1019.png "Directiva de riesgo de usuario")
...
* Configurar los usuarios y grupos a los que se aplica la directiva:
    ...
    ![Directiva de MFA](./media/overview/1020.png "Directiva de MFA")
* Establecer los controles que se aplicará cuando se desencadene la directiva:  

    ![Directiva de MFA](./media/overview/1021.png "Directiva de MFA")
* Cambiar el estado de la directiva:

    ![Directiva de MFA](./media/overview/403.png "Directiva de MFA")
* Ver el estado actual del registro:

    ![Directiva de MFA](./media/overview/1022.png "Directiva de MFA")
...
- En la hoja **Azure AD Identity Protection**, en la sección **Configurar**, haga clic en **Registro para autenticación multifactor**.
    ...
    ![Directiva de MFA](./media/overview/1019.png "Directiva de MFA")
...
* [Vulnerabilities detected by Azure Active Directory Identity Protection (Vulnerabilidades detectadas por Azure Active Directory Identity Protection)](vulnerabilities.md)

* [Eventos de riesgo de Azure Active Directory](../active-directory-identity-protection-risk-events.md)

* [Azure Active Directory Identity Protection notifications (Notificaciones de Azure Active Directory Identity Protection)](notifications.md)

* [Azure Active Directory Identity Protection playbook (Guía de Azure Active Directory Identity Protection)](playbook.md)

* [Azure Active Directory Identity Protection glossary (Glosario de Azure Active Directory Identity Protection)](glossary.md)

* [Experiencias de inicio de sesión con Azure AD Identity Protection](flows.md)

* [Azure Active Directory Identity Protection: desbloqueo de usuarios](howto-unblock-user.md)

* [Introducción a Azure Active Directory Identity Protection y Microsoft Graph](graph-get-started.md)
