...
Para ver información detallada sobre cada uno de estos pasos, consulte nuestra [documentación sobre el inicio de sesión único con encabezados](manage-apps/application-proxy-configure-single-sign-on-with-ping-access.md).
