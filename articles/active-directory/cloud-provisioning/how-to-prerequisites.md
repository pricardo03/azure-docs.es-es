...
En este tema se proporcionan instrucciones sobre cómo elegir y usar el aprovisionamiento en la nube de Azure AD Connect como solución de identidad.
...
2. Si hay un firewall entre los servidores y Azure AD, configure los elementos siguientes:
   - Asegúrese de que los agentes pueden realizar solicitudes *de salida* a Azure AD a través de los puertos siguientes:
     ...
     | **8080** (opcional) | Si el puerto 443 no está disponible, los agentes notifican su estado cada 10 minutos a través del puerto 8080. Este estado se muestra en el portal de Azure AD. |
...
El servidor de Windows que hospedará el agente de aprovisionamiento en la nube de Azure AD Connect debe tener TLS 1.2 habilitado antes de instalarlo.
