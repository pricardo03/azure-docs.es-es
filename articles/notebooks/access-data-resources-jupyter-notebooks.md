...
- [Compilación de una aplicación de Flask con Azure Cosmos DB para la API de MongoDB](https://docs.microsoft.com/azure/cosmos-db/create-mongodb-flask)
