...
Deberá implementar un agente en un equipo dedicado de Linux (máquina virtual o local) para admitir la comunicación entre el dispositivo y Azure Sentinel. Puede implementar al agente de forma automática o manual. Implementación automática se basa en plantillas de Resource Manager y se puede usar solo si su máquina Linux dedicada es una nueva máquina virtual se crea en Azure.
...
En este documento, ha aprendido cómo conectar dispositivos CEF a Centinela de Azure. Para obtener más información acerca de Centinela de Azure, consulte los artículos siguientes:
