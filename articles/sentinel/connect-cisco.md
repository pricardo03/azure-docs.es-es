...
Para conectar su dispositivo de Cisco ASA a Azure Sentinel, debe implementar un agente en una máquina dedicada (máquina virtual o local) para admitir la comunicación entre el dispositivo y Azure Sentinel. 
...
### <a name="deploy-the-agent-on-your-machine"></a>Implementación del agente en la máquina

1. En el portal de Azure Sentinel, haga clic en **Data connectors** (Conectores de datos) y seleccione **Cisco ASA** y, luego, **Open connector page** (Abrir página de conectores). 
