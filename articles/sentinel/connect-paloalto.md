---
title: Conexión de datos de Palo Alto Networks a la versión preliminar de Azure Sentinel | Microsoft Docs
...
6. Para usar el esquema correspondiente en Log Analytics para encontrar eventos de Palo Alto Networks, busque **CommonSecurityLog**.
