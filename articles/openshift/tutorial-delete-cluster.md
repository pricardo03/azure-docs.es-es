...
Más información sobre cómo usar OpenShift con la [documentación oficial de Red Hat OpenShift](https://access.redhat.com/documentation/openshift_dedicated/3/)