...
ms.locfileid: "61466755"
---
# <a name="transforms-and-jobs"></a>Transformaciones y trabajos

En este tema se proporciona detalles sobre [transforma](https://docs.microsoft.com/rest/api/media/transforms) y [trabajos](https://docs.microsoft.com/rest/api/media/jobs) y explica la relación entre estas entidades. En el siguiente diagrama se muestra el flujo de trabajo de transformaciones y trabajos.
