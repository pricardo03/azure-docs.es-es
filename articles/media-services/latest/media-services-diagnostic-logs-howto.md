...
description: En este artículo se muestra cómo enrutar y ver los registros de diagnóstico mediante Azure Monitor.
...
* [Registros de diagnóstico de Azure Monitor](../../azure-monitor/platform/diagnostic-logs-overview.md)
