...
Actualmente, Azure Media Services no definido concreta roles personalizados para el servicio. Los clientes pueden usar las funciones integradas de **propietario** o **colaborador** para obtener acceso total a una cuenta de Media Services. Es la diferencia principal entre estos roles: el **propietario** puede controlar quién tiene acceso a un recurso y el **colaborador** no. La cuenta de lector integrado solo tiene acceso de lectura a la cuenta de Media Services. 
...
- [Roles de administrador de suscripciones clásico de RBAC de Azure y de administrador de Azure AD](https://docs.microsoft.com/azure/role-based-access-control/rbac-and-directory-admin-roles)
