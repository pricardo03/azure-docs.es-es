...
ms.locfileid: "55977090"
---
# <a name="manage-streaming-endpoints-with-net-sdk-legacy"></a>Administración de los puntos de conexión de streaming con el SDK de .NET (heredado)
