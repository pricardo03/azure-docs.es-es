...
ms.locfileid: "55984229"
---
# <a name="upload-files-into-a-media-services-account-using-net-legacy"></a>Carga de archivos en una cuenta de Media Services mediante .NET (heredado)
