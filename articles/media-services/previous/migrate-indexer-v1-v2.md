...
* Los archivos de subtítulos en formato SAMI ya no se admitirán. Se trata de un formato de subtítulos que ya no se usa de forma generalizada. Se reemplaza por TTML, WebVTT y SRT.  
