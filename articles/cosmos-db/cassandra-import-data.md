...
## <a name="migrate-data-by-using-cqlsh-copy"></a>Migración de datos mediante cqlsh COPY
...
### <a name="steps-to-move-data-with-cqlsh"></a>Pasos para mover datos con cqlsh
