---
title: 'Script de Azure PowerShell: creación de una cuenta de API de Gremlin para Azure Cosmos DB | Microsoft Docs'
...
ms.locfileid: "41920309"
---
# <a name="azure-cosmos-db-create-a-gremlin-api-account-using-powershell"></a>Azure Cosmos DB: creación de una cuenta de API de Gremlin mediante PowerShell
