...
| [az cosmosdb cassandra keyspace throughput update](/cli/azure/cosmosdb/cassandra/keyspace/throughputaz-cosmosdb-cassandra-keyspace-throughput-update) | Actualiza la capacidad de proceso (RU/s) de un espacio de claves de Cassandra para Azure Cosmos. |
