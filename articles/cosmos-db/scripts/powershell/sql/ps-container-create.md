---
title: 'Azure PowerShell script: crear un contenedor en una cuenta de Azure Cosmos'
description: 'Script de PowerShell de Azure de ejemplo: creación de un contenedor en una cuenta de Azure Cosmos'
author: markjbrown
...
ms.locfileid: "65078241"
---
# <a name="create-a-container-in-an-azure-cosmos-account-using-powershell"></a>Crear un contenedor en una cuenta de Azure Cosmos mediante PowerShell
