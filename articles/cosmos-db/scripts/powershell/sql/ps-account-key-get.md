---
title: 'Script de PowerShell de Azure: obtención de claves para una cuenta de Azure Cosmos'
description: 'Ejemplo de script de Azure PowerShell: obtención de claves para una cuenta de Azure Cosmos'
author: markjbrown
...
ms.locfileid: "65078406"
---
# <a name="get-keys-for-an-azure-cosmos-account-using-powershell"></a>Obtener claves de una cuenta de Azure Cosmos mediante PowerShell
