---
title: 'Script de PowerShell de Azure: lista de todas las bases de datos en una cuenta de Azure Cosmos'
description: 'Ejemplo de script de Azure PowerShell: lista de todas las bases de datos en una cuenta de Azure Cosmos'
author: markjbrown
...
ms.locfileid: "65077686"
---
# <a name="list-all-databases-in-an-azure-cosmos-account-using-powershell"></a>Enumerar todas las bases de datos en una cuenta de Azure Cosmos mediante PowerShell
