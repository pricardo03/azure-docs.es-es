---
title: 'Azure PowerShell script: obtener las propiedades de un contenedor en una cuenta de Azure Cosmos'
description: 'Script de PowerShell de Azure de ejemplo: obtener las propiedades de un contenedor en una cuenta de Azure Cosmos'
author: markjbrown
...
ms.locfileid: "65078211"
---
# <a name="get-the-properties-of-a-container-in-an-azure-cosmos-account-using-powershell"></a>Obtiene las propiedades de un contenedor en una cuenta de Azure Cosmos mediante PowerShell
