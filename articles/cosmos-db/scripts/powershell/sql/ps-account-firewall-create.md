---
title: Script de PowerShell de Azure - configurar Firewall de IP para una cuenta de Azure Cosmos
description: 'Ejemplo de script de Azure PowerShell: configurar el Firewall de IP para una cuenta de Azure Cosmos'
author: markjbrown
...
ms.locfileid: "65078376"
---
# <a name="configure-ip-firewall-for-an-azure-cosmos-account-using-powershell"></a>Configurar Firewall de IP para una cuenta de Azure Cosmos mediante PowerShell
