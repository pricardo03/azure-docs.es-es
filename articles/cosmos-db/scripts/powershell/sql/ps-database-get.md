---
title: 'Azure PowerShell script: obtener las propiedades de una base de datos en una cuenta de Azure Cosmos'
description: 'Script de PowerShell de Azure de ejemplo: obtener las propiedades de una base de datos en una cuenta de Azure Cosmos'
author: markjbrown
...
ms.locfileid: "65077671"
---
# <a name="get-the-properties-of-a-database-in-an-azure-cosmos-account-using-powershell"></a>Obtiene las propiedades de una base de datos en una cuenta de Azure Cosmos mediante PowerShell
