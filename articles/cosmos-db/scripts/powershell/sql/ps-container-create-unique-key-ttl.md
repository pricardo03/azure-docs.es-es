---
title: 'Azure PowerShell script: crear un contenedor con la directiva de clave única y TTL en una cuenta de Azure Cosmos'
description: 'Script de PowerShell de Azure de ejemplo: creación de un contenedor con la directiva de clave única y TTL en una cuenta de Azure Cosmos'
author: markjbrown
...
---
# <a name="create-a-container-with-unique-key-policy-and-ttl-in-an-azure-cosmos-account-using-powershell"></a>Crear un contenedor con la directiva de clave única y TTL en una cuenta de Azure Cosmos mediante PowerShell
