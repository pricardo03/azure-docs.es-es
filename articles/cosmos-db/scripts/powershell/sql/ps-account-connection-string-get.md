---
title: Script de Azure PowerShell - Get de las cadenas de conexión para una cuenta de Azure Cosmos
description: 'Ejemplo de script de Azure PowerShell: Get de las cadenas de conexión para una cuenta de Azure Cosmos'
author: markjbrown
...
ms.locfileid: "65078451"
---
# <a name="get-connection-strings-for-an-azure-cosmos-account-using-powershell"></a>Obtengan cadenas de conexión para una cuenta de Azure Cosmos mediante PowerShell
