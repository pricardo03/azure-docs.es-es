---
title: 'Azure PowerShell script: creación de una base de datos de Azure Cosmos con rendimiento compartido'
description: 'Script de PowerShell de Azure de ejemplo: creación de una base de datos de Azure Cosmos con rendimiento compartido'
author: markjbrown
...
ms.locfileid: "65077716"
---
# <a name="create-an-azure-cosmos-database-with-shared-throughput-using-powershell"></a>Crear una base de datos de Azure Cosmos con rendimiento compartido mediante PowerShell
