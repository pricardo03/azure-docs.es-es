---
title: 'Azure PowerShell script: creación de una base de datos de Azure Cosmos'
description: 'Script de PowerShell de Azure de ejemplo: creación de una base de datos de Azure Cosmos'
author: markjbrown
...
ms.locfileid: "65077821"
---
# <a name="create-an-azure-cosmos-database-using-powershell"></a>Crear una base de datos de Cosmos Azure con PowerShell
