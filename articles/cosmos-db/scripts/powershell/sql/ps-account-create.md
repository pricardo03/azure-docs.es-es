---
title: 'Azure PowerShell script: crear una cuenta de Azure Cosmos para Core API (SQL)'
description: 'Script de PowerShell de Azure de ejemplo: crear una cuenta de Azure Cosmos para Core API (SQL)'
author: markjbrown
...
ms.locfileid: "65078436"
---
# <a name="create-an-azure-cosmos-account-for-core-sql-api-account-using-powershell"></a>Crear una cuenta de Azure Cosmos para la cuenta de API de SQL (Core) mediante PowerShell
