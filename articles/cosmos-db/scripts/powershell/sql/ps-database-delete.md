---
title: 'Script de Azure PowerShell: eliminación de una base de datos en una cuenta de Azure Cosmos'
description: 'Ejemplo de script de Azure PowerShell: eliminación de una base de datos en una cuenta de Azure Cosmos'
author: markjbrown
...
ms.locfileid: "65077731"
---
# <a name="delete-a-database-in-an-azure-cosmos-account-in-an-azure-cosmos-account-using-powershell"></a>Eliminar una base de datos en una cuenta de Azure Cosmos en una cuenta de Azure Cosmos mediante PowerShell
...
| [Remove-AzResource](https://docs.microsoft.com/powershell/module/az.resources/remove-azresource) | Elimina un recurso. |
