---
title: Script de PowerShell de Azure - regenerar claves para una cuenta de Azure Cosmos
description: Ejemplo de script de PowerShell de Azure - regenerar claves para una cuenta de Azure Cosmos
author: markjbrown
...
---
# <a name="regenerate-keys-for-an-azure-cosmos-account-using-powershell"></a>Regenerar claves para una cuenta de Azure Cosmos mediante PowerShell
