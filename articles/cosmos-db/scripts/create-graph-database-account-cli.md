---
title: 'Script de la CLI de Azure: creación de una cuenta, base de datos y colección de API de Gremlin para Azure Cosmos DB | Microsoft Docs'
description: 'Ejemplo de script de la CLI de Azure: creación de una cuenta, base de datos y colección de API de Gremlin para Azure Cosmos DB'
services: cosmos-db
...
Este script de ejemplo de la CLI crea una cuenta, base de datos y colección de API de Gremlin en Azure Cosmos DB. 
