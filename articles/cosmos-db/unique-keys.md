...
Si intenta insertar otro elemento con las combinaciones que aparecen en la tabla anterior, recibirá un error. El error indica que no se ha cumplido con la restricción de clave única. Como resultado, recibirá un mensaje del tipo "Ya existe un recurso con el id. o nombre especificado" o "Ya existe un recurso con el id., nombre o índice único especificado". 
