...
ms.locfileid: "53089439"
---
# <a name="quickstart-build-a-cassandra-app-with-net-and-azure-cosmos-db"></a>Inicio rápido: Creación de una aplicación de Cassandra con .NET y Azure Cosmos DB
