...
ms.locfileid: "43698662"
---
# <a name="azure-cosmos-db-build-a-nodejs-app-using-sql-api-javascript-sdk-20-preview-and-the-azure-portal"></a>Azure Cosmos DB: Creación de una aplicación Node.js con SQL API, el SDK de JavaScript 2.0 (versión preliminar) y Azure Portal 
