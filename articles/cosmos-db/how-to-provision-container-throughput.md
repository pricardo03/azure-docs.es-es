...
Si va a aprovisionar el rendimiento de una cuenta de la API de MongoDB, use "/myShardKey" como ruta de acceso de la clave de partición y, si va a aprovisionar el rendimiento de una cuenta de Cassandra API, use "/myPrimaryKey" como ruta de acceso de la clave de partición.
