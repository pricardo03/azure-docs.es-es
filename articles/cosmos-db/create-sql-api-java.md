---
title: Creación de una base de datos de documentos de Azure Cosmos DB con Java
...
ms.locfileid: "65979140"
---
# <a name="quickstart-build-a-java-application-using-azure-cosmos-db-sql-api-account"></a>Inicio rápido: Compilación de una aplicación Java mediante una cuenta de SQL API de Azure Cosmos DB
...
7. La aplicación no elimina los recursos creados. Vuelva al portal para [limpiar los recursos](#clean-up-resources).  desde su cuenta para que no incurrir en gastos.
    ...
    ![Salida de consola](./media/create-sql-api-java/rxjava-console-output.png)
