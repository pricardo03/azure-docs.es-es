...
Set-AzResource -ResourceType $resourceType `
    ...
    -Name $accountName -PropertyObject $CosmosDBProperties
```
### <a id="multi-master"></a> Habilitación de varias regiones de escritura para una cuenta de Azure Cosmos
...
### <a id="enable-automatic-failover"></a> Habilitación de la conmutación automática por error
