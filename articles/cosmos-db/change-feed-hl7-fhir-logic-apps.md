---
title: 'Fuente de cambios para recursos de HL7 FHIR: Azure Cosmos DB'
...
- Los documentos C-CDA se convierten en [Recursos HL7 FHIR](https://hl7.org/fhir/2017Jan/resourcelist.html) en formato JSON.
