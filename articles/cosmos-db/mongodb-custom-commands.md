---
title: Comandos personalizados para administrar los datos almacenados en la API de Azure Cosmos DB para MongoDB
description: En este artículo se describe cómo usar comandos personalizados para administrar los datos almacenados en la API de Azure Cosmos DB para MongoDB.
author: SnehaGunda
...
ms.locfileid: "58807055"
---
# <a name="use-custom-commands-to-manage-data-stored-in-azure-cosmos-dbs-api-for-mongodb"></a>Utilice los comandos personalizados para administrar los datos almacenados en la API de Azure Cosmos DB para MongoDB 
...
El comando personalizado de base de datos de creación crea una nueva base de datos de MongoDB. Se usa el nombre de la base de datos desde el contexto de las bases de datos en la que se ejecutó el comando. El formato del comando CreateDatabase es como sigue:
...
El comando personalizado de base de datos de actualización actualiza las propiedades asociadas con la base de datos especificado. Actualmente, solo se puede actualizar la propiedad "offerThroughput".
...
El comando personalizado de base de datos de get devuelve el objeto de base de datos. Se usa el nombre de la base de datos desde el contexto de base de datos en la que se ejecutó el comando.
...
El comando personalizado de colección de creación crea una nueva colección de MongoDB. Se usa el nombre de la base de datos desde el contexto de las bases de datos en la que se ejecutó el comando. El formato del comando CreateCollection es como sigue:
...
El comando personalizado de colección de actualización actualiza las propiedades asociadas a la colección especificada.
