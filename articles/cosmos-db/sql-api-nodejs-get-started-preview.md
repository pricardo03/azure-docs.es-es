...
ms.locfileid: "41919797"
---
# <a name="nodejs-tutorial-create-a-nodejs-console-application-with-azure-cosmos-db-sql-api-and-javascript-sdk-20-preview"></a>Tutorial de Node.js: crear una aplicación de consola de Node.js con SQL API de Azure Cosmos DB y el SDK de JavaScript 2.0 (versión preliminar)
...
* ¿Desea un ejemplo más complejo de Node.js? Consulte [Creación de una aplicación web de Node.js con Azure Cosmos DB](sql-api-nodejs-application-preview.md).
