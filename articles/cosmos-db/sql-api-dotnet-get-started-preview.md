...
Se puede crear una base de datos mediante la función [**CreateDatabaseIfNotExistsAsync**](/dotnet/api/microsoft.azure.cosmos.cosmosclient.createdatabaseifnotexistsasync) o [**CreateDatabaseAsync**](/dotnet/api/microsoft.azure.cosmos.cosmosclient.createdatabaseasync) de la clase ``CosmosDatabases``. Una base de datos es el contenedor lógico de elementos con particiones en contenedores.
