---
title: 'Introducción a Azure Cosmos DB: MongoDB API'
...
---
# <a name="introduction-to-azure-cosmos-db-mongodb-api"></a>Introducción a Azure Cosmos DB: MongoDB API
...
La API de MongoDB en Azure Cosmos DB no puede utilizarse como un punto de conexión directo para servicios como Azure Stream Analytics, porque la API de MongoDB usa los mismos [controladores cliente](https://docs.mongodb.org/ecosystem/drivers/) que la instancia de MongoDB nativa. Para integrar con Azure Stream Analytics, considere el uso de [Azure App Service](../app-service/app-service-web-overview.md) o el [servicio de Azure Functions](../azure-functions/functions-overview.md) como un servicio de middleware que pueda escribir datos en la API de MongoDB en Azure Cosmos DB.
