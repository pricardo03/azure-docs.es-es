---
title: Creación de una base de datos de Azure Cosmos en Azure Portal.
description: Cree una base de datos, un contenedor y elementos de Azure Cosmos mediante Azure Portal.
author: SnehaGunda
ms.author: sngun
