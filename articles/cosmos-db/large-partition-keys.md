...
Cuando use el SDK de .NET para crear un contenedor con una clave de partición de gran tamaño, debe especificar la propiedad `PartitionKeyDefinitionVersion.V2`. En el ejemplo siguiente se muestra cómo especificar la propiedad de versión dentro del objeto PartitionKeyDefinition y establecerla en PartitionKeyDefinitionVersion.V2:
