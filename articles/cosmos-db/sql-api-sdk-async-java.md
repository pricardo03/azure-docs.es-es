...
<tr><td>**Documentación de la API**</td><td>[Documentación de referencia de API](https://docs.microsoft.com/java/api/cosmosdb/client/async?view=azure-java-stable)</td></tr>
