...
Para administrar y planear la capacidad, Azure Cosmos DB garantiza que el número de RU para una operación de base de datos determinada en un conjunto de datos concreto sea determinista. Examine el encabezado de respuesta para realizar un seguimiento del número de RU consumidas por cualquier operación de base de datos. Una vez comprendidos los factores que afectan a los cargos de unidad de solicitud y los requisitos de rendimiento de la aplicación, se puede ejecutar la aplicación de forma rentable.

Se le factura por hora. El aprovisionamiento del número de RU para la aplicación se realiza por segundos en incrementos de 100 RU/segundo. Para escalar el rendimiento aprovisionado para la aplicación, puede aumentar o disminuir el número de RU en cualquier momento. Realice los cambios en incrementos o disminuciones de 100 RU. Puede realizar los cambios mediante programación o en Azure Portal.
...
* **Recuento de propiedades del elemento**: suponiendo que se aplica la indexación predeterminada en todas las propiedades, el número de RU consumidas para escribir un elemento aumenta a medida que aumenta el recuento de propiedades del elemento.
...
* Obtenga más información sobre las [particiones lógicas](partition-data.md).
