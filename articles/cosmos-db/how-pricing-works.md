...
ms.locfileid: "53263390"
---
# <a name="pricing-model-of-azure-cosmos-db"></a>Modelo de precios de Azure Cosmos DB 
...
* Sobre la [explicación de la factura de Cosmos DB](understand-your-bill.md)
...
* Sobre la [optimización del costo de las cuentas de Cosmos de varias regiones](optimize-cost-regions.md)
* Sobre el [pago por adelantado de recursos de Azure Cosmos DB con capacidad reservada](cosmos-db-reserved-capacity.md)
* Sobre el [emulador de Cosmos DB](local-emulator.md)
