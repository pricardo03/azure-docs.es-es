---
title: Realización de lecturas y escrituras en varias regiones eligiendo la clave de partición correcta | Microsoft Docs
description: Obtenga información sobre cómo diseñar arquitecturas de aplicaciones con lecturas y escrituras locales en varias regiones geográficas con Azure Cosmos DB eligiendo una clave de partición.
services: cosmos-db
author: rimman
manager: kfile
...
ms.locfileid: "40038433"
---
# <a name="perform-multi-region-writes-and-reads-by-choosing-the-right-partitioning-key"></a>Realización de lecturas y escrituras en varias regiones eligiendo la clave de partición correcta
...
![Arquitectura con varios maestros de Azure Cosmos DB](./media/multi-master-workaround/multi-master.png)
