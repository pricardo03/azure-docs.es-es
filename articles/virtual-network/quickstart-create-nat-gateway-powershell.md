...
```
Combine las definiciones de configuración para crear una máquina virtual llamada **myVM** con [New-AzVM]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) en **myResourceGroupNAT**.
