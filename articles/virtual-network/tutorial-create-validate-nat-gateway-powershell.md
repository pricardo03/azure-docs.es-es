...
```
Combine las definiciones de configuración para crear una máquina virtual llamada **myVMsource** con [New-AzVM]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) en **myResourceGroupNAT**.
...
```
Combine las definiciones de configuración para crear una máquina virtual llamada **myVMdestination** con [New-AzVM]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) en **myResourceGroupNAT**.
