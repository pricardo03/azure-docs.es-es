...
- **Ajuste adaptable:** Generación de perfiles de tráfico inteligente aprende el tráfico de la aplicación con el tiempo y selecciona y actualiza el perfil que resulta más adecuado para su servicio. El perfil se ajusta a medida que el tráfico cambia con el tiempo.
- **Protección de varias capas:** proporciona protección contra DDoS de pila completa cuando se usa con un firewall de aplicaciones web.
...
- Interactuar con el cliente para determinar si el tráfico es un posible paquete falsificado (p. ej.: Autorización de SYN o Cookie de SYN o colocando un paquete para el origen lo retransmita).
