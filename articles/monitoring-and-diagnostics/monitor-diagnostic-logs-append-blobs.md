...
* Este cambio afecta a los tipos de datos siguientes:
  ...
  * [Métricas de recursos de Azure que se exportan mediante la configuración de diagnóstico](./monitoring-overview-of-diagnostic-logs.md#diagnostic-settings).
