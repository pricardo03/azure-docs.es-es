...
- Instale la extensión Windows Azure Diagnostics (WAD) en su [máquina virtual Azure](metrics-store-custom-guestos-resource-manager-vm.md), [conjunto de escalado de máquinas virtuales](metrics-store-custom-guestos-resource-manager-vmss.md), [máquina virtual clásica](metrics-store-custom-guestos-classic-vm.md) o [Cloud Services clásico](metrics-store-custom-guestos-classic-cloud-service.md), y envíe los contadores de rendimiento a Azure Monitor. 
- Instale el [agente de InfluxData Telegraf](metrics-store-custom-linux-telegraf.md) en su máquina virtual Linux de Azure y envíe las métricas mediante el complemento de salida de Azure Monitor.
...
Use métricas personalizadas desde distintos servicios: 
 - [Máquinas virtuales](metrics-store-custom-guestos-resource-manager-vm.md)
 - [Conjunto de escalado de máquinas virtuales](metrics-store-custom-guestos-resource-manager-vmss.md)
 - [Azure Virtual Machines (clásico)](metrics-store-custom-guestos-classic-vm.md)
 ...
 - [Cloud Services clásico](metrics-store-custom-guestos-classic-cloud-service.md)
