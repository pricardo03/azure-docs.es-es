...
> [!IMPORTANT]
> La plantilla de Resource Manager especificada para la alerta de métrica no funcionará para el tipo de recurso: Microsoft.OperationalInsights/workspaces; ya que la compatibilidad con las métricas de Log Analytics está en la versión preliminar. Los usuarios interesados en usar la funcionalidad de la versión preliminar con la plantilla de recursos, pueden ponerse en contacto con el equipo de [comentarios de Azure Alerts](mailto:azurealertsfeedback@microsoft.com)
...
## <a name="resource-manager-template-for-metric-alert-that-monitors-multiple-resources"></a>Plantilla de Resource Manager para la alerta de métrica que supervisa varios recursos

En la sección anterior se han descrito las plantillas de Azure Resource Manager de ejemplo para crear alertas de métricas que supervisa un recurso individual. Ahora, Azure Monitor admite la supervisión de varios recursos con una sola regla de alerta de métrica. Esta característica en vista previa solo está disponible a través de plantillas de Azure Resource Manager y API REST, y solo se admite para las máquinas virtuales. Pronto podrá disfrutar del soporte técnico del portal para crear y editar estas reglas.
...
### <a name="all-virtual-machines-in-one-or-more-resource-groups"></a>Todas las máquinas virtuales en uno o varios grupos de recursos

Esta plantilla creará una regla de alerta de métrica que supervisa el valor de Porcentaje de CPU de todas las máquinas virtuales (de una región de Azure) en uno o varios grupos de recursos.

Guarde el archivo JSON siguiente como all-vms-in-resource-group.json para usarlo en este tutorial.
...
Guarde y modifique el archivo JSON siguiente como all-vms-in-resource-group.parameters.json para usarlo en este tutorial.
...
### <a name="all-virtual-machines-in-a-subscription"></a>Todas las máquinas virtuales de una suscripción

Esta plantilla creará una regla de alerta de métrica que supervisa el valor de Porcentaje de CPU de todas las máquinas virtuales (de una región de Azure) en una suscripción.

Guarde el archivo JSON siguiente como all-vms-in-subscription.json para usarlo en este tutorial.
...
Puede usar la plantilla anterior con el archivo de parámetros siguiente.
Guarde y modifique el archivo JSON siguiente como all-vms-in-suscription.parameters.json para usarlo en este tutorial.
...
### <a name="a-list-of-virtual-machines"></a>Una lista de máquinas virtuales

Esta plantilla creará una regla de alerta de métrica que supervisa el valor de Porcentaje de CPU de una lista de máquinas virtuales (de una región de Azure) en una suscripción.

Guarde el archivo JSON siguiente como list-of-vms.json para usarlo en este tutorial.
...
Puede usar la plantilla anterior con el archivo de parámetros siguiente.
Guarde y modifique el archivo JSON siguiente como list-of-vms.parameters.json para usarlo en este tutorial.
...
* Obtenga más información sobre [alertas en Azure](monitoring-overview-alerts.md)
