...
## <a name="manage-alert-rules-for-activity-log-using-azure-portal"></a>Administrar reglas de alertas para el registro de actividad mediante Azure Portal
...
### <a name="create-an-alert-rule-for-an-activity-log-using-azure-portal"></a>Crear una regla de alerta para el registro de actividad mediante Azure Portal
...
### <a name="view-and-manage-activity-log-alert-rules-in-azure-portal"></a>Ver y administrar las reglas de alertas del registro de actividad en Azure Portal
...
## <a name="manage-alert-rules-for-activity-log-using-azure-resource-template"></a>Administrar las reglas de alertas para el registro de actividad mediante la plantilla de recursos de Azure
...
## <a name="manage-alert-rules-for-activity-log-using-powershell-cli-or-api"></a>Administrar reglas de alertas para el registro de actividad mediante PowerShell, CLI o API
