...
Con Habitat, las aplicaciones pueden ejecutarse sin modificar en cualquier entorno de tiempo de ejecución. La aplicación puede ser cualquiera, desde máquinas virtuales y sin sistema operativo hasta contenedores (como Docker), sistemas de administración de clústeres (como Mesosphere o Kubernetes) y sistemas PaaS (como Pivotal Cloud Foundry).
