...
description: Este artículo consiste en una referencia básica de un punto de conexión ReSTful de C# del proveedor personalizado.
...
Este artículo consiste en una referencia básica de un punto de conexión ReSTful de C# del proveedor personalizado. Si no está familiarizado con los proveedores personalizados de Azure, consulte [la introducción a los proveedores de recursos personalizados](./custom-providers-overview.md).

## <a name="azure-function-restful-endpoint"></a>Punto de conexión RESTful de funciones de Azure

El código siguiente funciona con una función de Azure. Para obtener información sobre cómo configurar una función de Azure para que funcione con proveedores personalizados, consulte [Configuración de Azure Functions para los proveedores personalizados de Azure](./tutorial-custom-providers-function-setup.md).
