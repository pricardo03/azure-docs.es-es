---
title: Creación de una aplicación administrada de Azure con acciones y recursos personalizados
...
2. En **Centro de Managed Applications**, seleccione **Definición de aplicación del catálogo de servicios** y haga clic en **Agregar**. 
    ...
    ![Adición de catálogo de servicios](./media/managed-application-with-custom-providers/service-catalog-managed-application.png)
...
3. Proporcione valores para crear una definición del catálogo de servicios:
    ...
    * Para el **identificador URI del archivo de paquete**, proporcione la ruta de acceso al archivo ZIP que creó en el paso anterior.
    ...
    ![Proporcionar valores](./media/managed-application-with-custom-providers/add-service-catalog-managed-application.png)

4. Cuando llegue a la sección de Autenticación y Nivel de bloqueo, seleccione **Agregar autorización**.

    ![Agregar autorización](./media/managed-application-with-custom-providers/add-authorization.png)

5. Seleccione un grupo de Azure Active Directory para administrar los recursos y seleccione **Aceptar**.

   ![Agregar grupo de autorización](./media/managed-application-with-custom-providers/add-auth-group.png)

6. Cuando haya proporcionado todos los valores, seleccione **Crear**.

   ![Creación de la definición de aplicación administrada](./media/managed-application-with-custom-providers/create-service-catalog-definition.png)
...
2. En **Centro de Managed Applications**, seleccione **Aplicaciones del catálogo de servicios** y haga clic en **Agregar**. 
    ...
    ![Adición de aplicación administrada](./media/managed-application-with-custom-providers/add-managed-application.png)
...
3. En la página **Aplicaciones del catálogo de servicios**, escriba el nombre para mostrar de la definición del catálogo de servicios en el cuadro de búsqueda. Seleccione la definición creada en el paso anterior y haga clic en **Crear**.
    ...
    ![Selección del catálogo de servicios](./media/managed-application-with-custom-providers/select-service-catalog-definition.png)
...
4. Proporcione valores para crear una instancia de aplicación administrada a partir de la definición del catálogo de servicios:
    ...
    * Proporcione un nombre de función de Azure y un nombre de cuenta de Azure Storage únicos.
    ...
    ![Configuración de la aplicación](./media/managed-application-with-custom-providers/application-settings.png)

5. Cuando se supere la validación, haga clic en **Aceptar** para implementar una instancia de una aplicación administrada. 
    
    ![Implementación de una aplicación administrada](./media/managed-application-with-custom-providers/deploy-managed-application.png)
...
![Grupos de recursos de la aplicación](./media/managed-application-with-custom-providers/application-resource-groups.png)
...
![Realización de acción personalizada](./media/managed-application-with-custom-providers/perform-custom-action.png)
...
![Creación de un recurso personalizado](./media/managed-application-with-custom-providers/create-custom-resource.png)
...
![Creación de un recurso personalizado](./media/managed-application-with-custom-providers/perform-custom-resource-action.png)
