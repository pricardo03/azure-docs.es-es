...
**routingType** | Sin | El tipo de contrato del punto de conexión. Si no se especifica el valor, el valor predeterminado es "Proxy".
...
*request-body* | Sin | El cuerpo de la solicitud que se enviará al punto de conexión.
