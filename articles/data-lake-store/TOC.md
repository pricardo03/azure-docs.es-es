...
# [Cambio a la documentación de Data Lake Storage Gen2](https://docs.microsoft.com/azure/storage/data-lake-storage/introduction)
...
### [Uso de MapReduce en HDInsight](data-lake-store-performance-tuning-mapreduce.md)
...
## [Python (administración de sistemas de archivos)](https://azure-datalake-store.readthedocs.io/en/latest)
## [REST](/rest/api/datalakestore)
## [Plantilla de Resource Manager](/azure/templates/microsoft.datalakestore/allversions)
...
## [Foro de Stack Overflow](https://stackoverflow.com/questions/tagged/azure-data-lake)
