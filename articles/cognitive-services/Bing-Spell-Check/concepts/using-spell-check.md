...
Un [código de mercado](https://docs.microsoft.com/rest/api/cognitiveservices/bing-spell-check-api-v7-reference#market-codes) se debe especificar con el parámetro de consulta `mkt` en la solicitud. De lo contrario, la API usará un mercado predeterminado en función de la dirección IP de la solicitud.
