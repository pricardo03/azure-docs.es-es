---
title: Idiomas admitidos en Bing Spell Check API (Microsoft Cognitive Services en Azure) | Microsoft Docs
description: Lista de idiomas de disponibilidad general y en versión preliminar admitidos para operaciones con Bing Spell Check API.
...
ms.locfileid: "45573797"
---
# <a name="supported-language-list-and-status"></a>Estado y lista de idiomas admitidos
