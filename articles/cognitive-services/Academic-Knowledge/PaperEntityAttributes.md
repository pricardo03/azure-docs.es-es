---
title: Atributos de la entidad de documento de Academic Knowledge API | Microsoft Docs
description: Obtenga información sobre los atributos que puede usar con la entidad de documento en Academic Knowledge API en Cognitive Services.
