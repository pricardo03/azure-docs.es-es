...
- mediante un token de conclusión obtenido de una imagen en una llamada anterior a uno de los puntos de conexión de la [Bing Image Search API](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference).
- Enviando la dirección URL de una imagen.
- Cargando una imagen (en formato binario).
...
* [Tutorial: Compilación de una aplicación web de página única: Bing Visual Search](../tutorial-bing-visual-search-single-page-app.md)
