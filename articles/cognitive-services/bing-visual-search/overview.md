...
|<a name="contenttype" />Content-Type|Encabezado de solicitud obligatorio.<br /><br />Debe establecerse en multipart/form-data e incluir un parámetro de límite (por ejemplo, multipart/form-data; boundary=\<cadena de límite\>). Para más información, consulte [Tipos de formulario de contenido](#content-form-types).
