...
Introducción a la biblioteca de cliente de Bing Custom Search para Java. Siga estos pasos para instalar el paquete y probar el código de ejemplo para realizar tareas básicas. Bing Custom Search API le permite crear experiencias de búsqueda a medida y sin anuncios para los temas que le interesan.
...
### <a name="create-a-bing-custom-search-azure-resource"></a>Creación de un recurso de Azure Bing Custom Search

Los servicios de Azure Cognitive Services se representan por medio de recursos de Azure a los que se suscribe. Cree un recurso de Bing Custom Search con [Azure Portal](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-apis-create-account) o la [CLI de Azure](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-apis-create-account-cli) en su equipo local. También puede:
...
En la clase, cree un método `main` y las variables de la clave y el punto de conexión de Azure del recurso. Si ha creado la variable de entorno después de haber iniciado la aplicación, cierre y vuelva a abrir el editor, el IDE o el shell que lo ejecuta para acceder a la variable. Los métodos se definirán más adelante.
