---
title: Tutorial para aprender a llamar a una aplicación de Language Understanding Intelligent Service (LUIS) mediante Node.js | Microsoft Docs
...
ms.locfileid: "36265411"
---
# <a name="tutorial-call-a-luis-endpoint-using-javascript"></a>Tutorial: Llamar a un punto de conexión de LUIS mediante JavaScript
...
4. Vuelva al sitio web de [LUIS](luis-reference-regions.md) e inicie sesión con su cuenta de Azure. 
    ...
    [![](media/luis-get-started-node-get-intent/app-list.png "Captura de pantalla de creación de una lista de aplicaciones")](media/luis-get-started-node-get-intent/app-list.png)
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-javascript"></a>Uso de un resultado de LUIS mediante la API de punto de conexión con JavaScript 

Puede usar JavaScript para acceder a los mismos resultados que vio en la ventana del explorador del paso anterior. 
...
2. Reemplace `"YOUR SUBSCRIPTION KEY"` por su clave de suscripción en esta línea de código: `xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key","YOUR SUBSCRIPTION KEY");`

3. Use un explorador web para abrir el archivo que ha guardado.  Debe aparecer una ventana de alerta con el siguiente mensaje: `Detected the following intent: TurnOn`.

![Elemento emergente que dice TurnOn](./media/luis-get-started-node-get-intent/popup-turn-on.png)
