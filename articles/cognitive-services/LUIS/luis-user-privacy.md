...
A excepción de los datos de aprendizaje activo (que se detallan a continuación), LUIS sigue el [prácticas de almacenamiento de datos de servicios regionales](https://azuredatacentermap.azurewebsites.net/). 
