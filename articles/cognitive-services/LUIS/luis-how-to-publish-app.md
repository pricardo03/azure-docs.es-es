...
Siempre puede [probar](luis-interactive-test.md) la aplicación antes de publicarla. 
...
* Una clave de punto de conexión de LUIS.
...
* Consulte [Administrar claves](./luis-how-to-manage-keys.md) para agregar claves a la aplicación LUIS y obtener información sobre la asignación de claves en regiones.
