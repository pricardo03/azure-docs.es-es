...
|Parámetro Querystring|Descripción|
|--|--|
...
Un token es la unidad más pequeña que se puede etiquetar en una entidad. La tokenización se basa en la [referencia cultural](luis-supported-languages.md#tokenization) de la aplicación.
