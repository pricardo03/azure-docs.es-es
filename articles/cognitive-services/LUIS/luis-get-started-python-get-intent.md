---
title: Tutorial para aprender a llamar a una aplicación de Language Understanding Intelligent Service (LUIS) mediante Python | Microsoft Docs
...
ms.locfileid: "36264591"
---
# <a name="tutorial-call-a-luis-endpoint-using-python"></a>Tutorial: Llamada a un punto de conexión de LUIS mediante Python
...
1. Copie uno de los siguientes fragmentos de código:
...
2. Sustituya el valor del campo `Ocp-Apim-Subscription-Key` por su clave de suscripción de LUIS.

3. Ejecute el script. Muestra el mismo código JSON que vio anteriormente en la ventana del explorador.
<!-- 
