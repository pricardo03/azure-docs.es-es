...
Para llamar al punto de conexión, puede anexar el argumento de la clave de suscripción y la cadena de consulta al punto de conexión. 
...
Puede pegar la dirección URL en un explorador web y sustituir la clave de suscripción para el campo `{YOUR-SUBSCRIPTION-KEY}`.
