---
title: Tutorial para aprender a llamar a una aplicación de Language Understanding Intelligent Service (LUIS) mediante Ruby | Microsoft Docs
...
ms.locfileid: "36265116"
---
# <a name="tutorial-call-a-luis-endpoint-using-ruby"></a>Tutorial: Llamada a un punto de conexión de LUIS mediante Ruby
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-ruby"></a>Uso de un resultado de LUIS mediante la API de punto de conexión con Ruby 
...
2. Reemplace `"YOUR-SUBSCRIPTION-KEY"` por su clave de suscripción en esta línea de código: `subscriptionKey = "YOUR-SUBSCRIPTION-KEY"`

3. Ejecute la aplicación de Ruby. Muestra el mismo código JSON que vio anteriormente en la ventana del explorador.
