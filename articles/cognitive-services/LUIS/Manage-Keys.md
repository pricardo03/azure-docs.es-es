---
title: Administración de las claves en LUIS | Microsoft Docs
...
ms.locfileid: "36266029"
---
# <a name="manage-your-luis-keys"></a>Administración de las claves de LUIS
...
1. Cree una clave de LUIS en [Azure Portal](https://portal.azure.com). Para obtener más instrucciones, vea [Creating a subscription key using Azure](luis-how-to-azure-subscription.md) (Creación de una clave de suscripción mediante Azure).
...
Use su clave para publicar la aplicación en la página **Publicar aplicación**. Para obtener instrucciones sobre cómo publicarla, vea [Publish app](PublishApp.md) (Publicar la aplicación).
