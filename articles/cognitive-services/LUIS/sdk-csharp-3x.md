---
title: 'Inicio rápido: Biblioteca de cliente de creación de Language Understanding (LUIS) 3.x para .NET'
titleSuffix: Azure Cognitive Services
description: Empiece a trabajar con la biblioteca de cliente de LUIS 3.x para .NET. Siga estos pasos para instalar el paquete y probar el código de ejemplo para realizar tareas básicas.
...
ms.locfileid: "74808023"
---
# <a name="quickstart-language-understanding-luis-client-library-3x-for-net"></a>Inicio rápido: Biblioteca de cliente de Language Understanding (LUIS) 3.x para .NET

Introducción a la biblioteca de cliente de Language Understanding (LUIS) 3.x para .NET. Siga estos pasos para instalar el paquete y probar el código de ejemplo para realizar tareas básicas.  Language Understanding (LUIS) permite aplicar inteligencia de aprendizaje automático personalizado a una conversación o un texto de lenguaje natural de un usuario para predecir el significado global y extraer información pertinente y detallada.

Use la biblioteca de cliente de Language Understanding (LUIS) 3.x para .NET para:

* Consultar un punto de conexión publicado
