...
|[Formulario reconocedor](https://docs.microsoft.com/azure/cognitive-services/form-recognizer/ "formar reconocedor") (versión preliminar)|Formulario reconocedor identifica y extrae pares de clave-valor y datos de la tabla de documentos del formulario; a continuación, genera datos estructurados, incluidas las relaciones en el archivo original.|
|[Módulo de reconocimiento de tinta](https://docs.microsoft.com/azure/cognitive-services/ink-recognizer/ "reconocedor de tinta") (versión preliminar)|Módulo de reconocimiento de tinta le permite reconocer y analizar los datos del trazo de tinta digital, formas y contenido escrito a mano y de salida de una estructura de documento con todas las entidades reconocidas.|
...
|Nombre de servicio|Descripción del servicio|
|:-----------|:------------------|
|[Servicios de voz](https://docs.microsoft.com/azure/cognitive-services/speech-service/ "servicios de voz")|El servicio Voz agrega a las aplicaciones características habilitadas para la voz.|
...
|[Bing Speech](https://docs.microsoft.com/azure/cognitive-services/speech/home "Bing Speech") (retirada)|Bing Speech API proporciona un método sencillo para crear características habilitadas para la voz en las aplicaciones.|
|[Translator Speech](https://docs.microsoft.com/azure/cognitive-services/translator-speech/ "Translator Speech") (retirada)|Translator Speech es un servicio de traducción automática.|
...
|[Búsqueda de Bing empresarial Local](https://docs.microsoft.com/azure/cognitive-services/bing-local-business-search/ "búsqueda empresarial Local de Bing")| Negocios locales de Bing Search API permite que sus aplicaciones buscar información de contacto y la ubicación sobre negocios locales basadas en consultas de búsqueda.|
...
## <a name="decision-apis"></a>API de toma de decisiones

|Nombre de servicio|Descripción del servicio|
|:-----------|:------------------|
|[Detector de anomalías](https://docs.microsoft.com/azure/cognitive-services/anomaly-detector/ "Detector de anomalías") (versión preliminar)|Detector de anomalías permite supervisar y detectar anomalías en datos de series temporales.|
...
|[Personalizer](https://docs.microsoft.com/azure/cognitive-services/personalizer/ "Personalizer") (versión preliminar)|Personalizer le permite elegir la mejor experiencia para mostrar a los usuarios, aprendizaje de su comportamiento en tiempo real.|
...
## <a name="certifications-and-compliance"></a>Cumplimiento de normas y certificaciones

Cognitivas Services ha recibido las certificaciones como la certificación CSA STAR, moderadas de FedRAMP y BAA de HIPAA.

También puede [descargar](https://gallery.technet.microsoft.com/Overview-of-Azure-c1be3942) certificaciones para su propio auditorías y las revisiones de seguridad.

Para comprender la administración de datos y privacidad, vaya a la [centro de confianza](https://servicetrust.microsoft.com/).
