---
title: Guía de inicio rápido del SDK de Bing Entity Search para Java | Microsoft Docs
...
---
# <a name="bing-entity-search-sdk-java-quickstart"></a>Guía de inicio rápido del SDK de Bing Entity Search para Java
...
Obtenga una [clave de acceso de Cognitive Services](https://azure.microsoft.com/try/cognitive-services/) en **Buscar**. Instale las dependencias del SDK de Bing Entity Search con Maven, Gradle u otro sistema de administración de dependencias. El archivo POM de Maven requiere la declaración:
```
  <dependencies>
    <dependency>
