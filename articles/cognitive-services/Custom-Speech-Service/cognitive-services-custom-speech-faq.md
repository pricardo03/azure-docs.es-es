...
**Pregunta**: ¿Cómo sabré que el procesamiento de mi conjunto de datos o modelo se ha completado?
...
**Respuesta**: No se permite descargar los modelos y ejecutarlos localmente.
...
**Respuesta**: No, actualmente solo se permiten archivos de texto sin comprimir.

**Pregunta**: El informe de datos indica que ha habido expresiones erróneas. ¿Esto es un problema?

**Respuesta**: No pasa nada si solo unas cuantas expresiones no se han importado correctamente.
...
**Respuesta**: Puede crear una aplicación de recopilación de datos autónoma o usar algún software de grabación de audio comercial.
También puede crear una versión de la aplicación que registre los datos de audio y utilizarla. 

**Pregunta**: ¿Debo transcribir los datos de adaptación yo mismo? 
...
**Respuesta**: El tiempo de procesamiento para crear un modelo acústico personalizado es aproximadamente el mismo que la duración del conjunto de datos acústico.
...
**Pregunta**: ¿Puedo realizar una prueba sin conexión de mi modelo acústico personalizado con un modelo de lenguaje personalizado?
...
**Pregunta**: ¿Puedo realizar una prueba sin conexión de mi modelo de lenguaje personalizado con un modelo acústico personalizado?
...
**Pregunta**: ¿Cuántos datos de texto tengo que cargar?
