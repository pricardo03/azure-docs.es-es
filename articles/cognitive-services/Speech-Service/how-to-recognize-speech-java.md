...
description: >
  Se muestran diversas maneras para el reconocimiento de voz (de archivo, de micrófono, con un modelo personalizado, continuamente o de una sola vez) mediante Speech SDK para Java.
