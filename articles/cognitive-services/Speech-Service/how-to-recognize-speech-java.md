...
description: >
  Aprenda a reconocer voz (de un archivo, un micrófono, con un modelo personalizado, continuamente o de una sola vez) mediante Speech SDK para Java.
