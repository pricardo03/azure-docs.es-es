...
ms.locfileid: "71803677"
---
# <a name="quickstart-synthesize-speech-with-the-speech-sdk-for-python"></a>Inicio rápido: Síntesis de voz con el SDK de Voz para Python

También hay inicios rápidos disponibles para el [reconocimiento de voz](quickstart-python.md).

En este artículo se muestra cómo usar los servicios de voz mediante el SDK de voz de Python. Muestra cómo sintetizar voz a partir de texto y reproducirla con la salida de audio predeterminada.
...
1. Para ejecutar el código de ejemplo, haga clic con el botón derecho en algún lugar dentro del editor. Seleccione **Run Python File in Terminal** (Ejecutar archivo de Python en terminal).
   ...
   ![Ejecución de un ejemplo](media/sdk/qs-python-vscode-python-run-tts.png)
