...
También puede usar el SDK de dispositivos de voz para crear dispositivos de ambientales que tienen su propio [personalizar word wake](speech-devices-sdk-create-kws.md) por lo que es única para su marca la indicación de que inicia una interacción del usuario.

El SDK de dispositivos de voz facilita una variedad de escenarios compatibles con voz, como [personalizado voz primero Virtual asistentes](https://aka.ms/bots/speech/va), unidad a través ordenación de los sistemas, [transcripción de conversación](conversation-transcription-service.md)e inteligentes altavoces. Puede responder a los usuarios con texto, hablarles con una voz predeterminada o [personalizada](how-to-customize-voice-font.md), proporcionar resultados de búsqueda, [traducir](speech-translation.md) a otros idiomas y mucho más. Estamos deseando ver lo que ha compilado.
