---
title: 'Inicio rápido: Asistente de voz personalizado (versión preliminar) en Java para Windows y Linux (servicio Voz)'
...
ms.locfileid: "73506207"
---
# <a name="quickstart-create-a-voice-assistant-with-the-speech-sdk-java"></a>Inicio rápido: Creación de un asistente de voz con el SDK de Voz, Java
