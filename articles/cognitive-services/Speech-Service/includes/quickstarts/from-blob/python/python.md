...
> **Nota:** Debido a un [error conocido en la generación automática de Swagger](https://github.com/swagger-api/swagger-codegen/issues/7541), pueden producirse errores al importar el paquete `swagger_client`.
