...
5. Seleccione **nueva optimización**. A continuación, siga estos pasos:
   ...
   * Escriba la clave de suscripción de Azure Speech Services desde el portal de Azure y luego seleccione **agregar**. Las claves de suscripción están disponibles en el portal de Azure desde el panel de administración de recursos.  También puede obtener las claves de la lista de suscripciones en el portal de optimización de voz.
