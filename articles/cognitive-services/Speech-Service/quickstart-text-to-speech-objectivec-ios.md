...
También hay inicios rápidos disponibles para el [reconocimiento de voz](quickstart-objectivec-ios.md).
...
1. Reemplace el contenido del archivo `AppDelegate.m` generado automáticamente por: [!code-objectivec[Quickstart Code](~/samples-cognitive-services-speech-sdk/quickstart/text-to-speech/objectivec-ios/helloworld/helloworld/AppDelegate.m#code)].
...
1. Para compilar y ejecutar el código de ejemplo en el simulador de iOS seleccione **Producto** > **Ejecutar** en el menú o haga clic en el botón **Reproducir**.
   ...
   ![Aplicación de iOS simulada](media/sdk/qs-objectivec-simulated-app-tts.png)
