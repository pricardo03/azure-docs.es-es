...
> [!IMPORTANT]
> Solo se admite la transmisión por secuencias de audio comprimido para C++, C#y Java en Linux (Ubuntu 16.04 o Ubuntu 18.04).
> Compatibilidad está limitada a MP3 y OPUS/OGG.

## <a name="prerequisites"></a>Requisitos previos

Debe instalar estas dependencias para usar la entrada de audio comprimida con el SDK de voz para Linux:
...
Supongamos que tiene una clase de flujo de entrada llamada `myPushStream` y usas OPUS/OGG. Este es el aspecto que es posible que el código: 
