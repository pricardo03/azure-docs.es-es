...
> [!NOTE]
> Para obtener más información, consulte [Cómo obtener un token de acceso](https://docs.microsoft.com/azure/cognitive-services/speech-service/rest-apis#how-to-get-an-access-token).
