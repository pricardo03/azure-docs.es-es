---
title: Aplicación web Bing Web Search de página única (código fuente) | Microsoft Docs
description: Código fuente del tutorial que muestra cómo usar Bing Web Search API en una aplicación web de página única.
