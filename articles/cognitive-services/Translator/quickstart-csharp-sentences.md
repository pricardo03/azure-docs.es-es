...
---
# <a name="quickstart-use-the-translator-text-api-to-determine-sentence-length-using-c"></a>Guía de inicio rápido: Uso de Translator Text API para determinar las longitudes de frase mediante C#
