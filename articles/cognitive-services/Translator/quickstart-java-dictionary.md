---
title: 'Guía de inicio rápido: Obtención de traducciones alternativas con Translator Text API mediante Java'
...
ms.locfileid: "52888846"
---
# <a name="quickstart-use-the-translator-text-api-to-get-alternate-translations-using-java"></a>Guía de inicio rápido: Uso de Translator Text API para obtener traducciones alternativas mediante Java
