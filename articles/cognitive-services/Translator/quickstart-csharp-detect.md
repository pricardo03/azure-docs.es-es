...
ms.locfileid: "49647109"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-c"></a>Guía de inicio rápido: Identificación del idioma del texto con la API REST Translator Text (C#)
