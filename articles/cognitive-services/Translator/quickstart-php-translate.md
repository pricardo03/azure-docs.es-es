---
title: 'Guía de inicio rápido: Traducción de texto con Translator Text API en PHP'
titleSuffix: Azure Cognitive Services
description: En esta guía de inicio rápido se traduce texto de un idioma a otro mediante Translator Text API con PHP.
...
ms.locfileid: "49647806"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-php"></a>Guía de inicio rápido: Traducción de texto con la API REST Translator Text (PHP)
