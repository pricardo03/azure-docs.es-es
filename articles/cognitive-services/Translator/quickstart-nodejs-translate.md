...
ms.locfileid: "49648486"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-nodejs"></a>Guía de inicio rápido: Traducción de texto con la API REST Translator Text (Node.js)
