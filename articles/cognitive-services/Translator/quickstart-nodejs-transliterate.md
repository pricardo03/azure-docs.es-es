---
title: 'Guía de inicio rápido: conversión de script de texto con Node.js: Translator Text API'
...
ms.locfileid: "49646207"
---
# <a name="quickstart-transliterate-text-with-the-translator-text-rest-api-nodejs"></a>Guía de inicio rápido: Transcripción de texto con la API REST Translator Text (Node.js)
