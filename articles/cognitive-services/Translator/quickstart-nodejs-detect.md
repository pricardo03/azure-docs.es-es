---
title: Translator Text identifica el idioma del texto con Node.js | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: En esta guía de inicio rápido se identifica el idioma del texto de origen mediante Translator Text API con Node.js en Cognitive Services.
...
ms.locfileid: "43770805"
---
# <a name="quickstart-identify-language-from-text-with-nodejs"></a>Guía de inicio rápido: identificación del idioma del texto con Node.js
