---
title: 'Guía de inicio rápido: obtención de los idiomas admitidos (Python): Translator Text API'
...
ms.locfileid: "49644732"
---
# <a name="quickstart-get-supported-languages-with-the-translator-text-rest-api-python"></a>Guía de inicio rápido: obtención de los idiomas admitidos con la API REST Translator Text (Python)
