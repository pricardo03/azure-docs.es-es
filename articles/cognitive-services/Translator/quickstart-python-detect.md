---
title: 'Guía de inicio rápido: Identificación del idioma del texto - Translator Text, Python'
titleSuffix: Azure Cognitive Services
description: En esta guía de inicio rápido se identifica el idioma del texto de origen mediante Translator Text API con Python.
...
ms.locfileid: "46125007"
---
# <a name="quickstart-identify-language-from-text-with-python"></a>Guía de inicio rápido: identificación del idioma del texto con Python
