---
title: 'Guía de inicio rápido: identificación del idioma del texto con Python: Translator Text API'
...
ms.locfileid: "49644927"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-python"></a>Guía de inicio rápido: identificación del idioma del texto con la API REST Translator Text (Python)
