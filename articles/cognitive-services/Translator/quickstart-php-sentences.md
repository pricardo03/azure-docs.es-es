---
title: 'Inicio rápido: Obtención de las longitudes de oración, PHP (Translator Text API)'
...
ms.locfileid: "57542733"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-php"></a>Inicio rápido: Obtención de las longitudes de frase con Translator Text REST API (PHP)
