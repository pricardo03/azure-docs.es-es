---
title: 'Inicio rápido: Identificación del idioma del texto con PHP (Translator Text API)'
...
ms.locfileid: "57535984"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-php"></a>Inicio rápido: Identificación del idioma del texto con Translator Text REST API (PHP)
