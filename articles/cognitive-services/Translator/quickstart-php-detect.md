---
title: 'Guía de inicio rápido: Identificación del idioma del texto con Translator Text API en PHP'
titleSuffix: Azure Cognitive Services
description: En esta guía de inicio rápido se identifica el idioma del texto de origen mediante Translator Text API con PHP.
...
ms.locfileid: "49649458"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-php"></a>Guía de inicio rápido: Identificación del idioma del texto en la API REST Translator Text (PHP)
