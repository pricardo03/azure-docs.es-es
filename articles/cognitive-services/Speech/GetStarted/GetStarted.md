...
Para usar el servicio de conversión de texto a voz de Microsoft, consulte la [referencia de Text to Speech API](../api-reference-rest/bingvoiceoutput.md).
