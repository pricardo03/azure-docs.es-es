...
* Haga clic en el botón **Import** (Importar) para integrar el paquete de Unity en el proyecto.  

    ![Captura de pantalla del cuadro de diálogo de importación del paquete de Unity](media/import-dialog.png)  
