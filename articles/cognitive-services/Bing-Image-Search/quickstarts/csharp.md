...
1. Construya el URI para la solicitud de búsqueda. Tenga en cuenta que el término de búsqueda `SearchTerm` debe tener formato aplicado antes de que se anexe a la cadena.
