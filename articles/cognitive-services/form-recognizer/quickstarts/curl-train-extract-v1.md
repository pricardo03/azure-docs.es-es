...
> [!IMPORTANT]
> Este inicio rápido utiliza la versión v1.0 de la API de Form Recognizer. Si su suscripción se encuentra en la región `West US 2` o `West Europe`, debe seguir las indicaciones del [inicio rápido de la versión v2.0 de la API](./curl-train-extract.md) en su lugar.
