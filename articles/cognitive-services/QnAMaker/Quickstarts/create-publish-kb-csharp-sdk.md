...
Cambie la variable **Endpoint**, `<your-custom-domain>`, por el nombre de su dominio personalizado. Esta ubicación se encuentra en la página **Información general** del recurso de QnA Maker en Azure Portal.
