---
title: 'Creación de una base de conocimiento: Guía de inicio rápido de C# para Microsoft QnA Maker API (V4): Azure Cognitive Services | Microsoft Docs'
description: Cree una base de conocimiento en C# para contener las preguntas frecuentes o manuales de producto de manera que pueda empezar a trabajar con QnA Maker.
...
ms.locfileid: "43771274"
---
# <a name="create-a-new-knowledge-base-in-c"></a>Creación de una base de conocimiento en C#
...
1. Cree una nueva aplicación de consola de C# de .NET Framework en su IDE preferido.
2. Agregue el código que se proporciona a continuación.
3. Reemplace el valor de `key` por su clave de suscripción válida.
