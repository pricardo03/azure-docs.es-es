...
[![Ppublicar resultados](../media/qnamaker-quickstart-get-answer-with-postman/publish-settings.png)](../media/qnamaker-quickstart-get-answer-with-postman/publish-settings.png#lightbox)
...
1. En el área de trabajo, seleccione el método HTTP de **POST**.
    ...
    [![IEstablecimiento del método POST en Postman](../media/qnamaker-quickstart-get-answer-with-postman/postman-select-post-method.png)](../media/qnamaker-quickstart-get-answer-with-postman/postman-select-post-method.png#lightbox)
...
1. Para la dirección URL, concatene el valor HOST (el punto 2 de la imagen) y el valor POST (el punto 1 de la imagen) para crear la dirección URL completa. Una dirección URL de ejemplo completa se parece a esta: 
    ...
    [![IEstablecimiento de la URL completa en Postman](../media/qnamaker-quickstart-get-answer-with-postman/set-postman-method-and-url.png)](../media/qnamaker-quickstart-get-answer-with-postman/set-postman-method-and-url.png#lightbox)
...
1. Copie los encabezados (los puntos 3 y 4 de la imagen) en el área de texto.
    ...
    [![IEn Postman, establezca los encabezados](../media/qnamaker-quickstart-get-answer-with-postman/set-postman-headers.png)](../media/qnamaker-quickstart-get-answer-with-postman/set-postman-headers.png#lightbox)
...
1. Seleccione el formato **sin procesar** y escriba el código JSON (el punto 5 de la imagen) que representa la pregunta.
    ...
    [![IEn Postman, establezca el valor JSON del cuerpo](../media/qnamaker-quickstart-get-answer-with-postman/set-postman-body-json-value.png)](../media/qnamaker-quickstart-get-answer-with-postman/set-postman-body-json-value.png#lightbox)
...
1. La respuesta contiene la propia respuesta con otra información que puede resultar importante para la aplicación cliente. 
    ...
    [![IEn Postman, establezca el valor JSON del cuerpo](../media/qnamaker-quickstart-get-answer-with-postman/receive-postman-response.png)](../media/qnamaker-quickstart-get-answer-with-postman/receive-postman-response.png#lightbox)

## <a name="use-staging-endpoint"></a>Uso de un punto de conexión de almacenamiento provisional

Si desea obtener una respuesta del punto de conexión de almacenamiento provisional, anex la dirección URL con el parámetro booleano querystring `isTest` con el valor de `true`.
...
> [Uso de metadatos al generar una respuesta](../How-to/metadata-generateanswer-usage.md)
