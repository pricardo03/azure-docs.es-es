---
title: 'Actualización de una base de conocimiento: Guía de inicio rápido de Go: Azure Cognitive Services | Microsoft Docs'
description: Actualización de una base de conocimiento en Go para QnA Maker.
