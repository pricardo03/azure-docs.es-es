...
4. Inicie sesión en el [portal de QnA Maker](https://qnamaker.ai) con las credenciales de Azure y haga clic en **Create a knowledge base** (Crear una base de conocimientos).
