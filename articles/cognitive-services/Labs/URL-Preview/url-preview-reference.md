...
|400|ServerError, subcódigo ResourceError: no se pudo llegar a la dirección URL solicitada.|
|400|ServerError, subcódigo ResourceError: la dirección URL solicitada no devolvió un código correcto (incluso si devolvió HTTP 404).|
