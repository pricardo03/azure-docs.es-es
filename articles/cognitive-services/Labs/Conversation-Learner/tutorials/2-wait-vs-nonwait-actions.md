---
title: 'Uso de acciones de espera y de no espera con una aplicación Conversation Learner: Microsoft Cognitive Services | Microsoft Docs'
titleSuffix: Azure
description: Aprenda a usar acciones de espera y no espera con una aplicación Conversation Learner.
...
5. Haga clic en Score Actions (Acciones de puntuación) y seleccione "Cows say moo" (La vaca hace mú).
    - Tenga en cuenta que el bot no espera ninguna entrada y llevará a cabo la acción siguiente.
...
Observe la secuencia de las respuestas de bot con respecto a las acciones de espera y de no espera.
