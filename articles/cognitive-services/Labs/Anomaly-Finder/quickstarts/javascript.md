---
title: 'Uso de Anomaly Finder API con JavaScript: Microsoft Cognitive Services | Microsoft Docs'
description: Obtenga información y ejemplos de código que le ayuden a empezar a usar rápidamente Anomaly Finder con JavaScript en Cognitive Services.
...
## <a name="getting-anomaly-points-with-anomaly-detection-api-using-javascript"></a>Obtener puntos de anomalías con Anomaly Detection API mediante JavaScript
...
2. Reemplace el archivo HTML con el código siguiente.
3. Reemplace el valor de `[YOUR_SUBSCRIPTION_KEY]` por su clave de suscripción válida.
4. Reemplace los datos de requestTextArea con los puntos de datos.
5. Abra el archivo HTML en un explorador web y haga clic en el botón `Anomaly Detection`.
...
> [Aplicación de JavaScript](../tutorials/javascript-tutorial.md)
