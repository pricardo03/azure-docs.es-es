...
6. Cree una nueva función **HttpTrigger-CSharp** llamada **CMListener**. Esta función recibe eventos de Content Moderator. Siga estos pasos para crear la función.
