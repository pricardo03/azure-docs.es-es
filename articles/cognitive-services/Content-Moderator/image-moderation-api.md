---
title: 'Azure Content Moderator: moderación de imágenes | Microsoft Docs'
description: Usar la moderación de imágenes para moderar imágenes inapropiadas
