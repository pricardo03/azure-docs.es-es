---
title: Guía de inicio rápido de Face API con Go | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: En esta guía de inicio rápido detectará los rostros de una imagen mediante Face API con Go en Cognitive Services.
...
1. Compile el archivo, por ejemplo: `go build detect-face.go`.
1. Ejecute el archivo, por ejemplo: `detect-face`.
