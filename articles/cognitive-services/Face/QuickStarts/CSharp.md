...
Agregue el método siguiente a la clase **Program**. Esto da formato a la entrada JSON para que sea más fácil de leer. La aplicación escribirá estos datos de cadena en la consola.
