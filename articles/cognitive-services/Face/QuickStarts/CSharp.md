---
title: 'Guía de inicio rápido: Detección de caras en una imagen mediante la API REST y C#'
titleSuffix: Azure Cognitive Services
description: En esta guía de inicio rápido se detectan caras de una imagen mediante Face API con C#.
...
ms.locfileid: "49954528"
---
# <a name="quickstart-detect-faces-in-an-image-using-the-rest-api-and-c"></a>Guía de inicio rápido: Detección de caras en una imagen mediante la API REST y C#
...
2. Sustituya Program.cs por el código siguiente.
...
6. En el símbolo del sistema, escriba la ruta de acceso a una imagen.
...
> [Tutorial: Introducción a Face API en C#](../Tutorials/FaceAPIinCSharpTutorial.md)
