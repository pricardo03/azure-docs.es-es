...
* Se ha agregado la característica de instantánea para admitir la migración de datos entre suscripciones: [Instantánea](https://docs.microsoft.com/en-us/rest/api/cognitiveservices/face/snapshot).
