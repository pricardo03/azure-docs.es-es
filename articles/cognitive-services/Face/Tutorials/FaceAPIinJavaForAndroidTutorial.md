...
description: En este tutorial, va a crear una aplicación Android sencilla que usa el servicio Face de Cognitive Services para detectar y enmarcar caras en una imagen.
