---
title: Análisis de vídeo en tiempo real con Face API | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Use Face API en Cognitive Services para realizar el análisis casi en tiempo real de fotogramas procedentes de una secuencia de vídeo en directo.
