---
title: Glosario para el servicio Face API | Microsoft Docs
...
#### <a name="Detection-Face-Detection"></a>Detección/detección de caras
...
#### <a name="Face-Attributes-Facial-Attributes"></a>Atributos de cara/atributos faciales
...
#### <a name="Face-Landmarks-Facial-Landmarks"></a>Puntos de referencia de cara/puntos de referencia faciales
...
#### <a name="Name"></a>Nombre (LargePersonGroup/PersonGroup)
...
#### <a name="Train"></a>Entrenar (LargeFaceList/LargePersonGroup/PersonGroup)
...
#### <a name="UserData-User-Data"></a>UserData/datos de usuario
