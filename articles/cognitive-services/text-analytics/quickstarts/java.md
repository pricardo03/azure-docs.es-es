---
title: Inicio rápido de Java para Azure Cognitive Services, Text Analytics API | Microsoft Docs
...
ms.locfileid: "35381899"
---
# <a name="quickstart-for-text-analytics-api-with-java"></a>Inicio rápido de Text Analytics API con Java 
<a name="HOLTop"></a>
...
2. Agregue el código proporcionado a continuación.
3. Reemplace el valor `accessKey` por una clave de acceso válida para la suscripción.
4. Reemplace la ubicación de `uriBase` (actualmente `westus`) por la región para la que se ha registrado.
5. Ejecute el programa.
