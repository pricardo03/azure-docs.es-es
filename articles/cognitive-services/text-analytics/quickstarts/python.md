...
ms.locfileid: "52283594"
---
# <a name="quickstart-using-python-to-call-the-text-analytics-cognitive-service"></a>Guía de inicio rápido: Uso de Python para llamar a Text Analytics de Cognitive Services 
<a name="HOLTop"></a>
