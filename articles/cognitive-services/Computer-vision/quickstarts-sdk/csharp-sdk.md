---
title: 'Inicio rápido: Biblioteca cliente de Computer Vision para .NET | Microsoft Docs'
description: Introducción a la biblioteca cliente de Computer Vision para .NET.
...
En la clase **Program**, guarde una referencia de la dirección URL de la imagen que desea analizar.
