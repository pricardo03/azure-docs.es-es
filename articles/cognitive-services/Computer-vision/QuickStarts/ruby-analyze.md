---
title: 'Guía de inicio rápido: Análisis de imágenes remotas - REST, Ruby - Computer Vision'
titleSuffix: Azure Cognitive Services
description: En esta guía de inicio rápido, analizará una imagen mediante Computer Vision API con Ruby.
...
ms.locfileid: "49341586"
---
# <a name="quickstart-analyze-a-remote-image-using-the-rest-api-and-ruby-in-computer-vision"></a>Guía de inicio rápido: Análisis de imágenes remotas mediante la API de REST y Ruby en Computer Vision
...
1. Realice los siguientes cambios en el código donde sea necesario:
    ...
    1. También puede reemplazar `http://upload.wikimedia.org/wikipedia/commons/3/3c/Shaki_waterfall.jpg\` por la dirección URL de una imagen diferente que desee analizar.
1. Guarde el código como un archivo con la extensión `.rb`. Por ejemplo, `analyze-image.rb`.
1. Abra una ventana de símbolo del sistema.
1. En el símbolo del sistema, utilice el comando `ruby` para ejecutar el ejemplo. Por ejemplo, `ruby analyze-image.rb`.
