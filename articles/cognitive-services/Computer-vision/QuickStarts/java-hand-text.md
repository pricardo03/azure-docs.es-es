...
description: En esta guía de inicio rápido, extraerá texto escrito a mano de una imagen mediante Computer Vision con Java en Cognitive Services.
...
ms.locfileid: "43771957"
---
# <a name="quickstart-extract-handwritten-text---rest-java"></a>Guía de inicio rápido: Extracción de texto escrito a mano (REST, Java)

En esta guía de inicio rápido, extraerá texto escrito a mano de una imagen con Computer Vision.
...
Se devuelve una respuesta correcta en JSON. Los resultados de reconocimiento de escritura manual incluyen el texto detectado y los rectángulos de selección para regiones, líneas y palabras.

El programa debería producir una salida similar al siguiente código JSON:
