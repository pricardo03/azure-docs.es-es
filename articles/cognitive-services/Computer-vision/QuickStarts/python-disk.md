---
title: 'Guía de inicio rápido de Computer Vision para Python: Análisis de imágenes locales | Microsoft Docs'
titleSuffix: Microsoft Cognitive Services
description: En esta guía de inicio rápido, analizará una imagen local mediante Computer Vision con Python en Cognitive Services.
...
ms.locfileid: "43771915"
---
# <a name="quickstart-analyze-a-local-image---rest-python"></a>Guía de inicio rápido: Análisis de imágenes locales (REST, Python)

En esta guía de inicio rápido, analizará una imagen local mediante Computer Vision. Para analizar una imagen remota, consulte [Análisis de imágenes remotas con Python](python-analyze.md).
...
Este ejemplo es similar a [Analizar imágenes remotas con Python](python-analyze.md), salvo que la imagen para analizar se lee localmente desde el disco. Dos cambios son necesarios:

- Agregar un encabezado `{"Content-Type": "application/octet-stream"}` a la solicitud.
- Agregar los datos de imagen (matriz de bytes) al cuerpo de la solicitud.
