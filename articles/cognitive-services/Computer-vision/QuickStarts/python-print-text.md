---
title: 'Guía de inicio rápido de Computer Vision para Python: OCR | Microsoft Docs'
titleSuffix: Microsoft Cognitive Services
description: En esta guía de inicio rápido, extraerá texto impreso de una imagen mediante Computer Vision con Python en Cognitive Services.
...
ms.locfileid: "43771906"
---
# <a name="quickstart-extract-printed-text-ocr---rest-python"></a>Guía de inicio rápido: Extracción de texto impreso (OCR) (REST, Python)
...
## <a name="extract-printed-text"></a>Extraer texto impreso
