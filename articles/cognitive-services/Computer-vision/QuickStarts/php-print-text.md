---
title: 'Guía de inicio de rápido de Computer Vision API para PHP: OCR | Microsoft Docs'
titleSuffix: Microsoft Cognitive Services
description: En esta guía de inicio rápido, extraerá el texto impreso de una imagen mediante Computer Vision con PHP en Cognitive Services.
...
ms.locfileid: "43771985"
---
# <a name="quickstart-extract-printed-text-ocr---rest-php"></a>Guía de inicio rápido: Extracción de texto impreso (OCR) (REST, PHP)
