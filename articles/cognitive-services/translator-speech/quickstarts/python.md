---
title: 'Guía de inicio rápido: Translator Speech API con Python'
...
ms.locfileid: "49341229"
---
# <a name="quickstart-translator-speech-api-with-python"></a>Guía de inicio rápido: Translator Speech API con Python
<a name="HOLTop"></a>
