---
title: 'Tutorial: Compilación de una aplicación web de página única: Bing Video Search'
titlesuffix: Azure Cognitive Services
description: Código fuente del tutorial que muestra cómo utilizar Bing Video Search API en una aplicación web de página única.
...
ms.locfileid: "47223294"
---
# <a name="tutorial-single-page-bing-video-search-app"></a>Tutorial: Aplicación Bing Video Search de página única
