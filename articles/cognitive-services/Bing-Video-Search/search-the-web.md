---
title: ¿Qué es Bing Video Search?
titlesuffix: Azure Cognitive Services
description: Se muestra cómo usar Bing Video Search API para buscar vídeos en la web.
...
Bing Video Search API proporciona una experiencia similar (pero no exacta) a [Vídeos de Bing](https://www.bing.com/videos). Bing Video Search API le permite enviar una consulta de búsqueda a Bing y obtener una lista de vídeos pertinentes.

Si va a crear una página de resultados de búsqueda solo de vídeos para buscar los vídeos que están relacionados con la consulta de búsqueda del usuario, llame a esta API en lugar de llamar a la más general [Bing Web Search API](../bing-web-search/search-the-web.md). Si quiere vídeos y otros tipos de contenido, como páginas web, noticias e imágenes, llame a Bing Web Search API.
...
Podría mostrar un collage de todos los vídeos en miniatura o bien un subconjunto de las miniaturas. Si muestra un subconjunto, proporcione al usuario la opción para ver los vídeos restantes. Debe mostrar los vídeos en el orden proporcionado en la respuesta. Para obtener información acerca de cómo cambiar el tamaño de la miniatura, consulte [Cambio de tamaño y recorte de miniaturas](./resize-and-crop-thumbnails.md). 
...
- Use [hostPageUrl](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v7-reference#video-hostpageurl) para ver el vídeo en el sitio web del host (por ejemplo, YouTube).
- Utilice [webSearchUrl](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v7-reference#video-websearchurl) para ver el vídeo en el explorador de vídeos de Bing.
- Use [embdedHtml](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v7-reference#video-embedhtml) para insertar el vídeo en su propia experiencia. 

Asegúrese de utilizar el publicador y el creador para atribuir el vídeo al reproducirlo.

Para obtener más información sobre el uso de [videoId](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v7-reference#video-videoid) para obtener información detallada del vídeo, consulte [Información de vídeos](./video-insights.md).
...
- [pricing](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v7-reference#pricing)&mdash;filtra los vídeos por el precio (por ejemplo, vídeos gratuitos o por los que tiene que pagar).
- [resolution](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v7-reference#resolution)&mdash;filtra los vídeos por la resolución (por ejemplo, vídeos con un resolución de 720p o mayor).
...
Para obtener la clave de suscripción, consulte [Claves de suscripción](https://azure.microsoft.com/try/cognitive-services/?api=bing-video-search-api).

Familiarícese con la referencia de [Bing Video Search API v7](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v7-reference). La referencia contiene la lista de los puntos de conexión, encabezados y parámetros de consulta que se utilizan para solicitar los resultados de la búsqueda. También incluye definiciones de los objetos de respuesta. 
...
Cuando se llama a Video Search API, Bing devuelve una lista de resultados. La lista es un subconjunto del número total de resultados que están relacionados con la consulta. El campo `totalEstimatedMatches` de la respuesta contiene una estimación del número de vídeos que están disponibles para ver. Para más información acerca de cómo paginar a través de los vídeos restantes, consulte [Paginación de vídeos](./paging-videos.md).

Para obtener más información sobre cómo obtener información detallada de un vídeo, consulte [Información de vídeos](./video-insights.md).

Para obtener más información sobre cómo obtener vídeos populares, consulte [Obtener vídeos de tendencia](./trending-videos.md).