---
title: Guía de inicio rápido del SDK de Bing Video Search para Java | Microsoft Docs
description: Obtenga más información acerca de cómo configurar la aplicación de consola del SDK de Bing Video Search.
...
---
# <a name="bing-video-search-sdk-java-quickstart"></a>Guía de inicio rápido del SDK de Bing Video Search para Java

El SDK de Bing Video Search proporciona la funcionalidad de la API REST para consultas de vídeo y análisis de resultados.

El [código fuente de los ejemplos del SDK de Bing Video Search para Java](https://github.com/Azure-Samples/cognitive-services-java-sdk-samples/tree/master/Search/BingVideoSearch) está disponible en Git Hub.

## <a name="application-dependencies"></a>Dependencias de aplicaciones
Obtenga una [clave de acceso de Cognitive Services](https://azure.microsoft.com/try/cognitive-services/) en **Buscar**. Instale las dependencias del SDK de Bing Video Search con Maven, Gradle u otro sistema de administración de dependencias. El archivo POM de Maven requiere la declaración:
```
  <dependencies>
    <dependency>
...
```
Implemente el cliente **VideoSearchAPIImpl**, lo cual requiere una instancia de la clase **ServiceClientCredentials**.
```
...
```
Busque vídeos sobre "SwiftKey". Compruebe el número de resultados. Imprima el identificador, nombre y dirección URL del primer resultado de vídeo.
```
...
```
Busque vídeos sobre "Bellevue Trailer". Filtre la búsqueda con los parámetros *free*, *short* y *1080p resolution*. Compruebe el número de resultados. Imprima el identificador, nombre y dirección URL del primer resultado de vídeo.
```
...
```
Busque vídeos populares. Compruebe los parámetros **bannerTiles** y **categories**.
```
...
```
Busque vídeos sobre "Bellevue Trailer" y, después, busque detalles sobre el primer resultado de vídeo.
```
