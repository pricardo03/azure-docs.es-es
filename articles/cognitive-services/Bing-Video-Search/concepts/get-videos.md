...
Si Bing puede expandir la consulta para restringir la búsqueda original, el objeto [Videos](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v7-reference#videos) contiene el campo `queryExpansions`. Por ejemplo, si la consulta fuera *Cleaning Gutters*, las consultas expandidas podrían ser: Gutter Cleaning **Tools**, Cleaning Gutters **From the Ground**, Gutter Cleaning **Machine** y **Easy** Gutter Cleaning.
