---
title: Guía de inicio rápido del SDK de Video Search para C# | Microsoft Docs
...
ms.locfileid: "35382619"
---
# <a name="video-search-sdk-c-quickstart"></a>Guía de inicio rápido del SDK de Video Search para C#

El SDK de Bing Video Search contiene la funcionalidad de la API REST para consultas web y análisis de resultados.

El [código fuente de los ejemplos del SDK de Bing Video Search para C#](https://github.com/Azure-Samples/cognitive-services-dotnet-sdk-samples/tree/master/BingSearchv7/BingVideoSearch) está disponible en GitHub.

## <a name="application-dependencies"></a>Dependencias de aplicaciones

Para configurar una aplicación de consola con el SDK de Bing Video Search, vaya a la opción `Manage NuGet Packages` del Explorador de soluciones en Visual Studio.  Agregue el paquete `Microsoft.Azure.CognitiveServices.Search.VideoSearch`.

La instalación del [[paquete del SDK de NuGet Video Search]](https://www.nuget.org/packages/Microsoft.Azure.CognitiveServices.Search.VideoSearch/1.2.0) también instala las dependencias, entre las que se incluyen:
...
Para crear una instancia del cliente `VideoSearchAPI`, agregue directivas Using:
```
...
```
Utilice al cliente para buscar con un texto de consulta "SwiftKey" para vídeos.
```
...
Analice los resultados, a continuación, compruebe el número de resultados e imprima el Id., el nombre y la dirección URL del primer resultado de vídeo.
```
...
```
## <a name="url-parameters"></a>Parámetros de dirección URL

Busque el texto de consulta "Bellevue Trailer" para vídeos cortos, que están sin modificar y con una resolución de 1080p.  Compruebe el número de resultados e imprima el Id., el nombre y la dirección URL del primer resultado de vídeo.
...
Busque vídeos populares y, a continuación, compruebe las categorías e iconos de banner.
```
...
Busque vídeos de "Bellevue Trailer" y, a continuación, busque información detallada del primer vídeo.
```
