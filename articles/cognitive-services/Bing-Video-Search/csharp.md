...
## <a name="see-also"></a>Otras referencias 
 ...
 [Búsqueda de vídeos en la web](search-the-web.md)  
 [Probarlo](https://azure.microsoft.com/services/cognitive-services/bing-video-search-api/)