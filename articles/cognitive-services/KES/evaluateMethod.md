---
title: Método evaluate de Knowledge Exploration Service API | Microsoft Docs
description: Aprenda a usar el método evaluate de Knowledge Exploration Service (KES) API en Cognitive Services.
