...
Inicie sesión en su suscripción de Azure mediante el comando [Connect-AzAccount](/powershell/module/az.profile/connect-azaccount). Siga las instrucciones que aparecen en pantalla.
