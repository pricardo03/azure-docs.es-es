...
- Descargue e instale la [extensión de Azure IoT Edge](https://marketplace.visualstudio.com/items?itemName=vsc-iot.vsiotedgetools) desde el Visual Studio Marketplace para crear un proyecto de IoT Edge en Visual Studio 2017.
