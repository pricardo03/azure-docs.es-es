...
En este artículo se enumeran los pasos para ejecutar el entorno de ejecución de Azure IoT Edge en una máquina virtual de Ubuntu 16.04 con la [oferta de Azure Marketplace de Azure IoT Edge en Ubuntu](http://aka.ms/azure-iot-edge-ubuntuvm) preconfigurada. 
