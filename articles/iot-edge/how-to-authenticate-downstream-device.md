...
Si ha establecido una relación de tipo principal-secundario para este dispositivo de bajada (lo que es necesario para la autenticación de X.509, pero opcional para la autenticación de clave simétrica), puede simplificar la cadena de conexión mediante la llamada directa a la puerta de enlace como host de conexión. Por ejemplo: 
