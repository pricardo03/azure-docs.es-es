...
En el siguiente ejemplo se muestra una instalación automática con contenedores Windows:
...
6. El comando **Initialize-IoTEdge** configura el entorno de ejecución de Azure IoT Edge en el equipo. El comportamiento predeterminado del comando es el aprovisionamiento manual con contenedores de Windows. Utilice la marca `-Dps` para usar Device Provisioning Service, en lugar del aprovisionamiento manual.
...
7. Cuando se le solicite, especifique el identificador de ámbito de Device Provisioning Service y el identificador de registro del dispositivo, que debería haber recuperado en el paso 1.

8. Siga los pasos de [Comprobación de instalación correcta](#verify-successful-installation) para comprobar el estado de IoT Edge en el dispositivo. 
