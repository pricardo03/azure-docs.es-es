---
title: Implementación de módulos de Azure IoT Edge (VS Code) | Microsoft Docs
...
3. Seleccione **Create Deployment for IoT Edge Device** (Crear implementación para dispositivos IoT Edge). 
