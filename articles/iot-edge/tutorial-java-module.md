...
6. Haga clic en el botón Actualizar. Debería ver el nuevo **JavaModule** que se ejecuta junto con el módulo **TempSensor**, **$edgeAgent** y **$edgeHub**.  
