...
ms.locfileid: "60612027"
---
# <a name="security-standards-for-azure-iot-edge"></a>Estándares de seguridad para Azure IoT Edge

Azure IoT Edge está diseñado para afrontar los escenarios de riesgo inherentes al traslado de datos y análisis a la inteligencia perimetral. Los estándares de seguridad de IoT Edge ofrecen flexibilidad para diferentes perfiles de riesgo y escenarios de implementación mientras siguen ofreciendo la protección que se espera de todos los servicios de Azure. 
