...
1. Utilice la siguiente [Introducción a los certificados](https://github.com/Azure/azure-iot-sdk-c/blob/master/tools/CACertificates/CACertificateOverview.md) para crear los certificados de prueba.
