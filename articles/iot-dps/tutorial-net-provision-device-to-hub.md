...
description: En este tutorial se indica cómo aprovisionar el dispositivo en un único centro de IoT mediante Azure IoT Hub Device Provisioning Service (.NET)
author: wesmc7777
ms.author: wesmc
ms.date: 11/12/2019
ms.topic: tutorial
