---
title: Protección de un servicio RESTful mediante certificados de cliente
...
En un artículo relacionado se [crea un servicio REST](rest-api-claims-exchange-dotnet.md) que interactúa con Azure Active Directory B2C (Azure AD B2C).
...
>[!NOTE]
>El servicio REST también se puede proteger ful con la [autenticación HTTP básica](secure-rest-api-dotnet-basic-auth.md). Sin embargo, la autenticación HTTP básica se considera menos segura con un certificado de cliente. Nuestra recomendación es proteger el servicio REST mediante la autenticación de certificado de cliente como se describe en este artículo.
...
7. En el cuadro **Contraseña**, escriba la contraseña del certificado.
    ...
    ![Carga de la clave de directiva en la página Crear una clave en Azure Portal](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-cert-upload.png)
...
5. Agregue el siguiente fragmento de código XML inmediatamente después del elemento `<Metadata>` de cierre:
    ...
    ![Configuración de los elementos XML de la autenticación ClientCertificate](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-cert-tech-profile.png)
...
3. Pruebe el proceso escribiendo **Test** en el cuadro **Nombre propio**.
    ...
    ![Cuadro de texto Nombre propio resaltado y error de validación de entrada mostrado](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-test.png)
...
![Incorporación de código de validación de certificados](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-code.png)
...
Si necesita solucionar problemas de este paso, consulte [Recopilación de registros mediante Application Insights](troubleshoot-with-application-insights.md).
