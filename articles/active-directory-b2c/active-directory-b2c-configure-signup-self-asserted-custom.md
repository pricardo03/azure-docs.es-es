...
![Control desplegable de selección única que muestra varias opciones](./media/active-directory-b2c-configure-signup-self-asserted-custom/dropdown-menu-example.png)
...
![Control de casilla de selección múltiple que muestra varias opciones](./media/active-directory-b2c-configure-signup-self-asserted-custom/multiselect-menu-example.png)
