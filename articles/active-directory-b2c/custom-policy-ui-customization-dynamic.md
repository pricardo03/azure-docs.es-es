---
title: Personalización de la interfaz de usuario (IU) dinámicamente con directivas personalizadas
...
Este artículo se centra en cómo personalizar la interfaz de usuario de Azure AD B2C con *contenido dinámico* utilizando directivas personalizadas. Para empezar, consulte el artículo sobre [personalización de la interfaz de usuario en una directiva personalizada](custom-policy-ui-customization.md).

>[!NOTE]
>El artículo de Azure AD B2C [Configuración de la interfaz de usuario personalizada en una directiva personalizada](custom-policy-ui-customization.md), explica los fundamentos siguientes:
...
En el artículo [Configuración de la interfaz de usuario personalizada en una directiva personalizada](custom-policy-ui-customization.md) se cargaron los archivos HTML5 en Azure Blob Storage. Esos archivos HTML5 son estáticos y representan el mismo contenido HTML para cada solicitud.
...
3. Asigne un nombre a la aplicación, por ejemplo, *Contoso.AADB2C.UI* y, a continuación, seleccione **Aceptar**.
    ...
    ![Creación de un nuevo proyecto de Visual Studio](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-create-project1.png)

4. Seleccione la plantilla **Aplicación web**.

5. Establezca la autenticación en **Sin autenticación**.

    ![Seleccione la plantilla Aplicación Web](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-create-project2.png)
...
1. Haga clic con el botón derecho en la carpeta Vistas/Inicio y, a continuación, en **Agregar** > **Nuevo elemento**.
    ...
    ![Elemento de menú Agregar nuevo elemento en Visual Studio](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-add-view1.png)
...
5. Seleccione **Agregar**.
    ...
    ![Cuadro de diálogo Agregar nuevo elemento en Visual Studio con la página Vista de MVC resaltada](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-add-view2.png)
...
10. Copie el contenido del archivo y péguelo debajo de la definición de Layout. El código debe ser similar a:
    ...
    ![Archivo unified.cshtml después de agregar el HTML5](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-edit-view1.png)
...
![Elemento img con el valor src background_background_image personalizado](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-add-static-background.png)
...
1. Abra **Controllers\HomeController.cs** y agregue el siguiente método:
    ...
    ![Cambiar el controlador para representar la vista](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-controller-view.png)
...
1. En el **Explorador de soluciones**, haga clic con el botón derecho en el proyecto **Contoso.AADB2C.UI** y seleccione **Publicar**.
    ...
    ![Publicación en Microsoft Azure App Service](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-publish1.png)

2. Seleccione el elemento **Microsoft Azure App Service** y luego **Publicar**.

    ![Creación de nueva aplicación en Microsoft Azure App Service](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-publish2.png)
...
4. Seleccione **Crear** para comenzar a crear los recursos de Azure.
    ...
    ![Entrada de las propiedades de App Service](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-publish3.png)
...
1. En [Azure Portal](https://portal.azure.com/), seleccione **App Services** y, después, el nombre de la aplicación de API.
    ...
    ![Seleccionar la aplicación de API en Azure Portal](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-CORS1.png)

2. En la sección **Configuración**, en **API**, seleccione **CORS**.

    ![Elemento de menú de CORS resaltado en el menú de App Service de Azure Portal](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-CORS2.png)
...
4. Seleccione **Guardar**.
    ...
    ![Página de configuración de CORS con un asterisco resaltado en Orígenes permitidos](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-CORS3.png)
...
6. Cambie el valor de `LoadUri` de _~/tenant/default/unified_ a _https://<app_name>.azurewebsites.net/home/unified_.
    ...
    ![Fragmento de código XML de ejemplo con el elemento LoadUri resaltado](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-content-definition.png)
...
2. Abra **B2C_1A_signup_signin**, que es la directiva personalizada del usuario de confianza (RP) que ha cargado, y seleccione **Ejecutar ahora**.
    ...
    ![Directiva de registro o de inicio de sesión](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-demo1.png)
...
2. Busque el elemento `<img>` con identificador `background_background_image` y reemplace el valor de `src` por `@ViewData["background"]`.
    ...
    ![Elemento img con el valor src resaltado ](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-add-dynamic-background.png)
...
5. Agregue el parámetro de la cadena de consulta _campaignId_ al identificador URI. Por ejemplo, agregue `&campaignId=hawaii` tal y como se muestra en la siguiente imagen:
    ...
    ![URI con el parámetro de cadena de consulta campaignId resaltado](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-campaignId-param.png)

6. Seleccione **ENTRAR** para mostrar la imagen de fondo de Hawai.

    ![Página de inicio de sesión o registro con un fondo personalizado con una imagen de Hawai](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-demo2.png)

7. Cambie el valor a *Tokyo* y seleccione **Entrar**.
    El explorador muestra el fondo de Tokio.

    ![Página de inicio de sesión o registro con un fondo personalizado con una imagen de Tokio](./media/custom-policy-ui-customization-dynamic/aadb2c-ief-ui-customization-demo3.png)
