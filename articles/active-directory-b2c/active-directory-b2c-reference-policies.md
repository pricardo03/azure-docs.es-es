---
title: Directivas integradas en Azure Active Directory B2C | Microsoft Docs
description: Tema sobre el marco de directiva extensible de Azure Active Directory B2C y cómo crear distintos tipos de directiva.
