---
title: Configuración de la complejidad de las contraseñas con directivas personalizadas en Azure Active Directory B2C | Microsoft Docs
...
- Más información sobre [Configuración del cambio de contraseñas mediante directivas personalizadas en Azure Active Directory B2C](active-directory-b2c-reference-password-change-custom.md).
