...
En este artículo creará un atributo personalizado en el directorio de Azure Active Directory (Azure AD) B2C. Este atributo nuevo se usará como notificación personalizada en el recorrido del usuario de la edición de perfil.

## <a name="prerequisites"></a>Requisitos previos

Siga los pasos que aparecen en el artículo [Azure Active Directory B2C: introducción a las directivas personalizadas](active-directory-b2c-get-started-custom.md).
...
Azure AD B2C extiende el conjunto de atributos almacenado en cada cuenta de usuario. También puede leer y escribir estos atributos mediante [Graph API de Azure AD](active-directory-b2c-devquickstarts-graph-dotnet.md).
...
El token del identificador que se devuelve a la aplicación incluirá la nueva propiedad de extensión como notificación personalizada precedida por **extension_loyaltyId**. Consulte el ejemplo siguiente:
