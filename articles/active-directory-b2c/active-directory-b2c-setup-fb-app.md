...
8. Escriba `https://{tenantname}.b2clogin.com/` en **Site URL** (URL del sitio). Escriba una dirección URL en **Privacy Policy URL** (URL de directiva de privacidad), por ejemplo `http://www.contoso.com`.
...
15. Escriba `https://{tenantname}.b2clogin.com/te/{tenant}.onmicrosoft.com/oauth2/authresp` en **Valid OAuth redirect URIs** (URI de redireccionamiento OAuth válidos). Reemplace **{tenant}** con el nombre de su inquilino (por ejemplo, contosob2c). Haga clic en **Save Changes** (Guardar cambios) en la parte inferior de la página.
