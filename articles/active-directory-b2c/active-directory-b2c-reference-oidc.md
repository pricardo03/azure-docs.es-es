---
title: Inicio de sesión web con OpenID Connect en Azure Active Directory B2C | Microsoft Docs
...
Aprenda a [obtener su propio inquilino, aplicación y flujos de usuario B2C](#use-your-own-b2c-directory).
