---
title: Transmisión de un token de acceso a través de un flujo de usuario a la aplicación en Azure Active Directory B2C | Microsoft Docs
...
- El flujo de usuario se configura con un proveedor de identidades de OAuth 2.0. o de OpenID Connect.
...
4. Seleccione **Flujos de usuario**y, a continuación, elija el flujo de usuario. Por ejemplo, **B2C_1_SignupSignIn**.
5. Seleccione **Notificaciones de aplicación**.
6. Habilite **Token de acceso del proveedor de identidades**.

    ![Notificación de aplicación](./media/idp-pass-through-user-flow/idp-pass-through-user-flow-app-claim.png)
