...
1. Haga clic con el botón derecho en la carpeta Vistas/Inicio y, a continuación, en **Agregar** > **Nuevo elemento**.
    ...
    ![Elemento de menú Agregar nuevo elemento en Visual Studio](media/active-directory-b2c-ui-customization-custom-dynamic/aadb2c-ief-ui-customization-add-view1.png)
...
5. Seleccione **Agregar**.
    ...
    ![Cuadro de diálogo Agregar nuevo elemento en Visual Studio con la página Vista de MVC resaltada](media/active-directory-b2c-ui-customization-custom-dynamic/aadb2c-ief-ui-customization-add-view2.png)
...
2. En la sección **Configuración**, en **API**, seleccione **CORS**.
    ...
    ![Elemento de menú de CORS resaltado en el menú de App Service de Azure Portal](media/active-directory-b2c-ui-customization-custom-dynamic/aadb2c-ief-ui-customization-CORS2.png)
...
4. Seleccione **Guardar**.
    ...
    ![Página de configuración de CORS con un asterisco resaltado en Orígenes permitidos](media/active-directory-b2c-ui-customization-custom-dynamic/aadb2c-ief-ui-customization-CORS3.png)
...
2. Busque el elemento `<img>` con identificador `background_background_image` y reemplace el valor de `src` por `@ViewData["background"]`.
    ...
    ![Elemento img con el valor src resaltado ](media/active-directory-b2c-ui-customization-custom-dynamic/aadb2c-ief-ui-customization-add-dynamic-background.png)
...
5. Agregue el parámetro de la cadena de consulta _campaignId_ al identificador URI. Por ejemplo, agregue `&campaignId=hawaii` tal y como se muestra en la siguiente imagen:
    ...
    ![URI con el parámetro de cadena de consulta campaignId resaltado](media/active-directory-b2c-ui-customization-custom-dynamic/aadb2c-ief-ui-customization-campaignId-param.png)

6. Seleccione **ENTRAR** para mostrar la imagen de fondo de Hawai.

    ![Página de inicio de sesión o registro con un fondo personalizado con una imagen de Hawai](media/active-directory-b2c-ui-customization-custom-dynamic/aadb2c-ief-ui-customization-demo2.png)

7. Cambie el valor a *Tokyo* y seleccione **Entrar**.
    El explorador muestra el fondo de Tokio.

    ![Página de inicio de sesión o registro con un fondo personalizado con una imagen de Tokio](media/active-directory-b2c-ui-customization-custom-dynamic/aadb2c-ief-ui-customization-demo3.png)
