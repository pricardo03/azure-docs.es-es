---
title: 'Selección de un contrato de página: Azure Active Directory B2C'
...
Puede habilitar el código de JavaScript del lado cliente en las directivas de Azure Active Directory (Azure AD) B2C, independientemente de si usa flujos de usuario o directivas personalizadas. Para habilitar JavaScript para sus aplicaciones, debe agregar un elemento a su [directiva personalizada](active-directory-b2c-overview-custom.md), seleccionar un contrato de página y usar [b2clogin.com](b2clogin.md) en las solicitudes.

Un contrato de página es una asociación de elementos que proporciona Azure AD B2C y el contenido que proporciona el usuario.

En este artículo se trata cómo seleccionar un contrato de página en Azure AD B2C mediante su configuración en una directiva personalizada.

> [!NOTE]
> Si quiere habilitar JavaScript para los flujos de usuario, consulte [Versiones de contratos de JavaScript y página en Azure Active Directory B2C](user-flow-javascript-overview.md).
...
Los paquetes de contrato de página se actualizan periódicamente para incluir correcciones y mejoras en sus elementos de la página. El registro de cambios siguiente especifica los cambios introducidos en cada versión.
...
- Página de MFA (multifactor)
  ...
  - Después de tres (3) intentos con un código incorrecto, B2C envía un error al servicio.
