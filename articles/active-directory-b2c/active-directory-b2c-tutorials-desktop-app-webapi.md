...
2. En la configuración de B2C, haga clic en **Aplicaciones** y luego en **Agregar**.
    ...
    | ------------ | ------- | -------------------------------------------------- |
    | **Nombre** | My sample Node.js web API | Escriba un **Nombre** que describa su API web para los desarrolladores. |
...
1. Abra el archivo `index.js` en la API web de Node.js de ejemplo.
