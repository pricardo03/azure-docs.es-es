...
Complete los pasos y requisitos previos en [Tutorial: Autenticación de usuarios en una aplicación cliente de escritorio nativa](active-directory-b2c-tutorials-desktop-app.md).
...
![Nombre para mostrar indicado en el panel superior de la aplicación de escritorio de WPF](media/active-directory-b2c-tutorials-desktop-app-webapi/desktop-app-01-post-api-call.png)
