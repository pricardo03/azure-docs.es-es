---
title: Protección de un servicio RESTful mediante la autenticación HTTP básica
...
En un [artículo de Azure AD B2C relacionado](rest-api-claims-exchange-dotnet.md), se crea un servicio REST (API web) que se integra en los recorridos del usuario de Azure Active Directory B2C (Azure AD B2C) sin autenticación.
...
Complete los pasos del artículo [Azure Active Directory B2C: integración de intercambios de notificaciones de API de REST en el recorrido del usuario de Azure AD B2C como validación en entradas de usuario](rest-api-claims-exchange-dotnet.md).
...
1. Haga clic con el botón derecho en la carpeta *App_Start*, seleccione **Agregar** y, después, seleccione **Clase**.
   ...
   ![Agregar la clase ClientAuthMiddleware.cs a la carpeta App_Start](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup-auth1.png)

2. En el cuadro **Nombre**, escriba **ClientAuthMiddleware.cs**.

   ![Creación de una nueva clase de C# en el cuadro de diálogo Agregar nuevo elemento de Visual Studio](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup-auth2.png)
...
### <a name="step-14-add-an-owin-startup-class"></a>Paso 1.4: Agregar una clase de inicio de OWIN
...
1. Haga clic con el botón derecho en el proyecto, seleccione **Agregar** > **Nuevo elemento** y luego busque **OWIN**.
   ...
   ![Creación de una nueva clase de inicio de OWIN en el cuadro de diálogo Agregar nuevo elemento de Visual Studio](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup.png)
...
![Agregar la etiqueta Authorize al controlador](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-authorize.png)
...
7. En **Uso de claves**, seleccione **Firma**.
...
5. Agregue el siguiente fragmento de código XML inmediatamente después del elemento `<Metadata>` de cierre:
    ...
    ![Incorporación de elementos XML de autenticación básica a TechnicalProfile](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-add-1.png)
...
3. Pruebe el proceso escribiendo **Test** en el cuadro **Nombre propio**.
    ...
    ![Prueba de la validación de entrada de un nombre propio en la API de identidad](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-test.png)
...
* El código completo se puede descargar en [Ejemplo de solución de Visual Studio para referencia](https://github.com/Azure-Samples/active-directory-b2c-custom-policy-starterpack/tree/master/scenarios/aadb2c-ief-rest-api-netfw-secure-basic).

## <a name="next-steps"></a>Pasos siguientes

* [Uso de certificados de cliente para proteger la API de REST](secure-rest-api-dotnet-certificate-auth.md)
