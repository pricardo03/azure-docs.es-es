...
2. Para **Orígenes permitidos**, **Encabezados permitidos**, y **Encabezados expuestos**, introduzca `your-tenant-name.b2clogin.com`. Reemplace `your-tenant-name` por el nombre del inquilino de Azure AD B2C. Por ejemplo, `fabrikam.b2clogin.com`.
3. Para **Verbos permitidos**, seleccione `GET` y `OPTIONS`.
4. Para **Antigüedad máxima**, introduzca 200.
