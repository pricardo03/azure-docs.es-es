...
| --------- | -------- | ----------- |
| ReferenceId | SÍ | Identificador del recorrido del usuario en la directiva. Para obtener más información, vea [Recorridos del usuario](userjourneys.md) |
