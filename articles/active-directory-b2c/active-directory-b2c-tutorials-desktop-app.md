---
title: 'Tutorial: Autenticación de usuarios en una aplicación cliente nativa mediante Azure Active Directory B2C'
...
3. El flujo de trabajo del registro presenta una página para recopilar y verificar la identidad del usuario con una dirección de correo electrónico. El flujo de trabajo de registro también recopila la contraseña del usuario y los atributos requeridos definidos en el flujo de usuario.
    ...
    ![Página de registro que se muestra como parte del flujo de trabajo de inicio de sesión o registro](media/active-directory-b2c-tutorials-desktop-app/azure-ad-b2c-sign-up-workflow.png)
...
![Detalles de token mostrados en el panel inferior de la aplicación de escritorio de WPF](media/active-directory-b2c-tutorials-desktop-app/desktop-app-01-post-signin.png)
...
> [Tutorial: Concesión de acceso a una API web de Node.js desde una aplicación de escritorio >](active-directory-b2c-tutorials-desktop-app-webapi.md)
