...
| Suscripción | No | Permite a los usuarios crear una cuenta. Con este flujo de usuario, puede configurar: <ul><li>[Multi-factor Authentication](active-directory-b2c-reference-mfa.md)</li><li>[Vigencia de tokens](active-directory-b2c-reference-tokens.md)</li><li>Configuración de compatibilidad de tokens</li><li>Comportamiento de la sesión</li><li>[Requisitos de complejidad de la contraseña](active-directory-b2c-reference-password-complexity.md)</li></ul> |
