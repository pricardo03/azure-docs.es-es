...
![Módulo OMSIngestionAPI](media/monitoring-runbook-datacollect/OMSIngestionAPI.png)
...
![Edición de un runbook](media/monitoring-runbook-datacollect/edit-runbook.png)
...
![Prueba del runbook](media/monitoring-runbook-datacollect/test-runbook.png)
...
4. Asegúrese de que el resultado no muestra ningún error en el comando de registro de Log Analytics.  Debería ver un mensaje similar al siguiente.
    ...
    ![Registro de salida](media/monitoring-runbook-datacollect/post-output.png)
...
![Resultados del registro](media/monitoring-runbook-datacollect/log-output.png)
...
![Publicación del runbook](media/monitoring-runbook-datacollect/publish-runbook.png)
...
![Registro y seguimiento](media/monitoring-runbook-datacollect/logging.png)
...
![Programación de un runbook](media/monitoring-runbook-datacollect/schedule-runbook.png)
...
![Trabajos](media/monitoring-runbook-datacollect/jobs.png)
...
5. Desplácese hacia abajo para buscar una entrada similar a la de la imagen siguiente.<br>![Detallado](media/monitoring-runbook-datacollect/verbose.png)
...
- Empaquete el runbook en una [solución de administración](monitoring-solutions-creating.md) para distribuirla a los clientes.
