...
![Agentes de Service Map](media/monitoring-service-map-configure/agents.png)
...
1.  Instale el agente de Log Analytics para Windows siguiendo uno de los métodos descritos en [Recopilar datos de equipos en su entorno con Log Analytics](../log-analytics/log-analytics-concept-hybrid.md).
...
1.  Instale el agente de Log Analytics siguiendo uno de los métodos descritos en [Recopilar datos de equipos en su entorno con Log Analytics](../log-analytics/log-analytics-concept-hybrid.md).
...
### <a name="uinstall-agent-on-windows"></a>Desinstalación del agente en Windows
