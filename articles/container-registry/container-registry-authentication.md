...
Las entidades de servicio permiten la conectividad desatendida en un registro en escenarios de extracción e inserción como los siguientes:
  ...
  * *Colaborador*: soluciones de integración e implementación continua (por ejemplo, Azure Pipelines o Jenkins) que crean imágenes de contenedor y las insertan en un registro.
