...
description: Condiciones de coincidencia del motor de reglas de documentación de referencia para Azure Content Delivery Network de Verizon Premium.
services: cdn
author: mdgattuso
ms.service: cdn
ms.topic: article
...
ms.locfileid: "66481660"
---
# <a name="azure-cdn-from-verizon-premium-rules-engine-match-conditions"></a>Condiciones de coincidencia de red CDN de Azure desde el motor de reglas de Verizon Premium

En este artículo se muestra descripciones detalladas de las condiciones de coincidencia disponibles para el Azure Content Delivery Network (CDN) de Verizon Premium [motor de reglas](cdn-verizon-premium-rules-engine.md).
