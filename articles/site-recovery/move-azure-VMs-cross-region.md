...
4. Identifique y enumere el diseño de la red de origen y todos los recursos que está utilizando actualmente, incluidos entre otros equilibradores de carga, grupos de seguridad de red y dirección IP pública, para su verificación.
...
5. Puede elegir entre ir con los recursos de destino predeterminados o utilizar los que ha creado previamente.
...
> [!IMPORTANT]
> Es importante realizar el paso anterior para evitar cargos por la replicación de Site Recovery después del traslado.
