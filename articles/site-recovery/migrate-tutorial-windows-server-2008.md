...
- [Configure](physical-azure-disaster-recovery.md#set-up-the-source-environment) el entorno de origen mediante el archivo del instalador descargado en el paso anterior.
