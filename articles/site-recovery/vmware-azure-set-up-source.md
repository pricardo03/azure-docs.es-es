---
title: Configuración del entorno de origen para la recuperación ante desastres de máquinas virtuales de VMware en Azure con Azure Site Recovery | Microsoft Docs
description: En este artículo se describe cómo configurar un entorno local para la recuperación ante desastres de máquinas virtuales de VMware en Azure con Azure Site Recovery.
...
ms.locfileid: "50230733"
---
# <a name="set-up-the-source-environment-for-disaster-recovery-of-vmware-vms-to-azure"></a>Configuración del entorno de origen para la recuperación ante desastres de máquinas virtuales de VMware en Azure
...
Para que la replicación se realice sin problema alguno y para evitar problemas de conectividad, excluya las siguientes carpetas del software antivirus
 ...
 2. C:\Archivos de programa\Microsoft Azure Site Recovery Provider
 3. C:\Archivos de programa\Microsoft Azure Site Recovery Configuration Manager 
 4. C:\Archivos de programa\Microsoft Azure Site Recovery Error Collection Tool 
 5. C:\thirdparty
 6. C:\Temp
 7. C:\strawberry
 8. C:\ProgramData\MySQL
 9. C:\Archivos de programa (x86)\MySQL
 ...
 15. C:\inetpub
 16. El directorio de instalación del servidor de ASR. Por ejemplo: E:\Archivos de programa (x86)\Microsoft Azure Site Recovery
...
7. Directorio de instalación del servidor de procesos con equilibrio de carga de ASR. Por ejemplo: C:\Archivos de programa (x86) \Microsoft Azure Site Recovery
