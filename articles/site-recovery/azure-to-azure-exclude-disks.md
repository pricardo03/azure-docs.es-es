...
- Ya ha creado el almacén de Recovery Services y ha realizado la protección de las máquinas virtuales al menos una vez. Si no lo ha hecho, hágalo con la ayuda de la documentación mencionada [aquí](azure-to-azure-powershell.md). 
...
- La máquina virtual ha alcanzado los [límites de Azure Site Recovery para replicar frecuencias de cambio de datos](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-support-matrix#azure-site-recovery-limits-to-replicate-data-change-rates).
