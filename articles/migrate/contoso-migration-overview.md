...
ms.locfileid: "66238028"
---
# <a name="contoso-migration-series"></a>Serie de migración de Contoso


Tenemos una serie de artículos que se muestra cómo la organización ficticia, Contoso migra infraestructura local a la [Microsoft Azure](https://azure.microsoft.com/overview/what-is-azure/) en la nube. 

La serie incluye información y escenarios que ilustran cómo configurar una infraestructura de migración y ejecutar los diferentes tipos de migraciones. Escenarios aumentan la complejidad a medida que avanzan. En los artículos se muestra cómo la empresa Contoso completa su misión de migración, y también se proporcionan consejos de lectura general e instrucciones específicas a lo largo de la serie.
...
[Obtenga información sobre](https://docs.microsoft.com/azure/architecture/cloud-adoption/migrate/) migración a la nube. 
