---
title: Solución de problemas comunes con el indizador en Azure Search | Microsoft Docs
description: Solución de problemas comunes con los indizadores en Azure Search
author: mgottein
manager: cgronlun
services: search
ms.service: search
...
Las excepciones no funcionan en [Cognitive Search](cognitive-search-concept-intro.md). La única solución alternativa es deshabilitar el firewall.
