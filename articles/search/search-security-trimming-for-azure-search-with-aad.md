---
title: Filtros de seguridad para limitar los resultados de Azure Search mediante las identidades de Active Directory
description: Control de acceso al contenido de Azure Search mediante filtros de seguridad e identidades de Azure Active Directory (AAD).
author: brjohnstmsft
manager: jlembicz
services: search
ms.service: search
