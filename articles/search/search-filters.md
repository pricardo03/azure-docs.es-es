...
En los ejemplos siguientes se muestran varios patrones de diseño para escenarios de filtro. Para obtener más ideas, consulte [OData expression syntax > Examples](https://docs.microsoft.com/rest/api/searchservice/odata-expression-syntax-for-azure-search#filter-examples) (Sintaxis de expresiones de OData > Ejemplos).
...
Filtros de texto son válidos para los campos de cadena, desde el que van a extraer una colección arbitraria de documentos basados en valores de índice de búsqueda.
