...
ms.locfileid: "59270475"
---
# <a name="tutorial-in-c-crawl-an-azure-sql-database-using-azure-search-indexers"></a>Tutorial en C#: Cómo rastrear una base de datos SQL de Azure mediante los indexadores de Azure Search
