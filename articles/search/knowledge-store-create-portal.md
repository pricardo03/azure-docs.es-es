...
description: Use el Asistente para la importación de datos a fin de crear un almacén de información y conservar el contenido enriquecido. Conéctese a un almacén de información para el análisis desde otras aplicaciones o envíe contenido enriquecido a los procesos de nivel inferior.
author: lisaleib
manager: nitinme
ms.author: v-lilei
...
> [!Note]
> El almacén de conocimiento se encuentra en versión preliminar y no debe usarse en producción. Tanto Azure Portal como la [API REST de Azure Search, versión 2019-05-06-Preview](search-api-preview.md) proporcionan esta característica. Por el momento, no hay compatibilidad con .NET SDK.
>
...
1. [Descarga de HotelReviews_Free.csv](https://knowledgestoredemo.blob.core.windows.net/hotel-reviews/HotelReviews_Free.csv?st=2019-07-29T17%3A51%3A30Z&se=2021-07-30T17%3A51%3A00Z&sp=rl&sv=2018-03-28&sr=c&sig=LnWLXqFkPNeuuMgnohiz3jfW4ijePeT5m2SiQDdwDaQ%3D). Estos datos son las reseñas del hotel guardadas en un archivo CSV (procede de Kaggle.com) y contiene 19 fragmentos de comentarios de clientes sobre un solo hotel. 
