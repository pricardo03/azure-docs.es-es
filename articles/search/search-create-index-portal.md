...
description: Obtenga información sobre cómo crear un índice de Azure Search con un diseñador de índices integrados en el portal.
manager: nitinme
author: heidisteen
services: search
ms.service: search
