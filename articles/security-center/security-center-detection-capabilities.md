...
El nivel estándar de Azure Security Center dispone de medidas de detección avanzadas. Hay disponible una versión de evaluación gratuita de 60 días. Si desea actualizar la versión, puede seleccionar las opciones disponibles en el Plan de tarifa de la [Directiva de seguridad](security-center-azure-policy.md). Para más información sobre los precios, visite la [página de Security Center](https://azure.microsoft.com/pricing/details/security-center/) .
