...
(Los precios de la imagen se proporcionan únicamente con fines ilustrativos) [![Precios de Security Center](media/security-center-pricing/pricing-tier-page.png)](media/security-center-pricing/pricing-tier-page.png#lightbox)
...
- **Características de seguridad de contenedor**: Aproveche la administración de vulnerabilidades y la detección de amenazas en tiempo real en los entornos en contenedores. Al habilitar el recurso de registros de contenedor, se puede tardar hasta 12 horas para que se habiliten todas las características.
