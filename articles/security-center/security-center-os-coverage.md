...
|Detección de amenazas de Filess|✔|✔|X|X|
|Mapa de red|✔|X|✔|X|
...
- [Blog de seguridad de Azure](https://blogs.msdn.com/b/azuresecurity/): encuentre entradas de blog sobre cumplimiento y seguridad de Azure.
