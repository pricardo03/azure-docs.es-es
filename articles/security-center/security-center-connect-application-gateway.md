...
2. En el **menú de Microsoft Azure**, seleccione **Security Center**.

3. En **PROTECCIÓN DE SEGURIDAD DE RECURSOS**, seleccione **Soluciones de seguridad**.
...
* [Blog de seguridad de Azure](https://blogs.msdn.com/b/azuresecurity/).
