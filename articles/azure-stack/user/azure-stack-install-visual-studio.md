...
Puede usar Visual Studio para escribir e implementar [plantillas](azure-stack-arm-templates.md) de Azure Resource Manager en Azure Stack. Los pasos de este artículo le guiarán a través de la instalación de Visual Studio en [Azure Stack](azure-stack-connect-azure-stack.md#connect-to-azure-stack-with-remote-desktop), o en un equipo externo si planea realizar la instalación de Azure Stack a través de la [VPN](azure-stack-connect-azure-stack.md#connect-to-azure-stack-with-vpn).
...
5. Seleccione **Agregar**.  
    ...
    Visual Studio llama al Azure Resource Manager y descubre los puntos de conexión, incluyendo el punto de conexión de autenticación para Azure Directory Federated Services (AD FS).
...
## <a name="next-steps"></a>Pasos siguientes
 ...
 - Obtenga más información sobre la [coexistencia](https://msdn.microsoft.com/library/ms246609.aspx) con otras versiones de Visual Studio.
