...
> [!div class="checklist"]
> - Crear una cuenta de almacenamiento y un contenedor que contenga los datos limpios
...
Se requieren conocimientos previos de Azure y Azure Stack. Para más información antes de continuar, comience con estos temas:
 ...
 -  [Guía de soluciones híbridas de CI/CD de Azure Stack](/azure-stack-solution-pipeline.md)
...
1.  En Configuración, configure las características opcionales.
    ...
    e.  Nota: Con AAD habilitado y configurado para la suscripción de Azure, Managed Service Identity se puede habilitar también.
