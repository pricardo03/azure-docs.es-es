...
1. Inicie sesión en el portal de administrador de Azure Stack (https://adminportal.local.azurestack.external) y seleccione **+Crear un recurso** > **Ofertas + Planes de inquilinos** > **Oferta**.
