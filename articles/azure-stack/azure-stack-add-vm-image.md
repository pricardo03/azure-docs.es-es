...
2. Inicie sesión como operador en Azure Stack. En el menú, seleccione **Todos los servicios**. Después, en la categoría **ADMINISTRACIÓN**, seleccione **Proceso** > **Imágenes de VM** > **Agregar**.
