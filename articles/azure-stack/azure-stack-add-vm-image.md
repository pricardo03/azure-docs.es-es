...
2. Inicie sesión como operador en Azure Stack. En el menú, seleccione **Más servicios**. A continuación, seleccione **Proceso** > **Imágenes de máquina virtual** > **Agregar**.
