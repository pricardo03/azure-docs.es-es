...
| FQDN externo | SÍ |  | Nombre de dominio completo externo utilizado como sufijo para puntos de conexión. (Por ejemplo, local.azurestack.external o redmond.contoso.com). |
...
| Contraseña de inquilino | Obligatorio |  | Contraseña del usuario inquilino. |
...
| Contraseña de administrador de la nube | Obligatorio |  | Contraseña del usuario administrador de la nube. |
