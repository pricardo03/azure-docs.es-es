...
* Dos servidores y otros requisitos previos que cumplen con los requisitos de hardware del ASDK, tal como se describe en [Inicio rápido: Evaluación del Kit de desarrollo de Azure Stack](azure-stack-deploy-overview.md).
...
> [!NOTE]
> Siga las [instrucciones de implementación](azure-stack-run-powershell-script.md) para cada ASDK que implemente. En este artículo, los entornos de ASDK se llaman **POC1** y **POC2**.
