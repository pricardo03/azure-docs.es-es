---
title: Solución de problemas de errores con instancias de Azure Blueprint
...
1. En la parte superior de la página de asignación de planos técnicos hay un banner rojo de advertencia que indica que la asignación ha dado error. Haga clic en cualquier lugar del banner para obtener más detalles.

Es habitual que el error se deba a un artefacto incluido en el plano técnico y no al plano técnico en su conjunto. Por ejemplo, si el plano técnico contiene un artefacto para crear una instancia de Key Vault, pero Azure Policy impide la creación de dicha instancia, la asignación entera dará error.

## <a name="general-errors"></a>Errores generales

### <a name="policy-violation"></a>Escenario: infracción de directivas
...
Ajuste el plano técnico para que no entre en conflicto con las directivas enumeradas en la información del error. Si esto no es posible, una opción alternativa es tener modificado el ámbito de la asignación de directivas para que el plano técnico deje de estar en conflicto con la directiva.
