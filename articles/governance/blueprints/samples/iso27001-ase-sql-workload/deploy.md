---
title: 'Ejemplo: plano de carga de trabajo de ISO 27001 App Service entorno/SQL Database: pasos de implementación'
...
ms.locfileid: "58201915"
---
# <a name="deploy-the-azure-blueprints-iso-27001-app-service-environmentsql-database-workload-blueprint-sample"></a>Implementar el ejemplo de plano técnico de carga de trabajo planos técnicos de Azure ISO 27001 App Service entorno/SQL Database
...
1. Escriba el _Fundamentos_ del ejemplo de plano técnico:
   ...
   - **Nombre de instancia de blueprint**: Proporcione un nombre para la copia de la muestra de plano técnico de carga de trabajo ISO 27001 ASE/SQL.
