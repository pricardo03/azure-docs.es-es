...
Ahora que ha revisado la asignación de control de la muestra de plano técnico de carga de trabajo ISO 27001 App Service entorno/SQL Database, visite los siguientes artículos para obtener información sobre la arquitectura y cómo implementar este ejemplo:

> [!div class="nextstepaction"]
> [Plano de carga de trabajo de ISO 27001 App Service entorno/SQL Database: información general sobre](./index.md)
> [carga de trabajo de ISO 27001 App Service entorno/SQL Database blueprint: pasos de implementación](./deploy.md)
