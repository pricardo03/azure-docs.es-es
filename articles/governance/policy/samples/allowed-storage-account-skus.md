...
description: Esta definición de directiva de ejemplo requiere que las cuentas de almacenamiento usen una SKU aprobada definida en un parámetro.
ms.date: 01/23/2019
ms.topic: sample
