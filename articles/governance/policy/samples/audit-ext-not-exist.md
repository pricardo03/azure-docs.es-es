---
title: 'Ejemplo de Azure Policy: auditar si la extensión no existe'
description: Esta directiva de ejemplo audita si una extensión no se implementa con una máquina virtual.
