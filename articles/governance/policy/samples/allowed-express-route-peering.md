...
description: Esta definición de directiva de ejemplo requiere que ExpressRoute use ubicaciones de emparejamiento especificadas definidas en un parámetro.
ms.date: 01/23/2019
ms.topic: sample
