...
description: Esta ejemplo de definición de directiva requiere un nombre y un valor de etiqueta que se define en un parámetro en un grupo de recursos.
ms.date: 01/31/2019
ms.topic: sample
