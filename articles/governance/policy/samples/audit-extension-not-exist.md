...
description: Este ejemplo de definición de directiva audita si una extensión definida en un parámetro no está implementada en una máquina virtual.
ms.date: 01/23/2019
ms.topic: sample
