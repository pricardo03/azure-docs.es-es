...
description: Esta definición de directiva de ejemplo requiere que los equilibradores de carga usen una SKU aprobada definida en un parámetro.
ms.date: 01/23/2019
ms.topic: sample
