---
title: 'Ejemplo de Azure Policy: auditar si Network Watcher no está habilitado en la región'
description: Esta directiva de ejemplo audita si Network Watcher no está habilitado en una región especificada
