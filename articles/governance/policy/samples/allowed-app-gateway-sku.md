...
description: Esta definición de directiva de ejemplo requiere que Application Gateway use una SKU aprobada definida en un parámetro.
ms.date: 01/23/2019
ms.topic: sample
