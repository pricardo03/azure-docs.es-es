...
description: Esta definición de directiva de ejemplo requiere que todos los recursos se implementen en las ubicaciones aprobadas que se han definido en un parámetro.
ms.date: 01/26/2019
ms.topic: sample
