...
description: Esta definición de directiva de ejemplo requiere que las bases de datos de SQL Database usen una SKU aprobada. Los recursos que no cumplan en requisito se deniegan.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74076370"
---
# <a name="sample---allowed-sql-database-skus"></a>Ejemplo: SKU permitidas de SQL Database
