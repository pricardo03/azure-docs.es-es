...
description: Esta definición de directiva de ejemplo prohíbe el uso de las extensiones especificadas que se han definido en un parámetro en las máquinas virtuales.
ms.date: 01/23/2019
ms.topic: sample
