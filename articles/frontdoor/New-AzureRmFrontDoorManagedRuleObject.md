...
ms.locfileid: "47046529"
---
# New-AzureRmFrontDoorManagedRuleObject
Crear un objeto ManagedRule para la creación de directivas de WAF
...
### -RuleGroupOverride
Lista de la configuración de invalidación del proveedor administrado por Azure.
