...
ms.locfileid: "47047207"
---
# Set-AzureRmFrontDoor
Actualizar un equilibrador de carga de Front Door
...
## Description
El cmdlet **Set-AzureRmFrontDoor** actualiza un equilibrador de carga de Front Door. Si no se proporcionan parámetros de entrada, se usarán los parámetros antiguos desde la instancia de Front Door existente.

## EJEMPLOS

### Ejemplo 1: Actualizar una instancia de Front Door existente con ResourceGroupName y FrontDoorName.
```powershell
...
Actualizar una instancia de FrontDoor existente.

### Ejemplo 2: Actualizar una instancia de Front Door existente con el objeto PSFrontDoor.
```powershell
...
### Ejemplo 3: Actualizar una instancia de Front Door existente con ResourceId.
```powershell
...
### -BackendPool
Grupos de back-ends disponibles para la regla de enrutamiento.
...
### -EnabledState
Estado operativo del equilibrador de carga de Front Door.
...
### -FrontendEndpoint
Puntos de conexión de front-end disponibles para la regla de enrutamiento.
...
### -InputObject
Objeto de Front Door que se va a actualizar.
...
### -Name
Nombre de la instancia de Front Door que se va a actualizar.
...
### -ResourceId
Id. del recurso de la instancia de Front Door que se va a actualizar.
...
### -RoutingRule
Reglas de enrutamiento asociadas con esta instancia de Front Door.
...
### -Tag
Etiquetas asociadas con FrontDoor.
