...
ms.locfileid: "47046744"
---
# Set-AzureRmFrontDoorFireWallPolicy
Actualizar una directiva de WAF.
...
## Description
El cmdlet **Set-AzureRmFrontDoor** actualiza una directiva existente de WAF. Si no se proporcionan parámetros de entrada, se usarán los parámetros antiguos desde la directiva de WAF existente.

## EJEMPLOS

### Ejemplo 1: Actualizar una directiva existente de WAF
```powershell
...
Actualizar una directiva existente de WAF

### Ejemplo 2: Actualizar una directiva existente de WAF
```powershell
...
### Ejemplo 3: Actualizar una directiva existente de WAF
```powershell
...
### Ejemplo 4: Actualizar todas las directivas de WAF en $resourceGroup
```powershell
...
Actualizar todas las directivas de WAF en $resourceGroup
...
### -InputObject
Objeto FireWallPolicy que se va a actualizar.
...
### -Name
Nombre de FireWallPolicy que se va a actualizar.
...
### -ResourceGroupName
Grupo de recursos al que pertenece FireWallPolicy.
...
### -ResourceId
Id. de recurso de FireWallPolicy que se va a actualizar.
