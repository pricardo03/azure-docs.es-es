...
ms.locfileid: "47046800"
---
# New-AzureRmFrontDoorCustomRuleObject
Crear un objeto CustomRule para la creación de directivas de WAF
...
Crear un objeto CustomRule

## PARÁMETROS

### -Action
Tipo de acción.
Los valores posibles son: "Allow", "Block", "Log".
...
Duración del límite de tasa. Valor predeterminado: 1 minuto
...
### -RuleType
Tipo de la regla.
Entre los valores posibles se incluyen: "MatchRule", "RateLimitRule"
