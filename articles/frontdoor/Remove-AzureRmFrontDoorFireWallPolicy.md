...
ms.locfileid: "47046736"
---
# Remove-AzureRmFrontDoorFireWallPolicy
Quitar una directiva de WAF
...
## Description
El cmdlet **Remove-AzureRmFrontDoor** quita una directiva de WAF en la suscripción actual
...
Quitar la directiva de WAF denominada $name en $resourceGroup.
...
Quitar todas las directivas de WAF en $resourceGroup.
...
### -InputObject
Objeto de la directiva de WAF que va a eliminar.
...
### -Name
Nombre de la directiva de WAF que va a eliminar.
...
### -ResourceGroupName
Grupo de recursos al que pertenece la directiva de WAF.
...
### -ResourceId
Id. del recurso de la directiva de WAF que va a eliminar.
