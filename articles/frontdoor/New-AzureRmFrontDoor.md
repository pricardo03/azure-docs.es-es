...
ms.locfileid: "47047025"
---
# New-AzureRmFrontDoor

Creación de un nuevo equilibrador de carga de Azure Front Door
...
## Description
El cmdlet **New-AzureRmFrontDoor** crea un nuevo equilibrador de carga de Azure Front Door en el grupo de recursos especificado en la suscripción actual

## EJEMPLOS

### Ejemplo 1: Creación de Front Door según los parámetros dados.
```powershell
...
Cree una instancia de Front Door según los parámetros dados.

## PARÁMETROS

### -BackendPool
Grupos de back-end disponibles para la regla de enrutamiento.
...
### -EnabledState
Si el estado del equilibrador de carga de Front Door está habilitado.
...
### -HealthProbeSetting
La configuración del sondeo de mantenimiento asociada con esta instancia de Front Door.
...
La configuración del equilibrio de carga asociada con esta instancia de Front Door.
...
### -ResourceGroupName
Nombre del grupo de recursos en el que se creará Front Door.
...
### -Tag
Etiquetas asociadas con Front Door.
