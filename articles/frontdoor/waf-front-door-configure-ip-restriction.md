...
En primer lugar, cree una regla de permiso de IP para la directiva creada en el paso anterior. Tenga en cuenta que se requiere **--defer** porque una regla debe incluir al menos una condición de coincidencia. 
