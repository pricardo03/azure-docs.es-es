---
title: Uso de Azure IoT Device Workbench para crear dispositivos de versión preliminar de IoT Plug and Play | Microsoft Docs
description: Use la extensión de Azure IoT Device Workbench en Visual Studio Code para acelerar la creación de modelos de dispositivos IoT Plug and Play y la implementación del código de dispositivo.
author: liydu
ms.author: liydu
ms.date: 07/25/2019
ms.topic: conceptual
...
ms.locfileid: "69879212"
---
# <a name="use-azure-iot-device-workbench-extension-in-visual-studio-code"></a>Uso de la extensión de Azure IoT Device Workbench en Visual Studio Code

La extensión de Azure IoT Device Workbench de Visual Studio Code proporciona un entorno integrado para crear interfaces y modelos de funcionalidad del dispositivo (DCM), publicar en repositorios de modelos y generar código C de esqueleto para implementar la aplicación de dispositivo.
...
Para más información sobre cómo usar la extensión de Device Workbench para desarrollar dispositivos IOT, vea [https://github.com/microsoft/vscode-iot-workbench](https://github.com/microsoft/vscode-iot-workbench).

## <a name="prerequisites"></a>Requisitos previos

Instale [Visual Studio Code](https://code.visualstudio.com/).

Siga estos pasos para instalar la extensión en VS Code.

1. En VS Code, seleccione la pestaña **Extensiones**.
1. Busque e instale **Azure IOT Device Workbench** desde Marketplace.
...
1. Abra el repositorio **azure-iot-sdk-c** en el panel de **Team Explorer**, seleccione **Ramas**, busque la rama **public-preview** y extráigala del repositorio.
    ...
    ![Versión preliminar pública](media/howto-use-iot-device-workbench/vs-public-preview.png)
...
1. En la barra de herramientas **General**, busque el menú desplegable **Configuraciones**. Seleccione **Administrar configuración** para agregar la configuración de CMake del proyecto.
    ...
    ![Administrar configuración](media/howto-use-iot-device-workbench/vs-manage-config.png)
...
La extensión de Azure IoT Device Workbench es un proyecto de código abierto en GitHub. En caso de que se produzca alguna incidencia o quiera solicitar una característica, puede [crear una incidencia en GitHub](https://github.com/microsoft/vscode-iot-workbench/issues).

## <a name="next-steps"></a>Pasos siguientes

En este artículo de procedimientos, ha aprendido a usar Azure IoT Device Workbench para crear archivos de DCM y de interfaz. También ha aprendido a generar código de C de esqueleto para implementar la aplicación de dispositivo. El siguiente paso sugerido es obtener información sobre cómo [instalar y usar la herramienta de explorador de Azure IoT](./howto-install-iot-explorer.md).
