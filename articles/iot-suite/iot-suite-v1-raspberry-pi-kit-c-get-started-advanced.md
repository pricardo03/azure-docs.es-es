---
title: Conexión de Raspberry Pi con Azure IoT Suite mediante C para admitir las actualizaciones de firmware | Microsoft Docs
description: Use el Starter Kit de IoT de Microsoft Azure para Raspberry Pi 3 y Azure IoT Suite. Use C para conectar su Raspberry Pi a la solución de supervisión remota, enviar telemetría desde sensores a la nube y realizar una actualización de firmware remota.
services: ''
suite: iot-suite
documentationcenter: ''
author: dominicbetts
