...
|`displayName`|Cadena|El nombre para mostrar del grupo.|
...
|`imageType`|Cadena|El método de implementación de la imagen. Estos son los valores que se admiten: `virtualMachineConfiguration` o `cloudServiceConfiguration`|
...
|`nodeAgentId`|Cadena|El SKU agente del nodo de Batch proporcionado en el nodo de ejecución.|
