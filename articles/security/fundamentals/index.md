---
title: Documentación sobre aspectos básicos de Azure Security Center
description: Más información sobre Azure Security
services: security
author: arob98
manager: angrobe
layout: LandingPage
...
ms.locfileid: "72792367"
---
# <a name="azure-security-fundamentals-documentation"></a>Documentación sobre aspectos básicos de Azure Security Center

Más información sobre Azure Security
        ...
        <a href="/azure/security/fundamentals/infrastructure">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">¿Cómo protege Microsoft la infraestructura de Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/develop">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Desarrollo e implementación de aplicaciones seguras</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/develop/secure-dev-overview">Procedimientos recomendados para un desarrollo seguro</a>
                            </li>
                        </ul>
                    </div>
                </div>
