...
![XML de eventos](media/azure-log-integration-faq/event-xml.png)
...
* [Operaciones de auditoría con Azure Resource Manager](/azure/azure-resource-manager/resource-group-audit)
...
Consulte [Administración y respuesta a las alertas de seguridad en Azure Security Center](/azure/security-center/security-center-managing-and-responding-alerts).
...
Consulte [Uso de PowerShell para habilitar Azure Diagnostics en una máquina virtual con Windows](/azure/virtual-machines/windows/ps-extensions-diagnostics?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) para más información acerca de cómo obtener, modificar y configurar Azure Diagnostics en Window. 
...
Si tiene algún problema durante la instalación y configuración, abra una [solicitud de soporte técnico](/azure/azure-supportability/how-to-create-azure-support-request). Seleccione **Azure Log Integration** como el servicio para el que está solicitando el soporte técnico.
