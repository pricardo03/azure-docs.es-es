...
**Detalles**: Supervise [usuarios en riesgo](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-user-at-risk) e [inicios de sesión en riesgo](../active-directory/reports-monitoring/concept-risk-events.md) mediante los informes de seguridad de Azure AD.

**Procedimiento recomendado**: Detectar y corregir de forma automática las contraseñas de alto riesgo.   
**Detalles**: [Azure AD Identity Protection](../active-directory/identity-protection/overview.md) es una característica de la edición Azure AD Premium P2 que permite:
