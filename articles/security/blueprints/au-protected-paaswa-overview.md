...
Cada uno de los grupos de seguridad de red tiene puertos y protocolos específicos abiertos para que la solución pueda funcionar de forma segura y correcta. Además, las siguientes opciones de configuración están habilitadas para cada grupo de seguridad de red:
  ...
  - Registros de Azure Monitor se conecta a la [diagnósticos del grupo de seguridad de red](https://github.com/krnese/AzureDeploy/blob/master/AzureMgmt/AzureMonitor/nsgWithDiagnostics.json)
...
Además, todas las transacciones en Azure a través del portal de administración de Azure se producen a través de HTTPS mediante TLS v1.2.
