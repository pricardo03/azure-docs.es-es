---
title: 'Azure Security and Compliance Blueprint: almacenamiento de datos para FFIEC'
description: 'Azure Security and Compliance Blueprint: almacenamiento de datos para FFIEC'
services: security
author: meladie
...
ms.locfileid: "37906371"
---
# <a name="azure-security-and-compliance-blueprint-data-warehouse-for-ffiec-financial-services"></a>Azure Security and Compliance Blueprint: almacenamiento de datos para servicios financieros FFIEC

## <a name="overview"></a>Información general

Este plano técnico Azure Security and Compliance Blueprint ofrece orientación para la implementación de una arquitectura de almacenamiento de datos en Azure adecuada para la recopilación, el almacenamiento y la recuperación de datos financieros regulados por el Consejo Federal de Inspección de Instituciones Financieras (FFIEC).
...
![Diagrama de arquitectura de referencia de almacenamiento de datos para FFIEC](images/ffiec-dw-architecture.png "Data Warehouse for FFIEC reference architecture diagram")
...
El diagrama de flujo de datos de esta arquitectura de referencia está disponible para su [descarga](https://aka.ms/ffiec-dw-tm/) y se encuentra a continuación. El modelo puede ayudar a los clientes a comprender los puntos de riesgo potencial de la infraestructura del sistema al realizar modificaciones.

![Modelo de amenazas de almacenamiento de datos para FFIEC](images/ffiec-dw-threat-model.png "Data Warehouse for FFIEC threat model")
...
En [Azure Security and Compliance Blueprint: matriz de implementación de almacenamiento de datos para FFIEC](https://aka.ms/ffiec-dw-cim) se proporciona información sobre qué objetivos de FFIEC aborda la arquitectura de almacenamiento de datos, incluida una descripción detallada de cómo la implementación cumple los requisitos de cada objetivo cubierto.
