...
* La extensión Azure Disk Encryption se aplican después de una secuencia de comandos de shell personalizado que se da formato al servicio de soporte (Linux): [deploy-extseq-linux-ADE-after-customscript.json](https://github.com/Azure-Samples/compute-automation-configurations/blob/master/ade-vmss/deploy-extseq-linux-ADE-after-customscript.json)
