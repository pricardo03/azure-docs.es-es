...
![Actualizaciones de la galería de símbolos de Azure](./media/azure-security-threat-modeling-tool-releases-71509112/tmt_azure_stencil_update-300x70.png)
...
![Problema conocido con pantallas de alta resolución](./media/azure-security-threat-modeling-tool-releases-71509112/tmt_screen_resolution-300x153.png)
...
![Eliminada característica de OneDrive](./media/azure-security-threat-modeling-tool-releases-71509112/tmt_save_error-300x131.png)
...
![Eliminada característica de OneDrive](./media/azure-security-threat-modeling-tool-releases-71509112/tmt_save_onedrive-300x149.png)
...
![Actualizaciones de la galería de símbolos de Azure en el cliente de 2016](./media/azure-security-threat-modeling-tool-releases-71509112/tmt_azure_stencils-300x212.png)
