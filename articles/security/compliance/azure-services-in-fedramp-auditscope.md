...
| _Última actualización: mayo de 2019_ |
...
| [Azure DevOps (anteriormente VSTS)](https://azure.microsoft.com/services/devops/) | |  |  | :heavy_check_mark: |
...
| [Análisis de Data Lake](https://azure.microsoft.com/services/data-lake-analytics/) |  |  |  |  |
| [Event Grid](https://azure.microsoft.com/services/event-grid/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Advanced Threat Protection de Defender](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) |  | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Análisis de tráfico de Network Watcher](https://docs.microsoft.com/azure/network-watcher/traffic-analytics) |  |  |  | :heavy_check_mark: |
...
&ast;&ast; Atestación de SOC de Azure Databricks que incluye solo el informe de SOC 2 tipo 2
...
| [Centros de notificaciones](https://azure.microsoft.com/services/notification-hubs/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: **&ast;** | :heavy_check_mark: |
