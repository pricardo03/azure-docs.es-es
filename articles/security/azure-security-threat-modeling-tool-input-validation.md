...
| **Atributos**              | N/D  |
| **Referencias**              | [Impedir el scripting entre sitios en ASP.NET](http://msdn.microsoft.com/library/ms998274.aspx), [Scripting entre sitios](http://cwe.mitre.org/data/definitions/79.html), [Hoja de referencia rápida de prevención de (scripting entre sitios) XSS](https://www.owasp.org/index.php/XSS_(Cross_Site_Scripting)_Prevention_Cheat_Sheet) |
