...
El destino Open Hub (OHD) para SAP BW define el destino al que se retransmitirán los datos de SAP. Todos los objetos compatibles con el proceso de transferencia de datos (DTP) de SAP pueden utilizarse como orígenes de datos de Open Hub; por ejemplo, DSO, InfoCube, MultiProvider, DataSource, etc. Tipo de destino Open Hub: donde se almacenan los datos retransmitidos; puede tratarse de tablas de base de datos (locales o remotas) y de archivos planos. Este conector de Open Hube para SAP BW admite la copia de datos desde la tabla local de OHD a BW. Si usa otros tipos, puede conectarse directamente a la base de datos o al sistema de archivos con otros conectores.
...
- SAP Business Warehouse **versión 7.30 o posteriores (en una pila de paquetes de soporte técnico de SAP reciente lanzada después de 2015)**.
...
|:--- |:--- |:--- |
| Tipo | La propiedad type debe establecerse en: **SapOpenHub** | SÍ |
