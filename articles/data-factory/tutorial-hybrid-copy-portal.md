...
13. En la ventana **Nuevo servicio vinculado**, asegúrese de que el **entorno de ejecución de integración** que creó anteriormente está seleccionado en **Connect via integration runtime** (Conectar mediante IR). 
