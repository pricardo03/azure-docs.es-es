---
title: Copia de datos de Azure Data Lake Storage Gen1 en Gen2 (versión preliminar) con Azure Data Factory
description: Uso de Azure Data Factory para copiar datos de Azure Data Lake Storage Gen1 en Gen2 (versión preliminar)
...
1. En el menú izquierdo, seleccione **Nuevo** > **Datos y análisis** > **Data Factory**:
   ...
   ![Creación de una factoría de datos](./media/load-azure-data-lake-storage-gen2-from-gen1/new-azure-data-factory-menu.png)
...
4. En la página **Specify Azure Data Lake Storage Gen1 connection** (Especificar conexión de Azure Data Lake Storage Gen1), siga estos pasos:
   ...
   > [!IMPORTANT]
   > En este tutorial, utilizará una _identidad de servicio administrada_ para autenticar Data Lake Storage Gen1e. Asegúrese de conceder a MSI los permisos adecuados en Azure Data Lake Storage Gen1 con [estas instrucciones](connector-azure-data-lake-store.md#using-managed-service-identity-authentication).
