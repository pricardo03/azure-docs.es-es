...
>[!NOTE]
>Si escribe en el tipo de datos **Money/Smallmoney** mediante la invocación de un procedimiento almacenado, se pueden redondear los valores. Especifique el tipo de datos correspondiente en los parámetros con valores de tabla como **Decimal** en lugar de **Money/Smallmoney** para mitigar este problema. 
