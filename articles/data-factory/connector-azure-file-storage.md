...
| host | Especifica el punto de conexión de Azure File Storage como: <br/>-Usar la interfaz de usuario: especificar `\\<storage name>.file.core.windows.net\<file service name>`<br/>-Si se usa JSON: `"host": "\\\\<storage name>.file.core.windows.net\\<file service name>"`. | Sí |
| userid | Especifique el usuario para acceder a Azure File Storage como: <br/>-Usar la interfaz de usuario: especificar `AZURE\<storage name>`<br/>-Si se usa JSON: `"userid": "AZURE\\<storage name>"`. | Sí |
