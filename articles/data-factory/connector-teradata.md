...
- Instalar el [proveedor de datos .NET para Teradata](https://go.microsoft.com/fwlink/?LinkId=278886) versión 14 o posterior en la máquina de Integration Runtime.
