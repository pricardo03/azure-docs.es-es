...
> [!NOTE]
> Mientras que la luz del modo de depuración es verde en la barra de herramientas de Data Factory, se le cobrará a la tarifa de depuración de flujo de datos de 8 núcleos por hora de proceso general con un 60 minutos período de vida 
...
Cuando haya terminado con la depuración, desactivar el conmutador de depuración para que pueda finalizar el clúster de Azure Databricks y ya no se le cobrará de la actividad de depuración.
