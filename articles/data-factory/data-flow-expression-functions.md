...
Se convierte en la marca de tiempo a la hora UTC. Opcionalmente, puede transferir la zona horaria en forma de 'GMT', 'PST', 'UTC', ' América/Caimán'. La zona horaria actual se establece como predeterminada * ``fromUTC(currentTimeStamp()) -> 12-12-2030T19:18:12``
...
Basándose en una condición, aplica un valor o el otro. Si otros no se especifica, se considera NULL. Ambos valores deben ser compatibles (numéricos, cadena...) * ``iif(custType == 'Premium', 10, 4.5)``
* ``iif(amount > 100, 'High')``
...
Comprueba si la fila está marcada para eliminar. Para las transformaciones tardando más de un flujo de entrada puede pasar el índice (basado en 1) de la secuencia. El valor predeterminado del índice del flujo es 1 * ``isDelete() -> true``
* ``isDelete(1) -> false``
*********************************
<code>isError</code>
==============================
<code><b>isError([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Comprueba si la fila se marca como error. Para las transformaciones tardando más de un flujo de entrada puede pasar el índice (basado en 1) de la secuencia. El valor predeterminado del índice del flujo es 1 * ``isError() -> true``
* ``isError(1) -> false``
*********************************
<code>isIgnore</code>
==============================
<code><b>isIgnore([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Comprueba si la fila se marca para pasarse por alto. Para las transformaciones tardando más de un flujo de entrada puede pasar el índice (basado en 1) de la secuencia. El valor predeterminado del índice del flujo es 1 * ``isIgnore() -> true``
* ``isIgnore(1) -> false``
*********************************
<code>isInsert</code>
==============================
<code><b>isInsert([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Comprueba si la fila está marcada para insertar. Para las transformaciones tardando más de un flujo de entrada puede pasar el índice (basado en 1) de la secuencia. El valor predeterminado del índice del flujo es 1 * ``isInsert() -> true``
* ``isInsert(1) -> false``
*********************************
<code>isMatch</code>
==============================
<code><b>isMatch([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Comprueba si la fila cumplía los criterios de coincidencia en la búsqueda. Para las transformaciones tardando más de un flujo de entrada puede pasar el índice (basado en 1) de la secuencia. El valor predeterminado del índice del flujo es 1 * ``isMatch() -> true``
* ``isMatch(1) -> false``
*********************************
<code>isNull</code>
==============================
...
Comprueba si la fila está marcada para actualizar. Para las transformaciones tardando más de un flujo de entrada puede pasar el índice (basado en 1) de la secuencia. El valor predeterminado del índice del flujo es 1 * ``isUpdate() -> true``
* ``isUpdate(1) -> false``
*********************************
<code>kurtosis</code>
==============================
...
Obtiene el valor del primer parámetro evaluado n filas antes de la fila actual. El segundo parámetro es el número de filas para mirar hacia atrás y el valor predeterminado es 1. Si no hay tantas filas, se devuelve un valor null a menos que se especifique un valor predeterminado * ``lag(amount, 2) -> 60``
...
Obtiene el valor del primer parámetro evaluado n filas después de la fila actual. El segundo parámetro es el número de filas para buscar hacia delante y el valor predeterminado es 1. Si no hay tantas filas, se devuelve un valor null a menos que se especifique un valor predeterminado * ``lead(amount, 2) -> 60``
...
Devuelve un valor NULL. Use la función syntax(null()) si hay un nombre de columna denominado 'null'. Cualquier operación que utiliza dará como resultado un valor NULL * ``custId = NULL (for derived field)``
* ``custId == NULL -> NULL``
* ``'nothing' + NULL -> NULL``
* ``10 * NULL -> NULL'``
* ``NULL == '' -> NULL'``
...
Convierte una cadena en una fecha dado un formato de marca de tiempo opcional. Consulte Java SimpleDateFormat para todos los formatos posibles. Si la marca de tiempo se omite, se usa el patrón predeterminado aaaa-[M]M-[d]d hh:mm:ss[.f...] * ``toTimestamp('2016-12-31 00:12:00') -> 2012-8-8T00:12:00``
...
==============================
<code><b>toInteger(<i>&lt;value&gt;</i> : any, [<i>&lt;format&gt;</i> : string]) => integer</b></code><br/><br/>
Convierte cualquier numérica o cadena en un valor entero. Se puede utilizar un formato decimal de Java opcional para la conversión. Trunca cualquier tipo long, float o double * ``toInteger(123) -> 123``
* ``toInteger('123') -> 123``
* ``toInteger('$123', '$###') -> 123``
*********************************
<code>toLong</code>
