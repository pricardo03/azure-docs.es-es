...
Asigna cada elemento de la matriz a un nuevo elemento mediante la expresión proporcionada. Map espera una referencia a un elemento en la función de expresión como #item y una referencia al índice del elemento como #index * ``iMap([1, 2, 3, 4], #item + 2 + #index) -> [4, 6, 8, 10]``
___
### <code>iif</code>
...
Acumula los elementos de una matriz. Reduce espera una referencia a un acumulador y a un elemento en la primera función de expresión, como #acc e #item, y espera que el valor resultante sea #result para poder usarlo en la segunda función de expresión * ``reduce([1, 2, 3, 4], 0, #acc + #item, #result) -> 10``
