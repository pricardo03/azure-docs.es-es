...
Para obtener acceso a la aplicación web en Internet, necesita una dirección IP pública para el equilibrador de carga. Utilice [az network public-ip create](https://docs.microsoft.com/cli/azure/network/public-ip) para crear una dirección IP pública llamada *myPublicIP* en *myResourceGroupLB*.
...
Cree dos interfaces de red con el comando [az network nic create](/cli/azure/network/nic#az-network-nic-create) y asócielas con la dirección IP pública y el grupo de seguridad de red. 
