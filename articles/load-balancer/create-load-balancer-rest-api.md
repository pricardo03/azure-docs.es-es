...
| :--- | :--- | :---------- |
| ubicación | string | Ubicación del recurso Obtenga una lista actualizada de ubicaciones mediante la operación [Enumerar ubicaciones](https://docs.microsoft.com/rest/api/resources/subscriptions/listlocations) operación. |
