...
- En general, no se admite el reenvío de fragmentos de IP o la realización de la fragmentación de IP de paquetes UDP y TCP en las reglas de equilibrio de carga.  [Las reglas de equilibrio de carga de los puertos de alta disponibilidad](load-balancer-ha-ports-overview.md) son una excepción a esta instrucción general y se pueden usar para reenviar fragmentos de IP existentes.
