---
title: 'Ejemplo de la CLI: Máquinas virtuales de Load Balancer en varias zonas de disponibilidad: Azure | Microsoft Docs'
...
| [az network lb rule create](https://docs.microsoft.com/cli/azure/network/lb/rule#az_network_lb_rule_create) | Crea una regla de equilibrador de carga. En este ejemplo, se crea una regla para el puerto 80. Según va llegando el tráfico HTTP al equilibrador de carga, se enruta al puerto 80 de las máquinas virtuales incluido en un conjunto de carga equilibrada. |
