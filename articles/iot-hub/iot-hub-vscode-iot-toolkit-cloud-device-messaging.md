---
title: Administración de la mensajería de dispositivos en la nube de Azure IoT Hub con la extensión Azure IoT Toolkit para Visual Studio Code | Microsoft Docs
description: Aprenda a usar la extensión Azure IoT Toolkit para Visual Studio Code a fin de supervisar mensajes del dispositivo a la nube y enviar mensajes de la nube al dispositivo en Azure IoT Hub.
...
ms.locfileid: "39206790"
---
# <a name="use-azure-iot-toolkit-extension-for-visual-studio-code-to-send-and-receive-messages-between-your-device-and-iot-hub"></a>Utilice la extensión Azure IoT Toolkit para Visual Studio Code a fin de enviar y recibir mensajes entre el dispositivo e IoT Hub

![Diagrama integral](media/iot-hub-get-started-e2e-diagram/2.png)

[Azure IoT Toolkit](https://marketplace.visualstudio.com/items?itemName=vsciot-vscode.azure-iot-toolkit) es una útil extensión de Visual Studio Code que facilita la administración de IoT Hub. Este artículo trata de cómo utilizar la extensión Azure IoT Toolkit para Visual Studio Code a fin de enviar y recibir mensajes entre el dispositivo e IoT Hub.
...
- Utilizará la extensión Azure IoT Toolkit para Visual Studio Code a fin de supervisar los mensajes del dispositivo a la nube.
- Utilizará la extensión Azure IoT Toolkit para Visual Studio Code a fin de enviar los mensajes de la nube al dispositivo.
...
1. Se mostrarán los mensajes controlados en la vista **SALIDA** > **Azure IoT Toolkit**.
...
1. Se mostrarán los resultados en la vista **SALIDA** > **Azure IoT Toolkit**.
