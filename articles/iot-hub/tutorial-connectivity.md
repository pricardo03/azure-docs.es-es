...
> * Comprobar la conectividad de la nube al dispositivo
...
Los scripts de la CLI que se ejecutan en este tutorial usan la [extensión de Microsoft Azure IoT para la CLI de Azure 2.0](https://github.com/Azure/azure-iot-cli-extension/blob/master/README.md). Para instalar esta extensión, ejecute el siguiente comando de la CLI:
