---
title: Configuración y uso de métricas y registros de diagnóstico con una instancia de Azure IoT Hub | Microsoft Docs
description: Configuración y uso de métricas y registros de diagnóstico con una instancia de Azure IoT Hub
author: robinsh
manager: philmea
ms.service: iot-hub
services: iot-hub
...
Los [registros de diagnóstico](../azure-monitor/platform/diagnostic-logs-overview.md) están deshabilitados de forma predeterminada cuando se crea un centro de IoT. En esta sección, habilitará los registros de diagnóstico para su centro.
