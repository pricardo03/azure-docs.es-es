...
>
> - No se permite realizar operaciones consecutivas de conmutación por error/conmutación por recuperación. Los usuarios tendrán que esperar una hora entre estas operaciones.
...
Tiempo de recuperación = RTO [10 m - 2 horas de conmutación por error manual | 2 - 26 horas de conmutación por error iniciada por Microsoft] + Retraso de propagación de DNS + Tiempo que emplea la aplicación cliente para actualizar la dirección IP de IoT Hub almacenada en caché. 
