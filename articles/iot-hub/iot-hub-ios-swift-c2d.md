...
Este es el dispositivo de ejemplo que se creó en el artículo [Send telemetry from a device to an IoT hub]. Si ya lo tiene en ejecución, puede omitir esta sección.
