...
* Una cuenta de Azure activa. (En caso de no tener ninguna, puede crear una [cuenta gratuita de Azure](http://azure.microsoft.com/pricing/free-trial/) en tan solo unos minutos).
