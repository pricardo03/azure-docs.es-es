---
title: Introducción a la identidad de módulo y a los módulos gemelos de Azure IoT Hub (C) | Microsoft Docs
...
ms.locfileid: "37035381"
---
# <a name="get-started-with-iot-hub-module-identity-and-module-twin-using-c-back-end-and-c-device"></a>Introducción a la identidad de módulo y los dispositivos gemelos de módulo de IoT Hub con un dispositivo C y un servidor back-end C
...
* Instalación del [SDK de C](https://github.com/Azure/azure-iot-sdk-c) más reciente.
...
## <a name="create-a-device-identity-and-a-module-identity-in-iot-hub"></a>Creación de una identidad del dispositivo y del módulo en IoT Hub
