...
1. Edite el archivo de origen *iothub_client_c2d_streaming_sample.c* en la carpeta *iothub_client/samples/iothub_client_c2d_streaming_sample* y proporcione la cadena de conexión del dispositivo, la dirección IP o nombre de host del dispositivo de destino y el puerto SSH 22:
