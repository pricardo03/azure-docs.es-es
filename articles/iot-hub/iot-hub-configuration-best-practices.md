...
La administración automática de dispositivos incluye las muchas ventajas de los [dispositivos gemelos][lnk-device-twins] y los [módulos gemelos][lnk-module-twins] para sincronizar los estados deseados y notificados entre los dispositivos y la nube.  Las [configuraciones automáticas de dispositivos][lnk-auto-device-config] actualizan automáticamente grandes conjuntos de gemelos y resumen el progreso y el cumplimiento. En los siguientes pasos generales se describe cómo se desarrolla y usa la administración automática de dispositivos:

* El **integrador o fabricante de hardware de IoT** implementa las características de administración de dispositivos dentro de una aplicación integrada mediante [dispositivos gemelos][lnk-device-twins]. Estas características pueden incluir actualizaciones de firmware, instalación y actualizaciones de software y administración de configuraciones.
* El **desarrollador de soluciones de IoT** implementa la capa de administración de las operaciones de administración de dispositivos mediante [dispositivos gemelos][lnk-device-twins] y [configuraciones automáticas de dispositivos][lnk-auto-device-config]. La solución debe incluir la definición de una interfaz de operador para llevar a cabo las tareas de administración de dispositivos.
...
* **Implementar [dispositivos gemelos][lnk-device-twins]:** los dispositivos gemelos permiten la sincronización de la configuración deseada desde la nube y la notificación de las propiedades actuales de configuración y de dispositivo.  La mejor manera de implementar dispositivos gemelos en aplicaciones integradas es mediante los [SDK de Azure IoT][lnk-azure-sdk].  Los dispositivos gemelos resultan muy adecuados para la configuración debido a que: a. admiten la comunicación bidireccional b. permiten estados de dispositivo conectado y desconectado c. siguen el principio de coherencia final d. se pueden consultar completamente en la nube
...
* Aprenda sobre la implementación de dispositivos gemelos en [Dispositivos gemelos de IoT Hub][lnk-device-twins].
* Siga los pasos para crear, actualizar o eliminar una configuración automática de dispositivos en [Configuración y supervisión de dispositivos IoT a escala][lnk-auto-device-config].
* Implemente un patrón de actualización de firmware mediante dispositivos gemelos y configuraciones automáticas de dispositivos con los pasos del [Tutorial: Implementación de un proceso de actualización de firmware de dispositivos][lnk-firmware-update].
