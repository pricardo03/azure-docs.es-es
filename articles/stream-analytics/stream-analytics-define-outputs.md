...
Stream Analytics admite [Azure Data Lake Storage Gen 1](../data-lake-store/data-lake-store-overview.md). Azure Data Lake Storage es un repositorio de hiperescala de toda la empresa para cargas de trabajo de análisis de macrodatos. Puede usar Data Lake Storage para almacenar los datos de cualquier tamaño, tipo y velocidad de ingesta para realizar análisis exploratorios y operativos. Stream Analytics debe tener autorización para acceder a Data Lake Storage.

Salida de almacenamiento de Azure Data Lake de Stream Analytics no está disponible en las regiones de Azure Alemania (T-Systems International) y Azure China (21Vianet).

En la tabla siguiente se enumera los nombres de propiedad y sus descripciones para configurar la salida de Data Lake Storage Gen 1.   
...
| Subscription | La suscripción que contiene la cuenta de Azure Data Lake Storage. |
...
| Modo de autenticación | Puede autorizar el acceso a su cuenta de Data Lake Storage mediante [identidad administrada](stream-analytics-managed-identities-adls.md) o token de usuario. Una vez que concede acceso, puede revocar el acceso cambiando la contraseña de cuenta de usuario, eliminando la salida de Data Lake Storage para este trabajo o la eliminación del trabajo de Stream Analytics. |
...
> [!NOTE]
> La base de datos de SQL Azure ofrece se admite para un trabajo de salida en Stream Analytics, pero una máquina virtual de Azure que ejecuta SQL Server con una base de datos adjunta no se admite.

## <a name="blob-storage"></a>Almacenamiento de blobs

Azure Blob storage ofrece una solución rentable y escalable para almacenar grandes cantidades de datos no estructurados en la nube. Para obtener una introducción en Blob storage y su uso, consulte [carga, descarga y enumeración de blobs con Azure portal](../storage/blobs/storage-quickstart-blobs-portal.md).
...
En la tabla siguiente se enumera los nombres de propiedad y sus descripciones para configurar la salida de Power BI.
...
| Autorizar conexión | Deberá realizar la autorización con Power BI para configurar los valores de salida. Una vez que se puede conceder este acceso de salida en el panel de Power BI, puede revocar el acceso cambiando la contraseña de cuenta de usuario, eliminando la salida del trabajo o la eliminación del trabajo de Stream Analytics. | 

Para ver un tutorial de la configuración de una salida de Power BI y un panel, vea el [Azure Stream Analytics y Power BI](stream-analytics-power-bi-dashboard.md) tutorial.
