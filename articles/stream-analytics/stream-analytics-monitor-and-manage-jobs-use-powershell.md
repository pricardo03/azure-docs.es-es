...
**En los ejemplos que muestran el primer comando es para Azure PowerShell 0.9.8, el segundo comando es para Azure PowerShell 1.0.** Los comandos de Azure PowerShell 1.0 siempre tendrán "Az" en el comando.
