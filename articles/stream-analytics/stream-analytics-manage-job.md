...
2. Seleccione **Crear un recurso** > **Internet de las cosas** > **Event Hubs**.  
   ...
   ![Crear un centro de eventos de Azure](media/stream-analytics-manage-job/find-eh.png)
...
4. **Guarde** la consulta.  
   ...
   ![Definir la consulta de Stream Analytics](media/stream-analytics-manage-job/define-query.png)
