...
## <a name="handling-event-producers-with-differing-timelines-with-substreams"></a>Control de productores de eventos con escalas de tiempo diferentes con "secuencias secundarias"
