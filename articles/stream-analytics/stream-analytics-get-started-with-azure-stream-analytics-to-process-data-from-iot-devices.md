...
4. Active la casilla para colocar el trabajo en el panel y haga clic en **CREAR**.
    ...
    ![Creación del trabajo de Stream Analytics en curso](./media/stream-analytics-get-started-with-iot-devices/stream-analytics-get-started-with-iot-devices-03a.png)
5. Debería ver un mensaje de "La implementación empezó..." en la parte superior derecha de la ventana del explorador. Pronto cambiará a una ventana completada, tal como se muestra a continuación.
    ...
    ![La implementación de Stream Analytics se realizó correctamente](./media/stream-analytics-get-started-with-iot-devices/stream-analytics-get-started-with-iot-devices-03b.png)
...
![Icono del trabajo de Stream Analytics en Azure Portal](./media/stream-analytics-get-started-with-iot-devices/stream-analytics-get-started-with-iot-devices-04.png)
...
1. Copie y pegue la consulta del archivo PassThrough.txt. 
    ...
    ![Pegar la consulta en el editor de consultas de Stream Analytics](./media/stream-analytics-get-started-with-iot-devices/stream-analytics-get-started-with-iot-devices-06.png)
2. Haga clic en los puntos suspensivos junto a la entrada y seleccione el cuadro **Cargar datos de ejemplo desde un archivo**.
   
    ![Elegir cargar datos de ejemplo desde un archivo](./media/stream-analytics-get-started-with-iot-devices/stream-analytics-get-started-with-iot-devices-06a.png)
3. Como resultado, se abre un panel a la derecha; en él, seleccione el archivo de datos HelloWorldASA-InputStream.json en la ubicación donde esté descargado y haga clic en **Aceptar** en la parte inferior del panel.
    ...
    ![Cargar un archivo de datos de ejemplo json](./media/stream-analytics-get-started-with-iot-devices/stream-analytics-get-started-with-iot-devices-06b.png)
