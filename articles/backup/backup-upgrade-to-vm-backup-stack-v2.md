...
### <a name="what-happens-if-i-select-retention-period-of-restore-point-tier-2-less-than-snapshot-tier1"></a>¿Qué ocurre si selecciono un período de retención de punto de restauración (nivel 2) inferior a la instantánea (nivel 1)?
La versión 2 de pila de copia de seguridad de VM no permite eliminar el punto de restauración (nivel 2), a menos que se elimine la instantánea (nivel 1). Actualmente admitimos períodos de retención de 7 días para la eliminación de la instantánea (nivel 1), por lo que el período de retención del punto de restauración (nivel 2) inferior a 7 días no se respeta. Se recomienda programar un período de retención del punto de restauración (nivel 2) superior a 7 días.
