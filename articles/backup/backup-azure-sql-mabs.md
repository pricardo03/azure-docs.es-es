---
title: Copias de seguridad de SQL Server con Azure Backup Server
...
3. MABS muestra la pantalla de inicio con instrucciones sobre cómo crear un **grupo de protección**. Haga clic en **Next**.
