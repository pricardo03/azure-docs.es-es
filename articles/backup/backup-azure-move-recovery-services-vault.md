---
title: 'Traslado de un almacén de Recovery Services entre suscripciones de Azure o grupos de recursos: Azure Backup'
...
## <a name="supported-region"></a>Región admitida
