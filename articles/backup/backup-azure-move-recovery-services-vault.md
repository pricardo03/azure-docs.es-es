...
## <a name="register-the-subscription-to-move-your-recovery-services-vault"></a>Registro de la suscripción para mover el almacén de Recovery Services

Para registrar la suscripción para **mover** el almacén de Recovery Services, ejecute los siguientes cmdlets desde el terminal de PowerShell:
