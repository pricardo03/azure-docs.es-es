...
| DiffBackupRetentionDuration     | Número decimal | Duración de retención de las copias de seguridad diferenciales de SQL en la copia de seguridad de máquinas virtuales de Azure. |
| DiffBackupTime                  | Hora           | Tiempo para copias de seguridad diferenciales de SQL en la copia de seguridad de máquinas virtuales de Azure.     |
| LogBackupFrequency              | Número decimal | Frecuencia de las copias de seguridad de registros de SQL.                            |
| LogBackupRetentionDuration      | Número decimal | Duración de retención de las copias de seguridad de registro de SQL en la copia de seguridad de máquinas virtuales de Azure. |
...
| SynchronisationFrequencyPerDay  | Número entero   | Número de veces en un día que se sincroniza una copia de seguridad de archivos para SC DPM y MABS. |
...
- [Más información sobre cómo enviar datos a Log Analytics](https://aka.ms/AA6il6r)