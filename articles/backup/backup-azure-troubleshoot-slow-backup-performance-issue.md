...
## <a name="cause-performance-bottlenecks-on-the-computer"></a>Causa: Cuellos de botella en el equipo
...
## <a name="cause-backup-agent-running-on-an-azure-virtual-machine"></a>Causa: Agente de copia de seguridad que se ejecuta en una máquina virtual de Azure
...
## <a name="cause-backing-up-a-large-number-millions-of-files"></a>Causa: Un gran número (millones) de los archivos de copia de seguridad
