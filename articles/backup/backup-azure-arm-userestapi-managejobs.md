---
title: 'Azure Backup: Administración de los trabajos de copia de seguridad mediante API REST'
...
Una operación como desencadenar la copia de seguridad siempre devolverá un valor de jobID. Por ejemplo, la respuesta final de una [operación para desencadenar una copia de seguridad en API REST](backup-azure-arm-userestapi-backupazurevms.md#example-responses-3) es como sigue:
