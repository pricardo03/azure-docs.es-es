...
En el siguiente ejemplo se agrega la extensión Estado de la aplicación (con el nombre myHealthExtension) a extensionProfile en un modelo de conjunto de escalado de un conjunto de escalado basado en Windows.
...
Use el cmdlet [Add-AzureRmVmssExtension](/powershell/module/azurerm.compute/add-azurermvmssextension) para agregar la extensión Estado de la aplicación a la definición del modelo del conjunto de escalado.

En el siguiente ejemplo se agrega la extensión Estado de la aplicación al `extensionProfile` en un modelo de conjunto de escalado de un conjunto de escalado basado en Windows.
