...
Basta con que agregue el parámetro "-Priority" a [New-AzVmssConfig](/powershell/module/az.compute/new-azvmssconfig) y lo establezca en *Low*, como se muestra en el ejemplo siguiente:
