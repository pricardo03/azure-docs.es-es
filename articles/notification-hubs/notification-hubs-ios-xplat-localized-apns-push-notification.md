...
1. En `Notification.h` agregue el método `retrieveLocale` y modifique el almacén y suscríbase a métodos tal como se muestra en el siguiente código:
