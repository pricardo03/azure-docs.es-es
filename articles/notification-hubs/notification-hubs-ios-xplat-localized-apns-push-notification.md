...
* Visual Studio de 2019 es opcional.
...
1. En su `Notification.h`, agregue el `retrieveLocale` método, modifique el almacén y suscríbase a métodos tal como se muestra en el código siguiente:
