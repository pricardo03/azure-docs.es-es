...
3. Seleccione **Guardar**.
   ...
   ![Captura de pantalla que muestra los cuadros SID del paquete y la clave de seguridad](./media/notification-hubs-windows-store-dotnet-get-started/notification-hub-configure-wns.png)
