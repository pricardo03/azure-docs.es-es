...
Puede descargar el token de autenticación después de generar un token para la aplicación. Para obtener más información sobre cómo generar este token, vea la [documentación para desarrolladores de Apple](https://help.apple.com/xcode/mac/current/#/devdfd3d04a1).
...
> [!IMPORTANT]
> La autenticación basada en token requiere una versión de API de: **2017-04 o posterior**.
