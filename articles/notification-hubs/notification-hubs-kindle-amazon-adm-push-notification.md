...
* Obtenga Android SDK (asumiendo que esté usando Eclipse) en el [portal para desarrolladores de Android](https://go.microsoft.com/fwlink/?LinkId=389797).
...
1. En Eclipse, cree un archivo nuevo de nombre `api_key.txt` en los recursos del directorio del proyecto.
