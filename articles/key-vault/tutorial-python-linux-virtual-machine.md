---
title: 'Tutorial: Uso de Azure Key Vault con una máquina virtual Linux de Azure en Python | Microsoft Docs'
...
El siguiente proceso tiene dos pasos. 
...
Al ejecutarlo, debería ver el valor del secreto 
