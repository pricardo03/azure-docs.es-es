...
En este tutorial se verán los pasos necesarios para conseguir que una aplicación web de Azure lea información del almacén de claves mediante identidades administradas para recursos de Azure. Aprenderá a:
...
En el ejemplo siguiente, se crea un grupo de recursos denominado *ContosoResourceGroup* en la ubicación *eastus*.
...
>[!IMPORTANT]
> Si recibe el mensaje Error HTTP 502.5: error en el proceso,
> > compruebe el nombre de la instancia de Key Vault especificada en `Program.cs`
