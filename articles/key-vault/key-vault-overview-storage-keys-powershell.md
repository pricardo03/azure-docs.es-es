...
> [!TIP]
> Azure AD proporciona a cada aplicación registrada una **[entidad de servicio](/azure/active-directory/develop/developer-glossary#service-principal-object)**, que actúa como la identidad de la aplicación. La entidad de servicio puede luego recibir autorización para el acceso a otros recursos de Azure, como Key Vault, a través del control de acceso basado en rol (RBAC). Dado que Key Vault es una aplicación de Microsoft, está registrada previamente en todos los inquilinos de Azure AD con el identificador de aplicación "cfa8b339-82a2-471a-a3c9-0fc0be7a4093".
...
- [Referencia de PowerShell para Key Vault](/powershell/module/azurerm.keyvault/)
