...
Para conocer las referencias de programación, consulte [Referencia de la API de cliente de C# de Azure Key Vault](https://msdn.microsoft.com/en-us/library/azure/mt430941.aspx).
