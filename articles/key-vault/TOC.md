...
## [Lectura desde un almacén de claves: Node.js](quick-create-node.md)
# Tutoriales
...
## Node.js
### [Administración de almacenes](https://docs.microsoft.com/javascript/api/azure-arm-keyvault/)
### [Biblioteca cliente de almacén](https://docs.microsoft.com/javascript/api/azure-keyvault/)
## Desarrollo
