---
title: Creación de una canalización de CI/CD para lenguaje Go con Azure DevOps Projects | Guía de inicio rápido
description: Azure DevOps Projects facilita empezar a usar Azure. Le ayuda a iniciar rápidamente una aplicación web de Go en el servicio de Azure de su elección.
ms.prod: devops
...
ms.locfileid: "47408970"
---
# <a name="create-a-cicd-pipeline-for-go-with-the-azure-devops-project"></a>Creación de una canalización de CI/CD para Go con Azure DevOps Projects

Configure la integración continua (CI) y la entrega continua (CD) para la aplicación **Go** con **Azure DevOps Projects**.  El proyecto de Azure DevOps simplifica la configuración inicial de una compilación de Azure DevOps Services y la canalización de versión.
...
Azure DevOps Projects crea una canalización de CI/CD en Azure.  Puede crear una organización de **Azure DevOps Services nueva** o usar una **existente**.  Azure DevOps Projects también crea **recursos de Azure** en la **suscripción de Azure** de su elección.
...
1. Elija el icono **+ Crear un recurso** en la barra de navegación izquierda y busque **Proyecto de DevOps**.  Seleccione **Create**.
    ...
    ![Inicio de la entrega continua](_img/azure-devops-project-go/fullbrowser.png)
...
1. **Aplicación simple de Go** es el marco de trabajo predeterminado.  Elija **Siguiente**. 

1. El marco de trabajo de la aplicación que eligió en los pasos anteriores determina el tipo de destino de implementación del servicio de Azure disponible para su implementación.  Deje el servicio de Azure predeterminado y haga clic en **Siguiente**.
...
1. En el lado izquierdo del explorador, vaya al archivo **views/index.html**.

1. Seleccione **Editar** y realice un cambio en algún texto.  Por ejemplo, modifique el texto dentro de una de las etiquetas div.

1. Elija **Confirmar** y, después, guarde los cambios.

1. En el explorador, vaya al **panel de proyectos de Azure DevOps**.  Debería ver que hay una compilación en curso.  Los cambios que hizo se compilan e implementan automáticamente a través de una canalización de CI/CD de Azure.
