...
Configure la integración continua (CI) y la entrega continua (CD) para la aplicación Ruby on Rails con **Azure DevOps Projects**.  El proyecto de Azure DevOps simplifica la configuración inicial de una compilación de Azure DevOps Services y la canalización de versión.
