...
El proyecto de Azure DevOps ofrece una experiencia simplificada que crea recursos de Azure y configura una canalización de integración continua (CI) y entrega continua (CD) para la aplicación Python en Azure DevOps Services.  
...
El proyecto de Azure DevOps configura automáticamente una compilación de CI y un desencadenador de versión.  Ahora ya puede colaborar con un equipo en una aplicación de Node.js con un proceso de CI/CD que implemente automáticamente el trabajo más reciente en su sitio web.
