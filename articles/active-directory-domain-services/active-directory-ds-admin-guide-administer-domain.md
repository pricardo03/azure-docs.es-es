...
Microsoft administra el dominio, incluidas actividades como aplicación de revisiones, supervisión, realizar copias de seguridad, etc. El dominio está bloqueado, y usted no tiene privilegios para realizar ciertas tareas administrativas en él. A continuación se proporcionan algunos ejemplos de tareas que no puede realizar.
...
Ahora, puede usar herramientas administrativas de Windows Server AD para explorar y administrar el dominio administrado.
