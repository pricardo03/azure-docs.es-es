---
title: Cómo decidir si Active Directory Domain Services es adecuado para su caso de uso
...
* Consulte los [escenarios de implementación comunes de Azure AD Domain Services](scenarios.md).
* Finalmente, [compare Azure AD Domain Services con una opción de AD de implementación personal](comparison.md#compare-azure-ad-domain-services-to-diy-ad-domain-in-azure).
...
| --- |:---:|:---:|
| [**Servicio administrado**](comparison.md#managed-service) |**&#x2713;** |**&#x2715;** |
| [**Implementaciones seguras**](comparison.md#secure-deployments) |**&#x2713;** |El administrador debe proteger la implementación. |
| [**Servidor DNS**](comparison.md#dns-server) |**&#x2713;** (servicio administrado) |**&#x2713;** |
| [**Domain or Enterprise administrator privileges**](comparison.md#domain-or-enterprise-administrator-privileges) |**&#x2715;** |**&#x2713;** |
| [**Unión a un dominio**](comparison.md#domain-join) |**&#x2713;** |**&#x2713;** |
| [**Autenticación de dominios mediante NTLM y Kerberos**](comparison.md#domain-authentication-using-ntlm-and-kerberos) |**&#x2713;** |**&#x2713;** |
| [**Delegación limitada de Kerberos**](comparison.md#kerberos-constrained-delegation)|basada en recursos|basada en recursos y basada en cuentas|
| [**Estructura de unidad organizativa personalizada**](comparison.md#custom-ou-structure) |**&#x2713;** |**&#x2713;** |
| [**Extensiones de esquema**](comparison.md#schema-extensions) |**&#x2715;** |**&#x2713;** |
| [**Confianzas de bosques o dominios de AD**](comparison.md#ad-domain-or-forest-trusts) |**&#x2715;** |**&#x2713;** |
...
| [**Implementación distribuida geográficamente**](comparison.md#geo-dispersed-deployments) |**&#x2715;** |**&#x2713;** |
...
[Más información](configure-ldaps.md)
...
[Más información](manage-group-policy.md)
...
> [!NOTE]
> Puede determinar que una opción de implementación personal es más adecuada para sus casos de uso de implementación. Considere la posibilidad de [enviarnos comentarios](contact-us.md) para ayudarnos a comprender qué características lo ayudarán a decantarse por Azure AD Domain Services en un futuro. Estos comentarios nos ayudan a mejorar el servicio para que se ajuste mejor a sus necesidades de implementación y casos de uso.
>
>

Hemos publicado [directrices de implementación de Windows Server Active Directory en Microsoft Azure Virtual Machines](/windows-server/identity/ad-ds/introduction-to-active-directory-domain-services-ad-ds-virtualization-level-100) para ayudar a simplificar las instalaciones personales.
...
* [Directrices para implementar Windows Server Active Directory en Microsoft Azure Virtual Machines](/windows-server/identity/ad-ds/introduction-to-active-directory-domain-services-ad-ds-virtualization-level-100)
