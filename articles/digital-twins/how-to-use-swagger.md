...
1. Agregue la siguiente **dirección URL de redireccionamiento** al registro de la aplicación de Azure AD:
...
1. Copie el **identificador de cliente** de la aplicación de Azure AD.
