...
Consulte [zonas de disponibilidad](../availability-zones/az-overview.md#regions-that-support-availability-zones) para obtener la lista más reciente de las regiones disponibles.
