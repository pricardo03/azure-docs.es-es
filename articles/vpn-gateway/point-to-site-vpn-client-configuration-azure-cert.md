---
title: 'Creación e instalación de archivos de configuración de cliente VPN de punto a sitio para la autenticación con certificados de Azure: Azure | Microsoft Docs'
...
4. Desde la carpeta **Generic**, copie o mueva cp client.p12 a /etc/ipsec.d/private/.
