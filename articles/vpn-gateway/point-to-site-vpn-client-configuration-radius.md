...
1. Use el cmdlet `Get-AzureRmVpnClientConfiguration` para generar la configuración de cliente VPN para EapMSChapv2. Para obtener instrucciones, consulte esta sección del artículo.
