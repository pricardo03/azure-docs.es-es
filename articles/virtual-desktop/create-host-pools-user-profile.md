...
1. Unir las máquinas de virtuales del host de sesión a una [grupo de seguridad de Active Directory](https://docs.microsoft.com/windows/security/identity-protection/access-control/active-directory-security-groups). Este grupo de seguridad se utilizará para autenticar las máquinas de virtuales de hosts de sesión a la máquina de virtual del recurso compartido de archivo que acaba de crear.
