...
- [Tutorial: Creación de un inquilino en Windows Virtual Desktop (versión preliminar)](https://docs.microsoft.com/azure/virtual-desktop/tenant-setup-azure-active-directory)
