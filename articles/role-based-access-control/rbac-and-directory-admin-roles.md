...
En Azure Portal, las asignaciones de roles mediante RBAC aparecen en la hoja **Control de acceso (IAM)**. Esta hoja se puede encontrar en todo el portal, como grupos de administración, suscripciones, grupos de recursos y distintos recursos.
...
Para una lista de todos los roles de administrador de Azure AD, consulte [Permisos de roles de administrador en Azure Active Directory](../active-directory/users-groups-roles/directory-assign-admin-roles.md).
