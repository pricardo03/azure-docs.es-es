...
1. Obtenga el identificador único de un usuario, grupo o aplicación. Por ejemplo, puede usar el comando [Get-AzureRmADUser](/powershell/module/azurerm.resources/get-azurermaduser) para enumerar los usuarios de Azure AD.
...
1. Utilice el comando [New-AzureRmResourceGroupDeployment](/powershell/module/azurerm.resources/new-azurermresourcegroupdeployment) para iniciar la implementación.
