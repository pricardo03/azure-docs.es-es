...
> [!TIP]
> Solo debe agregar un coadministrador si el usuario necesita administrar las implementaciones clásicas de Azure. Se recomienda utilizar RBAC para cualquier otro fin.
