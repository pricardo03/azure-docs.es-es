...
2. Agregue el siguiente código JavaScript para agregar los marcadores de los puntos inicial y final del mapa:
    ...
    ```
    **map.setCameraBounds** ajusta la ventana de mapa de acuerdo con las coordenadas de los puntos de inicio y fin. **map.events.add** garantiza que todas las funciones de mapas agregadas al mapa se cargan después de que el mapa se haya cargado completamente. La API **map.addPins** dentro de los agentes de escucha de eventos agrega los puntos al control de mapa como componentes visuales.
