---
title: 'Exploradores compatibles con el SDK web: Azure Maps | Microsoft Docs'
description: Información sobre los exploradores compatibles con el SDK web de Azure Maps
author: rbrundritt
ms.author: richbrun
ms.date: 03/25/2019
ms.topic: conceptual
