...
![Escriba la información de la cuenta de Azure Maps en Azure Portal](./media/how-to-manage-account-keys/new-account-portal.png)
...
![Elimine la cuenta de Azure Maps en Azure Portal](./media/how-to-manage-account-keys/account-delete-portal.png)
