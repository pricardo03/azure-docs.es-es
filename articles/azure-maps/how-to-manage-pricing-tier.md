---
title: Administración del plan de tarifa de la cuenta de Azure Maps | Microsoft Docs
description: Puede usar Azure Portal para administrar la cuenta de Azure Maps y sus planes de tarifa.
author: walsehgal
ms.author: v-musehg
ms.date: 02/12/2019
ms.topic: conceptual
...
ms.locfileid: "60794192"
---
# <a name="manage-the-pricing-tier-of-your-azure-maps-account"></a>Administración del plan de tarifa de la cuenta de Azure Maps

Puede administrar el plan de tarifa de la cuenta de Azure Maps en Azure Portal. Después de crear la [cuenta](https://azure.microsoft.com/free/?WT.mc_id=A261C142F), puede ver o cambiar su plan de tarifa.
...
![Consultar el plan de tarifa elegido](./media/how-to-manage-pricing-tier/view-pricing-tier.png)
