...
Si acaba de empezar a trabajar con el aprendizaje automático, eche un vistazo a la [versión básica](service/how-to-designer-sample-regression-automobile-price-basic.md) de esta canalización.
