...
description: Más información sobre cómo usar el módulo Filter Based Feature Selection (Selección de características basada en filtro) en el servicio Azure Machine Learning para identificar las características de un conjunto de datos con la mayor potencia predictiva.
