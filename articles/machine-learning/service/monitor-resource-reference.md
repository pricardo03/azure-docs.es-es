...
En las tablas siguientes se enumeran las métricas de plataforma recopiladas para Azure Machine Learning todas las métricas se almacenan en el espacio de nombres **Área de trabajo de servicio de Azure Machine Learning**.

**Model**

| Modelo | Unidad | DESCRIPCIÓN |
| ----- | ----- | ----- |
...
| Dimension Data | Métrica(s) disponible(s) con | DESCRIPCIÓN |
| ---- | ---- | ---- |
