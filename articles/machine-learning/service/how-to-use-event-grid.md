...
[Azure Event Grid](https://docs.microsoft.com/azure/event-grid/) admite eventos de Azure Machine Learning Service. Por ejemplo, puede usar eventos de la finalización de la ejecución, el registro del modelo, la implementación del modelo y la detección del desfase de datos en el ámbito de un área de trabajo.
...
* Acceso de colaborador o propietario al área de trabajo del servicio Azure Machine Learning para la que se crearán los eventos.
