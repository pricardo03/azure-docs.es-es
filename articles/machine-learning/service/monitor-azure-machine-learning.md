...
> [!TIP]
> La información de este documento es principalmente para administradores, ya que describe la supervisión de Azure Machine Learning Service. Los científicos de datos o desarrolladores que desee supervisar información específica acerca de las ejecuciones de entrenamiento de un modelo deben ver los siguientes documentos:
>
