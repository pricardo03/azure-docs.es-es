---
title: Entrenamiento y registro de modelos Keras que se ejecutan en TensorFlow
titleSuffix: Azure Machine Learning service
description: En este artículo se muestra cómo entrenar y registrar un modelo Keras que se ejecuta en TensorFlow con el servicio Azure Machine Learning.
...
ms.locfileid: "67165569"
---
# <a name="train-and-register-keras-models-at-scale-with-azure-machine-learning-service"></a>Entrenamiento y registro de modelos Keras a escala con el servicio Azure Machine Learning

En este artículo se muestra cómo entrenar y registrar un modelo Keras creado en TensorFlow con el servicio Azure Machine Learning. Se usa el popular [conjunto de datos MNIST](http://yann.lecun.com/exdb/mnist/) para clasificar dígitos escritos a mano mediante una red neuronal profunda (DNN) creada con la [biblioteca Keras de Python](https://keras.io) que se ejecuta sobre [TensorFlow](https://www.tensorflow.org/overview).
...
Ejecute este código en cualquiera de estos entornos:
 ...
 - Su propio servidor de Jupyter Notebook
     ...
     - [Instalar el SDK de Azure Machine Learning para Python](setup-create-workspace.md#sdk)
    - [Crear un archivo de configuración del área de trabajo](setup-create-workspace.md#write-a-configuration-file)
    - [Descargar los archivos de script de ejemplo](https://github.com/Azure/MachineLearningNotebooks/tree/master/how-to-use-azureml/training-with-deep-learning/train-hyperparameter-tune-deploy-with-keras) `mnist-keras.py` y `utils.py`
...
El estimador de TensorFlow se implementa a través de la clase genérica [`estimator`](https://docs.microsoft.com//python/api/azureml-train-core/azureml.train.estimator.estimator?view=azure-ml-py), que se puede usar para admitir cualquier marco de trabajo. Para más información sobre cómo entrenar modelos con el estimador genérico, vea [Entrenamiento de modelos con Azure Machine Learning mediante un objeto Estimator](how-to-train-ml-models.md).
...
Una vez que haya entrenado el modelo, puede registrarlo en el área de trabajo. El registro del modelo permite almacenar y crear versiones de los modelos en el área de trabajo para simplificar la [administración e implementación de modelos](concept-model-management-and-deployment.md).
