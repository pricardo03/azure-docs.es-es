...
1. Si no tiene una suscripción a Azure, cree una cuenta gratuita antes de empezar. Pruebe la [versión gratuita o de pago de Azure Machine Learning Service](https://aka.ms/AMLFree).
...
![Página principal del diseñador](media/how-to-run-batch-predictions-ui/ui-batch-scoring-1.png)
...
![Creación de un experimente sencillo](media/how-to-run-batch-predictions-ui/ui-batch-scoring-2.png)
...
![Creación de una canalización de inferencias por lotes](media/how-to-run-batch-predictions-ui/ui-batch-scoring-5.png)
...
![Canalización de inferencias por lotes predeterminada](media/how-to-run-batch-predictions-ui/ui-batch-scoring-6.png)
...
![Nuevo nodo](media/how-to-run-batch-predictions-ui/ui-batch-scoring-7.png)
...
![Configuración de la muestra](media/how-to-run-batch-predictions-ui/ui-batch-scoring-8.png)
...
![Parámetro Pipeline](media/how-to-run-batch-predictions-ui/ui-batch-scoring-9.png)
...
![Implementación de la canalización](media/how-to-run-batch-predictions-ui/ui-batch-scoring-10.png)
...
![Configuración del punto de conexión](media/how-to-run-batch-predictions-ui/ui-batch-scoring-11.png)
...
![Vínculo al punto de conexión](media/how-to-run-batch-predictions-ui/ui-batch-scoring-12.png)
...
![Canalización de inferencia](media/how-to-run-batch-predictions-ui/ui-batch-scoring-13.png)
...
![Detalles de la canalización](media/how-to-run-batch-predictions-ui/ui-batch-scoring-14.png)
...
![Ejecución de la canalización](media/how-to-run-batch-predictions-ui/ui-batch-scoring-15.png)
