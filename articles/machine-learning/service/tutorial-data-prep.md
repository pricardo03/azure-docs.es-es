...
* Después de iniciar el panel de información de Jupyter Notebook, abra el cuaderno **tutorials/regression-part1-data-prep.ipynb**.

Este tutorial también está disponible en [GitHub](https://github.com/Azure/MachineLearningNotebooks/tree/master/tutorials) si quiere usarlo en su propio [entorno local](how-to-configure-environment.md#local).  Asegúrese de haber instalado el paquete `azureml-dataprep` del SDK de Azure Machine Learning.
