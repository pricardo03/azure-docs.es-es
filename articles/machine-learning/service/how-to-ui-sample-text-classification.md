---
title: 'Ejemplo 7 de interfaz visual: clasificación de las reseñas de libros'
titleSuffix: Azure Machine Learning
description: Aprenda a crear un modelo de aprendizaje automático para clasificar las reseñas de libros en distintas categorías.
...
En este ejemplo se muestra cómo usar los módulos de análisis de texto para crear una canalización de clasificación de texto la interfaz visual de Azure Machine Learning.
...
[![Gráfico del experimento](./media/how-to-ui-sample-text-classification/nlp-modules-overall.png)](./media/how-to-ui-sample-text-classification/nlp-modules-overall.png#lightbox)

## <a name="data"></a>Datos

En este experimento, usamos el conjunto de datos **Wikipedia SP 500**. Los conjuntos de datos se han extraído de Wikipedia (https://www.wikipedia.org/) ) y se basan en artículos de cada empresa del índice S&P 500. Antes de cargarlo la interfaz visual de Azure Machine Learning, el conjunto de datos se ha procesado como sigue:
...
La elección del algoritmo a menudo depende de los requisitos del caso de uso. Dado que el objetivo de este experimento es predecir la categoría de la empresa, un modelo clasificador de varias clases es una buena elección. Teniendo en cuenta que el número de características es grande y que estas características son dispersas, usamos el modelo **Multiclass Logistic Regression** (Regresión logística multiclase) para este experimento.
