---
title: Habilitación del registro en Azure Machine Learning Service
titleSuffix: Azure Machine Learning service
description: Aprenda a habilitar el registro en Azure Machine Learning Service mediante el paquete de registros de Python predeterminado y la funcionalidad específica del SDK.
ms.author: trbye
author: trevorbye
...
Use la [guía](https://docs.microsoft.com/python/api/overview/azure/ml/install?view=azure-ml-py) para instalar el SDK y [empiece](https://docs.microsoft.com/azure/machine-learning/service/quickstart-create-workspace-with-python) con este a crear un área de trabajo en Azure Portal.
...
## <a name="logging-during-image-creation"></a>Registro durante la creación de imágenes

Habilitar el registro durante la creación de imágenes le permitirá ver todos los errores que se produjeron durante el proceso de compilación. Establezca el parámetro `show_output` en la función `wait_for_deployment()`.
