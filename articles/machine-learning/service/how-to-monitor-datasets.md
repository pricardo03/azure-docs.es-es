...
Las métricas y la información están disponibles a través del recurso de [Azure Aplicación Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) asociado al área de trabajo del servicio de Azure Machine Learning.
...
Consulte la [Documentación de referencia de Python SDK sobre el desfase de datos](https://aka.ms/datadriftapi) para obtener información completa. 
