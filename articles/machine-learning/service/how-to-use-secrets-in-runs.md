...
ms.locfileid: "70019340"
---
# <a name="use-secrets-in-training-runs"></a>Uso de secretos en ejecuciones de entrenamiento

En este artículo, aprenderá a usar secretos en las ejecuciones de entrenamiento de forma segura. Por ejemplo, para conectarse a una base de datos externa y consultar datos de entrenamiento, deberá pasar el nombre de usuario y la contraseña al contexto de ejecución remoto. La codificación de estos valores en scripts de entrenamiento en texto no cifrado no es segura, ya que expondría el secreto. 
...
El flujo básico para el uso de secretos es:
 ...
 2. En el equipo local, establezca un secreto en el área de trabajo de Key Vault.
...
Puede enumerar los nombres de secretos mediante el método [list_secrets](https://docs.microsoft.com/python/api/azureml-core/azureml.core.keyvault.keyvault?view=azure-ml-py#set-secret-name--value-). El método __set_secret__ actualiza el valor del secreto si el nombre ya existe.
 ...
 * [Información sobre seguridad de empresa con Azure Machine Learning Service](concept-enterprise-security.md)
