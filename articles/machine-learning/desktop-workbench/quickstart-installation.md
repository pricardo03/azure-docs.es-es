---
title: Inicio rápido de instalación del servicio Azure Machine Learning | Microsoft Docs
...
El servicio Azure Machine Learning (versión preliminar) es una solución de análisis avanzado y ciencia de datos integrada y completa. Ayuda a los científicos de datos profesionales a preparar datos, desarrollar experimentos e implementar modelos a escala de nube.

Esta guía de inicio rápido le muestra cómo:

* Crear cuentas de servicio para el servicio Azure Machine Learning
...
Como parte de la cartera de Microsoft Azure, el servicio Azure Machine Learning requiere una suscripción a Azure. Si no tiene una suscripción a Azure, cree una [cuenta gratuita](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) antes de empezar.
...
## <a name="create-azure-machine-learning-service-accounts"></a>Creación de cuentas del servicio Azure Machine Learning
...
1. Rellene los campos del formulario y seleccione el botón **Create** (Crear) para crear un nuevo proyecto en Workbench.
   ...
   Dirección URL de repositorio de GIT de VisualStudio.com |_déjelo en blanco_ | Campo opcional. Si lo desea, el proyecto puede asociarse con un repositorio de Git en Azure DevOps para el control de código fuente y la colaboración. [Vea cómo configurarlo](../desktop-workbench/using-git-ml-project.md#step-3-set-up-a-machine-learning-project-and-git-repo). 
...
También se instala la interfaz de línea de comandos (CLI) de Azure Machine Learning. La interfaz CLI le permite acceder a su servicio Azure Machine Learning e interactuar con él mediante los comandos `az` para realizar todas las tareas necesarias para un flujo de trabajo de ciencia de datos de principio a fin. [Más información.](../desktop-workbench/tutorial-iris-azure-cli.md)
