...
Esta introducción enlaza a tutoriales que proporcionan instrucciones sobre cómo configurar el entorno de TDSP para el grupo de ciencia de datos completo, los equipos de ciencia de datos y los proyectos. Facilita instrucciones detalladas del uso de Visual Studio Team Services (VSTS) en los tutoriales.  VSTS ofrece una plataforma de hospedaje de código y la herramienta de planeamiento de Agile para administrar las tareas de equipo, controlar el acceso y administrar los repositorios. 
