...
2. Confirman el código en el control de código fuente que eligen (VSTS tiene buena compatibilidad con diversos controles de código fuente).
...
5. Se inicia una compilación en VSTS según la confirmación en GitHub.
6. La canalización de compilación de VSTS extrae el último modelo del contenedor de blobs y crea un contenedor.
7. VSTS inserta la imagen en el repositorio de imágenes privado en Azure Container Registry.
