...
* Busque las credenciales del área de trabajo en la configuración de Azure Machine Learning Studio. En Azure Machine Learning Studio, haga clic en **Configuración** --> **Nombre** --> **Tokens de autorización**.
