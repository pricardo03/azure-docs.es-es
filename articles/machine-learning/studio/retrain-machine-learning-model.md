...
En primer lugar, inicie sesión en su cuenta de Azure en el entorno de PowerShell mediante el uso de la [Connect AzAccount](/powershell/module/az.accounts/connect-azaccount) cmdlet.
