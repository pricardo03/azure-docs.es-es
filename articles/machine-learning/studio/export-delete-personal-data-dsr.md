---
title: Exportación y eliminación de los datos de Azure Machine Learning Studio | Microsoft Docs
...
Para obtener documentación sobre los servicios web y el plan de compromiso de facturación, consulte [Referencia de la API REST de Azure Machine Learning](https://docs.microsoft.com/en-us/rest/api/machinelearning/). 
