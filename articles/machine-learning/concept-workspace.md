...
+ En la Web:
    ...
    + [Diseñador de Azure Machine Learning](concept-designer.md): solo disponible en las áreas de trabajo de [Enterprise Edition](overview-what-is-azure-ml.md#sku).
