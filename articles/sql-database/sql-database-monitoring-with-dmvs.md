...
Si su principal tipo de espera es `RESOURCE_SEMAHPORE` y no tiene un problema de CPU alto, es posible que tenga un problema de espera de concesión de memoria.
