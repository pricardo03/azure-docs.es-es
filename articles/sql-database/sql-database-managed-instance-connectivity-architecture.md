...
|mi_subnet   |Cualquiera           |Cualquiera     |Cualquiera              |MI SUBNET  |PERMITIR |
  ...
  > [!Note]
  > Si usa la replicación transaccional en Instancia administrada y cualquier base de datos de Instancia administrada se utiliza como publicador o distribuidor, el puerto 445 (salida TCP) también debe estar abierto en las reglas de seguridad de la subred para acceder al recurso compartido de archivos de Azure.
