...
- Además del módulo **AzureRM.Sql** 4.8.1-preview, este tutorial también requiere el módulo *sqlserver* de PowerShell. Para más información, consulte [Instalación de un módulo de SQL Server PowerShell](https://docs.microsoft.com/sql/powershell/download-sql-server-ps-module).
