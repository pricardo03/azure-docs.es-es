...
ms.locfileid: "47163008"
---
# <a name="configure-a-point-to-site-connection-to-connect-to-an-azure-sql-database-managed-instance-from-on-premises-computer"></a>Configuración de una conexión de punto a sitio para conectarse a una Instancia administrada de Azure SQL Database desde el equipo local
...
## <a name="connect-to-the-vpn-connection"></a>Conéctese a la conexión VPN.
...
- Para restaurar una base de datos SQL Server existente del entorno local en una Instancia administrada, puede utilizar [Azure Database Migration Service (DMS) para la migración ](../dms/tutorial-sql-server-to-managed-instance.md) a fin de restaurar desde un archivo de copia de seguridad de base de datos o el [comando T-SQL RESTORE](sql-database-managed-instance-get-started-restore.md) para restaurar desde un archivo de copia de seguridad de base de datos.
