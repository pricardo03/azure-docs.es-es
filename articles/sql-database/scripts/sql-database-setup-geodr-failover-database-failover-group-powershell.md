---
title: Ejemplo de PowerShell de grupo de conmutación por error de replicación geográfica para una base de datos independiente de Azure SQL Database | Microsoft Docs
