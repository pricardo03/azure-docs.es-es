...
1. Conceda al inicio de sesión de Azure AD el rol de servidor `sysadmin` mediante la siguiente sintaxis de T-SQL:
...
## <a name="create-additional-azure-ad-logins-using-ssms"></a>Creación de inicios de sesión de Azure AD adicionales con SSMS
...
1. También se admite con la creación de un usuario de Azure AD a partir de un inicio de sesión de Azure AD que sea un grupo.
    ...
    > [!IMPORTANT]
    > Cuando cree un usuario en **USER** a partir de un inicio de sesión de Azure AD, especifique el nombre de usuario como el mismo nombre de inicio de sesión desde **LOGIN**.
...
## <a name="additional-scenarios-supported-for-azure-ad-logins-public-preview"></a>Escenarios adicionales admitidos para los inicios de sesión de Azure AD (versión preliminar pública) 

- Se admiten la administración del agente SQL y las ejecuciones de los trabajos con los inicios de sesión de Azure AD.
- Las operaciones de copia de seguridad y restauración de la base de datos se pueden ejecutar en los inicios de sesión de Azure AD.
- [Auditoría](sql-database-managed-instance-auditing.md) de todas las instrucciones relacionadas con los inicios de sesión y eventos de autenticación de Azure AD.
- Conexión de administrador dedicada para los inicios de sesión de Azure AD que son miembros del rol de servidor `sysadmin`.
- Se admiten los inicios de sesión de Azure AD con el uso de la [utilidad sqlcmd](/sql/tools/sqlcmd-utility) y de la herramienta [SQL Server Management Studio](/sql/ssms/download-sql-server-management-studio-ssms).
- Se admiten los desencadenadores de inicio de sesión con los eventos correspondientes procedentes de los inicios de sesión de Azure AD.
- Se puede configurar Service Broker y el correo electrónico de la base de datos con los inicios de sesión de Azure AD.
