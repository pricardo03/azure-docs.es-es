...
ms.locfileid: "47161920"
---
# <a name="create-a-server-level-firewall-rule-for-your-sql-database-using-the-azure-portal"></a>Creación de una regla de firewall de nivel de servidor para SQL Database mediante Azure Portal
