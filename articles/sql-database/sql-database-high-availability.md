...
En el modelo Premium, Azure SQL Database integra el proceso y el almacenamiento en un único nodo. La alta disponibilidad en este modelo de arquitectura se logra replicando el proceso (es decir, el proceso del motor de base de datos de SQL Server) y el almacenamiento (SSD conectado localmente) implementado en el clúster de 4 nodos denominado [Grupos de disponibilidad AlwaysOn](https://docs.microsoft.com/sql/database-engine/availability-groups/windows/overview-of-always-on-availability-groups-sql-server).
