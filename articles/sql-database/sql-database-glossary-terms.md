...
||Base de datos de nivel Básico|Base de datos que se crea en el nivel de servicio básico del modelo de compra basado en DTU, o que se mueve al mismo.|
||Base de datos de nivel Estándar|Base de datos que se crea en el nivel de servicio estándar del modelo de compra basado en DTU, o que se mueve al mismo.|
||Base de datos Premium|Base de datos que se crea en el nivel de servicio Premium del modelo de compra basado en DTU, o que se mueve al mismo.|
...
|Reglas de firewall de IP del servidor de bases de datos|Reglas de firewall de IP|[Reglas de firewall por IP](sql-database-firewall-configure.md)|
