---
title: Notas de la versión de Azure SQL Database | Microsoft Docs
...
| Replicación con las instancias administradas |Para más información, consulte [Configuración de la replicación en una base de datos de instancia administrada de Azure SQL Database](replication-with-sql-database-managed-instance.md).|
...
| Detección de amenazas con instancias administradas |Para más información, consulte [Configuración de la detección de amenazas en Instancia administrada de Azure SQL Database](sql-database-managed-instance-threat-detection.md).|
| Cifrado de datos transparente (TDE) con Bring Your Own Key y con instancias administradas |Para más información, consulte [Cifrado de datos transparente de Azure SQL con una clave administrada por el cliente de Azure Key Vault: Compatibilidad con Bring Your Own Key](transparent-data-encryption-byok-azure-sql.md).|
| &nbsp; |
