...
- **Portal de Azure**: Azure Portal muestra la utilización de una sola base de datos al seleccionar la base de datos y hacer clic en el gráfico en el panel Información general. Puede modificar el gráfico para mostrar varias métricas, incluido el porcentaje de CPU, el porcentaje de DTU, el porcentaje de E/S de datos, el porcentaje de las sesiones y el porcentaje de tamaño de base de datos.
...
### <a name="how-do-i-ensure-i-am-using-the-appropriate-service-tier-and-compute-size"></a>¿Cómo me aseguro de que utilizo el nivel de servicio y el tamaño de proceso adecuados?
