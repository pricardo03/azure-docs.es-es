...
5. Seleccione **Plan de tarifa** para cambiar el tamaño de los recursos de almacenamiento y de proceso, así como para revisar las opciones del plan de tarifa. El plan de tarifa de uso general con 32 GB de memoria y 16 núcleos de virtuales es el valor predeterminado.
...
7. Cuando haya terminado, elija **Aplicar** para guardar la selección.  
8. Haga clic en **Crear** para implementar Instancia administrada.
9. Seleccione el icono **Notificaciones** para ver el estado de la implementación.
...
10. Seleccione **Deployment in progress** (Implementación en curso) para abrir la ventana de Instancia administrada y supervisar el progreso de la implementación. 
