---
title: 'Límites de recursos de Azure SQL Database: servidor lógico | Microsoft Docs'
description: En este artículo se proporciona información general sobre los límites de recursos de servidor lógico de Azure SQL Database para bases de datos individuales y bases de datos agrupadas mediante grupos elásticos. También se proporciona información acerca de lo qué ocurre cuando se alcanzan o superan dichos límites.
...
ms.locfileid: "51620905"
---
# <a name="sql-database-resource-limits-for-single-and-pooled-databases"></a>Límites de recursos de SQL Database para bases de datos individuales y agrupadas

En este artículo se proporciona información general acerca de los límites de recursos de SQL Database para bases de datos individuales y agrupadas en un servidor lógico. También se proporciona información acerca de lo qué ocurre cuando se alcanzan o superan dichos límites.
...
| Número máximo de grupos por servidor | Limitado por el número de DTU o núcleos virtuales. Por ejemplo, si cada grupo tiene 1000 DTU, un único servidor puede admitir 54 grupos.|
||||
