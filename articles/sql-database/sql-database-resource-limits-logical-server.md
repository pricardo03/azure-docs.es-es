...
description: En este artículo se proporciona información general acerca de los límites de recursos de Azure SQL Database para bases de datos individuales y bases de datos agrupadas mediante grupos elásticos. También se proporciona información acerca de lo qué ocurre cuando se alcanzan o superan dichos límites.
...
ms.locfileid: "48829570"
---
# <a name="sql-database-resource-limits-for-single-and-pooled-databases-on-a-logical-server"></a>Límites de recursos de SQL Database para bases de datos individuales y agrupadas en un servidor lógico 
