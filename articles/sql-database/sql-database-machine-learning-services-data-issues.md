...
Para obtener más información sobre los tipos de datos de R admitidos y no admitidos, vea [tipos de datos y las bibliotecas de R](/sql/advanced-analytics/r/r-libraries-and-data-types).
