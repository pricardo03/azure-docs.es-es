...
- [Administración](#administration): las opciones PaaS reducen la cantidad de tiempo que necesita invertir para administrar la base de datos. Sin embargo, también limita la gama de tareas de administración personalizados y secuencias de comandos que se pueden realizar o se ejecuta. Por ejemplo, el CLR no es compatible con las bases de datos única o agrupadas, pero se admite para una instancia administrada. Además, no hay opciones de implementación de PaaS admiten el uso de las marcas de seguimiento.
