...
- Consulte la información general, [Machine Learning Services de Azure SQL Database con R (versión preliminar)](sql-database-machine-learning-services-overview.md).
