...
- Tener instalado [Windows PowerShell](https://docs.microsoft.com/powershell/scripting/install/installing-windows-powershell), versión 5.0 o superior.
