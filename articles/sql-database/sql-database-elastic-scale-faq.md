...
## <a name="can-i-use-a-different-azure-database-edition-for-each-shard-in-my-shard-set"></a>¿Puedo usar una edición diferente de la base de datos de Azure en cada partición de mi conjunto de particiones?
