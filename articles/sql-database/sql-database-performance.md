...
| :----------------------------- | ----- | ----- |
| **[Información general del rendimiento](#performance-overview)** : supervise todas las actividades de rendimiento de la base de datos. | Sí | Sin | 
| **[Recomendaciones de rendimiento](#performance-recommendations)** : muestra recomendaciones de rendimiento que pueden mejorar el rendimiento de la carga de trabajo. | Sí | Sin | 
| **[Información de rendimiento de consultas](#query-performance-insight)** : muestra el rendimiento de las consultas que más consumen en la base de datos. | Sí | Sin | 
| **[Ajuste automático](#automatic-tuning)** : use Azure SQL Database para optimizar automáticamente el rendimiento de la base de datos. | Sí | Sin | 
