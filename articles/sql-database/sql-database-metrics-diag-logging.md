...
Esto es porque instancia administrada es un contenedor de la base de datos con su propia telemetría que se va a independiente de una telemetría de base de datos de instancia individual.
