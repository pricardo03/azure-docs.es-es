---
title: Problemas en la conexión y uso de Azure SQL Database
...
> [!TIP]
> Para resolver los problemas que se analizan en las siguientes secciones, pruebe los pasos (en orden) de la sección [Pasos para solucionar problemas de conexión comunes](#steps-to-fix-common-connection-issues).
...
2. Si no hay interrupciones conocidas, vaya al [sitio web de soporte técnico de Microsoft Azure](https://azure.microsoft.com/support/options) para abrir un caso de soporte técnico.

Para más información, consulte [Solución del error "La base de datos del servidor no está disponible en este momento"](sql-database-troubleshoot-common-connection-issues.md#troubleshoot-transient-errors).
...
#### <a name="cannot-connect-to-a-secondary-database"></a>No se puede conectar a una base de datos secundaria
...
#### <a name="adonet-and-blocking-period"></a>ADO.NET y período de bloqueo
