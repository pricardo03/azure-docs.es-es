...
El problema se produce porque la aplicación no se puede conectar al servidor.
...
Si se encuentra con frecuencia este mensaje de error, siga estos pasos para resolver el problema: 
