...
| **Creación de reflejo de la base de datos** |Los servidores principal y de reflejo se ejecutan en distintos centros de datos para la recuperación ante desastres. Debe implementar con certificados de servidor. No se admite la creación de reflejo de base de datos de SQL Server para SQL Server 2008 ni SQL Server 2008 R2 en una máquina virtual de Azure. <br/>![Creación de reflejo de la base de datos](./media/virtual-machines-windows-sql-high-availability-dr/azure_only_dr_dbmirroring.gif) |
