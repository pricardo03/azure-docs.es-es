...
## <a name="remarks"></a>Comentarios
 ...
 - El proveedor de recursos de VM de SQL solo admite VM con SQL Server implementado mediante el modelo de ''Resource Manager''. Las VM con SQL Server implementadas mediante el ''modelo clásico'' no se admiten. 
