...
* **Microsoft.ReportViewer.WebForms.dll**: contiene el código de ReportViewer que necesita para usar ReportViewer en la página. Al colocar un control ReportViewer en una página ASP.NET del proyecto, se agrega una referencia para este ensamblado al proyecto.
* **Microsoft.ReportViewer.Common.dll**: contiene las clases que usa el control ReportViewer en tiempo de ejecución. No se agrega automáticamente al proyecto.
...
2. Cree la carpeta \<Lenguaje\> en el proyecto y copie allí los archivos de ensamblado de recursos asociados. Los archivos de ensamblado de recursos que va a copiar son: **Microsoft.ReportViewer.Webforms.Resources.dll** y **Microsoft.ReportViewer.Common.Resources.dll**. Seleccione los archivos de ensamblado de recursos y, en el panel Properties (Propiedades), establezca **Copy to Output Directory** (Copiar en el directorio de salida) en "**Copy always**" (Copiar siempre).
...
Para obtener instrucciones sobre cómo publicar una aplicación web de ASP.NET en Azure, consulte [Cómo migrar y publicar una aplicación web en Azure desde Visual Studio](../../../vs-azure-tools-migrate-publish-web-app-to-cloud-service.md) y [Get started with Web Apps and ASP.NET](../../../app-service/app-service-web-get-started-dotnet.md) (Empezar a trabajar con aplicaciones web y ASP.NET).
