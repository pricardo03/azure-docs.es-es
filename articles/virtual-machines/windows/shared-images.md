...
Una vez que la versión de la imagen se completa, puede crear una o varias VM nuevas. Con el parámetro simplificado establecido para el cmdlet [New-AzureRMVM](https://docs.microsoft.com/powershell/module/azurerm.compute/new-azurermvm), solo debe proporcionar el identificador de la versión de la imagen. 
