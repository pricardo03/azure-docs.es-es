...
Una vez que la versión de la imagen se completa, puede crear una o varias máquinas virtuales nuevas. Con el parámetro simplificado establecido para el cmdlet [New-AzureRMVM](), solo debe proporcionar el identificador de la versión de la imagen. 
