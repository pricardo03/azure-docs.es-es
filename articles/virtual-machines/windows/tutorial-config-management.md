---
title: 'Tutorial: Administración de la configuración de una máquina virtual Windows en Azure | Microsoft Docs'
...
Azure [Change Tracking](../../automation/change-tracking.md) permite identificar fácilmente los cambios y [Update Management](../../automation/automation-update-management.md), administrar las actualizaciones del sistema operativo en las máquinas virtuales Windows de Azure.
