...
Si usa PowerShell y tiene instalado el módulo Aure PowerShell también se puede conectar con el `Get-AzRemoteDesktopFile` cmdlet, tal y como se muestra a continuación.
