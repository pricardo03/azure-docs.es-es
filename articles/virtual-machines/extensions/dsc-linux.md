...
La extensión DSC de Linux es compatible con todas las [distribuciones de Linux aprobadas en Azure](https://docs.microsoft.com/en-us/azure/virtual-machines/linux/endorsed-distros), excepto:
