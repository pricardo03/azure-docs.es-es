...
> [!NOTE]
> Si implementa esta extensión en una máquina virtual creada anteriormente, asegúrese de que la máquina tiene al menos 1 GB de memoria asignada o la extensión no se instalará
