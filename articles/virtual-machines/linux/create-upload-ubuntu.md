...
Para Ubuntu 18.04/18.10, actualice el origen de datos de Azure, edite esto: /etc/cloud/cloud.cfg.d/90-azure.cfg, agregue este código al final del archivo:

**Importante: se debe agregar el código tal y como se muestra, incluidos los espacios.**
