---
title: 'Tamaños de las máquinas virtuales Linux en Azure: memoria'
...
* Obtenga información sobre la [creación y administración de VM Linux con la CLI de Azure](tutorial-manage-vm.md)
