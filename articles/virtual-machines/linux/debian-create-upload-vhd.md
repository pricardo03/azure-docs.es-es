---
title: Preparación de un disco duro virtual con Debian Linux en Azure
description: Aprenda a crear imágenes VHD de Debian para implementarlas en Azure.
