...
- Versión de [Alta disponibilidad de SAP NetWeaver en máquinas virtuales de Azure en SUSE Linux Enterprise Server con Azure NetApp Files para las aplicaciones de SAP](high-availability-guide-suse-netapp-files.md)
- Aclaración sobre la configuración del **parámetro de sistema operativo de Linux net.ipv4.tcp_timestamps** en combinación con un equilibrador de carga de Azure
