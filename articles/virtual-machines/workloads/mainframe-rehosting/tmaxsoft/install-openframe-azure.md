...
- Obtener los medios de instalación OpenFrame desde TmaxSoft. Si es un cliente existente de TmaxSoft, póngase en contacto con su representante de TmaxSoft para una copia con licencia. En caso contrario, solicitar una versión de prueba de [TmaxSoft](http://www.tmaxsoft.com/contact/).
...
7. Cambio `jeus.password=jeusadmin nodename=Tmaxsoft` a `jeus.password=tmax1234 nodename=ofdemo`
...
-   [Introducción a Azure](https://docs.microsoft.com/azure/)
