---
title: Se produce un error interno al conectarse mediante el escritorio remoto a Azure Virtual Machines | Microsoft Docs
...
Conéctese a una [consola serie y abra una instancia de PowerShell](./serial-console-windows.md#open-cmd-or-powershell-in-serial-console
...
2. Si Termservice.exe usa dicho puerto, vaya al paso 2. Si otro servicio o aplicación que no sea Termservice.exe usa el puerto 8080, siga estos pasos:
    ...
    A. Detenga el servicio para la aplicación que utiliza el servicio 3389: 

        Stop-Service -Name <ServiceName>

    B. Inicie el servicio del terminal: 
...
2. Si la aplicación no se puede detener o si este método no le resulta válido, cambie el puerto de RDP:
    ...
    B. Establezca el firewall del nuevo puerto:

        Set-NetFirewallRule -Name "RemoteDesktop-UserMode-In-TCP" -LocalPort <NEW PORT (decimal)>

    C. [Actualice el grupo de seguridad de red del nuevo puerto](../../virtual-network/security-overview.md) en el puerto RDP de Azure Portal.
...
5.  [Desconecte el disco del sistema operativo y vuelva a crear la máquina virtual](../windows/troubleshoot-recovery-disks-portal.md)y, después, compruebe si se ha resuelto el problema.
