...
Antes de que se presentaran las redes virtuales regionales, era necesario asociar una red virtual a un grupo de afinidad. Como resultado, calcular los recursos que se colocan en un grupo de afinidad se enlazan por las mismas restricciones como se describe en la "escenario de asignación: Grupo de afinidad (proximidad de la máquina virtual o servicio) "sección anterior. Es decir, los recursos de proceso están asociados a un clúster.
