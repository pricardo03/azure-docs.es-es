...
* [CLI de Azure](#use-the-azure-cli): si ya está en la línea de comandos, restablezca rápidamente la configuración o las credenciales de SSH. También puede usar la [CLI de Azure](#use-the-azure-classic-cli)
