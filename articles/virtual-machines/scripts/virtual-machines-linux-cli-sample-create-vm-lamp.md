---
title: 'Ejemplo de script de la CLI de Azure: implementación de la pila de LAMP en un conjunto de escalado de máquinas virtuales con carga equilibrada | Microsoft Docs'
