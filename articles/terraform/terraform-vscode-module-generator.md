...
> [Instalación y uso de la extensión de Visual Studio Code para Azure Terraform](https://docs.microsoft.com/azure/terraform/terraform-vscode-extension)
