...
Después de hacer clic en **Guardar**, la medida **Temperatura** aparecerá en la lista de medidas. En breve, podrá ver los datos de temperatura desde el dispositivo simulado.
