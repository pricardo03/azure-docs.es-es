...
Ahora que ha aprendido cómo conectar un cliente de Node.js genérico a una aplicación de Azure IoT Central, el siguiente paso sugerido es obtener información sobre cómo [preparar y conexión de Raspberry Pi](howto-connect-raspberry-pi-python.md).
