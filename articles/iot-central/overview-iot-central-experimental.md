...
Los administradores pueden administrar el acceso a la aplicación con [permisos y roles de usuario](howto-administer.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).

## <a name="next-steps"></a>Pasos siguientes

Ahora que ya tiene información general de Azure IoT Central, estos son los próximos pasos sugeridos:

- Comprender las diferencias entre [Azure IoT Central y los aceleradores de soluciones de IoT de Azure](overview-iot-options.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
- Familiarizarse con la [interfaz de usuario de Azure IoT Central](overview-iot-central-tour.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
- [Crear una aplicación de Azure IoT Central](quick-deploy-iot-central.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) para empezar a trabajar.
- Esta serie de tutoriales, le muestran cómo:
  - [Como compilador, crear una plantilla de dispositivo](tutorial-define-device-type.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
  - [Como compilador, agregar reglas para automatizar la solución](tutorial-configure-rules.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
  - [Como compilador, personalizar la aplicación para los operadores](tutorial-customize-operator.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
  - [Como operador, supervisar los dispositivos](tutorial-monitor-devices.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
  - [Como operador, agregar un dispositivo real a la solución](tutorial-add-device.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
