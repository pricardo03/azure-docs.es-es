...
2. En el menú de la izquierda, seleccione **Exportación de datos**.
    ...
    ![Creación de un centro de eventos](media/howto-export-data-pnp/export-menu1.png)
...
3. Seleccione el botón **+ Nuevo** en la esquina superior derecha. Elija **Azure Event Hubs** o **Azure Service Bus** como destino de la exportación. 
    ...
    ![Creación de una exportación de datos continua](media/howto-export-data-pnp/export-new1.png)
...
4. En el cuadro de lista desplegable, seleccione su **espacio de nombres de Event Hubs o de Service Bus**. También puede elegir la última opción de la lista que es **Escriba una cadena de conexión**. 
    ...
    ![Creación de un centro de eventos](media/howto-export-data-pnp/export-create1.png)
...
6. Para activar la exportación de datos continua, asegúrese de que la opción **Exportación de datos** esté **activada**. Seleccione **Guardar**.
    ...
    ![Configuración de la exportación continua de datos](media/howto-export-data-pnp/export-list1.png)
...
> [Desencadenar Azure Functions](howto-trigger-azure-functions.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
