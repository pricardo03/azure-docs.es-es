...
ms.locfileid: "71973204"
---
# <a name="export-your-data-in-azure-iot-central-preview-features"></a>Exportación de los datos a Azure IoT Central (características de versión preliminar)

[!INCLUDE [iot-central-pnp-original](../../includes/iot-central-pnp-original-note.md)]

*Este tema se aplica a administradores*.

En este artículo se describe cómo usar la característica de exportación continua de datos de Azure IoT Central para exportar los datos a sus propias instancias de **Azure Event Hubs** y **Azure Service Bus**. Puede exportar **datos de telemetría**, **dispositivos** y **plantillas de dispositivo** a su propio destino para analizar las rutas de acceso activas. Esto incluye el desencadenamiento de reglas personalizadas en Azure Stream Analytics, el desencadenamiento de flujos de trabajo personalizados en Azure Logic Apps o su paso a través de Azure Functions para su transformación.
...
4. En el cuadro de lista desplegable, seleccione su **espacio de nombres de Event Hubs o de Service Bus**. También puede elegir la última opción de la lista que es **Escriba una cadena de conexión**. 
    ...
    ![Creación de un centro de eventos](media/howto-export-data-pnp/export-eh.png)
...
Los datos de telemetría, dispositivos y plantillas de dispositivo se exportan a su centro de eventos o cola o tema de Service Bus casi en tiempo real. Los datos de telemetría exportados contienen la totalidad del mensaje que los dispositivos enviaron a IoT Central, no solo los valores de los propios datos de telemetría. Los datos de dispositivo exportados contienen los cambios en las propiedades y los metadatos de todos los dispositivos; las plantillas de dispositivo exportadas contienen los cambios en todas las plantillas de dispositivo. Los datos exportados se encuentran en la propiedad "body" y están en formato JSON.
...
El ejemplo siguiente muestra un mensaje acerca de los datos de telemetría que se han recibido en Event Hubs o en la cola o tema de Service Bus.
...
- Dispositivos con valores de propiedad modificados
...
- Nuevas plantillas de dispositivo que se han agregado o versionado
- Plantillas de dispositivo con capabilityModels, cloudProperties, invalidaciones y valores iniciales modificados
...
El ejemplo siguiente muestra un mensaje de plantilla de dispositivo en Event Hubs o en la cola o tema de Service Bus:
