...
4. En el cuadro de lista desplegable, seleccione su **espacio de nombres de Storage**. También puede elegir la última opción de la lista que es **Escriba una cadena de conexión**. 
    ...
    ![Creación de un centro de eventos](media/howto-export-data-pnp/export-create-blob.png)
...
6. Para activar la exportación de datos continua, asegúrese de que la opción **Exportación de datos** esté **activada**. Seleccione **Guardar**.
   ...
   ![Configuración de la exportación continua de datos](media/howto-export-data-pnp/export-list-blob.png)
...
> [Procedimiento para visualizar los datos en Power BI](howto-connect-powerbi-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
