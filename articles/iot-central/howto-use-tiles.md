...
Para obtener más información sobre cómo configurar el panel de la aplicación de Azure IoT Central, consulte [Configuración del panel de la aplicación](howto-configure-homepage.md).
