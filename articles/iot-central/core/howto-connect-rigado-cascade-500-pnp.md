...
1. Vaya a la pestaña ***Device Templates*** (Plantillas de dispositivo) en el panel izquierdo y seleccione **+ New** (+ Nuevo): ![Creación de una plantilla de dispositivo](./media/howto-connect-rigado-cascade500-pnp/device-template-new.png)
1. La página ofrece una opción para ***crear una plantilla personalizada*** o ***usar una plantilla de dispositivo preconfigurada***.
1. Seleccione la plantilla de dispositivo C500 en la lista de plantillas de dispositivo preconfiguradas, como se muestra a continuación: ![Selección de la plantilla de dispositivo C500](./media/howto-connect-rigado-cascade500-pnp/device-template-preconfigured.png)
...
![Identificador de ámbito de la aplicación](./media/howto-connect-rigado-cascade500-pnp/app-scope-id.png)
3. Ahora, haga clic en **View Keys** (Ver claves) y anote el valor de **Primary key** (Clave principal) 
![Clave principal](./media/howto-connect-rigado-cascade500-pnp/primary-key-sas.png)  
...
![Clave principal](./media/howto-connect-rigado-cascade500-pnp/devices-list-c500.png)  
