...
1. Agregue un dispositivo desde Dispositivos. Seleccione **+ Nuevo > Real** para agregar un dispositivo real.
...
1. Mediante el menú izquierdo, seleccione el botón **Cloud Logging** (Registro en la nube).
