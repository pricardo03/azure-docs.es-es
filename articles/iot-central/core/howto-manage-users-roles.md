...
Ahora que ha aprendido a administrar usuarios y roles en Azure IoT Central, el siguiente paso sugerido es aprender a [ver su factura](howto-view-bill.md) en Azure IoT Central.
