---
title: 'Tutorial: Configuración de reglas y acciones en Azure IoT Central'
...
En este tutorial se crea una regla que envía un correo electrónico cuando la temperatura de un dispositivo de aire acondicionado conectado supera los 70&deg; F.
...
1. Para agregar una nueva regla basada en telemetría a la aplicación, en el panel izquierdo, seleccione **Device Templates** (Plantillas de dispositivos):
...
4. Para definir la regla, use la información de la tabla siguiente:
    ...
    | Condición                                    | La temperatura supera los 70°    |
    | Agregación                                  | None                              |
...
2. Para definir la acción, use la información de la tabla siguiente:
    ...
    | Configuración      | Value                                               |
    | ------------ | --------------------------------------------------- |
    | Nombre para mostrar | Alerta de temperatura por correo electrónico                             |
