...
2. En el menú izquierdo, seleccione **Exportación de datos continua**.
    ...
    > [!Note]
    > Si no ve la opción de Exportación de datos continua en el menú izquierdo, significa que no es un administrador de la aplicación. Hable con un administrador para configurar la exportación de datos.
