...
ms.locfileid: "72990335"
---
# <a name="create-a-new-device-template-version-preview-features"></a>Creación de una nueva versión de plantilla de dispositivo (características en versión preliminar)
...
> [!NOTE]
> Para más información sobre cómo crear una plantilla de dispositivo, consulte [Configuración de una plantilla de dispositivo](howto-set-up-template-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
![Migración de un dispositivo](media/howto-version-device-template-pnp/pick-version.png)
...
> [Creación de reglas de telemetría](tutorial-create-telemetry-rules-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
