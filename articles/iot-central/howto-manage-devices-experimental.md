...
ms.locfileid: "55768648"
---
# <a name="manage-devices-in-your-azure-iot-central-application-new-ui-design"></a>Administración de dispositivos en la aplicación de Azure IoT Central (nuevo diseño de la interfaz de usuario)
...
1. Elija **Device Explorer** en el menú de navegación izquierdo. Aquí verá una lista de las [plantillas de dispositivo](howto-set-up-template-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
1. En el panel derecho de la página **Device Explorer**, verá una lista de dispositivos creados con esa plantilla de dispositivo. Elija un dispositivo para ver la página de detalles de ese dispositivo:
    ...
    ![Página Detalles del dispositivo](./media/howto-manage-devices-experimental/devicelist.png)
...
1. Haga clic en **Import**.
    ...
    ![Acción de importación](./media/howto-manage-devices-experimental/BulkImport1.png)
...
1. Una vez finalizada la importación, se muestra un mensaje de confirmación en la cuadrícula de dispositivos.
    ...
    ![Importación correcta](./media/howto-manage-devices-experimental/BulkImport3.png)
...
1. En el panel izquierdo, elija **Unassociated devices** (Dispositivos no asociados):
    ...
    ![Dispositivos no asociados](./media/howto-manage-devices-experimental/UnassociatedDevices1.png)

1. Seleccione los dispositivos que quiere asociar con una plantilla:

1. Haga clic en **Asociar**:

    ![Asociar dispositivos](./media/howto-manage-devices-experimental/UnassociatedDevices2.png)
...
Para conectar un dispositivo real a IoT Central, necesita su cadena de conexión. Puede exportar los detalles del dispositivo en bloque para obtener las cadenas de conexión y otras propiedades. El proceso de exportación crea un archivo CSV con la identidad, nombre y cadena de conexión principal de todos los dispositivos seleccionados.
...
1. Seleccione los dispositivos que desea exportar y, a continuación, haga clic en la acción **Exportar**.
    ...
    ![Exportación](./media/howto-manage-devices-experimental/Export1.png)
...
1. Haga clic en el **mensaje de operación correcta** para descargar el archivo en una carpeta local en el disco.
    ...
    ![Exportación correcta](./media/howto-manage-devices-experimental/Export2.png)
...
> [How to use device sets](howto-use-device-sets-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) (Uso de conjuntos de dispositivos)
