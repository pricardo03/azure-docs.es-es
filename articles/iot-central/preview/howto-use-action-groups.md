...
ms.locfileid: "74974366"
---
# <a name="group-multiple-actions-to-run-from-one-or-more-rules-preview-features"></a>Agrupación de varias acciones para ejecutar desde una o varias reglas (Características en vista previa (GB))
