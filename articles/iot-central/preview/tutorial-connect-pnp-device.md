---
title: 'Tutorial: Conexión de un dispositivo de IoT Plug and Play (versión preliminar) a Azure IoT Central'
...
1. Inicie sesión en la aplicación de IoT Central que creó mediante la plantilla **Custom app > Preview application (Personalizar aplicación > Aplicación de versión preliminar)** en el inicio rápido [Creación de una aplicación de Azure IoT Central (características de versión preliminar)](./quick-deploy-iot-central.md).
