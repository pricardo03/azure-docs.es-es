...
1. Haga clic en **Generar**.
    ![Captura de pantalla de la página de tokens de acceso](media/howto-use-iotc-explorer-experimental/accesstokenspage.png)
...
1. Escriba un nombre para el token, haga clic en **Siguiente**, y **copie el valor del token**.
    ...
    ![Captura de pantalla del cuadro diálogo de la opción para copiar el token de acceso](media/howto-use-iotc-explorer-experimental/copyaccesstoken.png)
...
![salida del comando monitor-messages](media/howto-use-iotc-explorer-experimental/monitormessages.png)
...
![salida del comando get-twin](media/howto-use-iotc-explorer-experimental/getdevicetwin.png)
...
Ahora que ya ha aprendido a usar IoT Central Explorer, el siguiente paso sugerido es explorar las opciones de [administración de dispositivos de IoT Central](howto-manage-devices-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
