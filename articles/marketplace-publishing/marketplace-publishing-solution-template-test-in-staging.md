...
3. Inicie sesión en Azure Portal mediante el identificador de suscripción que usó en el paso anterior.
4. Realice al menos una ronda de pruebas en Azure Portal sobre los puntos que se mencionan a continuación:
...
Si está satisfecho con los resultados, puede continuar en la fase de publicación de la oferta final, **paso 4**:  [Implementación de su oferta en Marketplace](marketplace-publishing-push-to-production.md). Si no, realice cambios en la oferta y vuelva a solicitar la certificación.
