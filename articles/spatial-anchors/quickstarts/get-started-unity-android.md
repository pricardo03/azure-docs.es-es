...
- La aplicación debe usar la versión **1.5** de ARCore SDK para Unity (la compatibilidad con ARCore 1.6+ estará disponible en una fecha posterior).
