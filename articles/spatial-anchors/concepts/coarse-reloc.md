---
title: Relocalización general | Microsoft Docs
...
Los Spatial Anchors de Azure solo realizarán un seguimiento de las balizas Bluetooth que se encuentran en la lista. Sin embargo, las balizas maliciosas programadas para tener UUID en la lista blanca aún pueden afectar negativamente la calidad del servicio. Por ese motivo, solo debe usar balizas en espacios seleccionados en los que pueda controlar su implementación.
