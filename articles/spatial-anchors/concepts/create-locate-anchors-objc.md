---
title: Crear y localizar los anclajes mediante Azure espacial anclajes en Objective-C | Microsoft Docs
...
ms.locfileid: "57850741"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-objective-c"></a>Crear y localizar los anclajes mediante Azure espacial anclajes en Objective-C
...
Azure Spatial Anchors permite compartir delimitadores entre diferentes dispositivos de todo el mundo. Admite varios entornos de desarrollo. En este artículo, analizaremos en profundidad para saber cómo hacerlo en Objective-C.
