---
title: Solución de problemas del cifrado de datos para un servidor único de Azure Database for PostgreSQL
description: Aprenda a solucionar problemas del cifrado de datos para el servidor único de Azure Database for PostgreSQL.
author: kummanish
ms.author: manishku
...
ms.locfileid: "77371474"
---
# <a name="troubleshooting-data-encryption-with-customer-managed-keys-in-azure-database-for-postgresql---single-server"></a>Solución de problemas del cifrado de datos con claves administradas por el cliente en el servidor único de Azure Database for PostgreSQL
En este artículo se describe cómo identificar y resolver problemas y errores comunes que se producen en un servidor único de Azure Database for PostgreSQL configurado con cifrado de datos mediante una clave administrada por el cliente.
...
* La identidad administrada por la instancia del servidor único de Azure Database for PostgreSQL se eliminó accidentalmente.
* Los permisos concedidos a la identidad administrada de Azure Database for PostgreSQL para las claves no son suficientes (no incluyen los permisos Get, Wrap ni Unwrap).
* Los permisos para la identidad administrada por la instancia del servidor único de Azure Database for PostgreSQL se revocaron o eliminaron.
...
[Configuración del cifrado de datos con una clave administrada por el cliente en Azure Database for PostgreSQL mediante Azure Portal](howto-data-encryption-portal.md).