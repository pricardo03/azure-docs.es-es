...
---
# <a name="azure-database-for-postgresql-use-php-to-connect-and-query-data"></a>Azure Database for PostgreSQL: Uso de PHP para conectarse a los datos y consultarlos
