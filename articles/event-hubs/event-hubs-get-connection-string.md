...
Puede usar Get-AzureRmEventHubNamespaceKey para obtener la cadena de conexión para el nombre de directiva o regla especificada, tal como se muestra a continuación:
