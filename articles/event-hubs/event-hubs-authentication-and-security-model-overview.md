---
title: 'Modelo de autenticación y seguridad: Azure Event Hubs | Microsoft Docs'
description: En este artículo se describe la autenticación y la seguridad de Azure Event Hubs.
services: event-hubs
